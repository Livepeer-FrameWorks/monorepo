...
func billingQueryContracts() []queryContract {
	...
	return []queryContract{
		...
		{APIUsageByDimension, []any{contractTenantID, startMS, endMS, contractTenantID, startMS}},
		{ClusterStreamRuntime, []any{contractTenantID, startMS, endMS, contractTenantID, startMS}},
