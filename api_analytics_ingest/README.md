...
Consumes analytics and service-plane events from Kafka and writes time-series data to ClickHouse. **Self-hostable with on-premise ClickHouse**—your analytics data stays on your infrastructure.
