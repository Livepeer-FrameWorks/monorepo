...
| Infrastructure  | `browse_marketplace`, `subscribe_to_cluster`, `set_preferred_cluster`, `create_edge_cluster`, `create_enrollment_token`, `get_node_info`, `manage_node`, `set_node_mode`, `get_node_health` | `nodes://list`, `nodes://{id}`, `clusters://list`, `clusters://{id}`, `clusters://marketplace`                                                        | Gateway       |
