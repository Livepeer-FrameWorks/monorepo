...
var graphqlMutationClasses = map[string]Class{
	...
	"createWebhookEndpoint":          Control,
	"updateWebhookEndpoint":          Control,
	"deleteWebhookEndpoint":          Control,
	"enableWebhookEndpoint":          Control,
	"disableWebhookEndpoint":         Control,
	"rotateWebhookEndpointSecret":    Control,
	"testWebhookEndpoint":            Control,
	"replayWebhookDelivery":          Control,
	"replayWebhookDeliveries":        Control,
...
var mcpToolClasses = map[string]Class{
	"get_media_placement_policy":          Read,
	"get_media_placement_options":         Read,
	"preview_media_placement":             Read,
	...
	"get_cluster_media_consent_change":    Read,
	...
	"get_webhook_delivery":                Read,
	"list_webhook_event_types":            Read,
	"create_webhook_endpoint":             Control,
	"update_webhook_endpoint":             Control,
	"delete_webhook_endpoint":             Control,
	"enable_webhook_endpoint":             Control,
	"disable_webhook_endpoint":            Control,
	"rotate_webhook_secret":               Control,
	"test_webhook_endpoint":               Control,
	"replay_webhook_delivery":             Control,
	"replay_webhook_deliveries":           Control,
