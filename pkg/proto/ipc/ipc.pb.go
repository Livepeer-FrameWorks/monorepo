...
// ClusterRejectReason standardizes rejection reasons for audit trails.
...
const (
	RestreamState_RESTREAM_STATE_UNSPECIFIED RestreamState = 0
	RestreamState_RESTREAM_STATE_PENDING     RestreamState = 1
	RestreamState_RESTREAM_STATE_PUSHING     RestreamState = 2
	RestreamState_RESTREAM_STATE_RETRYING    RestreamState = 3
	RestreamState_RESTREAM_STATE_STOPPING    RestreamState = 4
	RestreamState_RESTREAM_STATE_IDLE        RestreamState = 5
	RestreamState_RESTREAM_STATE_FAILED      RestreamState = 6
)

// Enum value maps for RestreamState.
var (
	RestreamState_name = map[int32]string{
		0: "RESTREAM_STATE_UNSPECIFIED",
		1: "RESTREAM_STATE_PENDING",
		2: "RESTREAM_STATE_PUSHING",
		3: "RESTREAM_STATE_RETRYING",
		4: "RESTREAM_STATE_STOPPING",
		5: "RESTREAM_STATE_IDLE",
		6: "RESTREAM_STATE_FAILED",
	}
	RestreamState_value = map[string]int32{
		"RESTREAM_STATE_UNSPECIFIED": 0,
		"RESTREAM_STATE_PENDING":     1,
		"RESTREAM_STATE_PUSHING":     2,
		"RESTREAM_STATE_RETRYING":    3,
		"RESTREAM_STATE_STOPPING":    4,
		"RESTREAM_STATE_IDLE":        5,
		"RESTREAM_STATE_FAILED":      6,
	}
)

func (x RestreamState) Enum() *RestreamState {
	p := new(RestreamState)
	*p = x
	return p
}

func (x RestreamState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
func (x RestreamReason) Enum() *RestreamReason {
	p := new(RestreamReason)
	*p = x
	return p
}

func (x RestreamReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
const (
	MistTriggerAction_MIST_TRIGGER_ACTION_UNSPECIFIED    MistTriggerAction = 0 // Legacy response-body interpretation.
	MistTriggerAction_MIST_TRIGGER_ACTION_VALUE          MistTriggerAction = 1
	MistTriggerAction_MIST_TRIGGER_ACTION_DENY           MistTriggerAction = 2
	MistTriggerAction_MIST_TRIGGER_ACTION_KEEP           MistTriggerAction = 3
	MistTriggerAction_MIST_TRIGGER_ACTION_OFFLINE        MistTriggerAction = 4
	MistTriggerAction_MIST_TRIGGER_ACTION_USE_CONFIGURED MistTriggerAction = 5
)

// Enum value maps for MistTriggerAction.
var (
	MistTriggerAction_name = map[int32]string{
		0: "MIST_TRIGGER_ACTION_UNSPECIFIED",
		1: "MIST_TRIGGER_ACTION_VALUE",
		2: "MIST_TRIGGER_ACTION_DENY",
		3: "MIST_TRIGGER_ACTION_KEEP",
		4: "MIST_TRIGGER_ACTION_OFFLINE",
		5: "MIST_TRIGGER_ACTION_USE_CONFIGURED",
	}
	MistTriggerAction_value = map[string]int32{
		"MIST_TRIGGER_ACTION_UNSPECIFIED":    0,
		"MIST_TRIGGER_ACTION_VALUE":          1,
		"MIST_TRIGGER_ACTION_DENY":           2,
		"MIST_TRIGGER_ACTION_KEEP":           3,
		"MIST_TRIGGER_ACTION_OFFLINE":        4,
		"MIST_TRIGGER_ACTION_USE_CONFIGURED": 5,
	}
)

func (x MistTriggerAction) Enum() *MistTriggerAction {
	p := new(MistTriggerAction)
	*p = x
	return p
}

func (x MistTriggerAction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
const (
	TriggerAckErrorCode_TRIGGER_ACK_ERROR_NONE                   TriggerAckErrorCode = 0
	TriggerAckErrorCode_TRIGGER_ACK_ERROR_INTERNAL               TriggerAckErrorCode = 1 // Consult retryable; deterministic internal outcomes are permanent
	TriggerAckErrorCode_TRIGGER_ACK_ERROR_DOWNSTREAM_UNAVAILABLE TriggerAckErrorCode = 2 // Retryable
	TriggerAckErrorCode_TRIGGER_ACK_ERROR_KAFKA_PUBLISH          TriggerAckErrorCode = 3 // Retryable
	TriggerAckErrorCode_TRIGGER_ACK_ERROR_PARSE                  TriggerAckErrorCode = 4 // Non-retryable
	TriggerAckErrorCode_TRIGGER_ACK_ERROR_SCHEMA                 TriggerAckErrorCode = 5 // Non-retryable
	TriggerAckErrorCode_TRIGGER_ACK_ERROR_TENANT_MISSING         TriggerAckErrorCode = 6 // Non-retryable
)

// Enum value maps for TriggerAckErrorCode.
var (
	TriggerAckErrorCode_name = map[int32]string{
		0: "TRIGGER_ACK_ERROR_NONE",
		1: "TRIGGER_ACK_ERROR_INTERNAL",
		2: "TRIGGER_ACK_ERROR_DOWNSTREAM_UNAVAILABLE",
		3: "TRIGGER_ACK_ERROR_KAFKA_PUBLISH",
		4: "TRIGGER_ACK_ERROR_PARSE",
		5: "TRIGGER_ACK_ERROR_SCHEMA",
		6: "TRIGGER_ACK_ERROR_TENANT_MISSING",
	}
	TriggerAckErrorCode_value = map[string]int32{
		"TRIGGER_ACK_ERROR_NONE":                   0,
		"TRIGGER_ACK_ERROR_INTERNAL":               1,
		"TRIGGER_ACK_ERROR_DOWNSTREAM_UNAVAILABLE": 2,
		"TRIGGER_ACK_ERROR_KAFKA_PUBLISH":          3,
		"TRIGGER_ACK_ERROR_PARSE":                  4,
		"TRIGGER_ACK_ERROR_SCHEMA":                 5,
		"TRIGGER_ACK_ERROR_TENANT_MISSING":         6,
	}
)

func (x TriggerAckErrorCode) Enum() *TriggerAckErrorCode {
	p := new(TriggerAckErrorCode)
	*p = x
	return p
}

func (x TriggerAckErrorCode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
// active-DVR refuse-S3 rule and HLS gap marker rendering.
type AssetState int32

const (
	AssetState_ASSET_STATE_UNSPECIFIED    AssetState = 0
	AssetState_ASSET_STATE_PLAYABLE       AssetState = 1 // resolved; media_presigned_url is valid
	AssetState_ASSET_STATE_SOURCE_MISSING AssetState = 2 // no durable source → 404/500
	AssetState_ASSET_STATE_ACTIVE_DVR     AssetState = 3 // active DVR; rolling-window playback rules
)
...
var (
	AssetState_name = map[int32]string{
		...
		1: "ASSET_STATE_PLAYABLE",
		2: "ASSET_STATE_SOURCE_MISSING",
		3: "ASSET_STATE_ACTIVE_DVR",
	}
	AssetState_value = map[string]int32{
		"ASSET_STATE_UNSPECIFIED":    0,
		"ASSET_STATE_PLAYABLE":       1,
		"ASSET_STATE_SOURCE_MISSING": 2,
		"ASSET_STATE_ACTIVE_DVR":     3,
	}
)
...
// Covers origin-pull replication lifecycle, peer topology changes,
// QueryStream fan-out, and loop prevention.
type FederationEventType int32

const (
	FederationEventType_FEDERATION_EVENT_UNSPECIFIED FederationEventType = 0
	FederationEventType_ORIGIN_PULL_ARRANGED         FederationEventType = 1 // arrangeOriginPull() succeeded; DTSC pull initiated
	FederationEventType_ORIGIN_PULL_COMPLETED        FederationEventType = 2 // Replicated stream detected as live on local edge
	FederationEventType_ORIGIN_PULL_FAILED           FederationEventType = 3 // arrangeOriginPull() failed (RPC error, rejected, no capacity)
	FederationEventType_FEDERATION_QUERY             FederationEventType = 4 // a cross-cluster QueryStream fan-out completed
	FederationEventType_PEER_CONNECTED               FederationEventType = 5 // PeerChannel established to remote cluster
	FederationEventType_PEER_DISCONNECTED            FederationEventType = 6 // PeerChannel lost (error or missed heartbeats)
	FederationEventType_LEADER_ACQUIRED              FederationEventType = 7 // Redis leader lease acquired for PeerManager
	FederationEventType_LEADER_LOST                  FederationEventType = 8 // Redis leader lease lost
	FederationEventType_REPLICATION_LOOP_PREVENTED   FederationEventType = 9 // Loop check blocked a redundant origin-pull
)

// Enum value maps for FederationEventType.
var (
	FederationEventType_name = map[int32]string{
		0: "FEDERATION_EVENT_UNSPECIFIED",
		1: "ORIGIN_PULL_ARRANGED",
		2: "ORIGIN_PULL_COMPLETED",
		3: "ORIGIN_PULL_FAILED",
		4: "FEDERATION_QUERY",
		5: "PEER_CONNECTED",
		6: "PEER_DISCONNECTED",
		7: "LEADER_ACQUIRED",
		8: "LEADER_LOST",
		9: "REPLICATION_LOOP_PREVENTED",
	}
	FederationEventType_value = map[string]int32{
		"FEDERATION_EVENT_UNSPECIFIED": 0,
		"ORIGIN_PULL_ARRANGED":         1,
		"ORIGIN_PULL_COMPLETED":        2,
		"ORIGIN_PULL_FAILED":           3,
		"FEDERATION_QUERY":             4,
		"PEER_CONNECTED":               5,
		"PEER_DISCONNECTED":            6,
		"LEADER_ACQUIRED":              7,
		"LEADER_LOST":                  8,
		"REPLICATION_LOOP_PREVENTED":   9,
	}
)

func (x FederationEventType) Enum() *FederationEventType {
	p := new(FederationEventType)
	*p = x
	return p
}

func (x FederationEventType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
type ArtifactNodeCopyEvent_Transition int32

const (
	ArtifactNodeCopyEvent_TRANSITION_UNSPECIFIED ArtifactNodeCopyEvent_Transition = 0
	ArtifactNodeCopyEvent_GAINED                 ArtifactNodeCopyEvent_Transition = 1 // node now holds a local copy (present)
	ArtifactNodeCopyEvent_LOST                   ArtifactNodeCopyEvent_Transition = 2 // node no longer holds it (evicted / orphaned / purged)
	ArtifactNodeCopyEvent_UPDATED                ArtifactNodeCopyEvent_Transition = 3 // still present; role or completeness changed
)

// Enum value maps for ArtifactNodeCopyEvent_Transition.
var (
	ArtifactNodeCopyEvent_Transition_name = map[int32]string{
		0: "TRANSITION_UNSPECIFIED",
		1: "GAINED",
		2: "LOST",
		3: "UPDATED",
	}
	ArtifactNodeCopyEvent_Transition_value = map[string]int32{
...
func (x ArtifactNodeCopyEvent_Transition) Enum() *ArtifactNodeCopyEvent_Transition {
	p := new(ArtifactNodeCopyEvent_Transition)
	*p = x
	return p
}

func (x ArtifactNodeCopyEvent_Transition) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
// Deprecated: Use ArtifactNodeCopyEvent_Transition.Descriptor instead.
func (ArtifactNodeCopyEvent_Transition) EnumDescriptor() ([]byte, []int) {
	return file_ipc_proto_rawDescGZIP(), []int{9, 0}
}

// Source dispatch — Foghorn picks at CreateClip time based on the
// requested range. Helmsman branches on source_kind:
//
//	LIVE          — pull from the live MistServer process
//	DVR_ROLLING   — pull from local TS segments under the rolling
//	                DVR window; source_dvr_hash names the DVR row
//	CHAPTER       — pull from the chapter artifact's canonical .mkv
//	                via the relay; source_chapter_artifact_hash
//	                names the artifact
type ClipPullRequest_SourceKind int32

const (
	ClipPullRequest_SOURCE_KIND_UNSPECIFIED ClipPullRequest_SourceKind = 0
	ClipPullRequest_SOURCE_KIND_LIVE        ClipPullRequest_SourceKind = 1
	ClipPullRequest_SOURCE_KIND_DVR_ROLLING ClipPullRequest_SourceKind = 2
	ClipPullRequest_SOURCE_KIND_CHAPTER     ClipPullRequest_SourceKind = 3
)

// Enum value maps for ClipPullRequest_SourceKind.
var (
	ClipPullRequest_SourceKind_name = map[int32]string{
		0: "SOURCE_KIND_UNSPECIFIED",
		1: "SOURCE_KIND_LIVE",
		2: "SOURCE_KIND_DVR_ROLLING",
		3: "SOURCE_KIND_CHAPTER",
	}
	ClipPullRequest_SourceKind_value = map[string]int32{
		"SOURCE_KIND_UNSPECIFIED": 0,
		"SOURCE_KIND_LIVE":        1,
		"SOURCE_KIND_DVR_ROLLING": 2,
		"SOURCE_KIND_CHAPTER":     3,
	}
)

func (x ClipPullRequest_SourceKind) Enum() *ClipPullRequest_SourceKind {
	p := new(ClipPullRequest_SourceKind)
	*p = x
	return p
}

func (x ClipPullRequest_SourceKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
func (ClipPullRequest_SourceKind) EnumDescriptor() ([]byte, []int) {
	return file_ipc_proto_rawDescGZIP(), []int{37, 0}
}

// Read-pattern hint for sidecar admission policy. Foghorn echoes this back
// in policy_hint when it has a stronger opinion (e.g., processing input is
// always sequential one-shot regardless of caller).
type RelayResolveRequest_RelayHint int32

const (
	RelayResolveRequest_RELAY_HINT_UNSPECIFIED        RelayResolveRequest_RelayHint = 0
	RelayResolveRequest_RELAY_HINT_RANDOM_ACCESS      RelayResolveRequest_RelayHint = 1 // playback — seekable, replayable
	RelayResolveRequest_RELAY_HINT_SEQUENTIAL_ONESHOT RelayResolveRequest_RelayHint = 2 // processing input — read once
)

// Enum value maps for RelayResolveRequest_RelayHint.
var (
	RelayResolveRequest_RelayHint_name = map[int32]string{
		0: "RELAY_HINT_UNSPECIFIED",
		1: "RELAY_HINT_RANDOM_ACCESS",
		2: "RELAY_HINT_SEQUENTIAL_ONESHOT",
	}
	RelayResolveRequest_RelayHint_value = map[string]int32{
		"RELAY_HINT_UNSPECIFIED":        0,
		"RELAY_HINT_RANDOM_ACCESS":      1,
		"RELAY_HINT_SEQUENTIAL_ONESHOT": 2,
	}
)

func (x RelayResolveRequest_RelayHint) Enum() *RelayResolveRequest_RelayHint {
	p := new(RelayResolveRequest_RelayHint)
	*p = x
	return p
}

func (x RelayResolveRequest_RelayHint) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
func (RelayResolveRequest_RelayHint) EnumDescriptor() ([]byte, []int) {
	return file_ipc_proto_rawDescGZIP(), []int{73, 0}
}

// Foghorn's recommendation for admission policy. Sidecar honors as a hint;
// local pressure/intent still overrides.
type RelayResolveResponse_CacheDecisionHint int32

const (
	RelayResolveResponse_CACHE_HINT_UNSPECIFIED RelayResolveResponse_CacheDecisionHint = 0
	RelayResolveResponse_CACHE_HINT_PREFER_DISK RelayResolveResponse_CacheDecisionHint = 1 // playback, replayable
	RelayResolveResponse_CACHE_HINT_PREFER_MEM  RelayResolveResponse_CacheDecisionHint = 2 // processing input, one-shot
)

// Enum value maps for RelayResolveResponse_CacheDecisionHint.
var (
	RelayResolveResponse_CacheDecisionHint_name = map[int32]string{
		0: "CACHE_HINT_UNSPECIFIED",
		1: "CACHE_HINT_PREFER_DISK",
		2: "CACHE_HINT_PREFER_MEM",
	}
	RelayResolveResponse_CacheDecisionHint_value = map[string]int32{
		"CACHE_HINT_UNSPECIFIED": 0,
		"CACHE_HINT_PREFER_DISK": 1,
		"CACHE_HINT_PREFER_MEM":  2,
	}
)

func (x RelayResolveResponse_CacheDecisionHint) Enum() *RelayResolveResponse_CacheDecisionHint {
	p := new(RelayResolveResponse_CacheDecisionHint)
	*p = x
	return p
}

func (x RelayResolveResponse_CacheDecisionHint) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
const (
	...
	StorageLifecycleData_ACTION_CACHE_FAILED  StorageLifecycleData_Action = 9  // Read-through cache fill from S3 failed
...
func (StorageLifecycleData_Action) EnumDescriptor() ([]byte, []int) {
	return file_ipc_proto_rawDescGZIP(), []int{79, 0}
}

// Typed failure reason for CACHE_FAILED rows so analytics can
// distinguish "out of space" from "S3 5xx'd" from "local IO error."
type StorageLifecycleData_CacheFailureReason int32

const (
	StorageLifecycleData_CACHE_REASON_UNSPECIFIED        StorageLifecycleData_CacheFailureReason = 0
	StorageLifecycleData_CACHE_REASON_INSUFFICIENT_SPACE StorageLifecycleData_CacheFailureReason = 1 // Eviction tried; still not enough room
	StorageLifecycleData_CACHE_REASON_DOWNLOAD_ERROR     StorageLifecycleData_CacheFailureReason = 2 // presigned GET / network / S3
	StorageLifecycleData_CACHE_REASON_LOCAL_IO           StorageLifecycleData_CacheFailureReason = 3 // mkdir/create/rename failed for non-space reasons
	StorageLifecycleData_CACHE_REASON_PRESIGNED_INVALID  StorageLifecycleData_CacheFailureReason = 4 // missing/expired URL
)

// Enum value maps for StorageLifecycleData_CacheFailureReason.
var (
	StorageLifecycleData_CacheFailureReason_name = map[int32]string{
		0: "CACHE_REASON_UNSPECIFIED",
		1: "CACHE_REASON_INSUFFICIENT_SPACE",
		2: "CACHE_REASON_DOWNLOAD_ERROR",
		3: "CACHE_REASON_LOCAL_IO",
		4: "CACHE_REASON_PRESIGNED_INVALID",
	}
	StorageLifecycleData_CacheFailureReason_value = map[string]int32{
		"CACHE_REASON_UNSPECIFIED":        0,
		"CACHE_REASON_INSUFFICIENT_SPACE": 1,
		"CACHE_REASON_DOWNLOAD_ERROR":     2,
		"CACHE_REASON_LOCAL_IO":           3,
		"CACHE_REASON_PRESIGNED_INVALID":  4,
	}
)

func (x StorageLifecycleData_CacheFailureReason) Enum() *StorageLifecycleData_CacheFailureReason {
	p := new(StorageLifecycleData_CacheFailureReason)
	*p = x
	return p
}

func (x StorageLifecycleData_CacheFailureReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
func (StorageLifecycleData_CacheFailureReason) EnumDescriptor() ([]byte, []int) {
	return file_ipc_proto_rawDescGZIP(), []int{79, 1}
}
...
func (ClipLifecycleData_Stage) EnumDescriptor() ([]byte, []int) {
	return file_ipc_proto_rawDescGZIP(), []int{107, 0}
}
...
// locally by the recording/processing sidecar that produced it; eligible to
// serve cross-cluster peer-relay reads when is_complete=true. This is a
// producer/serving role, not the durable copy (that lives in object storage).
// CACHE = a materialized full file synced from object storage to this node; never
// authoritative for peer-relay. (Read-through relay block caches — <asset>.blocks/ —
// are NOT reported here: the poller only sees materialized full files, so a partial
// block cache is invisible to node-copy telemetry.) The polling path reports CACHE;
// finalizer RPCs report ORIGIN. Origin-wins upsert in Foghorn ensures CACHE writes
// can't downgrade an ORIGIN row.
type StoredArtifact_Role int32

const (
	StoredArtifact_ROLE_UNSPECIFIED StoredArtifact_Role = 0
	StoredArtifact_ROLE_CACHE       StoredArtifact_Role = 1
	StoredArtifact_ROLE_ORIGIN      StoredArtifact_Role = 2
)

// Enum value maps for StoredArtifact_Role.
var (
	StoredArtifact_Role_name = map[int32]string{
		0: "ROLE_UNSPECIFIED",
		1: "ROLE_CACHE",
		2: "ROLE_ORIGIN",
	}
	StoredArtifact_Role_value = map[string]int32{
		"ROLE_UNSPECIFIED": 0,
		"ROLE_CACHE":       1,
		"ROLE_ORIGIN":      2,
	}
...
func (x StoredArtifact_Role) Enum() *StoredArtifact_Role {
	p := new(StoredArtifact_Role)
	*p = x
	return p
}

func (x StoredArtifact_Role) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
type ServiceEvent struct {
	...
	//	*ServiceEvent_ArtifactNodeCopyEvent
	//	*ServiceEvent_IncidentEvent
...
func (x *ServiceEvent) GetArtifactNodeCopyEvent() *ArtifactNodeCopyEvent {
	if x != nil {
		if x, ok := x.Payload.(*ServiceEvent_ArtifactNodeCopyEvent); ok {
			return x.ArtifactNodeCopyEvent
		}
	}
	return nil
}

func (x *ServiceEvent) GetIncidentEvent() *IncidentEvent {
	if x != nil {
		if x, ok := x.Payload.(*ServiceEvent_IncidentEvent); ok {
...
type ServiceEvent_ArtifactNodeCopyEvent struct {
	ArtifactNodeCopyEvent *ArtifactNodeCopyEvent `protobuf:"bytes,29,opt,name=artifact_node_copy_event,json=artifactNodeCopyEvent,proto3,oneof"`
}

type ServiceEvent_IncidentEvent struct {
	IncidentEvent *IncidentEvent `protobuf:"bytes,30,opt,name=incident_event,json=incidentEvent,proto3,oneof"`
}
...
func (*ServiceEvent_ArtifactNodeCopyEvent) isServiceEvent_Payload() {}

func (*ServiceEvent_IncidentEvent) isServiceEvent_Payload() {}
...
func (x *TenantEvent) GetAttribution() *common.SignupAttribution {
	if x != nil {
...
type ClusterEvent struct {
	...
	RejectReasonCode ClusterRejectReason    `protobuf:"varint,6,opt,name=reject_reason_code,json=rejectReasonCode,proto3,enum=helmsmancontrol.ClusterRejectReason" json:"reject_reason_code,omitempty"`
	// Transactional operator-access audits use typed before/after state instead
	// of overloading the human-readable reason field with JSON text.
...
func (x *ClusterEvent) GetRejectReasonCode() ClusterRejectReason {
	if x != nil {
...
func (x *ClusterEvent) GetBeforeState() *structpb.Struct {
	if x != nil {
...
func (x *ClusterEvent) GetAfterState() *structpb.Struct {
	if x != nil {
		return x.AfterState
	}
	return nil
...
// ArtifactNodeCopyEvent reports a per-(artifact, node) transition for a transient
// LOCAL NODE COPY of an artifact — not the durable copy, which lives in object
// storage and is tracked separately. Emitted by Foghorn when its artifact_nodes
// state changes (see docs/architecture/analytics-pipeline.md). GAINED = the node now
// holds a copy; LOST = it no longer does; UPDATED = still present but its role or
// completeness changed. role distinguishes the producer/relay source ("origin") from a
// synced pull ("cache"); is_complete marks a full local copy. The gateway resolves the
// node's cluster from the registry, so no cluster is carried here. version is a
// Foghorn-assigned monotonic revision used to order concurrent updates deterministically.
// tenant_id rides the ServiceEvent envelope.
type ArtifactNodeCopyEvent struct {
	state        protoimpl.MessageState           `protogen:"open.v1"`
	...
	Role         string                           `protobuf:"bytes,4,opt,name=role,proto3" json:"role,omitempty"` // "origin" | "cache"
	Transition   ArtifactNodeCopyEvent_Transition `protobuf:"varint,6,opt,name=transition,proto3,enum=helmsmancontrol.ArtifactNodeCopyEvent_Transition" json:"transition,omitempty"`
	IsComplete   bool                             `protobuf:"varint,7,opt,name=is_complete,json=isComplete,proto3" json:"is_complete,omitempty"` // full local copy present
	// Point-in-time size at this transition; not maintained between transitions (a
	// pure size change does not emit an event).
	SizeBytes     int64  `protobuf:"varint,8,opt,name=size_bytes,json=sizeBytes,proto3" json:"size_bytes,omitempty"`
	TimestampMs   int64  `protobuf:"varint,9,opt,name=timestamp_ms,json=timestampMs,proto3" json:"timestamp_ms,omitempty"` // when the transition was observed
	Version       uint64 `protobuf:"varint,10,opt,name=version,proto3" json:"version,omitempty"`                           // Foghorn-assigned monotonic revision (ordering)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ArtifactNodeCopyEvent) Reset() {
	*x = ArtifactNodeCopyEvent{}
	mi := &file_ipc_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ArtifactNodeCopyEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ArtifactNodeCopyEvent) ProtoMessage() {}

func (x *ArtifactNodeCopyEvent) ProtoReflect() protoreflect.Message {
	mi := &file_ipc_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ArtifactNodeCopyEvent.ProtoReflect.Descriptor instead.
func (*ArtifactNodeCopyEvent) Descriptor() ([]byte, []int) {
	return file_ipc_proto_rawDescGZIP(), []int{9}
}

func (x *ArtifactNodeCopyEvent) GetArtifactHash() string {
	if x != nil {
...
func (x *ArtifactNodeCopyEvent) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *ArtifactNodeCopyEvent) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
func (x *ArtifactNodeCopyEvent) GetTransition() ArtifactNodeCopyEvent_Transition {
	if x != nil {
		return x.Transition
	}
	return ArtifactNodeCopyEvent_TRANSITION_UNSPECIFIED
}

func (x *ArtifactNodeCopyEvent) GetIsComplete() bool {
	if x != nil {
		return x.IsComplete
	}
	return false
...
func (x *ArtifactNodeCopyEvent) GetSizeBytes() int64 {
	if x != nil {
		return x.SizeBytes
	}
	return 0
...
func (x *ArtifactNodeCopyEvent) GetTimestampMs() int64 {
	if x != nil {
...
func (x *ArtifactNodeCopyEvent) GetVersion() uint64 {
	if x != nil {
		return x.Version
	}
	return 0
...
// IncidentEvent is the realtime projection of a Lookout incident change. Lookout
// sends it twice per change: as service event "incident_updated" to the tenant
// that can see a tenant-scope incident (the envelope tenant), and as the
// tenantless "platform_incident_updated" for the platform operator audience,
// including platform-scope incidents.
type IncidentEvent struct {
	state      protoimpl.MessageState `protogen:"open.v1"`
	IncidentId string                 `protobuf:"bytes,1,opt,name=incident_id,json=incidentId,proto3" json:"incident_id,omitempty"`
	// The receiving tenant on "incident_updated"; the incident's owning tenant,
	// empty for a platform-scope incident, on "platform_incident_updated".
	TenantId  string `protobuf:"bytes,2,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`
	...
	// Timeline kind that produced this update: opened, alert_firing,
	// alert_resolved, acknowledged, assigned, note, resolved,
...
func (x *IncidentEvent) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (x *IncidentEvent) GetClusterId() string {
	if x != nil {
		return x.ClusterId
	}
	return ""
...
func (x *IncidentEvent) GetChange() string {
	if x != nil {
		return x.Change
	}
	return ""
...
func (x *IncidentEvent) GetUpdatedAtMs() int64 {
	if x != nil {
...
type ControlMessage struct {
	...
	//	*ControlMessage_MistTriggerAck
	//	*ControlMessage_ConfigSeed
	//	*ControlMessage_BalancerCapabilityUpdate
	//	*ControlMessage_ConfigSeedApplyResult
	...
	//	*ControlMessage_FreezeRequest
	//	*ControlMessage_TranscodeJobRequest
	//	*ControlMessage_TranscodeJobProgress
	//	*ControlMessage_TranscodeJobComplete
	//	*ControlMessage_ProcessingJobRequest
	//	*ControlMessage_ProcessingJobResult
	//	*ControlMessage_ProcessingJobProgress
	//	*ControlMessage_StopSessionsRequest
	//	*ControlMessage_InvalidateSessionsRequest
	//	*ControlMessage_ModeChangeRequest
	//	*ControlMessage_ActivatePushTargets
	//	*ControlMessage_DeactivatePushTargets
	//	*ControlMessage_PushTargetStatus
	//	*ControlMessage_ValidateEdgeTokenRequest
	//	*ControlMessage_ValidateEdgeTokenResponse
	//	*ControlMessage_EdgeMistAdminSessionRequest
	//	*ControlMessage_EdgeMistAdminSessionResponse
	//	*ControlMessage_ThumbnailUploadRequest
	//	*ControlMessage_ThumbnailUploadResponse
	//	*ControlMessage_ThumbnailUploaded
	//	*ControlMessage_DesiredStateUpdate
	//	*ControlMessage_UpdateApplyResult
	//	*ControlMessage_RecordDvrSegmentRequest
	//	*ControlMessage_RecordDvrSegmentResponse
	//	*ControlMessage_MarkDvrSegmentUploaded
	//	*ControlMessage_DvrSegmentDropped
	//	*ControlMessage_EvictableSegmentsRequest
	//	*ControlMessage_EvictableSegmentsResponse
	//	*ControlMessage_RetryDvrSegmentUpload
	//	*ControlMessage_ReclaimDvrSegment
	//	*ControlMessage_RestoreLocalSegmentIndexRequest
	//	*ControlMessage_RestoreLocalSegmentIndexResponse
	//	*ControlMessage_RelayResolveRequest
	//	*ControlMessage_RelayResolveResponse
	//	*ControlMessage_ApplyManagedStream
	//	*ControlMessage_RetractManagedStream
	//	*ControlMessage_DrainStreamRequest
	//	*ControlMessage_DrainStreamResponse
	//	*ControlMessage_AuthorizeRelayPullRequest
	//	*ControlMessage_AuthorizeRelayPullResponse
...
func (x *ControlMessage) GetMistTriggerAck() *MistTriggerAck {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_MistTriggerAck); ok {
			return x.MistTriggerAck
		}
	}
	return nil
}
...
func (x *ControlMessage) GetBalancerCapabilityUpdate() *BalancerCapabilityUpdate {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_BalancerCapabilityUpdate); ok {
			return x.BalancerCapabilityUpdate
		}
	}
	return nil
}

func (x *ControlMessage) GetConfigSeedApplyResult() *ConfigSeedApplyResult {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_ConfigSeedApplyResult); ok {
			return x.ConfigSeedApplyResult
		}
	}
	return nil
}
...
func (x *ControlMessage) GetFreezeRequest() *FreezeRequest {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_FreezeRequest); ok {
...
func (x *ControlMessage) GetProcessingJobRequest() *ProcessingJobRequest {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_ProcessingJobRequest); ok {
			return x.ProcessingJobRequest
		}
	}
	return nil
}

func (x *ControlMessage) GetProcessingJobResult() *ProcessingJobResult {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_ProcessingJobResult); ok {
			return x.ProcessingJobResult
		}
	}
	return nil
}

func (x *ControlMessage) GetProcessingJobProgress() *ProcessingJobProgress {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_ProcessingJobProgress); ok {
			return x.ProcessingJobProgress
		}
	}
	return nil
}
...
func (x *ControlMessage) GetInvalidateSessionsRequest() *InvalidateSessionsRequest {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_InvalidateSessionsRequest); ok {
			return x.InvalidateSessionsRequest
		}
	}
	return nil
}

func (x *ControlMessage) GetModeChangeRequest() *ModeChangeRequest {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_ModeChangeRequest); ok {
			return x.ModeChangeRequest
		}
	}
	return nil
}

func (x *ControlMessage) GetActivatePushTargets() *ActivatePushTargets {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_ActivatePushTargets); ok {
...
func (x *ControlMessage) GetDeactivatePushTargets() *DeactivatePushTargets {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_DeactivatePushTargets); ok {
...
func (x *ControlMessage) GetPushTargetStatus() *PushTargetStatusReport {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_PushTargetStatus); ok {
			return x.PushTargetStatus
		}
	}
	return nil
}

func (x *ControlMessage) GetValidateEdgeTokenRequest() *ValidateEdgeTokenRequest {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_ValidateEdgeTokenRequest); ok {
			return x.ValidateEdgeTokenRequest
		}
	}
	return nil
}

func (x *ControlMessage) GetValidateEdgeTokenResponse() *ValidateEdgeTokenResponse {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_ValidateEdgeTokenResponse); ok {
			return x.ValidateEdgeTokenResponse
		}
	}
	return nil
}

func (x *ControlMessage) GetEdgeMistAdminSessionRequest() *EdgeMistAdminSessionRequest {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_EdgeMistAdminSessionRequest); ok {
			return x.EdgeMistAdminSessionRequest
		}
	}
	return nil
}

func (x *ControlMessage) GetEdgeMistAdminSessionResponse() *EdgeMistAdminSessionResponse {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_EdgeMistAdminSessionResponse); ok {
			return x.EdgeMistAdminSessionResponse
		}
	}
	return nil
}

func (x *ControlMessage) GetThumbnailUploadRequest() *ThumbnailUploadRequest {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_ThumbnailUploadRequest); ok {
			return x.ThumbnailUploadRequest
		}
	}
	return nil
}

func (x *ControlMessage) GetThumbnailUploadResponse() *ThumbnailUploadResponse {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_ThumbnailUploadResponse); ok {
			return x.ThumbnailUploadResponse
		}
	}
	return nil
}

func (x *ControlMessage) GetThumbnailUploaded() *ThumbnailUploaded {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_ThumbnailUploaded); ok {
			return x.ThumbnailUploaded
		}
	}
	return nil
}

func (x *ControlMessage) GetDesiredStateUpdate() *DesiredStateUpdate {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_DesiredStateUpdate); ok {
...
func (x *ControlMessage) GetUpdateApplyResult() *UpdateApplyResult {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_UpdateApplyResult); ok {
			return x.UpdateApplyResult
		}
	}
	return nil
}

func (x *ControlMessage) GetRecordDvrSegmentRequest() *RecordDVRSegmentRequest {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_RecordDvrSegmentRequest); ok {
			return x.RecordDvrSegmentRequest
		}
	}
	return nil
}

func (x *ControlMessage) GetRecordDvrSegmentResponse() *RecordDVRSegmentResponse {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_RecordDvrSegmentResponse); ok {
			return x.RecordDvrSegmentResponse
		}
	}
	return nil
}

func (x *ControlMessage) GetMarkDvrSegmentUploaded() *MarkDVRSegmentUploaded {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_MarkDvrSegmentUploaded); ok {
			return x.MarkDvrSegmentUploaded
		}
	}
	return nil
}

func (x *ControlMessage) GetDvrSegmentDropped() *DVRSegmentDropped {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_DvrSegmentDropped); ok {
			return x.DvrSegmentDropped
		}
	}
	return nil
}

func (x *ControlMessage) GetEvictableSegmentsRequest() *EvictableSegmentsRequest {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_EvictableSegmentsRequest); ok {
			return x.EvictableSegmentsRequest
		}
	}
	return nil
}

func (x *ControlMessage) GetEvictableSegmentsResponse() *EvictableSegmentsResponse {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_EvictableSegmentsResponse); ok {
			return x.EvictableSegmentsResponse
		}
	}
	return nil
}

func (x *ControlMessage) GetRetryDvrSegmentUpload() *RetryDVRSegmentUpload {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_RetryDvrSegmentUpload); ok {
			return x.RetryDvrSegmentUpload
		}
	}
	return nil
}

func (x *ControlMessage) GetReclaimDvrSegment() *ReclaimDVRSegment {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_ReclaimDvrSegment); ok {
			return x.ReclaimDvrSegment
		}
	}
	return nil
}

func (x *ControlMessage) GetRestoreLocalSegmentIndexRequest() *RestoreLocalSegmentIndexRequest {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_RestoreLocalSegmentIndexRequest); ok {
			return x.RestoreLocalSegmentIndexRequest
		}
	}
	return nil
}

func (x *ControlMessage) GetRestoreLocalSegmentIndexResponse() *RestoreLocalSegmentIndexResponse {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_RestoreLocalSegmentIndexResponse); ok {
			return x.RestoreLocalSegmentIndexResponse
		}
	}
	return nil
}

func (x *ControlMessage) GetRelayResolveRequest() *RelayResolveRequest {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_RelayResolveRequest); ok {
			return x.RelayResolveRequest
		}
	}
	return nil
}

func (x *ControlMessage) GetRelayResolveResponse() *RelayResolveResponse {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_RelayResolveResponse); ok {
			return x.RelayResolveResponse
		}
	}
	return nil
}

func (x *ControlMessage) GetApplyManagedStream() *ApplyManagedStream {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_ApplyManagedStream); ok {
...
func (x *ControlMessage) GetRetractManagedStream() *RetractManagedStream {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_RetractManagedStream); ok {
...
func (x *ControlMessage) GetDrainStreamRequest() *DrainStreamRequest {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_DrainStreamRequest); ok {
			return x.DrainStreamRequest
		}
	}
	return nil
}

func (x *ControlMessage) GetDrainStreamResponse() *DrainStreamResponse {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_DrainStreamResponse); ok {
			return x.DrainStreamResponse
		}
	}
	return nil
}

func (x *ControlMessage) GetAuthorizeRelayPullRequest() *AuthorizeRelayPullRequest {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_AuthorizeRelayPullRequest); ok {
			return x.AuthorizeRelayPullRequest
		}
	}
	return nil
}

func (x *ControlMessage) GetAuthorizeRelayPullResponse() *AuthorizeRelayPullResponse {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_AuthorizeRelayPullResponse); ok {
			return x.AuthorizeRelayPullResponse
		}
	}
	return nil
}

func (x *ControlMessage) GetActivatePushTargetsResult() *ActivatePushTargetsResult {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_ActivatePushTargetsResult); ok {
			return x.ActivatePushTargetsResult
		}
	}
	return nil
}

func (x *ControlMessage) GetDeactivatePushTargetsResult() *DeactivatePushTargetsResult {
	if x != nil {
		if x, ok := x.Payload.(*ControlMessage_DeactivatePushTargetsResult); ok {
			return x.DeactivatePushTargetsResult
		}
	}
	return nil
}
...
type ControlMessage_MistTriggerAck struct {
	// Foghorn → Helmsman: durable ack for non-blocking final/accounting
	// triggers (USER_END, STREAM_END, PUSH_END, RECORDING_END,
	// RECORDING_SEGMENT, LIVEPEER_SEGMENT_COMPLETE,
	// PROCESS_AV_VIRTUAL_SEGMENT_COMPLETE). Sent only after Decklog's
	// SendEvent returns success, which only happens after the Kafka publish
	// commits — so a positive ack means the trigger is durably ingested.
	// Helmsman keeps its WAL entry pending until this lands; on negative
	// retryable ack, backoff+resend with the same stable RequestId.
	MistTriggerAck *MistTriggerAck `protobuf:"bytes,150,opt,name=mist_trigger_ack,json=mistTriggerAck,proto3,oneof"`
}
...
type ControlMessage_BalancerCapabilityUpdate struct {
	// Foghorn -> Helmsman: rotate only the node-bound Mist source lookup
	// capability without replaying TLS, Caddy, protocols, or baseline config.
	BalancerCapabilityUpdate *BalancerCapabilityUpdate `protobuf:"bytes,169,opt,name=balancer_capability_update,json=balancerCapabilityUpdate,proto3,oneof"`
}

type ControlMessage_ConfigSeedApplyResult struct {
	// Helmsman to Foghorn: per-seed apply result for TLS/Caddy activation.
	// Gates Navigator's DNS membership decisions.
	ConfigSeedApplyResult *ConfigSeedApplyResult `protobuf:"bytes,34,opt,name=config_seed_apply_result,json=configSeedApplyResult,proto3,oneof"`
}
...
type ControlMessage_FreezeRequest struct {
	// Proactive freeze (Foghorn -> Helmsman: sync local artifact to S3)
	FreezeRequest *FreezeRequest `protobuf:"bytes,51,opt,name=freeze_request,json=freezeRequest,proto3,oneof"`
}
...
type ControlMessage_ProcessingJobRequest struct {
	// VOD processing jobs (Foghorn <-> Helmsman)
	ProcessingJobRequest *ProcessingJobRequest `protobuf:"bytes,63,opt,name=processing_job_request,json=processingJobRequest,proto3,oneof"`
}

type ControlMessage_ProcessingJobResult struct {
	ProcessingJobResult *ProcessingJobResult `protobuf:"bytes,64,opt,name=processing_job_result,json=processingJobResult,proto3,oneof"`
}

type ControlMessage_ProcessingJobProgress struct {
	ProcessingJobProgress *ProcessingJobProgress `protobuf:"bytes,65,opt,name=processing_job_progress,json=processingJobProgress,proto3,oneof"`
}
...
type ControlMessage_InvalidateSessionsRequest struct {
	// Session invalidation (Foghorn -> Helmsman for re-running USER_NEW
	// after a playback-policy or signing-key change). Does NOT disconnect viewers.
	InvalidateSessionsRequest *InvalidateSessionsRequest `protobuf:"bytes,72,opt,name=invalidate_sessions_request,json=invalidateSessionsRequest,proto3,oneof"`
}

type ControlMessage_ModeChangeRequest struct {
	// Node mode change request (Helmsman -> Foghorn, from local agent/CLI)
	ModeChangeRequest *ModeChangeRequest `protobuf:"bytes,71,opt,name=mode_change_request,json=modeChangeRequest,proto3,oneof"`
}

type ControlMessage_ActivatePushTargets struct {
	// Multistream push target lifecycle (Foghorn <-> Helmsman)
	ActivatePushTargets *ActivatePushTargets `protobuf:"bytes,80,opt,name=activate_push_targets,json=activatePushTargets,proto3,oneof"`
}

type ControlMessage_DeactivatePushTargets struct {
	DeactivatePushTargets *DeactivatePushTargets `protobuf:"bytes,81,opt,name=deactivate_push_targets,json=deactivatePushTargets,proto3,oneof"`
}

type ControlMessage_PushTargetStatus struct {
	PushTargetStatus *PushTargetStatusReport `protobuf:"bytes,82,opt,name=push_target_status,json=pushTargetStatus,proto3,oneof"`
}

type ControlMessage_ValidateEdgeTokenRequest struct {
	// Edge API token validation (Helmsman -> Foghorn -> Commodore/JWT)
	ValidateEdgeTokenRequest *ValidateEdgeTokenRequest `protobuf:"bytes,90,opt,name=validate_edge_token_request,json=validateEdgeTokenRequest,proto3,oneof"`
}

type ControlMessage_ValidateEdgeTokenResponse struct {
	ValidateEdgeTokenResponse *ValidateEdgeTokenResponse `protobuf:"bytes,91,opt,name=validate_edge_token_response,json=validateEdgeTokenResponse,proto3,oneof"`
}

type ControlMessage_EdgeMistAdminSessionRequest struct {
	// Mist-admin session validation (Helmsman -> Foghorn -> Commodore).
	// Distinct from validate_edge_token because the session token is
	// bound to the connected node_id and carries different claims (the
	// operator-admin purpose, cluster_id, exp). Foghorn injects the
	// expected node_id at the relay so Helmsman cannot spoof it.
	EdgeMistAdminSessionRequest *EdgeMistAdminSessionRequest `protobuf:"bytes,92,opt,name=edge_mist_admin_session_request,json=edgeMistAdminSessionRequest,proto3,oneof"`
}

type ControlMessage_EdgeMistAdminSessionResponse struct {
	EdgeMistAdminSessionResponse *EdgeMistAdminSessionResponse `protobuf:"bytes,93,opt,name=edge_mist_admin_session_response,json=edgeMistAdminSessionResponse,proto3,oneof"`
}

type ControlMessage_ThumbnailUploadRequest struct {
	// Thumbnail asset upload (Helmsman -> Foghorn -> S3)
	ThumbnailUploadRequest *ThumbnailUploadRequest `protobuf:"bytes,100,opt,name=thumbnail_upload_request,json=thumbnailUploadRequest,proto3,oneof"`
}

type ControlMessage_ThumbnailUploadResponse struct {
	ThumbnailUploadResponse *ThumbnailUploadResponse `protobuf:"bytes,101,opt,name=thumbnail_upload_response,json=thumbnailUploadResponse,proto3,oneof"`
}

type ControlMessage_ThumbnailUploaded struct {
	ThumbnailUploaded *ThumbnailUploaded `protobuf:"bytes,102,opt,name=thumbnail_uploaded,json=thumbnailUploaded,proto3,oneof"`
}

type ControlMessage_DesiredStateUpdate struct {
	// Edge component desired-state updates
	DesiredStateUpdate *DesiredStateUpdate `protobuf:"bytes,110,opt,name=desired_state_update,json=desiredStateUpdate,proto3,oneof"`
}

type ControlMessage_UpdateApplyResult struct {
	UpdateApplyResult *UpdateApplyResult `protobuf:"bytes,111,opt,name=update_apply_result,json=updateApplyResult,proto3,oneof"`
}

type ControlMessage_RecordDvrSegmentRequest struct {
	// DVR per-segment ledger (Helmsman <-> Foghorn) — see docs/architecture/clips-dvr.md
	RecordDvrSegmentRequest *RecordDVRSegmentRequest `protobuf:"bytes,120,opt,name=record_dvr_segment_request,json=recordDvrSegmentRequest,proto3,oneof"`
}

type ControlMessage_RecordDvrSegmentResponse struct {
	RecordDvrSegmentResponse *RecordDVRSegmentResponse `protobuf:"bytes,121,opt,name=record_dvr_segment_response,json=recordDvrSegmentResponse,proto3,oneof"`
}

type ControlMessage_MarkDvrSegmentUploaded struct {
	MarkDvrSegmentUploaded *MarkDVRSegmentUploaded `protobuf:"bytes,122,opt,name=mark_dvr_segment_uploaded,json=markDvrSegmentUploaded,proto3,oneof"`
}

type ControlMessage_DvrSegmentDropped struct {
	DvrSegmentDropped *DVRSegmentDropped `protobuf:"bytes,123,opt,name=dvr_segment_dropped,json=dvrSegmentDropped,proto3,oneof"`
}

type ControlMessage_EvictableSegmentsRequest struct {
	EvictableSegmentsRequest *EvictableSegmentsRequest `protobuf:"bytes,124,opt,name=evictable_segments_request,json=evictableSegmentsRequest,proto3,oneof"`
}

type ControlMessage_EvictableSegmentsResponse struct {
	EvictableSegmentsResponse *EvictableSegmentsResponse `protobuf:"bytes,125,opt,name=evictable_segments_response,json=evictableSegmentsResponse,proto3,oneof"`
}

type ControlMessage_RetryDvrSegmentUpload struct {
	RetryDvrSegmentUpload *RetryDVRSegmentUpload `protobuf:"bytes,126,opt,name=retry_dvr_segment_upload,json=retryDvrSegmentUpload,proto3,oneof"`
}

type ControlMessage_ReclaimDvrSegment struct {
	// Foghorn -> Helmsman: delete a specific local TS segment file
	// after the chapter that owned it has reached state=frozen. The
	// recovery-bridge S3 object is deleted by Foghorn directly.
	ReclaimDvrSegment *ReclaimDVRSegment `protobuf:"bytes,129,opt,name=reclaim_dvr_segment,json=reclaimDvrSegment,proto3,oneof"`
}

type ControlMessage_RestoreLocalSegmentIndexRequest struct {
	// Sidecar restart reconciliation: bounded by request size (sidecar
	// batches discovered (artifact_hash, segment_name) pairs from local
	// disk into pages of ~500). Foghorn answers with current ledger state
	// for each requested name; sidecar repopulates its in-memory local
	// cache index from the responses.
	RestoreLocalSegmentIndexRequest *RestoreLocalSegmentIndexRequest `protobuf:"bytes,127,opt,name=restore_local_segment_index_request,json=restoreLocalSegmentIndexRequest,proto3,oneof"`
}

type ControlMessage_RestoreLocalSegmentIndexResponse struct {
	RestoreLocalSegmentIndexResponse *RestoreLocalSegmentIndexResponse `protobuf:"bytes,128,opt,name=restore_local_segment_index_response,json=restoreLocalSegmentIndexResponse,proto3,oneof"`
}

type ControlMessage_RelayResolveRequest struct {
	// Read-through relay resolution: sidecar asks Foghorn for the durable
	// source coordinates (presigned media GET, .dtsh GET/PUT, expected size,
	// DVR chapter segment refs) of an artifact it is about to serve via the
	// /internal/artifact/* HTTP relay. Same pattern as CanDelete /
	// FreezePermission: sidecar-originated request, Foghorn responds on the
	// same stream.
	RelayResolveRequest *RelayResolveRequest `protobuf:"bytes,140,opt,name=relay_resolve_request,json=relayResolveRequest,proto3,oneof"`
}

type ControlMessage_RelayResolveResponse struct {
	RelayResolveResponse *RelayResolveResponse `protobuf:"bytes,141,opt,name=relay_resolve_response,json=relayResolveResponse,proto3,oneof"`
}

type ControlMessage_ApplyManagedStream struct {
	// Foghorn -> Helmsman: concrete mist_native stream sync/unsync. Driven
	// by Foghorn's managed-stream reconciler, not by ConfigSeed. Apply means
	// "add/update this concrete Mist stream on this node now"; Retract means
	// "remove it now". Sidecar handlers map to mist.AddStreams / DelStreams.
	// Idempotent: re-Applying with identical fields is a no-op.
	ApplyManagedStream *ApplyManagedStream `protobuf:"bytes,160,opt,name=apply_managed_stream,json=applyManagedStream,proto3,oneof"`
}

type ControlMessage_RetractManagedStream struct {
	RetractManagedStream *RetractManagedStream `protobuf:"bytes,161,opt,name=retract_managed_stream,json=retractManagedStream,proto3,oneof"`
}

type ControlMessage_DrainStreamRequest struct {
	// Foghorn -> Helmsman: drain a specific runtime stream from the local
	// Mist process. Issued when a DB-confirmed projection change moves the
	// source to a new node, to drain the OLD owner so old viewer sessions
	// don't keep talking to the stale lingering buffer. Idempotent — missing
	// stream is success.
	DrainStreamRequest *DrainStreamRequest `protobuf:"bytes,162,opt,name=drain_stream_request,json=drainStreamRequest,proto3,oneof"`
}

type ControlMessage_DrainStreamResponse struct {
	DrainStreamResponse *DrainStreamResponse `protobuf:"bytes,163,opt,name=drain_stream_response,json=drainStreamResponse,proto3,oneof"`
}

type ControlMessage_AuthorizeRelayPullRequest struct {
	// Helmsman (serving edge) -> Foghorn: authorize an inbound peer-relay
	// pull that presented a peer_relay_grant_id. Foghorn responds on the
	// same stream. Same sidecar-originated request/response pattern as
	// RelayResolve.
	AuthorizeRelayPullRequest *AuthorizeRelayPullRequest `protobuf:"bytes,166,opt,name=authorize_relay_pull_request,json=authorizeRelayPullRequest,proto3,oneof"`
}

type ControlMessage_AuthorizeRelayPullResponse struct {
	AuthorizeRelayPullResponse *AuthorizeRelayPullResponse `protobuf:"bytes,167,opt,name=authorize_relay_pull_response,json=authorizeRelayPullResponse,proto3,oneof"`
}

type ControlMessage_ActivatePushTargetsResult struct {
	// Helmsman -> Foghorn: outcome of an ActivatePushTargets command. The
	// durable admission-effect obligation stays pending until this reports
	// converged=true, so a Helmsman crash after receiving the command, a
	// Mist push-list failure, or a failed PushStart is re-driven by the
	// obligation's next retry instead of being silently lost.
	ActivatePushTargetsResult *ActivatePushTargetsResult `protobuf:"bytes,168,opt,name=activate_push_targets_result,json=activatePushTargetsResult,proto3,oneof"`
}

type ControlMessage_DeactivatePushTargetsResult struct {
	// Helmsman reports teardown convergence after re-listing Mist. Foghorn's
	// durable offline obligation remains pending until this acknowledgement is
	// recorded, so a delivered command is never mistaken for a completed stop.
	DeactivatePushTargetsResult *DeactivatePushTargetsResult `protobuf:"bytes,170,opt,name=deactivate_push_targets_result,json=deactivatePushTargetsResult,proto3,oneof"`
}
...
func (*ControlMessage_MistTriggerAck) isControlMessage_Payload() {}

func (*ControlMessage_ConfigSeed) isControlMessage_Payload() {}

func (*ControlMessage_BalancerCapabilityUpdate) isControlMessage_Payload() {}

func (*ControlMessage_ConfigSeedApplyResult) isControlMessage_Payload() {}
...
func (*ControlMessage_FreezeRequest) isControlMessage_Payload() {}
...
func (*ControlMessage_ProcessingJobRequest) isControlMessage_Payload() {}

func (*ControlMessage_ProcessingJobResult) isControlMessage_Payload() {}

func (*ControlMessage_ProcessingJobProgress) isControlMessage_Payload() {}

func (*ControlMessage_StopSessionsRequest) isControlMessage_Payload() {}

func (*ControlMessage_InvalidateSessionsRequest) isControlMessage_Payload() {}

func (*ControlMessage_ModeChangeRequest) isControlMessage_Payload() {}

func (*ControlMessage_ActivatePushTargets) isControlMessage_Payload() {}

func (*ControlMessage_DeactivatePushTargets) isControlMessage_Payload() {}

func (*ControlMessage_PushTargetStatus) isControlMessage_Payload() {}

func (*ControlMessage_ValidateEdgeTokenRequest) isControlMessage_Payload() {}

func (*ControlMessage_ValidateEdgeTokenResponse) isControlMessage_Payload() {}

func (*ControlMessage_EdgeMistAdminSessionRequest) isControlMessage_Payload() {}

func (*ControlMessage_EdgeMistAdminSessionResponse) isControlMessage_Payload() {}

func (*ControlMessage_ThumbnailUploadRequest) isControlMessage_Payload() {}

func (*ControlMessage_ThumbnailUploadResponse) isControlMessage_Payload() {}

func (*ControlMessage_ThumbnailUploaded) isControlMessage_Payload() {}

func (*ControlMessage_DesiredStateUpdate) isControlMessage_Payload() {}

func (*ControlMessage_UpdateApplyResult) isControlMessage_Payload() {}

func (*ControlMessage_RecordDvrSegmentRequest) isControlMessage_Payload() {}

func (*ControlMessage_RecordDvrSegmentResponse) isControlMessage_Payload() {}

func (*ControlMessage_MarkDvrSegmentUploaded) isControlMessage_Payload() {}

func (*ControlMessage_DvrSegmentDropped) isControlMessage_Payload() {}

func (*ControlMessage_EvictableSegmentsRequest) isControlMessage_Payload() {}

func (*ControlMessage_EvictableSegmentsResponse) isControlMessage_Payload() {}

func (*ControlMessage_RetryDvrSegmentUpload) isControlMessage_Payload() {}

func (*ControlMessage_ReclaimDvrSegment) isControlMessage_Payload() {}

func (*ControlMessage_RestoreLocalSegmentIndexRequest) isControlMessage_Payload() {}

func (*ControlMessage_RestoreLocalSegmentIndexResponse) isControlMessage_Payload() {}

func (*ControlMessage_RelayResolveRequest) isControlMessage_Payload() {}

func (*ControlMessage_RelayResolveResponse) isControlMessage_Payload() {}

func (*ControlMessage_ApplyManagedStream) isControlMessage_Payload() {}

func (*ControlMessage_RetractManagedStream) isControlMessage_Payload() {}

func (*ControlMessage_DrainStreamRequest) isControlMessage_Payload() {}

func (*ControlMessage_DrainStreamResponse) isControlMessage_Payload() {}

func (*ControlMessage_AuthorizeRelayPullRequest) isControlMessage_Payload() {}

func (*ControlMessage_AuthorizeRelayPullResponse) isControlMessage_Payload() {}

func (*ControlMessage_ActivatePushTargetsResult) isControlMessage_Payload() {}

func (*ControlMessage_DeactivatePushTargetsResult) isControlMessage_Payload() {}
...
// node for the stream and ResolveStreamContext admits it. Sidecar maps to
// mist.AddStreams with `name` as the bare internal name (no live+/pull+
// prefix — concrete configs use bare names, prefixes are reserved for
// wildcard adapters), the literal `source`, and the tag set (always
// includes "fw:managed:foghorn" so the sidecar can scope ownership).
type ApplyManagedStream struct {
	state        protoimpl.MessageState `protogen:"open.v1"`
	Name         string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`     // bare Mist stream name (== commodore.streams.internal_name)
	Source       string                 `protobuf:"bytes,2,opt,name=source,proto3" json:"source,omitempty"` // literal Mist source string (ts-exec:..., file://..., etc.)
	AlwaysOn     bool                   `protobuf:"varint,3,opt,name=always_on,json=alwaysOn,proto3" json:"always_on,omitempty"`
	Realtime     bool                   `protobuf:"varint,4,opt,name=realtime,proto3" json:"realtime,omitempty"`
	StopSessions bool                   `protobuf:"varint,5,opt,name=stop_sessions,json=stopSessions,proto3" json:"stop_sessions,omitempty"`
	Tags         []string               `protobuf:"bytes,6,rep,name=tags,proto3" json:"tags,omitempty"`                               // includes "fw:managed:foghorn" owner marker
	IngestMode   string                 `protobuf:"bytes,7,opt,name=ingest_mode,json=ingestMode,proto3" json:"ingest_mode,omitempty"` // "mist_native" today
	StreamId     string                 `protobuf:"bytes,8,opt,name=stream_id,json=streamId,proto3" json:"stream_id,omitempty"`       // commodore.streams.id; for logging/correlation
	TenantId     string                 `protobuf:"bytes,9,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`
	// Required for placement-enabled sources; authenticated control-channel
	// attestation, not permission for an unauthenticated caller to start media.
	PlacementAdmission *ManagedStreamAdmission `protobuf:"bytes,10,opt,name=placement_admission,json=placementAdmission,proto3" json:"placement_admission,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *ApplyManagedStream) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ApplyManagedStream) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
func (x *ApplyManagedStream) GetAlwaysOn() bool {
	if x != nil {
		return x.AlwaysOn
	}
	return false
...
func (x *ApplyManagedStream) GetRealtime() bool {
	if x != nil {
		return x.Realtime
	}
	return false
...
func (x *ApplyManagedStream) GetStopSessions() bool {
	if x != nil {
...
func (x *ApplyManagedStream) GetTags() []string {
	if x != nil {
		return x.Tags
	}
	return nil
...
func (x *ApplyManagedStream) GetIngestMode() string {
	if x != nil {
		return x.IngestMode
	}
	return ""
...
func (x *ApplyManagedStream) GetStreamId() string {
	if x != nil {
		return x.StreamId
	}
	return ""
...
func (x *ApplyManagedStream) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (x *ApplyManagedStream) GetPlacementAdmission() *ManagedStreamAdmission {
	if x != nil {
		return x.PlacementAdmission
	}
	return nil
}

type ManagedStreamAdmission struct {
	state                  protoimpl.MessageState `protogen:"open.v1"`
	...
	ObjectAuthorityVersion int64                  `protobuf:"varint,4,opt,name=object_authority_version,json=objectAuthorityVersion,proto3" json:"object_authority_version,omitempty"`
	TenantAuthorityVersion int64                  `protobuf:"varint,5,opt,name=tenant_authority_version,json=tenantAuthorityVersion,proto3" json:"tenant_authority_version,omitempty"`
	...
	ParentRevision         uint64                 `protobuf:"varint,7,opt,name=parent_revision,json=parentRevision,proto3" json:"parent_revision,omitempty"`
	PolicyDigest           string                 `protobuf:"bytes,8,opt,name=policy_digest,json=policyDigest,proto3" json:"policy_digest,omitempty"`
	// SHA-256 of domain-separated deterministic ApplyManagedStream bytes with
	// placement_admission cleared. Binds source, identity, flags and tags.
	CommandSha256 []byte                 `protobuf:"bytes,9,opt,name=command_sha256,json=commandSha256,proto3" json:"command_sha256,omitempty"`
...
func (x *ManagedStreamAdmission) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ManagedStreamAdmission) GetTargetNodeId() string {
	if x != nil {
...
func (x *ManagedStreamAdmission) GetTargetClusterId() string {
	if x != nil {
...
func (x *ManagedStreamAdmission) GetObjectAuthorityVersion() int64 {
	if x != nil {
...
func (x *ManagedStreamAdmission) GetTenantAuthorityVersion() int64 {
	if x != nil {
...
func (x *ManagedStreamAdmission) GetPolicyRevision() uint64 {
	if x != nil {
...
func (x *ManagedStreamAdmission) GetParentRevision() uint64 {
	if x != nil {
...
func (x *ManagedStreamAdmission) GetPolicyDigest() string {
	if x != nil {
...
func (x *ManagedStreamAdmission) GetCommandSha256() []byte {
	if x != nil {
...
func (x *ManagedStreamAdmission) GetIssuedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.IssuedAt
	}
	return nil
...
func (x *ManagedStreamAdmission) GetExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpiresAt
	}
	return nil
...
// RetractManagedStream is sent by Foghorn to instruct Helmsman to remove a
// concrete mist_native stream config. Sidecar maps to mist.DelStreams.
// Idempotent: removing an absent stream is a no-op. Sidecar must only
// retract names it Applied (sanity check via owner tag) — tenant push/pull
// streams stay untouched even if a stale Retract for them is received.
type RetractManagedStream struct {
	state    protoimpl.MessageState `protogen:"open.v1"`
	Name     string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`                         // bare Mist stream name
	StreamId string                 `protobuf:"bytes,2,opt,name=stream_id,json=streamId,proto3" json:"stream_id,omitempty"` // commodore.streams.id; for logging/correlation
	// Retires only the exact admitted command; cannot delete a newer source.
	PlacementRetraction *ManagedStreamRetraction `protobuf:"bytes,3,opt,name=placement_retraction,json=placementRetraction,proto3" json:"placement_retraction,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *RetractManagedStream) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RetractManagedStream) GetStreamId() string {
	if x != nil {
		return x.StreamId
	}
	return ""
...
func (x *RetractManagedStream) GetPlacementRetraction() *ManagedStreamRetraction {
	if x != nil {
		return x.PlacementRetraction
	}
	return nil
}

type ManagedStreamRetraction struct {
	state                  protoimpl.MessageState `protogen:"open.v1"`
	...
	ObjectAuthorityVersion int64                  `protobuf:"varint,4,opt,name=object_authority_version,json=objectAuthorityVersion,proto3" json:"object_authority_version,omitempty"`
	TenantAuthorityVersion int64                  `protobuf:"varint,5,opt,name=tenant_authority_version,json=tenantAuthorityVersion,proto3" json:"tenant_authority_version,omitempty"`
	CommandSha256          []byte                 `protobuf:"bytes,6,opt,name=command_sha256,json=commandSha256,proto3" json:"command_sha256,omitempty"`
	...
	ParentRevision         uint64                 `protobuf:"varint,10,opt,name=parent_revision,json=parentRevision,proto3" json:"parent_revision,omitempty"`
...
func (x *ManagedStreamRetraction) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ManagedStreamRetraction) GetTargetClusterId() string {
	if x != nil {
		return x.TargetClusterId
	}
	return ""
...
func (x *ManagedStreamRetraction) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (x *ManagedStreamRetraction) GetObjectAuthorityVersion() int64 {
	if x != nil {
		return x.ObjectAuthorityVersion
	}
	return 0
...
func (x *ManagedStreamRetraction) GetTenantAuthorityVersion() int64 {
	if x != nil {
		return x.TenantAuthorityVersion
	}
	return 0
...
func (x *ManagedStreamRetraction) GetCommandSha256() []byte {
	if x != nil {
		return x.CommandSha256
	}
	return nil
...
func (x *ManagedStreamRetraction) GetIssuedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.IssuedAt
	}
	return nil
...
func (x *ManagedStreamRetraction) GetExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpiresAt
	}
	return nil
...
func (x *ManagedStreamRetraction) GetPolicyRevision() uint64 {
	if x != nil {
		return x.PolicyRevision
	}
	return 0
...
func (x *ManagedStreamRetraction) GetParentRevision() uint64 {
	if x != nil {
		return x.ParentRevision
	}
	return 0
...
func (x *ManagedStreamRetraction) GetPolicyDigest() string {
	if x != nil {
		return x.PolicyDigest
	}
	return ""
...
// DrainStreamRequest is sent by Foghorn when a new publisher session replaces
// an ended publisher on another node. The old owner must unload its
// lingering Mist buffer and disconnect viewer sessions for that runtime
// name so viewers don't keep talking to the stale buffer. Idempotent —
// when the stream is absent locally, Helmsman returns unloaded=false with
// sessions_disconnected=0 and no error.
type DrainStreamRequest struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	RuntimeName string                 `protobuf:"bytes,1,opt,name=runtime_name,json=runtimeName,proto3" json:"runtime_name,omitempty"` // exact Mist source name to nuke
	Reason      string                 `protobuf:"bytes,2,opt,name=reason,proto3" json:"reason,omitempty"`                              // e.g. "publisher_replaced_by_node:edge-us-2"
	// Obligation identity: the admitting ingest generation whose durable drain leg this command
	// serves. Echoed verbatim in the response so the acknowledgement completes EXACTLY that
	// obligation — a delayed response from an earlier generation must not complete a later one.
	...
	// Exact generation that occupied runtime_name on the drained node when this obligation was
	// created. Helmsman refuses the command after it has admitted a different local generation.
	PriorOwnerSourceGeneration string `protobuf:"bytes,4,opt,name=prior_owner_source_generation,json=priorOwnerSourceGeneration,proto3" json:"prior_owner_source_generation,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *DrainStreamRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DrainStreamRequest) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *DrainStreamRequest) GetSourceGeneration() string {
	if x != nil {
...
func (x *DrainStreamRequest) GetPriorOwnerSourceGeneration() string {
	if x != nil {
		return x.PriorOwnerSourceGeneration
	}
	return ""
}

// DrainStreamResponse acknowledges the drain COMMAND. nuke_stream launches MistUtilNuke
// asynchronously, so unloaded=true means "accepted and dispatched to Mist", not "buffer proven
// destroyed" — Mist owns the teardown from there.
type DrainStreamResponse struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	RuntimeName          string                 `protobuf:"bytes,1,opt,name=runtime_name,json=runtimeName,proto3" json:"runtime_name,omitempty"`
	Unloaded             bool                   `protobuf:"varint,2,opt,name=unloaded,proto3" json:"unloaded,omitempty"`
	SessionsDisconnected uint32                 `protobuf:"varint,3,opt,name=sessions_disconnected,json=sessionsDisconnected,proto3" json:"sessions_disconnected,omitempty"`
	Error                string                 `protobuf:"bytes,4,opt,name=error,proto3" json:"error,omitempty"`                                               // empty on success; populated on partial failure
	SourceGeneration     string                 `protobuf:"bytes,5,opt,name=source_generation,json=sourceGeneration,proto3" json:"source_generation,omitempty"` // echoed from the request for exact obligation correlation
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *DrainStreamResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DrainStreamResponse) GetUnloaded() bool {
	if x != nil {
		return x.Unloaded
	}
	return false
...
func (x *DrainStreamResponse) GetSessionsDisconnected() uint32 {
	if x != nil {
		return x.SessionsDisconnected
	}
	return 0
}

func (x *DrainStreamResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *DrainStreamResponse) GetSourceGeneration() string {
	if x != nil {
		return x.SourceGeneration
	}
	return ""
...
// ModeChangeRequest is sent by Helmsman when a local agent or CLI requests
// an operational mode change. Foghorn validates and applies the change,
// then pushes an updated ConfigSeed back with the new mode.
type ModeChangeRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RequestedMode NodeOperationalMode    `protobuf:"varint,1,opt,name=requested_mode,json=requestedMode,proto3,enum=helmsmancontrol.NodeOperationalMode" json:"requested_mode,omitempty"`
	Reason        string                 `protobuf:"bytes,2,opt,name=reason,proto3" json:"reason,omitempty"` // e.g. "agent_requested", "scheduled_maintenance"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ModeChangeRequest) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
type EdgeComponentVersion struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *EdgeComponentVersion) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *EdgeComponentVersion) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
type DesiredComponent struct {
	...
	DrainRequired bool                   `protobuf:"varint,5,opt,name=drain_required,json=drainRequired,proto3" json:"drain_required,omitempty"`
	SwapStrategy  string                 `protobuf:"bytes,6,opt,name=swap_strategy,json=swapStrategy,proto3" json:"swap_strategy,omitempty"`
	// Runtime implementation selected for this node (cpu, coreml, cuda,
	// tensorrt, openvino). Empty means the legacy/default CPU profile.
	OnnxProfile   string `protobuf:"bytes,7,opt,name=onnx_profile,json=onnxProfile,proto3" json:"onnx_profile,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DesiredComponent) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DesiredComponent) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *DesiredComponent) GetArtifactUrl() string {
	if x != nil {
...
func (x *DesiredComponent) GetChecksum() string {
	if x != nil {
		return x.Checksum
	}
	return ""
...
func (x *DesiredComponent) GetDrainRequired() bool {
	if x != nil {
		return x.DrainRequired
	}
	return false
}

func (x *DesiredComponent) GetSwapStrategy() string {
	if x != nil {
		return x.SwapStrategy
	}
	return ""
}

func (x *DesiredComponent) GetOnnxProfile() string {
	if x != nil {
		return x.OnnxProfile
	}
	return ""
}
...
type DesiredStateUpdate struct {
	...
	Components           []*DesiredComponent    `protobuf:"bytes,4,rep,name=components,proto3" json:"components,omitempty"`
	CordonToken          string                 `protobuf:"bytes,5,opt,name=cordon_token,json=cordonToken,proto3" json:"cordon_token,omitempty"`
	CordonTokenExpiresAt *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=cordon_token_expires_at,json=cordonTokenExpiresAt,proto3" json:"cordon_token_expires_at,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *DesiredStateUpdate) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *DesiredStateUpdate) GetTargetRelease() string {
	if x != nil {
...
func (x *DesiredStateUpdate) GetComponents() []*DesiredComponent {
	if x != nil {
		return x.Components
	}
	return nil
...
func (x *DesiredStateUpdate) GetCordonToken() string {
	if x != nil {
		return x.CordonToken
	}
	return ""
}

func (x *DesiredStateUpdate) GetCordonTokenExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CordonTokenExpiresAt
	}
	return nil
}
...
func (x *ComponentApplyResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ComponentApplyResult) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *ComponentApplyResult) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *ComponentApplyResult) GetDetail() string {
	if x != nil {
		return x.Detail
	}
	return ""
...
type UpdateApplyResult struct {
	...
	TargetRelease string                  `protobuf:"bytes,2,opt,name=target_release,json=targetRelease,proto3" json:"target_release,omitempty"`
	Components    []*ComponentApplyResult `protobuf:"bytes,3,rep,name=components,proto3" json:"components,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateApplyResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *UpdateApplyResult) GetTargetRelease() string {
	if x != nil {
		return x.TargetRelease
	}
	return ""
...
func (x *UpdateApplyResult) GetComponents() []*ComponentApplyResult {
	if x != nil {
		return x.Components
	}
	return nil
...
// InvalidateSessionsRequest tells Helmsman to re-run USER_NEW for active
// sessions on the given streams without disconnecting them.
// Used after a playback-policy or signing-key change so MistServer's
// per-session cache is rebuilt against the fresh policy.
// Maps to MistServer's `invalidate_sessions` JSON API.
type InvalidateSessionsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StreamNames   []string               `protobuf:"bytes,1,rep,name=stream_names,json=streamNames,proto3" json:"stream_names,omitempty"` // Internal stream names whose sessions need re-evaluating
	TenantId      string                 `protobuf:"bytes,2,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`          // For logging/audit
...
func (x *InvalidateSessionsRequest) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (x *InvalidateSessionsRequest) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
type ActivatePushTargets struct {
	state      protoimpl.MessageState `protogen:"open.v1"`
	StreamName string                 `protobuf:"bytes,1,opt,name=stream_name,json=streamName,proto3" json:"stream_name,omitempty"` // MistServer stream name (e.g., "live+abc123")
	Targets    []*PushTargetSpec      `protobuf:"bytes,2,rep,name=targets,proto3" json:"targets,omitempty"`
	// Obligation identity: the admitting ingest generation. Echoed in ActivatePushTargetsResult so
	// the acknowledgement completes exactly that obligation.
	SourceGeneration string `protobuf:"bytes,3,opt,name=source_generation,json=sourceGeneration,proto3" json:"source_generation,omitempty"`
	TenantId         string `protobuf:"bytes,4,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`
	StreamId         string `protobuf:"bytes,5,opt,name=stream_id,json=streamId,proto3" json:"stream_id,omitempty"`
	// Monotonic media-authority version for the complete desired target set.
	...
	MaxViewers     int32 `protobuf:"varint,7,opt,name=max_viewers,json=maxViewers,proto3" json:"max_viewers,omitempty"` // existing tenant delivery-capacity limit; 0 means unlimited
	// Runtime-attempt fence. Rotated whenever Foghorn re-arms the same desired
	// revision after a terminal push. Helmsman echoes it on results and status
	// reports so a delayed final cannot retire the replacement attempt.
	ActivationAttempt string `protobuf:"bytes,8,opt,name=activation_attempt,json=activationAttempt,proto3" json:"activation_attempt,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ActivatePushTargets) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ActivatePushTargets) GetTargets() []*PushTargetSpec {
	if x != nil {
		return x.Targets
	}
	return nil
...
func (x *ActivatePushTargets) GetSourceGeneration() string {
	if x != nil {
		return x.SourceGeneration
	}
	return ""
...
func (x *ActivatePushTargets) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (x *ActivatePushTargets) GetStreamId() string {
	if x != nil {
		return x.StreamId
	}
	return ""
...
func (x *ActivatePushTargets) GetTargetRevision() int64 {
	if x != nil {
...
func (x *ActivatePushTargets) GetMaxViewers() int32 {
	if x != nil {
		return x.MaxViewers
	}
	return 0
...
func (x *ActivatePushTargets) GetActivationAttempt() string {
	if x != nil {
		return x.ActivationAttempt
	}
	return ""
}

// PushTargetSpec is a single push destination for Helmsman to activate.
type PushTargetSpec struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TargetId      string                 `protobuf:"bytes,1,opt,name=target_id,json=targetId,proto3" json:"target_id,omitempty"`    // Commodore push_targets.id (for status reporting)
...
func (x *PushTargetSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PushTargetSpec) GetTargetUri() string {
	if x != nil {
		return x.TargetUri
	}
	return ""
...
func (x *PushTargetSpec) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
// Sent by Foghorn when a stream ends (STREAM_END trigger).
type DeactivatePushTargets struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	StreamName       string                 `protobuf:"bytes,1,opt,name=stream_name,json=streamName,proto3" json:"stream_name,omitempty"`                   // MistServer stream name
	SourceGeneration string                 `protobuf:"bytes,2,opt,name=source_generation,json=sourceGeneration,proto3" json:"source_generation,omitempty"` // ended generation; ignored after a successor is admitted
...
func (x *DeactivatePushTargets) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DeactivatePushTargets) GetSourceGeneration() string {
	if x != nil {
		return x.SourceGeneration
	}
	return ""
...
func (x *DeactivatePushTargets) GetTargetRevision() int64 {
	if x != nil {
		return x.TargetRevision
	}
	return 0
...
type DeactivatePushTargetsResult struct {
	state            protoimpl.MessageState   `protogen:"open.v1"`
	StreamName       string                   `protobuf:"bytes,1,opt,name=stream_name,json=streamName,proto3" json:"stream_name,omitempty"`
	SourceGeneration string                   `protobuf:"bytes,2,opt,name=source_generation,json=sourceGeneration,proto3" json:"source_generation,omitempty"`
	TargetRevision   int64                    `protobuf:"varint,3,opt,name=target_revision,json=targetRevision,proto3" json:"target_revision,omitempty"`
	Converged        bool                     `protobuf:"varint,4,opt,name=converged,proto3" json:"converged,omitempty"`
	Error            string                   `protobuf:"bytes,5,opt,name=error,proto3" json:"error,omitempty"`
	Targets          []*PushTargetConvergence `protobuf:"bytes,6,rep,name=targets,proto3" json:"targets,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *DeactivatePushTargetsResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DeactivatePushTargetsResult) GetSourceGeneration() string {
	if x != nil {
		return x.SourceGeneration
	}
	return ""
...
func (x *DeactivatePushTargetsResult) GetTargetRevision() int64 {
	if x != nil {
		return x.TargetRevision
	}
	return 0
...
func (x *DeactivatePushTargetsResult) GetConverged() bool {
	if x != nil {
		return x.Converged
	}
	return false
...
func (x *DeactivatePushTargetsResult) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *DeactivatePushTargetsResult) GetTargets() []*PushTargetConvergence {
	if x != nil {
		return x.Targets
	}
	return nil
...
// ActivatePushTargetsResult reports an ActivatePushTargets command's outcome back to Foghorn.
// converged=true means every requested target is now pushing (already live or freshly started);
// false means at least one target could not be confirmed (push-list unavailable, PushStart failed)
// and the durable obligation must retry the activation.
type ActivatePushTargetsResult struct {
	state             protoimpl.MessageState   `protogen:"open.v1"`
	StreamName        string                   `protobuf:"bytes,1,opt,name=stream_name,json=streamName,proto3" json:"stream_name,omitempty"` // MistServer stream name the command named
	Converged         bool                     `protobuf:"varint,2,opt,name=converged,proto3" json:"converged,omitempty"`
	Error             string                   `protobuf:"bytes,3,opt,name=error,proto3" json:"error,omitempty"`                                               // empty when converged; first failure otherwise
	SourceGeneration  string                   `protobuf:"bytes,4,opt,name=source_generation,json=sourceGeneration,proto3" json:"source_generation,omitempty"` // echoed from the request for exact obligation correlation
	...
	Targets           []*PushTargetConvergence `protobuf:"bytes,6,rep,name=targets,proto3" json:"targets,omitempty"`
	ActivationAttempt string                   `protobuf:"bytes,7,opt,name=activation_attempt,json=activationAttempt,proto3" json:"activation_attempt,omitempty"` // echoed from ActivatePushTargets
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ActivatePushTargetsResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ActivatePushTargetsResult) GetConverged() bool {
	if x != nil {
		return x.Converged
	}
	return false
...
func (x *ActivatePushTargetsResult) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *ActivatePushTargetsResult) GetSourceGeneration() string {
	if x != nil {
		return x.SourceGeneration
	}
	return ""
...
func (x *ActivatePushTargetsResult) GetTargetRevision() int64 {
	if x != nil {
		return x.TargetRevision
	}
	return 0
...
func (x *ActivatePushTargetsResult) GetTargets() []*PushTargetConvergence {
	if x != nil {
		return x.Targets
	}
	return nil
...
func (x *ActivatePushTargetsResult) GetActivationAttempt() string {
	if x != nil {
		return x.ActivationAttempt
	}
	return ""
...
type PushTargetConvergence struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	TargetId         string                 `protobuf:"bytes,1,opt,name=target_id,json=targetId,proto3" json:"target_id,omitempty"`
	MistPushId       int64                  `protobuf:"varint,2,opt,name=mist_push_id,json=mistPushId,proto3" json:"mist_push_id,omitempty"`
	Active           bool                   `protobuf:"varint,3,opt,name=active,proto3" json:"active,omitempty"`
	Reason           RestreamReason         `protobuf:"varint,4,opt,name=reason,proto3,enum=helmsmancontrol.RestreamReason" json:"reason,omitempty"`
	SanitizedMessage string                 `protobuf:"bytes,5,opt,name=sanitized_message,json=sanitizedMessage,proto3" json:"sanitized_message,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *PushTargetConvergence) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PushTargetConvergence) GetMistPushId() int64 {
	if x != nil {
		return x.MistPushId
	}
	return 0
...
func (x *PushTargetConvergence) GetActive() bool {
	if x != nil {
		return x.Active
	}
	return false
...
func (x *PushTargetConvergence) GetReason() RestreamReason {
	if x != nil {
		return x.Reason
	}
	return RestreamReason_RESTREAM_REASON_UNSPECIFIED
}

func (x *PushTargetConvergence) GetSanitizedMessage() string {
	if x != nil {
...
// PushTargetStatusReport is sent by Helmsman to Foghorn to report push lifecycle events.
// Foghorn uses this to update status in Commodore.
type PushTargetStatusReport struct {
	state      protoimpl.MessageState `protogen:"open.v1"`
	TargetId   string                 `protobuf:"bytes,1,opt,name=target_id,json=targetId,proto3" json:"target_id,omitempty"` // Commodore push_targets.id
	StreamName string                 `protobuf:"bytes,2,opt,name=stream_name,json=streamName,proto3" json:"stream_name,omitempty"`
	// Deprecated: Marked as deprecated in ipc.proto.
	Status string `protobuf:"bytes,3,opt,name=status,proto3" json:"status,omitempty"` // legacy: use state
	// Deprecated: Marked as deprecated in ipc.proto.
	Error             string         `protobuf:"bytes,4,opt,name=error,proto3" json:"error,omitempty"`                                // legacy: use sanitized_message
	MistPushId        int64          `protobuf:"varint,5,opt,name=mist_push_id,json=mistPushId,proto3" json:"mist_push_id,omitempty"` // MistServer's internal push ID (for PushStop)
	TenantId          string         `protobuf:"bytes,6,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`
	StreamId          string         `protobuf:"bytes,7,opt,name=stream_id,json=streamId,proto3" json:"stream_id,omitempty"`
	SourceGeneration  string         `protobuf:"bytes,8,opt,name=source_generation,json=sourceGeneration,proto3" json:"source_generation,omitempty"`
	TargetRevision    int64          `protobuf:"varint,9,opt,name=target_revision,json=targetRevision,proto3" json:"target_revision,omitempty"`
	State             RestreamState  `protobuf:"varint,10,opt,name=state,proto3,enum=helmsmancontrol.RestreamState" json:"state,omitempty"`
	Reason            RestreamReason `protobuf:"varint,11,opt,name=reason,proto3,enum=helmsmancontrol.RestreamReason" json:"reason,omitempty"`
	SanitizedMessage  string         `protobuf:"bytes,12,opt,name=sanitized_message,json=sanitizedMessage,proto3" json:"sanitized_message,omitempty"`
	StartedAtMs       int64          `protobuf:"varint,13,opt,name=started_at_ms,json=startedAtMs,proto3" json:"started_at_ms,omitempty"`
	EndedAtMs         int64          `protobuf:"varint,14,opt,name=ended_at_ms,json=endedAtMs,proto3" json:"ended_at_ms,omitempty"`
	...
	SourceEventId     string         `protobuf:"bytes,17,opt,name=source_event_id,json=sourceEventId,proto3" json:"source_event_id,omitempty"`
	Platform          string         `protobuf:"bytes,18,opt,name=platform,proto3" json:"platform,omitempty"`
	BytesObserved     bool           `protobuf:"varint,19,opt,name=bytes_observed,json=bytesObserved,proto3" json:"bytes_observed,omitempty"`            // true only when Mist supplied an explicit byte counter
	NodeId            string         `protobuf:"bytes,20,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`                                  // Foghorn-authenticated emitting node; stamped before analytics
	ActivationAttempt string         `protobuf:"bytes,21,opt,name=activation_attempt,json=activationAttempt,proto3" json:"activation_attempt,omitempty"` // runtime-attempt fence from ActivatePushTargets
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *PushTargetStatusReport) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PushTargetStatusReport) GetStreamName() string {
	if x != nil {
		return x.StreamName
	}
	return ""
...
// Deprecated: Marked as deprecated in ipc.proto.
func (x *PushTargetStatusReport) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
// Deprecated: Marked as deprecated in ipc.proto.
func (x *PushTargetStatusReport) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *PushTargetStatusReport) GetMistPushId() int64 {
	if x != nil {
		return x.MistPushId
	}
	return 0
...
func (x *PushTargetStatusReport) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (x *PushTargetStatusReport) GetStreamId() string {
	if x != nil {
		return x.StreamId
	}
	return ""
...
func (x *PushTargetStatusReport) GetSourceGeneration() string {
	if x != nil {
		return x.SourceGeneration
	}
	return ""
...
func (x *PushTargetStatusReport) GetTargetRevision() int64 {
	if x != nil {
		return x.TargetRevision
	}
	return 0
...
func (x *PushTargetStatusReport) GetState() RestreamState {
	if x != nil {
		return x.State
	}
	return RestreamState_RESTREAM_STATE_UNSPECIFIED
}

func (x *PushTargetStatusReport) GetReason() RestreamReason {
	if x != nil {
		return x.Reason
	}
	return RestreamReason_RESTREAM_REASON_UNSPECIFIED
...
func (x *PushTargetStatusReport) GetSanitizedMessage() string {
	if x != nil {
		return x.SanitizedMessage
	}
	return ""
...
func (x *PushTargetStatusReport) GetStartedAtMs() int64 {
	if x != nil {
...
func (x *PushTargetStatusReport) GetEndedAtMs() int64 {
	if x != nil {
		return x.EndedAtMs
	}
	return 0
...
func (x *PushTargetStatusReport) GetDurationMs() int64 {
	if x != nil {
		return x.DurationMs
	}
	return 0
...
func (x *PushTargetStatusReport) GetBytesSent() uint64 {
	if x != nil {
		return x.BytesSent
	}
	return 0
...
func (x *PushTargetStatusReport) GetSourceEventId() string {
	if x != nil {
...
func (x *PushTargetStatusReport) GetPlatform() string {
	if x != nil {
		return x.Platform
	}
	return ""
...
func (x *PushTargetStatusReport) GetBytesObserved() bool {
	if x != nil {
...
func (x *PushTargetStatusReport) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *PushTargetStatusReport) GetActivationAttempt() string {
	if x != nil {
		return x.ActivationAttempt
	}
	return ""
...
type ArtifactDeleted struct {
	...
	DeletedAtMs   int64                  `protobuf:"varint,8,opt,name=deleted_at_ms,json=deletedAtMs,proto3" json:"deleted_at_ms,omitempty"` // Original node deletion time; stable across durable replay
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ArtifactDeleted) GetDeletedAtMs() int64 {
	if x != nil {
...
type Register struct {
	...
	// Base URL Mist on this node uses to reach the /internal/artifact/* relay
	// on this Helmsman. In production this is http://127.0.0.1:18007 — Mist
	// and Helmsman share loopback on native hosts and inside the single edge
	// container alike. Only the dev compose bridge (separate containers) uses
	// an inter-container address like http://helmsman:18007. Foghorn stamps
	// STREAM_SOURCE responses with this prefix so Mist always resolves to the
	// right Helmsman.
	RelayBaseUrl string `protobuf:"bytes,16,opt,name=relay_base_url,json=relayBaseUrl,proto3" json:"relay_base_url,omitempty"`
	// Owner-tagged Mist streams currently configured on this node, as known
	// to Helmsman after sidecar hydration. Foghorn uses this to seed its
	// managed-stream lastSent map on (re)connect so a Foghorn restart does
	// not lose track of streams it already provisioned. Without this, a
	// restart + DB-row removal sequence would leave the Mist config in
	// place forever because no Retract would ever fire.
	AppliedManagedStreams []*AppliedManagedStream `protobuf:"bytes,17,rep,name=applied_managed_streams,json=appliedManagedStreams,proto3" json:"applied_managed_streams,omitempty"`
	// Monotonic control-protocol version the sidecar speaks, declared at
	// registration so Foghorn can gate protocol-dependent dispatch on an
	// OBSERVED (not per-request self-asserted) capability. A version below the
	// staged-freeze minimum means the sidecar does not upload to the
	// attempt-scoped staging key nor echo the server-minted attempt id, so
	// Foghorn FAILS CLOSED on freeze dispatch to it (the artifact stays local,
	// retryable) rather than hand out a staged freeze it would mishandle.
	// Absent/0 = a pre-staged-freeze sidecar. Bump only when the wire contract
	// Foghorn must gate on changes.
	ControlProtocolVersion int32 `protobuf:"varint,18,opt,name=control_protocol_version,json=controlProtocolVersion,proto3" json:"control_protocol_version,omitempty"`
	// Long-lived node identity public key. The private key is generated once and
	// persisted by Helmsman on its local storage volume.
	NodeIdentityPublicKeyEd25519 []byte `protobuf:"bytes,19,opt,name=node_identity_public_key_ed25519,json=nodeIdentityPublicKeyEd25519,proto3" json:"node_identity_public_key_ed25519,omitempty"`
	// Per-connection proof-of-possession. Foghorn verifies the signature and
	// consumes the nonce before accepting either online or cached identity.
	NodeIdentityProofNonce    []byte                 `protobuf:"bytes,20,opt,name=node_identity_proof_nonce,json=nodeIdentityProofNonce,proto3" json:"node_identity_proof_nonce,omitempty"`
	NodeIdentityProofIssuedAt *timestamppb.Timestamp `protobuf:"bytes,21,opt,name=node_identity_proof_issued_at,json=nodeIdentityProofIssuedAt,proto3" json:"node_identity_proof_issued_at,omitempty"`
	NodeIdentityProofEd25519  []byte                 `protobuf:"bytes,22,opt,name=node_identity_proof_ed25519,json=nodeIdentityProofEd25519,proto3" json:"node_identity_proof_ed25519,omitempty"`
	// Highest durable ConfigSeed version installed locally. Foghorn uses this
	// restart handshake to avoid replaying or rolling back configuration.
	AppliedConfigSeedVersion uint64 `protobuf:"varint,23,opt,name=applied_config_seed_version,json=appliedConfigSeedVersion,proto3" json:"applied_config_seed_version,omitempty"`
...
func (x *Register) GetRelayBaseUrl() string {
	if x != nil {
		return x.RelayBaseUrl
	}
	return ""
}

func (x *Register) GetAppliedManagedStreams() []*AppliedManagedStream {
	if x != nil {
		return x.AppliedManagedStreams
	}
	return nil
}

func (x *Register) GetControlProtocolVersion() int32 {
	if x != nil {
		return x.ControlProtocolVersion
	}
	return 0
}

func (x *Register) GetNodeIdentityPublicKeyEd25519() []byte {
	if x != nil {
		return x.NodeIdentityPublicKeyEd25519
	}
	return nil
}

func (x *Register) GetNodeIdentityProofNonce() []byte {
	if x != nil {
		return x.NodeIdentityProofNonce
	}
	return nil
}

func (x *Register) GetNodeIdentityProofIssuedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.NodeIdentityProofIssuedAt
	}
	return nil
}

func (x *Register) GetNodeIdentityProofEd25519() []byte {
	if x != nil {
		return x.NodeIdentityProofEd25519
	}
	return nil
}

func (x *Register) GetAppliedConfigSeedVersion() uint64 {
	if x != nil {
		return x.AppliedConfigSeedVersion
	}
	return 0
}

func (x *Register) GetNodeIdentityRotationRequested() bool {
	if x != nil {
...
// managed Mist stream currently configured on the node. The Foghorn-side
// reconciler seeds its lastSent map from this set so the next tick's
// elected-vs-applied diff sees the stream and can issue a Retract if the
// desired-state set no longer contains it.
//
// stream_id is the Foghorn lastSent map key. Without it, hydration would
// land under the bare Mist name while the reconciler keys by stream_id,
// and the next tick would Apply (under stream_id) then Retract (the
// hydrated bare-name entry) the same physical stream — race-free path
// requires the keys to match. Sidecar parses stream_id from the
// `fw:stream:<stream_id>` tag both Apply and Mist-config hydration write.
type AppliedManagedStream struct {
	state      protoimpl.MessageState `protogen:"open.v1"`
	Name       string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`     // bare Mist stream name (== commodore.streams.internal_name)
	Source     string                 `protobuf:"bytes,2,opt,name=source,proto3" json:"source,omitempty"` // literal Mist source string
	AlwaysOn   bool                   `protobuf:"varint,3,opt,name=always_on,json=alwaysOn,proto3" json:"always_on,omitempty"`
	IngestMode string                 `protobuf:"bytes,4,opt,name=ingest_mode,json=ingestMode,proto3" json:"ingest_mode,omitempty"`
	StreamId   string                 `protobuf:"bytes,5,opt,name=stream_id,json=streamId,proto3" json:"stream_id,omitempty"` // commodore.streams.id; required when known
	// Admission whose exact configuration was applied. Does not attest first media.
	PlacementAdmission *ManagedStreamAdmission `protobuf:"bytes,6,opt,name=placement_admission,json=placementAdmission,proto3" json:"placement_admission,omitempty"`
	TenantId           string                  `protobuf:"bytes,7,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`
	// Retained configuration needs cleanup and must not verify an active Apply.
	PlacementRetired bool `protobuf:"varint,8,opt,name=placement_retired,json=placementRetired,proto3" json:"placement_retired,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *AppliedManagedStream) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *AppliedManagedStream) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
func (x *AppliedManagedStream) GetAlwaysOn() bool {
	if x != nil {
		return x.AlwaysOn
	}
	return false
...
func (x *AppliedManagedStream) GetIngestMode() string {
	if x != nil {
		return x.IngestMode
	}
	return ""
...
func (x *AppliedManagedStream) GetStreamId() string {
	if x != nil {
		return x.StreamId
	}
	return ""
...
func (x *AppliedManagedStream) GetPlacementAdmission() *ManagedStreamAdmission {
	if x != nil {
		return x.PlacementAdmission
	}
	return nil
...
func (x *AppliedManagedStream) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (x *AppliedManagedStream) GetPlacementRetired() bool {
	if x != nil {
		return x.PlacementRetired
	}
	return false
}
...
type ClipPullRequest struct {
	...
	// stream_name is the Mist routing name Helmsman pulls FROM. For live
	// sources this is the live stream's internal_name; for DVR_ROLLING
	// it is dvr+<dvr_internal_name>; for CHAPTER it is
	// vod+<chapter_artifact_hash>. Helmsman uses this for /view/...
	// when cutting the clip — it MUST NOT be used as a storage
	// namespace for the output file (the chapter/DVR-rolling cases
	// would otherwise scatter clips under chapter-artifact-hashed dirs
	// that don't match the owning stream).
	StreamName string `protobuf:"bytes,2,opt,name=stream_name,json=streamName,proto3" json:"stream_name,omitempty"`
	// Timing (one of):
	...
	// The clip artifact's Mist routing name — what Mist will use as
	// vod+<internal_name> when serving playback for this clip. Foghorn
	// populates from foghorn.artifacts.internal_name at clip-create time.
	// Helmsman uses it to boot the clip post-download for .dtsh
	// generation; an empty value disables proactive sidecar creation.
	InternalName              string                     `protobuf:"bytes,12,opt,name=internal_name,json=internalName,proto3" json:"internal_name,omitempty"`
	SourceKind                ClipPullRequest_SourceKind `protobuf:"varint,20,opt,name=source_kind,json=sourceKind,proto3,enum=helmsmancontrol.ClipPullRequest_SourceKind" json:"source_kind,omitempty"`
	SourceDvrHash             string                     `protobuf:"bytes,21,opt,name=source_dvr_hash,json=sourceDvrHash,proto3" json:"source_dvr_hash,omitempty"`
	SourceChapterArtifactHash string                     `protobuf:"bytes,22,opt,name=source_chapter_artifact_hash,json=sourceChapterArtifactHash,proto3" json:"source_chapter_artifact_hash,omitempty"`
	// output_stream_name is the owning stream's internal_name — where
	// Helmsman writes clips/{output_stream_name}/{clip_hash}.{format}.
	// For LIVE sources this matches stream_name; for DVR_ROLLING and
	// CHAPTER it is the DVR artifact's stream_internal_name, so all
	// clips of one stream stay under one directory regardless of which
	// historical surface they were cut from. Required — Helmsman
	// rejects clip pulls with an empty value.
	OutputStreamName string `protobuf:"bytes,23,opt,name=output_stream_name,json=outputStreamName,proto3" json:"output_stream_name,omitempty"`
	// Foghorn-authoritative runtime name for the clip ARTIFACT, used by
	// Helmsman to boot the clip post-download for .dtsh generation. Always
	// vod+<clip_internal_name> today (clips are frozen VOD), but populated
	// from Foghorn's registry so Helmsman never derives runtime names.
	ArtifactRuntimeName string `protobuf:"bytes,24,opt,name=artifact_runtime_name,json=artifactRuntimeName,proto3" json:"artifact_runtime_name,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ClipPullRequest) GetInternalName() string {
	if x != nil {
...
func (x *ClipPullRequest) GetSourceKind() ClipPullRequest_SourceKind {
	if x != nil {
		return x.SourceKind
	}
	return ClipPullRequest_SOURCE_KIND_UNSPECIFIED
}

func (x *ClipPullRequest) GetSourceDvrHash() string {
	if x != nil {
		return x.SourceDvrHash
	}
	return ""
}

func (x *ClipPullRequest) GetSourceChapterArtifactHash() string {
	if x != nil {
		return x.SourceChapterArtifactHash
	}
	return ""
}

func (x *ClipPullRequest) GetOutputStreamName() string {
	if x != nil {
		return x.OutputStreamName
	}
	return ""
}

func (x *ClipPullRequest) GetArtifactRuntimeName() string {
	if x != nil {
		return x.ArtifactRuntimeName
	}
	return ""
}
...
type Heartbeat struct {
	state  protoimpl.MessageState `protogen:"open.v1"`
	NodeId string                 `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
	// Currently-applied managed Mist streams on this node. Foghorn's
	// managed-stream reconciler uses this as ground truth (verified
	// applied) — Apply / Retract are fire-and-forget on the control
	// channel, so the reconciler gates active-cluster pinning and
	// retract-completion on the next heartbeat's snapshot rather than
	// assuming the wire-send means Mist actually landed the config.
	AppliedManagedStreams []*AppliedManagedStream `protobuf:"bytes,2,rep,name=applied_managed_streams,json=appliedManagedStreams,proto3" json:"applied_managed_streams,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *Heartbeat) GetAppliedManagedStreams() []*AppliedManagedStream {
	if x != nil {
		return x.AppliedManagedStreams
	}
	return nil
...
type MistTrigger struct {
	...
	//	*MistTrigger_ClientLifecycleBatch
	//	*MistTrigger_RawMistWebhook
	//	*MistTrigger_PushInputClose
	//	*MistTrigger_PlaybackBootTrace
	//	*MistTrigger_PlaybackSessionQoe
...
func (x *MistTrigger) GetFederationEventData() *FederationEventData {
	if x != nil {
		if x, ok := x.TriggerPayload.(*MistTrigger_FederationEventData); ok {
			return x.FederationEventData
		}
	}
	return nil
}

func (x *MistTrigger) GetStreamProcess() *StreamProcessTrigger {
	if x != nil {
		if x, ok := x.TriggerPayload.(*MistTrigger_StreamProcess); ok {
			return x.StreamProcess
		}
	}
	return nil
}

func (x *MistTrigger) GetClientLifecycleBatch() *ClientLifecycleBatch {
	if x != nil {
		if x, ok := x.TriggerPayload.(*MistTrigger_ClientLifecycleBatch); ok {
			return x.ClientLifecycleBatch
		}
	}
	return nil
}

func (x *MistTrigger) GetRawMistWebhook() *RawMistWebhookTrigger {
	if x != nil {
		if x, ok := x.TriggerPayload.(*MistTrigger_RawMistWebhook); ok {
			return x.RawMistWebhook
		}
	}
	return nil
}

func (x *MistTrigger) GetPushInputClose() *PushInputCloseTrigger {
	if x != nil {
		if x, ok := x.TriggerPayload.(*MistTrigger_PushInputClose); ok {
			return x.PushInputClose
		}
	}
	return nil
}

func (x *MistTrigger) GetPlaybackBootTrace() *PlaybackBootTrace {
	if x != nil {
		if x, ok := x.TriggerPayload.(*MistTrigger_PlaybackBootTrace); ok {
			return x.PlaybackBootTrace
		}
	}
	return nil
}

func (x *MistTrigger) GetPlaybackSessionQoe() *PlaybackSessionQoe {
	if x != nil {
		if x, ok := x.TriggerPayload.(*MistTrigger_PlaybackSessionQoe); ok {
			return x.PlaybackSessionQoe
		}
	}
	return nil
}

func (x *MistTrigger) GetIngestRuntimeAbsent() *IngestRuntimeAbsent {
	if x != nil {
		if x, ok := x.TriggerPayload.(*MistTrigger_IngestRuntimeAbsent); ok {
			return x.IngestRuntimeAbsent
		}
	}
	return nil
}

func (x *MistTrigger) GetRestreamStatus() *PushTargetStatusReport {
	if x != nil {
		if x, ok := x.TriggerPayload.(*MistTrigger_RestreamStatus); ok {
			return x.RestreamStatus
		}
	}
	return nil
}

func (x *MistTrigger) GetConnectionPlay() *ConnectionPlayTrigger {
	if x != nil {
		if x, ok := x.TriggerPayload.(*MistTrigger_ConnectionPlay); ok {
			return x.ConnectionPlay
		}
	}
	return nil
}
...
func (x *MistTrigger) GetTriggerUuid() string {
	if x != nil {
...
func (x *MistTrigger) GetTriggerUnixMillis() int64 {
	if x != nil {
...
type MistTrigger_FederationEventData struct {
	FederationEventData *FederationEventData `protobuf:"bytes,36,opt,name=federation_event_data,json=federationEventData,proto3,oneof"`
}

type MistTrigger_StreamProcess struct {
	StreamProcess *StreamProcessTrigger `protobuf:"bytes,38,opt,name=stream_process,json=streamProcess,proto3,oneof"`
}

type MistTrigger_ClientLifecycleBatch struct {
	ClientLifecycleBatch *ClientLifecycleBatch `protobuf:"bytes,39,opt,name=client_lifecycle_batch,json=clientLifecycleBatch,proto3,oneof"`
}

type MistTrigger_RawMistWebhook struct {
	RawMistWebhook *RawMistWebhookTrigger `protobuf:"bytes,40,opt,name=raw_mist_webhook,json=rawMistWebhook,proto3,oneof"`
}

type MistTrigger_PushInputClose struct {
	PushInputClose *PushInputCloseTrigger `protobuf:"bytes,41,opt,name=push_input_close,json=pushInputClose,proto3,oneof"`
}

type MistTrigger_PlaybackBootTrace struct {
	PlaybackBootTrace *PlaybackBootTrace `protobuf:"bytes,42,opt,name=playback_boot_trace,json=playbackBootTrace,proto3,oneof"`
}

type MistTrigger_PlaybackSessionQoe struct {
	PlaybackSessionQoe *PlaybackSessionQoe `protobuf:"bytes,43,opt,name=playback_session_qoe,json=playbackSessionQoe,proto3,oneof"`
}

type MistTrigger_IngestRuntimeAbsent struct {
	IngestRuntimeAbsent *IngestRuntimeAbsent `protobuf:"bytes,44,opt,name=ingest_runtime_absent,json=ingestRuntimeAbsent,proto3,oneof"`
}

type MistTrigger_RestreamStatus struct {
	// Sanitized restream lifecycle fact. Unlike raw PUSH_OUT_START/PUSH_END,
	// this carries stable target identity and never carries a destination URI
	// or Mist log text, so it is safe for the durable trigger WAL and analytics.
	RestreamStatus *PushTargetStatusReport `protobuf:"bytes,45,opt,name=restream_status,json=restreamStatus,proto3,oneof"`
}

type MistTrigger_ConnectionPlay struct {
...
func (*MistTrigger_FederationEventData) isMistTrigger_TriggerPayload() {}

func (*MistTrigger_StreamProcess) isMistTrigger_TriggerPayload() {}

func (*MistTrigger_ClientLifecycleBatch) isMistTrigger_TriggerPayload() {}

func (*MistTrigger_RawMistWebhook) isMistTrigger_TriggerPayload() {}

func (*MistTrigger_PushInputClose) isMistTrigger_TriggerPayload() {}

func (*MistTrigger_PlaybackBootTrace) isMistTrigger_TriggerPayload() {}

func (*MistTrigger_PlaybackSessionQoe) isMistTrigger_TriggerPayload() {}

func (*MistTrigger_IngestRuntimeAbsent) isMistTrigger_TriggerPayload() {}
...
// final triggers are still durably journaled and operator-visible instead
// of being acknowledged and lost when the local parser lags MistServer.
type RawMistWebhookTrigger struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PayloadRaw    []byte                 `protobuf:"bytes,1,opt,name=payload_raw,json=payloadRaw,proto3" json:"payload_raw,omitempty"`
...
func (x *RawMistWebhookTrigger) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RawMistWebhookTrigger) GetParseError() string {
	if x != nil {
		return x.ParseError
	}
	return ""
...
type MistTriggerResponse struct {
	...
	Response  string                 `protobuf:"bytes,2,opt,name=response,proto3" json:"response,omitempty"`                    // Value returned to MistServer when action is VALUE or unspecified.
	Abort     bool                   `protobuf:"varint,3,opt,name=abort,proto3" json:"abort,omitempty"`                         // Compatibility alias for action=DENY.
	...
	// Present on an accepted PUSH_REWRITE. Helmsman records this as the current runtime generation
	// and fences delayed activation/deactivation commands against publisher replacement.
	IngestGeneration string `protobuf:"bytes,5,opt,name=ingest_generation,json=ingestGeneration,proto3" json:"ingest_generation,omitempty"`
	// Mist connector PID bound to ingest_generation. Persisted with the fence so a delayed
	// PUSH_INPUT_CLOSE can tombstone only the generation whose connector actually ended.
	IngestConnectorPid int64             `protobuf:"varint,6,opt,name=ingest_connector_pid,json=ingestConnectorPid,proto3" json:"ingest_connector_pid,omitempty"`
	Action             MistTriggerAction `protobuf:"varint,7,opt,name=action,proto3,enum=helmsmancontrol.MistTriggerAction" json:"action,omitempty"`
...
func (x *MistTriggerResponse) GetIngestGeneration() string {
	if x != nil {
...
func (x *MistTriggerResponse) GetIngestConnectorPid() int64 {
	if x != nil {
		return x.IngestConnectorPid
	}
	return 0
}

func (x *MistTriggerResponse) GetAction() MistTriggerAction {
	if x != nil {
		return x.Action
	}
	return MistTriggerAction_MIST_TRIGGER_ACTION_UNSPECIFIED
}

func (x *MistTriggerResponse) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
// MistTriggerAck is Foghorn's durable acknowledgement for non-blocking
// final-event triggers. Helmsman persists each such trigger to its local
// WAL before responding 200 OK to Mist and waits for this ack before
// truncating the WAL row.
//
// Positive ack (success=true) means Decklog's SendEvent returned nil for
// this trigger, which itself only happens after the Kafka publish commits —
// the trigger is durably ingested.
//
// Negative ack (success=false) carries retryable + error_code so Helmsman
// can decide whether to backoff+resend (same request_id) or move the row
// to dead-letter. Transient failures (timeout, downstream unavailable,
// Kafka publish error) are retryable=true; permanent failures (parse
// error, schema violation, tenant deleted, or a deterministic internal
// lifecycle outcome) are retryable=false. error_code describes the failure
// class independently; INTERNAL is therefore not necessarily retryable.
type MistTriggerAck struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RequestId     string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"` // Stable source_event_id from the originating MistTrigger
	Success       bool                   `protobuf:"varint,2,opt,name=success,proto3" json:"success,omitempty"`
	Retryable     bool                   `protobuf:"varint,3,opt,name=retryable,proto3" json:"retryable,omitempty"` // Only meaningful when success=false
	ErrorCode     TriggerAckErrorCode    `protobuf:"varint,4,opt,name=error_code,json=errorCode,proto3,enum=helmsmancontrol.TriggerAckErrorCode" json:"error_code,omitempty"`
	ErrorMessage  string                 `protobuf:"bytes,5,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"` // Operator-facing detail; never customer-visible
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MistTriggerAck) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MistTriggerAck) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *MistTriggerAck) GetRetryable() bool {
	if x != nil {
		return x.Retryable
	}
	return false
...
func (x *MistTriggerAck) GetErrorCode() TriggerAckErrorCode {
	if x != nil {
		return x.ErrorCode
	}
	return TriggerAckErrorCode_TRIGGER_ACK_ERROR_NONE
}

func (x *MistTriggerAck) GetErrorMessage() string {
	if x != nil {
...
type StorageSnapshot struct {
	...
	// hot = node-local cache (operational by default), cold = S3 (frozen,
	// rated by default). See docs/architecture/meter-contracts.md.
	StorageScope *string `protobuf:"bytes,7,opt,name=storage_scope,json=storageScope,proto3,oneof" json:"storage_scope,omitempty"`
	// Provider attribution for marketplace settlement. The customer's
	// `tenant_id` on TenantStorageUsage is the *usage* tenant. These
	// fields identify who owns the underlying *storage capacity*:
	//   - cold/S3 snapshots emitted by Foghorn: provider = the platform
	...
	StorageProviderClusterId *string `protobuf:"bytes,9,opt,name=storage_provider_cluster_id,json=storageProviderClusterId,proto3,oneof" json:"storage_provider_cluster_id,omitempty"`
	StorageBackend           *string `protobuf:"bytes,10,opt,name=storage_backend,json=storageBackend,proto3,oneof" json:"storage_backend,omitempty"` // 's3' | 'edge_disk' | 'r2' | 'gcs' | 'unknown'
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *StorageSnapshot) GetStorageProviderTenantId() string {
	if x != nil && x.StorageProviderTenantId != nil {
		return *x.StorageProviderTenantId
	}
	return ""
}

func (x *StorageSnapshot) GetStorageProviderClusterId() string {
	if x != nil && x.StorageProviderClusterId != nil {
		return *x.StorageProviderClusterId
	}
	return ""
}

func (x *StorageSnapshot) GetStorageBackend() string {
...
type DVRStartRequest struct {
	...
	// Foghorn-authoritative runtime name for the source stream Helmsman will
	// PUSH from. Derived by Foghorn's stream registry from
	// (ingest_mode, internal_name): live+<x> for push, pull+<x> for pull, bare
	// <x> for mist_native. Helmsman uses verbatim — never re-derives.
	SourceRuntimeName string `protobuf:"bytes,9,opt,name=source_runtime_name,json=sourceRuntimeName,proto3" json:"source_runtime_name,omitempty"`
	// Monotonic per-recording command generation, assigned by Foghorn. Helmsman
	// applies DVRStart/DVRStop by generation with an IN-MEMORY per-hash stop tombstone
	// (NOT durable across a Helmsman restart): a DVRStop tombstones the recording at its
	// generation, so a lower-or-equal DVRStart arriving shortly after is rejected. This is
	// a best-effort ordering guard for the ms-scale stop-overtakes-start race on one
	// connected node — it is NOT the correctness boundary. The durable boundary is
	// Foghorn's ingest_sessions.ended_at plus artifacts.status: the only path that
	// re-delivers a start (DVRStartingRecoveryJob) revalidates against it, so a start for
	// an ended/superseded session is never re-dispatched even after the in-memory tombstone
	// is lost. A stop always carries a strictly higher generation than the start it
	// supersedes; a DVR hash is never reused (time-seeded + UNIQUE), so start=1 < stop=2 holds.
	CommandGeneration int64 `protobuf:"varint,10,opt,name=command_generation,json=commandGeneration,proto3" json:"command_generation,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *DVRStartRequest) GetSourceRuntimeName() string {
	if x != nil {
		return x.SourceRuntimeName
	}
	return ""
}

func (x *DVRStartRequest) GetCommandGeneration() int64 {
	if x != nil {
...
// DVRConfig is the resolved per-session DVR configuration Foghorn passes to
// the sidecar at push start. All values are resolved policy outputs from
// pkg/dvrpolicy.Resolve - the sidecar applies them verbatim and never
// interprets tier or cluster context.
type DVRConfig struct {
	...
	SegmentDuration int32                  `protobuf:"varint,4,opt,name=segment_duration,json=segmentDuration,proto3" json:"segment_duration,omitempty"` // Mist split (seconds)
	// Live DVR rolling-window controls (Mist push parameters).
	DvrWindowSeconds int32 `protobuf:"varint,5,opt,name=dvr_window_seconds,json=dvrWindowSeconds,proto3" json:"dvr_window_seconds,omitempty"` // Mist targetAge for the rolling playlist
	MaxEntries       int32 `protobuf:"varint,6,opt,name=max_entries,json=maxEntries,proto3" json:"max_entries,omitempty"`                     // Mist maxEntries cap on playlist size
	// Legacy unused field. DVR sessions have no absolute expiry; Foghorn computes
	// artifact retention at FinalizeDVR from the persisted dvr_retention_days
	// snapshot and sends this as 0.
	RetentionUntil int64 `protobuf:"varint,7,opt,name=retention_until,json=retentionUntil,proto3" json:"retention_until,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *DVRConfig) GetDvrWindowSeconds() int32 {
	if x != nil {
		return x.DvrWindowSeconds
	}
	return 0
}

func (x *DVRConfig) GetMaxEntries() int32 {
	if x != nil {
		return x.MaxEntries
	}
	return 0
...
func (x *DVRConfig) GetRetentionUntil() int64 {
	if x != nil {
...
type DVRStopRequest struct {
	...
	CommandGeneration int64                  `protobuf:"varint,4,opt,name=command_generation,json=commandGeneration,proto3" json:"command_generation,omitempty"` // See DVRStartRequest.command_generation. A stop tombstones the recording at this generation.
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *DVRStopRequest) GetCommandGeneration() int64 {
	if x != nil {
		return x.CommandGeneration
	}
	return 0
...
func (x *RecordDVRSegmentRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RecordDVRSegmentRequest) GetDvrHash() string {
	if x != nil {
		return x.DvrHash
	}
	return ""
...
func (x *RecordDVRSegmentRequest) GetSegmentName() string {
	if x != nil {
...
func (x *RecordDVRSegmentRequest) GetMediaStartMs() int64 {
	if x != nil {
		return x.MediaStartMs
	}
	return 0
}

func (x *RecordDVRSegmentRequest) GetMediaEndMs() int64 {
	if x != nil {
		return x.MediaEndMs
	}
	return 0
...
func (x *RecordDVRSegmentRequest) GetDurationMs() int64 {
	if x != nil {
		return x.DurationMs
	}
	return 0
...
func (x *RecordDVRSegmentRequest) GetLocalPath() string {
	if x != nil {
		return x.LocalPath
	}
	return ""
...
func (x *RecordDVRSegmentRequest) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
type RecordDVRSegmentResponse struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	RequestId        string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	...
	Accepted         bool                   `protobuf:"varint,4,opt,name=accepted,proto3" json:"accepted,omitempty"` // false if DVR is in a terminal state (rejected)
	Reason           string                 `protobuf:"bytes,5,opt,name=reason,proto3" json:"reason,omitempty"`      // populated if !accepted
	Sequence         int64                  `protobuf:"varint,6,opt,name=sequence,proto3" json:"sequence,omitempty"` // Foghorn-assigned monotonic sequence
	S3Key            string                 `protobuf:"bytes,7,opt,name=s3_key,json=s3Key,proto3" json:"s3_key,omitempty"`
	PresignedPutUrl  string                 `protobuf:"bytes,8,opt,name=presigned_put_url,json=presignedPutUrl,proto3" json:"presigned_put_url,omitempty"`
	UrlExpirySeconds int64                  `protobuf:"varint,9,opt,name=url_expiry_seconds,json=urlExpirySeconds,proto3" json:"url_expiry_seconds,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *RecordDVRSegmentResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RecordDVRSegmentResponse) GetDvrHash() string {
	if x != nil {
		return x.DvrHash
	}
	return ""
...
func (x *RecordDVRSegmentResponse) GetSegmentName() string {
	if x != nil {
		return x.SegmentName
	}
	return ""
...
func (x *RecordDVRSegmentResponse) GetAccepted() bool {
	if x != nil {
		return x.Accepted
	}
	return false
...
func (x *RecordDVRSegmentResponse) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *RecordDVRSegmentResponse) GetSequence() int64 {
	if x != nil {
		return x.Sequence
	}
	return 0
...
func (x *RecordDVRSegmentResponse) GetS3Key() string {
	if x != nil {
		return x.S3Key
	}
	return ""
...
func (x *RecordDVRSegmentResponse) GetPresignedPutUrl() string {
	if x != nil {
...
func (x *RecordDVRSegmentResponse) GetUrlExpirySeconds() int64 {
	if x != nil {
...
// Sidecar -> Foghorn: S3 upload completed; transition row to 'uploaded'.
// Fire-and-forget report; Foghorn updates the ledger row.
type MarkDVRSegmentUploaded struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RequestId     string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	DvrHash       string                 `protobuf:"bytes,2,opt,name=dvr_hash,json=dvrHash,proto3" json:"dvr_hash,omitempty"`
	SegmentName   string                 `protobuf:"bytes,3,opt,name=segment_name,json=segmentName,proto3" json:"segment_name,omitempty"`
	SizeBytes     uint64                 `protobuf:"varint,4,opt,name=size_bytes,json=sizeBytes,proto3" json:"size_bytes,omitempty"` // Confirmed final size on S3
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MarkDVRSegmentUploaded) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MarkDVRSegmentUploaded) GetDvrHash() string {
	if x != nil {
		return x.DvrHash
	}
	return ""
...
func (x *MarkDVRSegmentUploaded) GetSegmentName() string {
	if x != nil {
		return x.SegmentName
	}
	return ""
...
func (x *MarkDVRSegmentUploaded) GetSizeBytes() uint64 {
	if x != nil {
		return x.SizeBytes
	}
	return 0
...
// updates the ledger row to deleted_local (was_uploaded=true; chapter
// finalization can recover from S3) or lost_local (was_uploaded=false;
// any chapter overlapping the lost segment moves to
...
type DVRSegmentDropped struct {
	...
	DvrHash       string                 `protobuf:"bytes,2,opt,name=dvr_hash,json=dvrHash,proto3" json:"dvr_hash,omitempty"`
	SegmentName   string                 `protobuf:"bytes,3,opt,name=segment_name,json=segmentName,proto3" json:"segment_name,omitempty"`
	Reason        string                 `protobuf:"bytes,4,opt,name=reason,proto3" json:"reason,omitempty"` // disk_pressure | retention_expired | operator_cleanup
	DurationMs    int64                  `protobuf:"varint,5,opt,name=duration_ms,json=durationMs,proto3" json:"duration_ms,omitempty"`
	MediaStartMs  int64                  `protobuf:"varint,6,opt,name=media_start_ms,json=mediaStartMs,proto3" json:"media_start_ms,omitempty"`
	MediaEndMs    int64                  `protobuf:"varint,7,opt,name=media_end_ms,json=mediaEndMs,proto3" json:"media_end_ms,omitempty"`
	SizeBytes     uint64                 `protobuf:"varint,8,opt,name=size_bytes,json=sizeBytes,proto3" json:"size_bytes,omitempty"`
	DroppedAt     int64                  `protobuf:"varint,9,opt,name=dropped_at,json=droppedAt,proto3" json:"dropped_at,omitempty"` // Unix seconds
	WasUploaded   bool                   `protobuf:"varint,10,opt,name=was_uploaded,json=wasUploaded,proto3" json:"was_uploaded,omitempty"`
...
func (x *DVRSegmentDropped) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DVRSegmentDropped) GetDvrHash() string {
	if x != nil {
		return x.DvrHash
	}
	return ""
...
func (x *DVRSegmentDropped) GetSegmentName() string {
	if x != nil {
		return x.SegmentName
	}
	return ""
...
func (x *DVRSegmentDropped) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *DVRSegmentDropped) GetDurationMs() int64 {
	if x != nil {
		return x.DurationMs
	}
	return 0
...
func (x *DVRSegmentDropped) GetMediaStartMs() int64 {
	if x != nil {
		return x.MediaStartMs
	}
	return 0
...
func (x *DVRSegmentDropped) GetMediaEndMs() int64 {
	if x != nil {
		return x.MediaEndMs
	}
	return 0
...
func (x *DVRSegmentDropped) GetSizeBytes() uint64 {
	if x != nil {
		return x.SizeBytes
	}
	return 0
...
func (x *DVRSegmentDropped) GetDroppedAt() int64 {
	if x != nil {
		return x.DroppedAt
	}
	return 0
...
func (x *DVRSegmentDropped) GetWasUploaded() bool {
	if x != nil {
		return x.WasUploaded
	}
	return false
}

func (x *DVRSegmentDropped) GetLocalPath() string {
	if x != nil {
		return x.LocalPath
	}
	return ""
...
// Sidecar -> Foghorn: ask for the authoritative list of segments that are
// safe to evict locally for this DVR. Used during storage-pressure passes
// so the sidecar does not guess from its local uploaded cache alone.
type EvictableSegmentsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RequestId     string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	DvrHash       string                 `protobuf:"bytes,2,opt,name=dvr_hash,json=dvrHash,proto3" json:"dvr_hash,omitempty"`
	MaxCount      int32                  `protobuf:"varint,3,opt,name=max_count,json=maxCount,proto3" json:"max_count,omitempty"` // 0 = server default; Foghorn always caps the response
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *EvictableSegmentsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *EvictableSegmentsRequest) GetDvrHash() string {
	if x != nil {
		return x.DvrHash
	}
	return ""
...
func (x *EvictableSegmentsRequest) GetMaxCount() int32 {
	if x != nil {
		return x.MaxCount
	}
	return 0
...
// Foghorn -> sidecar: list of segment names safe to delete (status='uploaded'
// AND media_end_ms < now - effective_window).
type EvictableSegmentsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RequestId     string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	DvrHash       string                 `protobuf:"bytes,2,opt,name=dvr_hash,json=dvrHash,proto3" json:"dvr_hash,omitempty"`
...
func (x *EvictableSegmentsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *EvictableSegmentsResponse) GetDvrHash() string {
	if x != nil {
		return x.DvrHash
	}
	return ""
...
func (x *EvictableSegmentsResponse) GetSegmentNames() []string {
	if x != nil {
...
func (x *RetryDVRSegmentUpload) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RetryDVRSegmentUpload) GetDvrHash() string {
	if x != nil {
		return x.DvrHash
	}
	return ""
...
// Foghorn -> Helmsman: delete local TS segment file(s) for a DVR
// recording. Issued by the chapter reclaim sweep once every chapter
// covering a segment range has reached state=frozen. Helmsman deletes
// the local files via the existing eviction primitive; the matching
// recovery-bridge S3 objects are deleted by Foghorn directly.
//
// Idempotent: missing-file responses are treated as success by Foghorn.
type ReclaimDVRSegment struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RequestId     string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	DvrHash       string                 `protobuf:"bytes,2,opt,name=dvr_hash,json=dvrHash,proto3" json:"dvr_hash,omitempty"`
	SegmentNames  []string               `protobuf:"bytes,3,rep,name=segment_names,json=segmentNames,proto3" json:"segment_names,omitempty"`
...
func (x *ReclaimDVRSegment) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ReclaimDVRSegment) GetDvrHash() string {
	if x != nil {
		return x.DvrHash
	}
	return ""
...
func (x *ReclaimDVRSegment) GetSegmentNames() []string {
	if x != nil {
		return x.SegmentNames
	}
	return nil
...
// Sidecar -> Foghorn: restart reconciliation. After a sidecar restart, the
// in-memory local segment index is empty; the sidecar walks its DVR
// directories and asks Foghorn for current ledger state for each batch of
// discovered segments. Bounded by request size (the sidecar caps the batch
// at ~500 names per call) — this is the only sanctioned restart path.
// Foghorn responds with one DVRSegmentRef per requested name (status,
// uploaded_at, size, s3_key). Names not found in the ledger are omitted.
type RestoreLocalSegmentIndexRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RequestId     string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	DvrHash       string                 `protobuf:"bytes,2,opt,name=dvr_hash,json=dvrHash,proto3" json:"dvr_hash,omitempty"` // = artifact_hash
	SegmentNames  []string               `protobuf:"bytes,3,rep,name=segment_names,json=segmentNames,proto3" json:"segment_names,omitempty"`
...
func (x *RestoreLocalSegmentIndexRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RestoreLocalSegmentIndexRequest) GetDvrHash() string {
	if x != nil {
		return x.DvrHash
	}
	return ""
...
func (x *RestoreLocalSegmentIndexRequest) GetSegmentNames() []string {
	if x != nil {
		return x.SegmentNames
	}
	return nil
...
func (x *RestoreLocalSegmentIndexRequest) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
type RestoreLocalSegmentIndexResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RequestId     string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	DvrHash       string                 `protobuf:"bytes,2,opt,name=dvr_hash,json=dvrHash,proto3" json:"dvr_hash,omitempty"`
	Segments      []*DVRSegmentRef       `protobuf:"bytes,3,rep,name=segments,proto3" json:"segments,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RestoreLocalSegmentIndexResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RestoreLocalSegmentIndexResponse) GetDvrHash() string {
	if x != nil {
		return x.DvrHash
	}
	return ""
...
func (x *RestoreLocalSegmentIndexResponse) GetSegments() []*DVRSegmentRef {
	if x != nil {
		return x.Segments
	}
	return nil
...
type FreezePermissionRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RequestId     string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	AssetType     string                 `protobuf:"bytes,2,opt,name=asset_type,json=assetType,proto3" json:"asset_type,omitempty"`  // "clip" or "vod" (DVR freeze is rejected — DVR reclaims segment-wise)
	AssetHash     string                 `protobuf:"bytes,3,opt,name=asset_hash,json=assetHash,proto3" json:"asset_hash,omitempty"`  // clip_hash or vod_hash
	SizeBytes     uint64                 `protobuf:"varint,5,opt,name=size_bytes,json=sizeBytes,proto3" json:"size_bytes,omitempty"` // Size of the asset to freeze (informational)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type FreezePermissionResponse struct {
	...
	// Server-minted attempt id. The node echoes it as SyncComplete.request_id, so completion consumes a
	// Foghorn-assigned operation rather than a node-chosen id. The presigned PUT targets an attempt-scoped
	// staging object that Foghorn promotes to the canonical key after verifying it.
...
func (x *FreezePermissionResponse) GetAttemptId() string {
	if x != nil {
		return x.AttemptId
	}
	return ""
...
type FreezeRequest struct {
	...
	AssetType         string                 `protobuf:"bytes,2,opt,name=asset_type,json=assetType,proto3" json:"asset_type,omitempty"`                                                                                  // "clip", "dvr", or "vod"
	AssetHash         string                 `protobuf:"bytes,3,opt,name=asset_hash,json=assetHash,proto3" json:"asset_hash,omitempty"`                                                                                  // clip_hash, dvr_hash, or vod_hash
	...
	PresignedPutUrl   string                 `protobuf:"bytes,7,opt,name=presigned_put_url,json=presignedPutUrl,proto3" json:"presigned_put_url,omitempty"`                                                              // Presigned PUT URL for single-file upload
	...
	SegmentUrls       map[string]string      `protobuf:"bytes,10,rep,name=segment_urls,json=segmentUrls,proto3" json:"segment_urls,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // For DVR: relative path -> presigned PUT URL
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *FreezeRequest) GetSegmentUrls() map[string]string {
	if x != nil {
...
// DVRSegmentRef is one segment in the chapter-finalize segment list
// Foghorn hands to Helmsman. Helmsman reads the local TS file when
// available, falls back to presigned_get_url when the local copy is
// gone (recovery bridge). status semantics:
//
//	uploaded       : local file present + S3 freeze object exists
//	deleted_local  : local file evicted post-upload; S3 freeze is the
//	                 sole source — presigned_get_url is required
//	lost_local     : local file gone before upload; presigned_get_url
//	                 may be empty (terminal source loss). Chapters
//	                 overlapping a lost_local row without a recovery
//	                 URL move to state='failed_source_missing'.
type DVRSegmentRef struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	...
	PresignedGetUrl string                 `protobuf:"bytes,3,opt,name=presigned_get_url,json=presignedGetUrl,proto3" json:"presigned_get_url,omitempty"` // empty for lost_local
	...
	Status          string                 `protobuf:"bytes,7,opt,name=status,proto3" json:"status,omitempty"`                         // 'uploaded' | 'lost_local' | 'deleted_local' | 'orphan_unreachable'
...
func (x *DVRSegmentRef) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DVRSegmentRef) GetS3Key() string {
	if x != nil {
		return x.S3Key
	}
	return ""
...
func (x *DVRSegmentRef) GetPresignedGetUrl() string {
	if x != nil {
...
func (x *DVRSegmentRef) GetMediaStartMs() int64 {
	if x != nil {
		return x.MediaStartMs
	}
	return 0
...
func (x *DVRSegmentRef) GetMediaEndMs() int64 {
	if x != nil {
		return x.MediaEndMs
	}
	return 0
...
func (x *DVRSegmentRef) GetDurationMs() int64 {
	if x != nil {
		return x.DurationMs
	}
	return 0
...
func (x *DVRSegmentRef) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
// RelayResolveRequest is sent by Helmsman to Foghorn to look up the durable
// source coordinates of an artifact for the /internal/artifact/* HTTP relay.
// The relay URL only encodes (kind, hash, ext); the actual S3 presigned URLs,
// expected size, and (for DVR) chapter segment refs come from this resolve.
//
// Lifecycle: relay HTTP server calls this on first request per (asset, session)
// and caches the response in memory for url_ttl_seconds * 0.8, then refreshes
// mid-playback on TTL expiry to handle sessions outliving the first presigned
// URL.
type RelayResolveRequest struct {
	state         protoimpl.MessageState        `protogen:"open.v1"`
	RequestId     string                        `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	AssetKind     string                        `protobuf:"bytes,2,opt,name=asset_kind,json=assetKind,proto3" json:"asset_kind,omitempty"` // "vod" | "clip" | "dvr" | "upload"
	AssetHash     string                        `protobuf:"bytes,3,opt,name=asset_hash,json=assetHash,proto3" json:"asset_hash,omitempty"` // artifact_hash / upload_hash / dvr_hash
	Ext           string                        `protobuf:"bytes,5,opt,name=ext,proto3" json:"ext,omitempty"`                              // "mp4" | "mkv" | "m3u8" | ...
	Hint          RelayResolveRequest_RelayHint `protobuf:"varint,6,opt,name=hint,proto3,enum=helmsmancontrol.RelayResolveRequest_RelayHint" json:"hint,omitempty"`
	NodeId        string                        `protobuf:"bytes,7,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"` // For locality decisions
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RelayResolveRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RelayResolveRequest) GetAssetKind() string {
	if x != nil {
		return x.AssetKind
	}
	return ""
...
func (x *RelayResolveRequest) GetAssetHash() string {
	if x != nil {
		return x.AssetHash
	}
	return ""
...
func (x *RelayResolveRequest) GetExt() string {
	if x != nil {
		return x.Ext
	}
	return ""
...
func (x *RelayResolveRequest) GetHint() RelayResolveRequest_RelayHint {
	if x != nil {
		return x.Hint
	}
	return RelayResolveRequest_RELAY_HINT_UNSPECIFIED
}

func (x *RelayResolveRequest) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
// RelayResolveResponse carries the durable source plus optional sidecar/.dtsh
// URLs and (for DVR) the full chapter segment ref list. AssetState lets the
// relay handle missing/active/gap cases without inferring from absent fields.
type RelayResolveResponse struct {
	state             protoimpl.MessageState                 `protogen:"open.v1"`
	RequestId         string                                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	AssetHash         string                                 `protobuf:"bytes,2,opt,name=asset_hash,json=assetHash,proto3" json:"asset_hash,omitempty"`
	State             AssetState                             `protobuf:"varint,3,opt,name=state,proto3,enum=helmsmancontrol.AssetState" json:"state,omitempty"`
	MediaPresignedUrl string                                 `protobuf:"bytes,4,opt,name=media_presigned_url,json=mediaPresignedUrl,proto3" json:"media_presigned_url,omitempty"` // S3 GET, range-capable (HEAD + Range)
	DtshPresignedGet  string                                 `protobuf:"bytes,5,opt,name=dtsh_presigned_get,json=dtshPresignedGet,proto3" json:"dtsh_presigned_get,omitempty"`    // empty if no sidecar yet
	ExpectedSizeBytes uint64                                 `protobuf:"varint,7,opt,name=expected_size_bytes,json=expectedSizeBytes,proto3" json:"expected_size_bytes,omitempty"`
	ContentType       string                                 `protobuf:"bytes,8,opt,name=content_type,json=contentType,proto3" json:"content_type,omitempty"`
	UrlTtlSeconds     int64                                  `protobuf:"varint,9,opt,name=url_ttl_seconds,json=urlTtlSeconds,proto3" json:"url_ttl_seconds,omitempty"` // for refresh on long playbacks
	PolicyHint        RelayResolveResponse_CacheDecisionHint `protobuf:"varint,11,opt,name=policy_hint,json=policyHint,proto3,enum=helmsmancontrol.RelayResolveResponse_CacheDecisionHint" json:"policy_hint,omitempty"`
	Error             string                                 `protobuf:"bytes,12,opt,name=error,proto3" json:"error,omitempty"` // populated when state != ASSET_STATE_PLAYABLE
	// Mist routing name owning this artifact. For DVR this is the stream the
	// recording belongs to; on-disk DVR layout nests as
	// storage/dvr/<stream_internal_name>/<dvr_hash>/{chapters,segments} so the
	// relay needs this value to find warm local files and write cold fills to
	// the same canonical location the freeze/relay paths use. For VOD/clip
	// this is the Mist internal_name (vod+<name>) that addresses the artifact.
	StreamInternalName string `protobuf:"bytes,13,opt,name=stream_internal_name,json=streamInternalName,proto3" json:"stream_internal_name,omitempty"`
	// Peer-relay fallback: when an artifact is hot on its origin node but
	// not yet synced to S3, Foghorn returns a URL pointing at that origin
	// node's Helmsman in place of media_presigned_url. The block-cache
	// fetcher uses this URL exactly like an S3 URL but presents
	// peer_relay_grant_id as Authorization: Bearer. When peer_relay_url is
	// set, media_presigned_url is empty. peer_relay_dtsh_url is the sidecar
	// (.dtsh) URL (Mist derives it as media + ".dtsh"); the same grant
	// authorizes both, so there is one grant id, not a per-path token.
	PeerRelayUrl     string `protobuf:"bytes,14,opt,name=peer_relay_url,json=peerRelayUrl,proto3" json:"peer_relay_url,omitempty"`
	PeerRelayDtshUrl string `protobuf:"bytes,16,opt,name=peer_relay_dtsh_url,json=peerRelayDtshUrl,proto3" json:"peer_relay_dtsh_url,omitempty"`
	// Opaque capability handle minted + stored by the origin cluster's
	// Foghorn. The serving edge authorizes an inbound pull by asking its
...
func (x *RelayResolveResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RelayResolveResponse) GetAssetHash() string {
	if x != nil {
		return x.AssetHash
	}
	return ""
...
func (x *RelayResolveResponse) GetState() AssetState {
	if x != nil {
		return x.State
	}
...
func (x *RelayResolveResponse) GetMediaPresignedUrl() string {
	if x != nil {
		return x.MediaPresignedUrl
	}
	return ""
}

func (x *RelayResolveResponse) GetDtshPresignedGet() string {
	if x != nil {
		return x.DtshPresignedGet
	}
	return ""
}

func (x *RelayResolveResponse) GetExpectedSizeBytes() uint64 {
	if x != nil {
...
func (x *RelayResolveResponse) GetContentType() string {
	if x != nil {
...
func (x *RelayResolveResponse) GetUrlTtlSeconds() int64 {
	if x != nil {
...
func (x *RelayResolveResponse) GetPolicyHint() RelayResolveResponse_CacheDecisionHint {
	if x != nil {
		return x.PolicyHint
	}
	return RelayResolveResponse_CACHE_HINT_UNSPECIFIED
}

func (x *RelayResolveResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *RelayResolveResponse) GetStreamInternalName() string {
	if x != nil {
...
func (x *RelayResolveResponse) GetPeerRelayUrl() string {
	if x != nil {
...
func (x *RelayResolveResponse) GetPeerRelayDtshUrl() string {
	if x != nil {
...
// AuthorizeRelayPullRequest is sent by a SERVING edge's Helmsman to its
// Foghorn when an inbound /internal/artifact/* pull presents a
// peer_relay_grant_id. Foghorn is the authority: it matches the grant it
// minted at resolve time against (artifact_hash, request_path) and replies
// allow/deny. The edge holds no key — this replaces self-validating JWTs.
type AuthorizeRelayPullRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RequestId     string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	...
	RequestPath   string                 `protobuf:"bytes,4,opt,name=request_path,json=requestPath,proto3" json:"request_path,omitempty"` // full /internal/artifact/... path (media or its .dtsh)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AuthorizeRelayPullRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *AuthorizeRelayPullRequest) GetGrantId() string {
	if x != nil {
		return x.GrantId
	}
	return ""
...
func (x *AuthorizeRelayPullRequest) GetArtifactHash() string {
	if x != nil {
		return x.ArtifactHash
	}
	return ""
...
func (x *AuthorizeRelayPullRequest) GetRequestPath() string {
	if x != nil {
...
type AuthorizeRelayPullResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RequestId     string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	Allowed       bool                   `protobuf:"varint,2,opt,name=allowed,proto3" json:"allowed,omitempty"`
	Reason        string                 `protobuf:"bytes,3,opt,name=reason,proto3" json:"reason,omitempty"` // diagnostic when allowed=false
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AuthorizeRelayPullResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *AuthorizeRelayPullResponse) GetAllowed() bool {
	if x != nil {
		return x.Allowed
	}
	return false
...
func (x *AuthorizeRelayPullResponse) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
// The sync keeps the local copy after uploading to S3.
type SyncComplete struct {
	state        protoimpl.MessageState `protogen:"open.v1"`
	RequestId    string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	AssetHash    string                 `protobuf:"bytes,2,opt,name=asset_hash,json=assetHash,proto3" json:"asset_hash,omitempty"`
	Status       string                 `protobuf:"bytes,3,opt,name=status,proto3" json:"status,omitempty"`                                  // "success" or "failed"
	SizeBytes    uint64                 `protobuf:"varint,5,opt,name=size_bytes,json=sizeBytes,proto3" json:"size_bytes,omitempty"`          // Node-reported size; Foghorn HEAD-verifies and records the observed size
...
type DtshSyncRequest struct {
	...
	AssetType        string                 `protobuf:"bytes,2,opt,name=asset_type,json=assetType,proto3" json:"asset_type,omitempty"`                         // "clip" or "vod" (DVR freeze is rejected — DVR reclaims segment-wise)
	AssetHash        string                 `protobuf:"bytes,3,opt,name=asset_hash,json=assetHash,proto3" json:"asset_hash,omitempty"`                         // clip_hash or vod_hash
	LocalPath        string                 `protobuf:"bytes,4,opt,name=local_path,json=localPath,proto3" json:"local_path,omitempty"`                         // Path to the main clip/vod asset (the sidecar appends .dtsh)
...
type StorageLifecycleData struct {
	...
	DurationMs      *int64                                   `protobuf:"varint,11,opt,name=duration_ms,json=durationMs,proto3,oneof" json:"duration_ms,omitempty"`                 // How long the operation took (sync/cache fill duration)
...
func (x *StorageLifecycleData) GetReason() StorageLifecycleData_CacheFailureReason {
...
type PushRewriteTrigger struct {
	...
	// MistServer publisher-connection identity, captured by Helmsman from the trigger
	// HTTP headers (X-PID, X-Trigger-UUID, X-Trigger-UnixMillis; lib/triggers.cpp).
	// PUSH_REWRITE runs inside the publisher connector process, so `pid` identifies the
	// actual ingest connection. The same connector emits PUSH_INPUT_CLOSE carrying the
	// same pid in its typed payload, so Foghorn correlates start↔end by (tenant, node,
	// pid). trigger_uuid/trigger_unix_millis fence delayed closes and PID reuse. These
	// are the ingest-session identity STREAM_END and tkn cannot provide.
	Pid               int64  `protobuf:"varint,18,opt,name=pid,proto3" json:"pid,omitempty"`
	TriggerUuid       string `protobuf:"bytes,19,opt,name=trigger_uuid,json=triggerUuid,proto3" json:"trigger_uuid,omitempty"`
	TriggerUnixMillis int64  `protobuf:"varint,20,opt,name=trigger_unix_millis,json=triggerUnixMillis,proto3" json:"trigger_unix_millis,omitempty"`
	// Connector name Mist itself reports as the 4th PUSH_REWRITE payload line
	// (RTMP, TSSRT, WebRTC, DTSC, ...). Unlike push_url, the publisher cannot
	// choose it; placement ingest admission derives the protocol from this and
	// never from the URL scheme. Empty when an older Mist sent three lines.
	ObservedConnector string `protobuf:"bytes,21,opt,name=observed_connector,json=observedConnector,proto3" json:"observed_connector,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *PushRewriteTrigger) GetPid() int64 {
	if x != nil {
		return x.Pid
	}
	return 0
...
func (x *PushRewriteTrigger) GetTriggerUuid() string {
	if x != nil {
		return x.TriggerUuid
	}
	return ""
...
func (x *PushRewriteTrigger) GetTriggerUnixMillis() int64 {
	if x != nil {
		return x.TriggerUnixMillis
	}
	return 0
...
func (x *PushRewriteTrigger) GetObservedConnector() string {
	if x != nil {
		return x.ObservedConnector
	}
	return ""
}

// ConnectionPlayTrigger is Mist's per-connection CONN_PLAY admission hook.
// It carries observations, not an authenticated identity for the remote peer.
type ConnectionPlayTrigger struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StreamName    string                 `protobuf:"bytes,1,opt,name=stream_name,json=streamName,proto3" json:"stream_name,omitempty"`
...
func (x *ConnectionPlayTrigger) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ConnectionPlayTrigger) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *ConnectionPlayTrigger) GetConnector() string {
	if x != nil {
		return x.Connector
	}
	return ""
...
func (x *ConnectionPlayTrigger) GetRequestUrl() string {
	if x != nil {
		return x.RequestUrl
	}
	return ""
...
type StreamProcessTrigger struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StreamName    string                 `protobuf:"bytes,1,opt,name=stream_name,json=streamName,proto3" json:"stream_name,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *StreamProcessTrigger) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// PushInputCloseTrigger is emitted by MistServer when a publisher input
// process exits (RTMP/SRT/WebRTC publisher disconnected or pushed input
// closed). This is the source-presence "publisher gone" edge Foghorn's
// admission state machine uses to flip source_active=false on the owner
// entry. Distinct from PUSH_END (which fires for outbound push targets)
// and from STREAM_END (which fires only after viewer activity also drains).
//
// Payload order verified against MistServer source
// (src/controller/controller_capabilities.cpp:457 and
// src/output/output.cpp:2209):
//
//	stream name (string), remote host (string), binary name (string),
//	pid (integer), machine-readable reason (string, enum),
//	human-readable reason (string), tracks JSON (object).
type PushInputCloseTrigger struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StreamName    string                 `protobuf:"bytes,1,opt,name=stream_name,json=streamName,proto3" json:"stream_name,omitempty"`
	RemoteHost    string                 `protobuf:"bytes,2,opt,name=remote_host,json=remoteHost,proto3" json:"remote_host,omitempty"`
	BinaryName    string                 `protobuf:"bytes,3,opt,name=binary_name,json=binaryName,proto3" json:"binary_name,omitempty"` // e.g. "MistInRTMP", "MistInDTSC"
	Pid           int64                  `protobuf:"varint,4,opt,name=pid,proto3" json:"pid,omitempty"`
	MachineReason string                 `protobuf:"bytes,5,opt,name=machine_reason,json=machineReason,proto3" json:"machine_reason,omitempty"` // short programmatic token
	HumanReason   string                 `protobuf:"bytes,6,opt,name=human_reason,json=humanReason,proto3" json:"human_reason,omitempty"`       // free-text
	TracksJson    string                 `protobuf:"bytes,7,opt,name=tracks_json,json=tracksJson,proto3" json:"tracks_json,omitempty"`          // raw JSON Mist provides; parsed downstream only if needed
	...
	// trigger_unix_millis is MistServer's X-Trigger-UnixMillis header (the
	// controller's own event time), captured by Helmsman. Used to fence a
	// delayed close against ingest-session PID reuse: a close is only allowed
	// to finalize the session whose start preceded it. Field 4 (pid) plus this
	// event time key the close to the exact ingest generation.
	TriggerUnixMillis int64 `protobuf:"varint,10,opt,name=trigger_unix_millis,json=triggerUnixMillis,proto3" json:"trigger_unix_millis,omitempty"`
	// trigger_uuid is MistServer's X-Trigger-UUID (MIST_TUUID) — stable across a
	// trigger's retries, distinct per logical trigger. It is folded into the WAL
	// source_event_id so two legitimately-distinct closes with IDENTICAL bodies
	// (same stream + reused PID) are not collapsed to one dedup key and dropped.
	TriggerUuid   string `protobuf:"bytes,11,opt,name=trigger_uuid,json=triggerUuid,proto3" json:"trigger_uuid,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PushInputCloseTrigger) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PushInputCloseTrigger) GetRemoteHost() string {
	if x != nil {
		return x.RemoteHost
	}
	return ""
...
func (x *PushInputCloseTrigger) GetBinaryName() string {
	if x != nil {
		return x.BinaryName
	}
	return ""
...
func (x *PushInputCloseTrigger) GetPid() int64 {
	if x != nil {
		return x.Pid
	}
	return 0
...
func (x *PushInputCloseTrigger) GetMachineReason() string {
	if x != nil {
		return x.MachineReason
	}
	return ""
}

func (x *PushInputCloseTrigger) GetHumanReason() string {
	if x != nil {
		return x.HumanReason
	}
	return ""
}

func (x *PushInputCloseTrigger) GetTracksJson() string {
	if x != nil {
		return x.TracksJson
	}
	return ""
...
func (x *PushInputCloseTrigger) GetNodeId() string {
	if x != nil && x.NodeId != nil {
		return *x.NodeId
	}
	return ""
...
func (x *PushInputCloseTrigger) GetStreamId() string {
	if x != nil && x.StreamId != nil {
		return *x.StreamId
	}
	return ""
...
func (x *PushInputCloseTrigger) GetTriggerUnixMillis() int64 {
	if x != nil {
		return x.TriggerUnixMillis
	}
	return 0
...
func (x *PushInputCloseTrigger) GetTriggerUuid() string {
	if x != nil {
		return x.TriggerUuid
	}
	return ""
...
type ViewerConnectTrigger struct {
	...
	Host string `protobuf:"bytes,2,opt,name=host,proto3" json:"host,omitempty"`
	// viewer_token is the bearer token MistServer extracted from the viewer
	// request: ?jwt=, ?tkn=, ?sid=, ?sessId=, Cookie: jwt=/tkn=, or
	// Authorization: Bearer. Source: MistServer session.cpp:272 (USER_NEW
	// payload field 3). Used by Foghorn's playback-policy enforcer.
	ViewerToken string `protobuf:"bytes,3,opt,name=viewer_token,json=viewerToken,proto3" json:"viewer_token,omitempty"`
...
func (x *ViewerConnectTrigger) GetViewerToken() string {
	if x != nil {
...
type ViewerDisconnectTrigger struct {
	...
	// MistServer USER_END breakdown arrays (preserved from
	// src/session.cpp's emission of streamSummary / connectorSummary /
	// hostSummary alongside streamTimes / connectorTimes / hostTimes).
	// For multi-stream sessions the scalar `stream_name`, `connector`,
	// and `host` fields above carry the comma-joined summary string;
...
func (x *ViewerDisconnectTrigger) GetStreamTimes() []*SessionTimeShare {
	if x != nil {
		return x.StreamTimes
	}
	return nil
}

func (x *ViewerDisconnectTrigger) GetConnectorTimes() []*SessionTimeShare {
	if x != nil {
		return x.ConnectorTimes
	}
	return nil
}

func (x *ViewerDisconnectTrigger) GetHostTimes() []*SessionTimeShare {
	if x != nil {
		return x.HostTimes
	}
	return nil
...
// USER_END breakdown array. `name` is the stream / connector / host
// identifier; `seconds` is the time the viewer spent on it.
type SessionTimeShare struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *SessionTimeShare) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SessionTimeShare) GetSeconds() uint32 {
	if x != nil {
		return x.Seconds
	}
	return 0
...
type StreamBufferTrigger struct {
	...
	StreamId       *string `protobuf:"bytes,13,opt,name=stream_id,json=streamId,proto3,oneof" json:"stream_id,omitempty"`                      // Enriched by Foghorn (UUID)
	// X-PID identifies the emitting buffer process, not a publisher connector.
	BufferPid     *int64 `protobuf:"varint,14,opt,name=buffer_pid,json=bufferPid,proto3,oneof" json:"buffer_pid,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StreamBufferTrigger) GetBufferPid() int64 {
	if x != nil && x.BufferPid != nil {
		return *x.BufferPid
	}
	return 0
}
...
type StreamEndTrigger struct {
	...
	NodeId          *string                `protobuf:"bytes,8,opt,name=node_id,json=nodeId,proto3,oneof" json:"node_id,omitempty"`
	StreamId        *string                `protobuf:"bytes,9,opt,name=stream_id,json=streamId,proto3,oneof" json:"stream_id,omitempty"` // Enriched by Foghorn (UUID)
	// MistServer's X-Trigger-UnixMillis header (event time of the stream ending). Foghorn uses it as
	// the event-time fence for the ingest-session reaper: STREAM_END ends only sessions that started
	// at or before this time, so a reconnect that came up AFTER the stream ended is preserved.
	TriggerUnixMillis int64 `protobuf:"varint,10,opt,name=trigger_unix_millis,json=triggerUnixMillis,proto3" json:"trigger_unix_millis,omitempty"`
	// MistServer's X-Trigger-UUID header. Stable across a single trigger's retries but distinct per
	// logical STREAM_END, so it (with trigger_unix_millis) makes the durable WAL identity distinguish
	// two same-body STREAM_ENDs — otherwise two later events with identical metrics bodies collapse to
	// one WAL record while Foghorn is unavailable, and replaying the older event time can miss the
	// newer generation.
	TriggerUuid   string `protobuf:"bytes,11,opt,name=trigger_uuid,json=triggerUuid,proto3" json:"trigger_uuid,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *StreamEndTrigger) GetTriggerUnixMillis() int64 {
	if x != nil {
		return x.TriggerUnixMillis
	}
	return 0
...
func (x *StreamEndTrigger) GetTriggerUuid() string {
	if x != nil {
		return x.TriggerUuid
	}
	return ""
...
// Per-job feeder speed aggregates from MistServer's processing rate
// controller, attached to RECORDING_END for process-controlled recordings
// and carried through clip/VOD lifecycle events for analytics. Tick = one
// controller cycle (~1s), so tick counts double as approximate seconds.
type ProcessingSpeedStats struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Ticks            uint32                 `protobuf:"varint,1,opt,name=ticks,proto3" json:"ticks,omitempty"`                                                 // controller ticks observed
	SpeedMin         float64                `protobuf:"fixed64,2,opt,name=speed_min,json=speedMin,proto3" json:"speed_min,omitempty"`                          // lowest effectiveSpeed multiplier
	SpeedAvg         float64                `protobuf:"fixed64,3,opt,name=speed_avg,json=speedAvg,proto3" json:"speed_avg,omitempty"`                          // time-weighted average multiplier
	SpeedMax         float64                `protobuf:"fixed64,4,opt,name=speed_max,json=speedMax,proto3" json:"speed_max,omitempty"`                          // highest effectiveSpeed multiplier
	HardSlowTicks    uint32                 `protobuf:"varint,5,opt,name=hard_slow_ticks,json=hardSlowTicks,proto3" json:"hard_slow_ticks,omitempty"`          // ticks slammed to 1x by a proc verdict
	RegularSlowTicks uint32                 `protobuf:"varint,6,opt,name=regular_slow_ticks,json=regularSlowTicks,proto3" json:"regular_slow_ticks,omitempty"` // ticks ramped down 20%
	RampUps          uint32                 `protobuf:"varint,7,opt,name=ramp_ups,json=rampUps,proto3" json:"ramp_ups,omitempty"`                              // ramp-up events
	LockoutTicks     uint32                 `protobuf:"varint,8,opt,name=lockout_ticks,json=lockoutTicks,proto3" json:"lockout_ticks,omitempty"`               // ticks under ramp lockout
	StaleHoldTicks   uint32                 `protobuf:"varint,9,opt,name=stale_hold_ticks,json=staleHoldTicks,proto3" json:"stale_hold_ticks,omitempty"`       // ticks held because a required proc was unobservable
	DrainMs          *int64                 `protobuf:"varint,10,opt,name=drain_ms,json=drainMs,proto3,oneof" json:"drain_ms,omitempty"`                       // recording drain tail after the source ended
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *ProcessingSpeedStats) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ProcessingSpeedStats) GetSpeedMin() float64 {
	if x != nil {
		return x.SpeedMin
	}
	return 0
...
func (x *ProcessingSpeedStats) GetSpeedAvg() float64 {
	if x != nil {
		return x.SpeedAvg
	}
	return 0
...
func (x *ProcessingSpeedStats) GetSpeedMax() float64 {
	if x != nil {
		return x.SpeedMax
	}
	return 0
...
func (x *ProcessingSpeedStats) GetHardSlowTicks() uint32 {
	if x != nil {
		return x.HardSlowTicks
	}
	return 0
}

func (x *ProcessingSpeedStats) GetRegularSlowTicks() uint32 {
	if x != nil {
		return x.RegularSlowTicks
	}
	return 0
}

func (x *ProcessingSpeedStats) GetRampUps() uint32 {
	if x != nil {
		return x.RampUps
	}
	return 0
...
func (x *ProcessingSpeedStats) GetLockoutTicks() uint32 {
	if x != nil {
		return x.LockoutTicks
	}
	return 0
}

func (x *ProcessingSpeedStats) GetStaleHoldTicks() uint32 {
	if x != nil {
		return x.StaleHoldTicks
	}
	return 0
}

func (x *ProcessingSpeedStats) GetDrainMs() int64 {
	if x != nil && x.DrainMs != nil {
		return *x.DrainMs
	}
	return 0
}
...
type RecordingCompleteTrigger struct {
	...
	ProcessingSpeed *ProcessingSpeedStats `protobuf:"bytes,14,opt,name=processing_speed,json=processingSpeed,proto3,oneof" json:"processing_speed,omitempty"` // present for process-controlled recordings
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *RecordingCompleteTrigger) GetExitReason() string {
...
func (x *RecordingCompleteTrigger) GetHumanExitReason() string {
	if x != nil && x.HumanExitReason != nil {
...
func (x *RecordingCompleteTrigger) GetProcessingSpeed() *ProcessingSpeedStats {
	if x != nil {
		return x.ProcessingSpeed
	}
	return nil
}
...
type StreamLifecycleUpdate struct {
	...
	// Exact admitted runtime identity used by Helmsman's authoritative Mist inventory
	// reconciliation. Ordinary lifecycle telemetry leaves these unset.
	IngestGeneration   *string                       `protobuf:"bytes,39,opt,name=ingest_generation,json=ingestGeneration,proto3,oneof" json:"ingest_generation,omitempty"`
	IngestConnectorPid *int64                        `protobuf:"varint,40,opt,name=ingest_connector_pid,json=ingestConnectorPid,proto3,oneof" json:"ingest_connector_pid,omitempty"`
	ProcessObservation *MistStreamProcessObservation `protobuf:"bytes,41,opt,name=process_observation,json=processObservation,proto3" json:"process_observation,omitempty"`
...
func (x *StreamLifecycleUpdate) GetIngestGeneration() string {
	if x != nil && x.IngestGeneration != nil {
		return *x.IngestGeneration
	}
	return ""
}

func (x *StreamLifecycleUpdate) GetIngestConnectorPid() int64 {
	if x != nil && x.IngestConnectorPid != nil {
		return *x.IngestConnectorPid
	}
	return 0
}

func (x *StreamLifecycleUpdate) GetProcessObservation() *MistStreamProcessObservation {
	if x != nil {
...
func (x *StreamLifecycleUpdate) GetBufferSampledUnixMillis() int64 {
	if x != nil && x.BufferSampledUnixMillis != nil {
...
// older Foghorn cannot ignore the identity fields and fall back to a broad
// stream-name reap during a rolling upgrade.
type IngestRuntimeAbsent struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	Lifecycle          *StreamLifecycleUpdate `protobuf:"bytes,1,opt,name=lifecycle,proto3" json:"lifecycle,omitempty"`
	IngestGeneration   string                 `protobuf:"bytes,2,opt,name=ingest_generation,json=ingestGeneration,proto3" json:"ingest_generation,omitempty"`
	IngestConnectorPid int64                  `protobuf:"varint,3,opt,name=ingest_connector_pid,json=ingestConnectorPid,proto3" json:"ingest_connector_pid,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *IngestRuntimeAbsent) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *IngestRuntimeAbsent) GetIngestGeneration() string {
	if x != nil {
		return x.IngestGeneration
	}
	return ""
...
func (x *IngestRuntimeAbsent) GetIngestConnectorPid() int64 {
	if x != nil {
		return x.IngestConnectorPid
	}
	return 0
...
type MistStreamProcessObservation struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	RuntimeName string                 `protobuf:"bytes,1,opt,name=runtime_name,json=runtimeName,proto3" json:"runtime_name,omitempty"`
	BufferPid   *int64                 `protobuf:"varint,2,opt,name=buffer_pid,json=bufferPid,proto3,oneof" json:"buffer_pid,omitempty"`
	// False means missing or malformed, not an authoritative empty inventory.
	SourcePidsKnown bool    `protobuf:"varint,3,opt,name=source_pids_known,json=sourcePidsKnown,proto3" json:"source_pids_known,omitempty"`
	SourcePids      []int64 `protobuf:"varint,4,rep,packed,name=source_pids,json=sourcePids,proto3" json:"source_pids,omitempty"`
	FirstMediaMs    *uint64 `protobuf:"varint,5,opt,name=first_media_ms,json=firstMediaMs,proto3,oneof" json:"first_media_ms,omitempty"`
	LastMediaMs     *uint64 `protobuf:"varint,6,opt,name=last_media_ms,json=lastMediaMs,proto3,oneof" json:"last_media_ms,omitempty"`
	// Zero means the read window was not captured; never substitute send time.
	ReadStartedUnixMillis   int64 `protobuf:"varint,7,opt,name=read_started_unix_millis,json=readStartedUnixMillis,proto3" json:"read_started_unix_millis,omitempty"`
	ReadCompletedUnixMillis int64 `protobuf:"varint,8,opt,name=read_completed_unix_millis,json=readCompletedUnixMillis,proto3" json:"read_completed_unix_millis,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *MistStreamProcessObservation) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MistStreamProcessObservation) GetBufferPid() int64 {
	if x != nil && x.BufferPid != nil {
		return *x.BufferPid
	}
	return 0
...
func (x *MistStreamProcessObservation) GetSourcePidsKnown() bool {
	if x != nil {
		return x.SourcePidsKnown
	}
	return false
}

func (x *MistStreamProcessObservation) GetSourcePids() []int64 {
	if x != nil {
		return x.SourcePids
	}
	return nil
...
func (x *MistStreamProcessObservation) GetFirstMediaMs() uint64 {
	if x != nil && x.FirstMediaMs != nil {
		return *x.FirstMediaMs
	}
	return 0
}

func (x *MistStreamProcessObservation) GetLastMediaMs() uint64 {
	if x != nil && x.LastMediaMs != nil {
		return *x.LastMediaMs
	}
	return 0
}

func (x *MistStreamProcessObservation) GetReadStartedUnixMillis() int64 {
	if x != nil {
		return x.ReadStartedUnixMillis
	}
	return 0
}

func (x *MistStreamProcessObservation) GetReadCompletedUnixMillis() int64 {
	if x != nil {
		return x.ReadCompletedUnixMillis
	}
	return 0
}
...
func (x *ClientLifecycleUpdate) GetEventId() string {
...
// one record per batch instead of one per sample.
type ClientLifecycleBatch struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
...
func (x *ClientLifecycleBatch) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ClientLifecycleBatch) GetStreamId() string {
	if x != nil && x.StreamId != nil {
		return *x.StreamId
	}
	return ""
...
func (x *ClientLifecycleBatch) GetInternalName() string {
	if x != nil {
		return x.InternalName
	}
	return ""
...
func (x *ClientLifecycleBatch) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *ClientLifecycleBatch) GetWindowStart() int64 {
	if x != nil {
...
func (x *ClientLifecycleBatch) GetWindowEnd() int64 {
	if x != nil {
		return x.WindowEnd
	}
	return 0
...
func (x *ClientLifecycleBatch) GetSamples() []*ClientLifecycleUpdate {
	if x != nil {
		return x.Samples
	}
	return nil
...
// startup (manifest, first segment, Mist json, poster). Sizes/timings come from
// the browser's PerformanceResourceTiming; cache_status/age are only present for
// requests the player itself owns (e.g. Mist json), never HLS.js/native fetches.
type PlaybackBootResource struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Kind            string                 `protobuf:"bytes,1,opt,name=kind,proto3" json:"kind,omitempty"` // "manifest" | "first_segment" | "mist_json" | "poster" | "other"
	Url             string                 `protobuf:"bytes,2,opt,name=url,proto3" json:"url,omitempty"`
	TtfbMs          uint32                 `protobuf:"varint,3,opt,name=ttfb_ms,json=ttfbMs,proto3" json:"ttfb_ms,omitempty"`
	DurationMs      uint32                 `protobuf:"varint,4,opt,name=duration_ms,json=durationMs,proto3" json:"duration_ms,omitempty"`
	TransferSize    uint64                 `protobuf:"varint,5,opt,name=transfer_size,json=transferSize,proto3" json:"transfer_size,omitempty"`
	EncodedBodySize uint64                 `protobuf:"varint,6,opt,name=encoded_body_size,json=encodedBodySize,proto3" json:"encoded_body_size,omitempty"`
	DecodedBodySize uint64                 `protobuf:"varint,7,opt,name=decoded_body_size,json=decodedBodySize,proto3" json:"decoded_body_size,omitempty"`
	CacheStatus     *string                `protobuf:"bytes,8,opt,name=cache_status,json=cacheStatus,proto3,oneof" json:"cache_status,omitempty"`
	AgeSeconds      *uint32                `protobuf:"varint,9,opt,name=age_seconds,json=ageSeconds,proto3,oneof" json:"age_seconds,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *PlaybackBootResource) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PlaybackBootResource) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *PlaybackBootResource) GetTtfbMs() uint32 {
	if x != nil {
		return x.TtfbMs
	}
	return 0
...
func (x *PlaybackBootResource) GetDurationMs() uint32 {
	if x != nil {
		return x.DurationMs
	}
	return 0
...
func (x *PlaybackBootResource) GetTransferSize() uint64 {
	if x != nil {
...
func (x *PlaybackBootResource) GetEncodedBodySize() uint64 {
	if x != nil {
...
func (x *PlaybackBootResource) GetDecodedBodySize() uint64 {
	if x != nil {
...
func (x *PlaybackBootResource) GetCacheStatus() string {
	if x != nil && x.CacheStatus != nil {
		return *x.CacheStatus
	}
	return ""
}

func (x *PlaybackBootResource) GetAgeSeconds() uint32 {
...
// PlaybackBootTrace is a one-shot browser-originated startup waterfall
// (time-to-first-frame split into spans) plus Resource Timing. Diagnostic and
// lossy — never a billing/viewer-count source.
//
// Attribution is server-derived: the browser sends content_id + ephemeral
// trace_id/session_id; Bridge resolves tenant_id/stream_id/artifact_hash and
// mints the canonical MistTrigger.event_id. node_id/cluster fields are trusted
// only when a valid telemetry token supplied them (cluster_attributed=true);
// otherwise they are left empty and excluded from cluster-ops aggregates.
type PlaybackBootTrace struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Server-derived attribution (filled by Bridge; ignored if sent by the browser).
	TenantId          *string `protobuf:"bytes,1,opt,name=tenant_id,json=tenantId,proto3,oneof" json:"tenant_id,omitempty"`
	StreamId          *string `protobuf:"bytes,2,opt,name=stream_id,json=streamId,proto3,oneof" json:"stream_id,omitempty"` // nullable for VOD/standalone artifacts
	ArtifactHash      string  `protobuf:"bytes,3,opt,name=artifact_hash,json=artifactHash,proto3" json:"artifact_hash,omitempty"`
	...
	ServingClusterId  string  `protobuf:"bytes,6,opt,name=serving_cluster_id,json=servingClusterId,proto3" json:"serving_cluster_id,omitempty"`
	...
	ClusterAttributed bool    `protobuf:"varint,8,opt,name=cluster_attributed,json=clusterAttributed,proto3" json:"cluster_attributed,omitempty"` // true only when a telemetry token supplied node/cluster
	// Client correlation (browser-supplied).
	ContentId         string `protobuf:"bytes,9,opt,name=content_id,json=contentId,proto3" json:"content_id,omitempty"` // playback id the browser requested
	...
	ClientTimestampMs int64  `protobuf:"varint,12,opt,name=client_timestamp_ms,json=clientTimestampMs,proto3" json:"client_timestamp_ms,omitempty"`
	// Waterfall spans (ms).
	TotalTtfMs       uint32 `protobuf:"varint,20,opt,name=total_ttf_ms,json=totalTtfMs,proto3" json:"total_ttf_ms,omitempty"`
	GatewayResolveMs uint32 `protobuf:"varint,21,opt,name=gateway_resolve_ms,json=gatewayResolveMs,proto3" json:"gateway_resolve_ms,omitempty"`
	MistHydrateMs    uint32 `protobuf:"varint,22,opt,name=mist_hydrate_ms,json=mistHydrateMs,proto3" json:"mist_hydrate_ms,omitempty"`
	PlayerSelectMs   uint32 `protobuf:"varint,23,opt,name=player_select_ms,json=playerSelectMs,proto3" json:"player_select_ms,omitempty"`
	ConnectMs        uint32 `protobuf:"varint,24,opt,name=connect_ms,json=connectMs,proto3" json:"connect_ms,omitempty"`
	PrebufferMs      uint32 `protobuf:"varint,25,opt,name=prebuffer_ms,json=prebufferMs,proto3" json:"prebuffer_ms,omitempty"`
	// Context.
	Outcome        string                  `protobuf:"bytes,30,opt,name=outcome,proto3" json:"outcome,omitempty"` // "success" | "error" | "abandoned"
	ErrorCode      string                  `protobuf:"bytes,31,opt,name=error_code,json=errorCode,proto3" json:"error_code,omitempty"`
	PlayerType     string                  `protobuf:"bytes,32,opt,name=player_type,json=playerType,proto3" json:"player_type,omitempty"`
	Protocol       string                  `protobuf:"bytes,33,opt,name=protocol,proto3" json:"protocol,omitempty"`
	ContentType    string                  `protobuf:"bytes,34,opt,name=content_type,json=contentType,proto3" json:"content_type,omitempty"`
	IsLive         bool                    `protobuf:"varint,35,opt,name=is_live,json=isLive,proto3" json:"is_live,omitempty"`
	ConnectionType string                  `protobuf:"bytes,36,opt,name=connection_type,json=connectionType,proto3" json:"connection_type,omitempty"` // navigator.connection.effectiveType bucket
	PlayerVersion  string                  `protobuf:"bytes,37,opt,name=player_version,json=playerVersion,proto3" json:"player_version,omitempty"`
	Resources      []*PlaybackBootResource `protobuf:"bytes,40,rep,name=resources,proto3" json:"resources,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *PlaybackBootTrace) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PlaybackBootTrace) GetStreamId() string {
	if x != nil && x.StreamId != nil {
		return *x.StreamId
	}
	return ""
...
func (x *PlaybackBootTrace) GetArtifactHash() string {
	if x != nil {
		return x.ArtifactHash
	}
	return ""
...
func (x *PlaybackBootTrace) GetInternalName() string {
	if x != nil {
		return x.InternalName
	}
	return ""
...
func (x *PlaybackBootTrace) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *PlaybackBootTrace) GetServingClusterId() string {
	if x != nil {
...
func (x *PlaybackBootTrace) GetOriginClusterId() string {
	if x != nil {
		return x.OriginClusterId
	}
	return ""
...
func (x *PlaybackBootTrace) GetClusterAttributed() bool {
	if x != nil {
		return x.ClusterAttributed
	}
	return false
}

func (x *PlaybackBootTrace) GetContentId() string {
	if x != nil {
		return x.ContentId
	}
	return ""
...
func (x *PlaybackBootTrace) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *PlaybackBootTrace) GetTraceId() string {
	if x != nil {
		return x.TraceId
	}
	return ""
...
func (x *PlaybackBootTrace) GetClientTimestampMs() int64 {
	if x != nil {
...
func (x *PlaybackBootTrace) GetTotalTtfMs() uint32 {
	if x != nil {
		return x.TotalTtfMs
	}
	return 0
...
func (x *PlaybackBootTrace) GetGatewayResolveMs() uint32 {
	if x != nil {
		return x.GatewayResolveMs
	}
	return 0
}

func (x *PlaybackBootTrace) GetMistHydrateMs() uint32 {
	if x != nil {
		return x.MistHydrateMs
	}
	return 0
}

func (x *PlaybackBootTrace) GetPlayerSelectMs() uint32 {
	if x != nil {
		return x.PlayerSelectMs
	}
	return 0
}

func (x *PlaybackBootTrace) GetConnectMs() uint32 {
	if x != nil {
		return x.ConnectMs
	}
	return 0
...
func (x *PlaybackBootTrace) GetPrebufferMs() uint32 {
	if x != nil {
		return x.PrebufferMs
	}
	return 0
}

func (x *PlaybackBootTrace) GetOutcome() string {
	if x != nil {
		return x.Outcome
	}
	return ""
...
func (x *PlaybackBootTrace) GetErrorCode() string {
	if x != nil {
		return x.ErrorCode
	}
	return ""
...
func (x *PlaybackBootTrace) GetPlayerType() string {
	if x != nil {
		return x.PlayerType
	}
	return ""
...
func (x *PlaybackBootTrace) GetProtocol() string {
	if x != nil {
		return x.Protocol
	}
	return ""
...
func (x *PlaybackBootTrace) GetContentType() string {
	if x != nil {
		return x.ContentType
	}
	return ""
...
func (x *PlaybackBootTrace) GetIsLive() bool {
	if x != nil {
		return x.IsLive
	}
	return false
...
func (x *PlaybackBootTrace) GetConnectionType() string {
	if x != nil {
...
func (x *PlaybackBootTrace) GetPlayerVersion() string {
	if x != nil {
...
func (x *PlaybackBootTrace) GetResources() []*PlaybackBootResource {
	if x != nil {
		return x.Resources
	}
	return nil
...
// PlaybackSessionQoe is a browser-originated viewer-experienced QoE delta. Unlike
// the one-shot boot trace, a session emits a SEQUENCE of these: periodic
// heartbeats plus a final beacon on page hide. Every counter is an ADDITIVE DELTA
// for the window since the previous beacon, so a lost final beacon still leaves
// correct partial data under sum(). Diagnostic and lossy — never a billing source.
//
// Two dedupe modes with DIFFERENT keys (not interchangeable): MistTrigger.event_id
// (minted per received beacon by Bridge) dedupes Kafka replay; the client-stable
// tuple (tenant_id, content_id, session_id, beacon_seq) dedupes a double-fired
// client beacon. Ingest must dedupe on the client-stable tuple before summing —
// summing a duplicate delta corrupts the ratio.
//
// Attribution is server-derived exactly as PlaybackBootTrace; node/cluster are
// trusted only via a valid telemetry token (cluster_attributed=true).
type PlaybackSessionQoe struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Server-derived attribution (filled by Bridge; ignored if sent by the browser).
	TenantId          *string `protobuf:"bytes,1,opt,name=tenant_id,json=tenantId,proto3,oneof" json:"tenant_id,omitempty"`
	StreamId          *string `protobuf:"bytes,2,opt,name=stream_id,json=streamId,proto3,oneof" json:"stream_id,omitempty"` // nullable for VOD/standalone artifacts
	...
	SessionId         string `protobuf:"bytes,10,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
	ClientTimestampMs int64  `protobuf:"varint,12,opt,name=client_timestamp_ms,json=clientTimestampMs,proto3" json:"client_timestamp_ms,omitempty"`
	// Delta envelope. beacon_seq increments per beacon within a session; the
	// (content_id, session_id, beacon_seq) tuple is the client-stable dedupe key.
	BeaconSeq   uint32 `protobuf:"varint,13,opt,name=beacon_seq,json=beaconSeq,proto3" json:"beacon_seq,omitempty"`
	IsFinal     bool   `protobuf:"varint,14,opt,name=is_final,json=isFinal,proto3" json:"is_final,omitempty"`
	FlushReason string `protobuf:"bytes,15,opt,name=flush_reason,json=flushReason,proto3" json:"flush_reason,omitempty"` // "heartbeat" | "visibility_hidden" | "pagehide" | "ended" | "error"
	// Context (stable across a session; repeated per beacon for denormalization).
	PlayerType     string `protobuf:"bytes,30,opt,name=player_type,json=playerType,proto3" json:"player_type,omitempty"`
	...
	IsLive         bool   `protobuf:"varint,33,opt,name=is_live,json=isLive,proto3" json:"is_live,omitempty"`
	ConnectionType string `protobuf:"bytes,34,opt,name=connection_type,json=connectionType,proto3" json:"connection_type,omitempty"` // navigator.connection.effectiveType bucket
	PlayerVersion  string `protobuf:"bytes,35,opt,name=player_version,json=playerVersion,proto3" json:"player_version,omitempty"`
	// ===== Additive QoE deltas for this window =====
	// Denominator for all ratios: union of video.played growth (genuine watch time),
	// NOT wall-clock and NOT currentTime delta.
	PlayedMs uint64 `protobuf:"varint,40,opt,name=played_ms,json=playedMs,proto3" json:"played_ms,omitempty"`
	// Genuine rebuffering only — initial buffering, seek waits, and pauses excluded.
	RebufferMs    uint64 `protobuf:"varint,41,opt,name=rebuffer_ms,json=rebufferMs,proto3" json:"rebuffer_ms,omitempty"`
	RebufferCount uint32 `protobuf:"varint,42,opt,name=rebuffer_count,json=rebufferCount,proto3" json:"rebuffer_count,omitempty"`
	// Seek-induced waiting, kept separate for diagnostics; NOT counted as rebuffer.
	SeekWaitMs uint64 `protobuf:"varint,43,opt,name=seek_wait_ms,json=seekWaitMs,proto3" json:"seek_wait_ms,omitempty"`
	// Rendering quality. Browser frame counters are cumulative & non-resettable, so
	// the client emits per-window deltas. frame_stats_supported=false means the
	// platform never reports frame stats (0/0 must not read as "perfect").
	FrameStatsSupported bool   `protobuf:"varint,44,opt,name=frame_stats_supported,json=frameStatsSupported,proto3" json:"frame_stats_supported,omitempty"`
	FramesDecoded       uint64 `protobuf:"varint,45,opt,name=frames_decoded,json=framesDecoded,proto3" json:"frames_decoded,omitempty"`       // delta over the window
	FramesDropped       uint64 `protobuf:"varint,46,opt,name=frames_dropped,json=framesDropped,proto3" json:"frames_dropped,omitempty"`       // delta over the window
	FramesCorrupted     uint64 `protobuf:"varint,47,opt,name=frames_corrupted,json=framesCorrupted,proto3" json:"frames_corrupted,omitempty"` // delta over the window
	// Session-terminal failure. fatal_error=true only for an unrecoverable error
	// AFTER first frame; pre-first-frame failures are boot's. The client flushes
	// this transition immediately so a lost final beacon does not hide it.
	FirstFrame bool   `protobuf:"varint,48,opt,name=first_frame,json=firstFrame,proto3" json:"first_frame,omitempty"` // session reached first painted frame
	FatalError bool   `protobuf:"varint,49,opt,name=fatal_error,json=fatalError,proto3" json:"fatal_error,omitempty"` // unrecoverable post-first-frame failure
	ErrorCode  string `protobuf:"bytes,50,opt,name=error_code,json=errorCode,proto3" json:"error_code,omitempty"`
	// ===== Delivery-quality fields =====
	// Time-weighted bitrate: sum over the window of selected_bitrate_bps * seconds.
	// Average = sum(bitrate_bps_seconds) / sum(played_ms/1000) at read time.
	BitrateBpsSeconds  uint64 `protobuf:"varint,60,opt,name=bitrate_bps_seconds,json=bitrateBpsSeconds,proto3" json:"bitrate_bps_seconds,omitempty"`
	AbrUpswitchCount   uint32 `protobuf:"varint,61,opt,name=abr_upswitch_count,json=abrUpswitchCount,proto3" json:"abr_upswitch_count,omitempty"`
	AbrDownswitchCount uint32 `protobuf:"varint,62,opt,name=abr_downswitch_count,json=abrDownswitchCount,proto3" json:"abr_downswitch_count,omitempty"`
	// Exit-before-video-start: play was intended but first frame never arrived.
	// Scope is post-player-ready (the session reporter starts at player onReady):
	// pre-ready startup failures — gateway/endpoint resolution, no playable source —
	// are the boot trace's video-start-failure domain, not EBVS.
	PlayIntent bool `protobuf:"varint,63,opt,name=play_intent,json=playIntent,proto3" json:"play_intent,omitempty"`
	// Live edge latency (player latency, NOT glass-to-glass), ms; 0 if unknown.
	LiveEdgeLatencyMs uint32 `protobuf:"varint,64,opt,name=live_edge_latency_ms,json=liveEdgeLatencyMs,proto3" json:"live_edge_latency_ms,omitempty"`
	// VOD retention histogram (empty for live). Fixed-width buckets along the asset
	// timeline; sparse parallel arrays of per-bucket watched-seconds DELTAS for this
	// window (retention_buckets[i] gained retention_seconds_watched[i] seconds). The
	// read layer derives the density ("most replayed") and audience-retention curves.
	BucketWidthS            uint32    `protobuf:"varint,70,opt,name=bucket_width_s,json=bucketWidthS,proto3" json:"bucket_width_s,omitempty"`
	AssetDurationS          uint32    `protobuf:"varint,71,opt,name=asset_duration_s,json=assetDurationS,proto3" json:"asset_duration_s,omitempty"`
	RetentionBuckets        []uint32  `protobuf:"varint,72,rep,packed,name=retention_buckets,json=retentionBuckets,proto3" json:"retention_buckets,omitempty"`
	RetentionSecondsWatched []float32 `protobuf:"fixed32,73,rep,packed,name=retention_seconds_watched,json=retentionSecondsWatched,proto3" json:"retention_seconds_watched,omitempty"`
	// Furthest bucket the playhead reached this session (cumulative; the read layer
	// takes the per-session max). Input to the audience-retention curve — distinct
	// from watch density, since a seek-to-end raises reach without adding density.
	MaxBucketReached uint32 `protobuf:"varint,74,opt,name=max_bucket_reached,json=maxBucketReached,proto3" json:"max_bucket_reached,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *PlaybackSessionQoe) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PlaybackSessionQoe) GetStreamId() string {
	if x != nil && x.StreamId != nil {
		return *x.StreamId
	}
	return ""
...
func (x *PlaybackSessionQoe) GetArtifactHash() string {
	if x != nil {
		return x.ArtifactHash
	}
	return ""
...
func (x *PlaybackSessionQoe) GetInternalName() string {
	if x != nil {
		return x.InternalName
	}
	return ""
...
func (x *PlaybackSessionQoe) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *PlaybackSessionQoe) GetServingClusterId() string {
	if x != nil {
		return x.ServingClusterId
	}
	return ""
...
func (x *PlaybackSessionQoe) GetOriginClusterId() string {
	if x != nil {
		return x.OriginClusterId
	}
	return ""
...
func (x *PlaybackSessionQoe) GetClusterAttributed() bool {
	if x != nil {
		return x.ClusterAttributed
	}
	return false
...
func (x *PlaybackSessionQoe) GetContentId() string {
	if x != nil {
		return x.ContentId
	}
	return ""
...
func (x *PlaybackSessionQoe) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *PlaybackSessionQoe) GetClientTimestampMs() int64 {
	if x != nil {
		return x.ClientTimestampMs
	}
	return 0
...
func (x *PlaybackSessionQoe) GetBeaconSeq() uint32 {
	if x != nil {
		return x.BeaconSeq
	}
	return 0
...
func (x *PlaybackSessionQoe) GetIsFinal() bool {
	if x != nil {
		return x.IsFinal
	}
	return false
...
func (x *PlaybackSessionQoe) GetFlushReason() string {
	if x != nil {
...
func (x *PlaybackSessionQoe) GetPlayerType() string {
	if x != nil {
		return x.PlayerType
	}
	return ""
...
func (x *PlaybackSessionQoe) GetProtocol() string {
	if x != nil {
		return x.Protocol
	}
	return ""
...
func (x *PlaybackSessionQoe) GetContentType() string {
	if x != nil {
		return x.ContentType
	}
	return ""
...
func (x *PlaybackSessionQoe) GetIsLive() bool {
	if x != nil {
		return x.IsLive
	}
	return false
...
func (x *PlaybackSessionQoe) GetConnectionType() string {
	if x != nil {
		return x.ConnectionType
	}
	return ""
...
func (x *PlaybackSessionQoe) GetPlayerVersion() string {
	if x != nil {
		return x.PlayerVersion
	}
	return ""
...
func (x *PlaybackSessionQoe) GetPlayedMs() uint64 {
	if x != nil {
		return x.PlayedMs
	}
	return 0
...
func (x *PlaybackSessionQoe) GetRebufferMs() uint64 {
	if x != nil {
		return x.RebufferMs
	}
	return 0
...
func (x *PlaybackSessionQoe) GetRebufferCount() uint32 {
	if x != nil {
...
func (x *PlaybackSessionQoe) GetSeekWaitMs() uint64 {
	if x != nil {
		return x.SeekWaitMs
	}
	return 0
...
func (x *PlaybackSessionQoe) GetFrameStatsSupported() bool {
	if x != nil {
		return x.FrameStatsSupported
	}
	return false
}

func (x *PlaybackSessionQoe) GetFramesDecoded() uint64 {
	if x != nil {
...
func (x *PlaybackSessionQoe) GetFramesDropped() uint64 {
	if x != nil {
...
func (x *PlaybackSessionQoe) GetFramesCorrupted() uint64 {
	if x != nil {
		return x.FramesCorrupted
	}
	return 0
}

func (x *PlaybackSessionQoe) GetFirstFrame() bool {
	if x != nil {
		return x.FirstFrame
	}
	return false
...
func (x *PlaybackSessionQoe) GetFatalError() bool {
	if x != nil {
		return x.FatalError
	}
	return false
...
func (x *PlaybackSessionQoe) GetErrorCode() string {
	if x != nil {
		return x.ErrorCode
	}
	return ""
...
func (x *PlaybackSessionQoe) GetBitrateBpsSeconds() uint64 {
	if x != nil {
		return x.BitrateBpsSeconds
	}
	return 0
}

func (x *PlaybackSessionQoe) GetAbrUpswitchCount() uint32 {
	if x != nil {
...
func (x *PlaybackSessionQoe) GetAbrDownswitchCount() uint32 {
	if x != nil {
...
func (x *PlaybackSessionQoe) GetPlayIntent() bool {
	if x != nil {
		return x.PlayIntent
	}
	return false
...
func (x *PlaybackSessionQoe) GetLiveEdgeLatencyMs() uint32 {
	if x != nil {
		return x.LiveEdgeLatencyMs
	}
	return 0
}

func (x *PlaybackSessionQoe) GetBucketWidthS() uint32 {
	if x != nil {
...
func (x *PlaybackSessionQoe) GetAssetDurationS() uint32 {
	if x != nil {
...
func (x *PlaybackSessionQoe) GetRetentionBuckets() []uint32 {
	if x != nil {
		return x.RetentionBuckets
	}
	return nil
}

func (x *PlaybackSessionQoe) GetRetentionSecondsWatched() []float32 {
	if x != nil {
		return x.RetentionSecondsWatched
	}
	return nil
}

func (x *PlaybackSessionQoe) GetMaxBucketReached() uint32 {
	if x != nil {
		return x.MaxBucketReached
	}
	return 0
}
...
type NodeLifecycleUpdate struct {
	...
	ComponentVersions []*EdgeComponentVersion `protobuf:"bytes,31,rep,name=component_versions,json=componentVersions,proto3" json:"component_versions,omitempty"`
	...
	// Runtime placement metadata for edge release selection.
	DeployMode string `protobuf:"bytes,45,opt,name=deploy_mode,json=deployMode,proto3" json:"deploy_mode,omitempty"` // native | container (legacy "docker" = retired multi-container mode, ineligible for auto-updates)
	Os         string `protobuf:"bytes,46,opt,name=os,proto3" json:"os,omitempty"`                                   // runtime.GOOS
	Arch       string `protobuf:"bytes,47,opt,name=arch,proto3" json:"arch,omitempty"`                               // runtime.GOARCH
	// artifacts_report_seq is a strictly-monotonic per-connection counter set by the sidecar,
	// captured atomically WITH the `artifacts` snapshot (see captureArtifactSnapshot). It orders
	// reports WITHIN one control connection.
	ArtifactsReportSeq int64 `protobuf:"varint,48,opt,name=artifacts_report_seq,json=artifactsReportSeq,proto3" json:"artifacts_report_seq,omitempty"`
	// artifacts_connection_fence is NOT sent by the sidecar (it stays 0 on the wire). Foghorn stamps
	// it on receipt with the monotonic fence it issued to the delivering control connection at
	// Register, so reports are ordered by (connection_fence, report_seq): a reconnect gets a strictly
	// higher fence and supersedes, and a delayed report from a superseded connection loses. This is
	// an ownership fence, not wall-clock or first-arrival ordering.
	ArtifactsConnectionFence int64 `protobuf:"varint,49,opt,name=artifacts_connection_fence,json=artifactsConnectionFence,proto3" json:"artifacts_connection_fence,omitempty"`
	// MistServer runtime implementation installed on this node. Foghorn uses
	// this with os/arch to select the matching immutable update artifact.
	OnnxProfile string `protobuf:"bytes,53,opt,name=onnx_profile,json=onnxProfile,proto3" json:"onnx_profile,omitempty"`
	// artifacts_snapshot_incomplete is set by the sidecar when the `artifacts` snapshot cannot be
	// trusted as the node's COMPLETE inventory — i.e. no complete filesystem scan has succeeded yet
	// (cold start with a directory-read error). Foghorn must NOT apply an incomplete snapshot as an
	// authoritative whole-node report, because a partial or empty list would orphan live copies.
	// Default false. A transient scan failure AFTER the first good scan retains the last-good index but
	// reports INCOMPLETE (artifactScanHealthy=false), so Foghorn re-arms the artifact-routing cordon for
	// the node until a fresh healthy scan lands. NOTE: this flag alone is NOT the completeness contract — a report is
	// authoritative only when it ALSO carries a non-zero artifacts_report_seq. A legacy sidecar that
	// predates the sequence sends report_seq=0 and Foghorn REJECTS its inventory (fails closed, keeps
	// the last trusted inventory) rather than trusting a proto3-default "complete".
	ArtifactsSnapshotIncomplete bool `protobuf:"varint,50,opt,name=artifacts_snapshot_incomplete,json=artifactsSnapshotIncomplete,proto3" json:"artifacts_snapshot_incomplete,omitempty"`
	// Node-clock time captured atomically with artifacts + artifacts_report_seq.
...
func (x *NodeLifecycleUpdate) GetComponentVersions() []*EdgeComponentVersion {
	if x != nil {
...
func (x *NodeLifecycleUpdate) GetDeployMode() string {
	if x != nil {
		return x.DeployMode
	}
	return ""
...
func (x *NodeLifecycleUpdate) GetOs() string {
	if x != nil {
		return x.Os
	}
	return ""
...
func (x *NodeLifecycleUpdate) GetArch() string {
	if x != nil {
		return x.Arch
	}
	return ""
...
func (x *NodeLifecycleUpdate) GetArtifactsReportSeq() int64 {
	if x != nil {
		return x.ArtifactsReportSeq
	}
	return 0
}

func (x *NodeLifecycleUpdate) GetArtifactsConnectionFence() int64 {
	if x != nil {
		return x.ArtifactsConnectionFence
	}
	return 0
}

func (x *NodeLifecycleUpdate) GetOnnxProfile() string {
	if x != nil {
		return x.OnnxProfile
	}
	return ""
...
func (x *NodeLifecycleUpdate) GetArtifactsSnapshotIncomplete() bool {
	if x != nil {
		return x.ArtifactsSnapshotIncomplete
	}
	return false
}

func (x *NodeLifecycleUpdate) GetArtifactsReportedAtMs() int64 {
	if x != nil {
		return x.ArtifactsReportedAtMs
	}
	return 0
}
...
type ClipLifecycleData struct {
	...
	StreamInternalName *string `protobuf:"bytes,13,opt,name=stream_internal_name,json=streamInternalName,proto3,oneof" json:"stream_internal_name,omitempty"` // Source stream's MistServer routing name (for analytics attribution)
	...
	HasLocalCopy *bool `protobuf:"varint,27,opt,name=has_local_copy,json=hasLocalCopy,proto3,oneof" json:"has_local_copy,omitempty"`
	...
	// Processing telemetry (STAGE_DONE): how fast the clip job actually ran.
	ProcessingSpeed  *ProcessingSpeedStats `protobuf:"bytes,31,opt,name=processing_speed,json=processingSpeed,proto3,oneof" json:"processing_speed,omitempty"`
	ProcessingWallMs *int64                `protobuf:"varint,32,opt,name=processing_wall_ms,json=processingWallMs,proto3,oneof" json:"processing_wall_ms,omitempty"` // push start -> RECORDING_END wall time
	// source_updated_at_ms is the source transition time (the outbox row's created_at, ms) stamped at
	// dispatch. It is STABLE across at-least-once redeliveries, so ingest collapses artifact_state_current
	// on it (not Decklog receipt time) and a replayed older transition keeps its original time. It is
	// BEST-EFFORT, not a rigorous total order — created_at is wall-clock, so concurrent same-artifact
	// transitions can tie/invert within a millisecond. 0 = not stamped (fall back to receipt time).
	SourceUpdatedAtMs *int64 `protobuf:"varint,33,opt,name=source_updated_at_ms,json=sourceUpdatedAtMs,proto3,oneof" json:"source_updated_at_ms,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ClipLifecycleData) GetStreamInternalName() string {
	if x != nil && x.StreamInternalName != nil {
		return *x.StreamInternalName
	}
	return ""
}
...
func (x *ClipLifecycleData) GetHasLocalCopy() bool {
...
func (x *ClipLifecycleData) GetProcessingSpeed() *ProcessingSpeedStats {
	if x != nil {
		return x.ProcessingSpeed
	}
	return nil
...
func (x *ClipLifecycleData) GetProcessingWallMs() int64 {
	if x != nil && x.ProcessingWallMs != nil {
		return *x.ProcessingWallMs
	}
	return 0
}

func (x *ClipLifecycleData) GetSourceUpdatedAtMs() int64 {
	if x != nil && x.SourceUpdatedAtMs != nil {
		return *x.SourceUpdatedAtMs
	}
	return 0
}
...
type DVRLifecycleData struct {
	...
	StreamInternalName *string `protobuf:"bytes,11,opt,name=stream_internal_name,json=streamInternalName,proto3,oneof" json:"stream_internal_name,omitempty"` // Source stream's MistServer routing name (for analytics attribution)
	...
	// has_local_copy: a node holds a present full local copy (origin or cache); nullable = unknown.
	HasLocalCopy *bool `protobuf:"varint,19,opt,name=has_local_copy,json=hasLocalCopy,proto3,oneof" json:"has_local_copy,omitempty"`
	...
	// source_updated_at_ms: stable source transition time (outbox created_at, ms) — see ClipLifecycleData.
	SourceUpdatedAtMs *int64 `protobuf:"varint,23,opt,name=source_updated_at_ms,json=sourceUpdatedAtMs,proto3,oneof" json:"source_updated_at_ms,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *DVRLifecycleData) GetStreamInternalName() string {
	if x != nil && x.StreamInternalName != nil {
		return *x.StreamInternalName
	}
	return ""
...
func (x *DVRLifecycleData) GetHasLocalCopy() bool {
	if x != nil && x.HasLocalCopy != nil {
		return *x.HasLocalCopy
	}
	return false
...
func (x *DVRLifecycleData) GetSourceUpdatedAtMs() int64 {
	if x != nil && x.SourceUpdatedAtMs != nil {
		return *x.SourceUpdatedAtMs
	}
	return 0
...
type VodLifecycleData struct {
	...
	// has_local_copy: a node holds a present full local copy (origin or cache); nullable = unknown.
	HasLocalCopy *bool `protobuf:"varint,26,opt,name=has_local_copy,json=hasLocalCopy,proto3,oneof" json:"has_local_copy,omitempty"`
	...
	// Processing telemetry (STATUS_COMPLETED): how fast the processing job ran.
	ProcessingSpeed  *ProcessingSpeedStats `protobuf:"bytes,30,opt,name=processing_speed,json=processingSpeed,proto3,oneof" json:"processing_speed,omitempty"`
	ProcessingWallMs *int64                `protobuf:"varint,31,opt,name=processing_wall_ms,json=processingWallMs,proto3,oneof" json:"processing_wall_ms,omitempty"` // push start -> RECORDING_END wall time
	// source_updated_at_ms: stable source transition time (outbox created_at, ms) — see ClipLifecycleData.
	SourceUpdatedAtMs *int64 `protobuf:"varint,32,opt,name=source_updated_at_ms,json=sourceUpdatedAtMs,proto3,oneof" json:"source_updated_at_ms,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *VodLifecycleData) GetProgressPct() int32 {
...
func (x *VodLifecycleData) GetHasLocalCopy() bool {
	if x != nil && x.HasLocalCopy != nil {
		return *x.HasLocalCopy
	}
	return false
...
func (x *VodLifecycleData) GetProcessingSpeed() *ProcessingSpeedStats {
	if x != nil {
		return x.ProcessingSpeed
	}
	return nil
...
func (x *VodLifecycleData) GetProcessingWallMs() int64 {
	if x != nil && x.ProcessingWallMs != nil {
		return *x.ProcessingWallMs
	}
	return 0
...
func (x *VodLifecycleData) GetSourceUpdatedAtMs() int64 {
	if x != nil && x.SourceUpdatedAtMs != nil {
		return *x.SourceUpdatedAtMs
	}
	return 0
...
type FederationEventData struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	EventType     FederationEventType    `protobuf:"varint,1,opt,name=event_type,json=eventType,proto3,enum=helmsmancontrol.FederationEventType" json:"event_type,omitempty"`
...
func (x *FederationEventData) GetEventType() FederationEventType {
	...
	return FederationEventType_FEDERATION_EVENT_UNSPECIFIED
}

func (x *FederationEventData) GetTenantId() string {
	if x != nil && x.TenantId != nil {
		return *x.TenantId
	}
	return ""
...
func (x *FederationEventData) GetLocalCluster() string {
	if x != nil {
...
func (x *FederationEventData) GetRemoteCluster() string {
	if x != nil {
...
func (x *FederationEventData) GetStreamName() string {
...
func (x *FederationEventData) GetStreamId() string {
	if x != nil && x.StreamId != nil {
		return *x.StreamId
	}
	return ""
...
func (x *FederationEventData) GetSourceNode() string {
...
func (x *FederationEventData) GetDestNode() string {
...
func (x *FederationEventData) GetDtscUrl() string {
...
func (x *FederationEventData) GetLatencyMs() float32 {
	if x != nil && x.LatencyMs != nil {
		return *x.LatencyMs
	}
	return 0
...
func (x *FederationEventData) GetTimeToLiveMs() float32 {
...
func (x *FederationEventData) GetFailureReason() string {
...
func (x *FederationEventData) GetQueriedClusters() uint32 {
...
func (x *FederationEventData) GetRespondingClusters() uint32 {
...
func (x *FederationEventData) GetTotalCandidates() uint32 {
...
func (x *FederationEventData) GetBestRemoteScore() uint64 {
...
func (x *FederationEventData) GetPeerCluster() string {
...
func (x *FederationEventData) GetRole() string {
	if x != nil && x.Role != nil {
		return *x.Role
	}
	return ""
...
func (x *FederationEventData) GetReason() string {
	if x != nil && x.Reason != nil {
		return *x.Reason
	}
	return ""
...
func (x *FederationEventData) GetBlockedCluster() string {
	if x != nil && x.BlockedCluster != nil {
		return *x.BlockedCluster
	}
	return ""
}

func (x *FederationEventData) GetExistingReplicationCluster() string {
	if x != nil && x.ExistingReplicationCluster != nil {
		return *x.ExistingReplicationCluster
	}
	return ""
}

func (x *FederationEventData) GetLocalLat() float64 {
	if x != nil && x.LocalLat != nil {
		return *x.LocalLat
	}
	return 0
}

func (x *FederationEventData) GetLocalLon() float64 {
	if x != nil && x.LocalLon != nil {
		return *x.LocalLon
	}
	return 0
}

func (x *FederationEventData) GetRemoteLat() float64 {
	if x != nil && x.RemoteLat != nil {
		return *x.RemoteLat
	}
	return 0
}

func (x *FederationEventData) GetRemoteLon() float64 {
	if x != nil && x.RemoteLon != nil {
		return *x.RemoteLon
	}
	return 0
}
...
type ProcessMeterQuantity struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ProcessMeterQuantity) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ProcessMeterQuantity) GetUnit() string {
	if x != nil {
		return x.Unit
	}
	return ""
...
func (x *ProcessMeterQuantity) GetQuantity() float64 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
func (x *ProcessMeterQuantity) GetDimensions() map[string]string {
	if x != nil {
		return x.Dimensions
	}
	return nil
...
// ProcessBillingEvent is the durable processing-completion fact used by
// analytics and regional metering. It covers transcoding today and product
// units from future transcription and inference executors.
...
type ProcessBillingEvent struct {
	...
	OperationId       *string                 `protobuf:"bytes,72,opt,name=operation_id,json=operationId,proto3,oneof" json:"operation_id,omitempty"`
	ProcessingProduct *string                 `protobuf:"bytes,73,opt,name=processing_product,json=processingProduct,proto3,oneof" json:"processing_product,omitempty"` // transcode | remux | transcription | inference
	ExecutionBackend  *string                 `protobuf:"bytes,74,opt,name=execution_backend,json=executionBackend,proto3,oneof" json:"execution_backend,omitempty"`    // native_av | ffmpeg | onnx_local | livepeer_network
	ProviderTenantId  *string                 `protobuf:"bytes,75,opt,name=provider_tenant_id,json=providerTenantId,proto3,oneof" json:"provider_tenant_id,omitempty"`
	ProviderClusterId *string                 `protobuf:"bytes,76,opt,name=provider_cluster_id,json=providerClusterId,proto3,oneof" json:"provider_cluster_id,omitempty"`
...
func (x *ProcessBillingEvent) GetOperationId() string {
...
func (x *ProcessBillingEvent) GetProcessingProduct() string {
	if x != nil && x.ProcessingProduct != nil {
		return *x.ProcessingProduct
	}
	return ""
}

func (x *ProcessBillingEvent) GetExecutionBackend() string {
...
func (x *ProcessBillingEvent) GetProviderTenantId() string {
	if x != nil && x.ProviderTenantId != nil {
		return *x.ProviderTenantId
	}
	return ""
}

func (x *ProcessBillingEvent) GetProviderClusterId() string {
	if x != nil && x.ProviderClusterId != nil {
		return *x.ProviderClusterId
	}
	return ""
}

func (x *ProcessBillingEvent) GetModelId() string {
...
func (x *ProcessBillingEvent) GetModelVersion() string {
...
func (x *ProcessBillingEvent) GetMeterQuantities() []*ProcessMeterQuantity {
	if x != nil {
...
// ProcessingClassCapacity is one node's capacity for a single class of
// processing work. A transcode slot is not comparable to an inference slot
// (different GPU type, different concurrency, and inference is gated by which
// models are loaded), so capacity is reported per class rather than as one
// scalar. slots_total is the configured ceiling (0 = unbounded); slots_used is
// the live in-flight count; ready carries class-specific readiness (e.g. loaded
// model ids for ai_inference).
type ProcessingClassCapacity struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Class         string                 `protobuf:"bytes,1,opt,name=class,proto3" json:"class,omitempty"` // "video_transcode" | "ai_inference" | "cpu_heavy"
	SlotsTotal    int32                  `protobuf:"varint,2,opt,name=slots_total,json=slotsTotal,proto3" json:"slots_total,omitempty"`
	SlotsUsed     int32                  `protobuf:"varint,3,opt,name=slots_used,json=slotsUsed,proto3" json:"slots_used,omitempty"`
...
func (x *ProcessingClassCapacity) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ProcessingClassCapacity) GetSlotsTotal() int32 {
	if x != nil {
		return x.SlotsTotal
	}
	return 0
...
func (x *ProcessingClassCapacity) GetSlotsUsed() int32 {
	if x != nil {
		return x.SlotsUsed
	}
	return 0
...
func (x *ProcessingClassCapacity) GetReady() []string {
	if x != nil {
		return x.Ready
	}
	return nil
...
type NodeLimits struct {
	...
	// Per-class processing capacity, the scheduler's source of truth for
	// load-aware routing of processing jobs. A processing-capable node reports
	// one entry per class it can run (video_transcode, ai_inference, cpu_heavy).
	ProcessingClasses []*ProcessingClassCapacity `protobuf:"bytes,4,rep,name=processing_classes,json=processingClasses,proto3" json:"processing_classes,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *NodeLimits) GetProcessingClasses() []*ProcessingClassCapacity {
	if x != nil {
		return x.ProcessingClasses
	}
	return nil
}
...
type StoredArtifact struct {
	...
	Role         StoredArtifact_Role        `protobuf:"varint,12,opt,name=role,proto3,enum=helmsmancontrol.StoredArtifact_Role" json:"role,omitempty"`
	// Writer-authoritative completeness — only true when the finalizer
	// RPC that wrote the file confirms it's fully written. Polling never
	// sets this.
...
func (x *StoredArtifact) GetRole() StoredArtifact_Role {
	if x != nil {
		return x.Role
	}
	return StoredArtifact_ROLE_UNSPECIFIED
}

func (x *StoredArtifact) GetIsComplete() bool {
	if x != nil {
		return x.IsComplete
	}
	return false
...
type StreamDef struct {
	...
	ProcessControlledRealtime bool                   `protobuf:"varint,6,opt,name=process_controlled_realtime,json=processControlledRealtime,proto3" json:"process_controlled_realtime,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *StreamDef) GetProcessControlledRealtime() bool {
	if x != nil {
		return x.ProcessControlledRealtime
	}
	return false
}
...
type TLSCertBundle struct {
	...
	//   ["acme.cdn.frameworks.network", "*.acme.cdn.frameworks.network", "media.customer.example"]
	SiteAddresses []string `protobuf:"bytes,6,rep,name=site_addresses,json=siteAddresses,proto3" json:"site_addresses,omitempty"`
	// Opaque content revision. Apply ACKs echo this so Navigator never treats an
	// ACK for an older certificate under the same bundle_id as replacement-ready.
...
func (x *TLSCertBundle) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *TLSCertBundle) GetKeyPem() string {
	if x != nil {
		return x.KeyPem
	}
	return ""
...
func (x *TLSCertBundle) GetDomain() string {
	if x != nil {
		return x.Domain
	}
	return ""
...
func (x *TLSCertBundle) GetExpiresAt() int64 {
	if x != nil {
		return x.ExpiresAt
	}
	return 0
...
func (x *TLSCertBundle) GetBundleId() string {
	if x != nil {
		return x.BundleId
	}
	return ""
...
func (x *TLSCertBundle) GetSiteAddresses() []string {
	if x != nil {
		return x.SiteAddresses
	}
	return nil
}

func (x *TLSCertBundle) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
type ConfigSeed struct {
	...
	Telemetry *common.EdgeTelemetryConfig `protobuf:"bytes,23,opt,name=telemetry,proto3" json:"telemetry,omitempty"`
	...
	// Monotonic version assigned by Foghorn per (node, generation). Helmsman
	// echoes this in ConfigSeedApplyResult so Foghorn can correlate ACKs.
	SeedVersion uint64 `protobuf:"varint,25,opt,name=seed_version,json=seedVersion,proto3" json:"seed_version,omitempty"`
	// Multi-cert SNI bundle set. Each entry has a stable bundle_id used to
	// key cert files on disk and track per-edge apply state. Helmsman
	// renders one Caddy site block per bundle. Foghorn preserves a tenant bundle
	// omitted by Quartermaster's list only through expires_at; Navigator's
	// explicit found=false removes it from the next durable seed. Subscription
	// revocation withdraws Navigator DNS membership before credential cleanup.
	TlsBundles    []*TLSCertBundle `protobuf:"bytes,26,rep,name=tls_bundles,json=tlsBundles,proto3" json:"tls_bundles,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ConfigSeed) GetTls() *TLSCertBundle {
	if x != nil {
		return x.Tls
	}
	return nil
...
func (x *ConfigSeed) GetTelemetry() *common.EdgeTelemetryConfig {
	if x != nil {
		return x.Telemetry
	}
	return nil
...
func (x *ConfigSeed) GetSeedVersion() uint64 {
	if x != nil {
...
func (x *ConfigSeed) GetTlsBundles() []*TLSCertBundle {
	if x != nil {
		return x.TlsBundles
	}
	return nil
...
type BalancerCapabilityUpdate struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	NodeId              string                 `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
	FoghornBalancerBase string                 `protobuf:"bytes,2,opt,name=foghorn_balancer_base,json=foghornBalancerBase,proto3" json:"foghorn_balancer_base,omitempty"`
	// Version of the full durable ConfigSeed snapshot containing this base.
	// Partial capability updates participate in the same monotonic sequence as
	// full seeds so neither path can clobber the other.
...
func (x *BalancerCapabilityUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *BalancerCapabilityUpdate) GetFoghornBalancerBase() string {
	if x != nil {
		return x.FoghornBalancerBase
	}
	return ""
...
func (x *BalancerCapabilityUpdate) GetSeedVersion() uint64 {
	if x != nil {
		return x.SeedVersion
	}
	return 0
...
// ConfigSeedApplyResult is sent by Helmsman after attempting to apply a
// ConfigSeed (write cert files + reload Caddy). Foghorn uses this to gate
// DNS publishing: Navigator only adds an edge to a tenant's smart record
// set after the edge has acked applying that tenant's bundle.
type ConfigSeedApplyResult struct {
	state  protoimpl.MessageState `protogen:"open.v1"`
	NodeId string                 `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
	// Echoes ConfigSeed.seed_version so Foghorn knows which seed this acks.
	SeedVersion uint64 `protobuf:"varint,2,opt,name=seed_version,json=seedVersion,proto3" json:"seed_version,omitempty"`
	// Bundle IDs that loaded successfully and are serving via Caddy.
	AppliedBundleIds []string `protobuf:"bytes,3,rep,name=applied_bundle_ids,json=appliedBundleIds,proto3" json:"applied_bundle_ids,omitempty"`
	// Bundle IDs that failed to load (e.g. malformed PEM, key mismatch).
	FailedBundleIds []string `protobuf:"bytes,4,rep,name=failed_bundle_ids,json=failedBundleIds,proto3" json:"failed_bundle_ids,omitempty"`
	// Overall success: true iff all bundles loaded AND Caddy reload succeeded.
	Success bool `protobuf:"varint,5,opt,name=success,proto3" json:"success,omitempty"`
	// Populated on failure: error message describing what went wrong.
	Error     string                 `protobuf:"bytes,6,opt,name=error,proto3" json:"error,omitempty"`
	AppliedAt *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=applied_at,json=appliedAt,proto3" json:"applied_at,omitempty"`
	// Exact revision observed for each applied/failed bundle id in this result.
	BundleVersions map[string]string `protobuf:"bytes,8,rep,name=bundle_versions,json=bundleVersions,proto3" json:"bundle_versions,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ConfigSeedApplyResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ConfigSeedApplyResult) GetSeedVersion() uint64 {
	if x != nil {
		return x.SeedVersion
	}
	return 0
...
func (x *ConfigSeedApplyResult) GetAppliedBundleIds() []string {
	if x != nil {
...
func (x *ConfigSeedApplyResult) GetFailedBundleIds() []string {
	if x != nil {
...
func (x *ConfigSeedApplyResult) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *ConfigSeedApplyResult) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *ConfigSeedApplyResult) GetAppliedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.AppliedAt
	}
	return nil
...
func (x *ConfigSeedApplyResult) GetBundleVersions() map[string]string {
	if x != nil {
...
// render the production Caddyfile after enrollment. Foghorn is the authority.
type SiteConfig struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SiteAddress   string                 `protobuf:"bytes,1,opt,name=site_address,json=siteAddress,proto3" json:"site_address,omitempty"` // Caddy site block address, e.g. "*.us-west-1.frameworks.network"
	EdgeDomain    string                 `protobuf:"bytes,2,opt,name=edge_domain,json=edgeDomain,proto3" json:"edge_domain,omitempty"`    // e.g. "edge-abc123.us-west-1.frameworks.network"
	PoolDomain    string                 `protobuf:"bytes,3,opt,name=pool_domain,json=poolDomain,proto3" json:"pool_domain,omitempty"`    // e.g. "edge.us-west-1.frameworks.network"
	AcmeEmail     string                 `protobuf:"bytes,4,opt,name=acme_email,json=acmeEmail,proto3" json:"acme_email,omitempty"`       // ACME email for auto-TLS fallback
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SiteConfig) GetEdgeDomain() string {
	if x != nil {
		return x.EdgeDomain
	}
	return ""
...
func (x *SiteConfig) GetPoolDomain() string {
	if x != nil {
		return x.PoolDomain
	}
	return ""
...
func (x *SiteConfig) GetAcmeEmail() string {
	if x != nil {
		return x.AcmeEmail
	}
	return ""
...
// Generic processing job request (Foghorn → Helmsman)
// Used for probe, process+, DTSH generation, DVR chapter finalization.
type ProcessingJobRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	JobId         string                 `protobuf:"bytes,1,opt,name=job_id,json=jobId,proto3" json:"job_id,omitempty"`
	TenantId      string                 `protobuf:"bytes,2,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`
	ArtifactHash  string                 `protobuf:"bytes,3,opt,name=artifact_hash,json=artifactHash,proto3" json:"artifact_hash,omitempty"`
	SourceUrl     string                 `protobuf:"bytes,4,opt,name=source_url,json=sourceUrl,proto3" json:"source_url,omitempty"`                                                    // Presigned HTTPS URL for source
	JobType       string                 `protobuf:"bytes,5,opt,name=job_type,json=jobType,proto3" json:"job_type,omitempty"`                                                          // "probe" | "process" | "dvr_chapter_finalize"
	OutputPath    string                 `protobuf:"bytes,6,opt,name=output_path,json=outputPath,proto3" json:"output_path,omitempty"`                                                 // Local disk path for output
	Params        map[string]string      `protobuf:"bytes,7,rep,name=params,proto3" json:"params,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // realtime_speed, process config JSON, segment_urls (for HLS)
	ProcessesJson string                 `protobuf:"bytes,8,opt,name=processes_json,json=processesJson,proto3" json:"processes_json,omitempty"`                                        // Pre-computed MistServer process config from Commodore
	InternalName  string                 `protobuf:"bytes,9,opt,name=internal_name,json=internalName,proto3" json:"internal_name,omitempty"`                                           // Artifact routing name (for vod+ stream name construction)
	// Deadline for the whole job. Helmsman aborts and reports timeout if
	// PUSH_END hasn't fired by this absolute Unix-ms wall clock. Chapter
	// intervals can be hours, so Foghorn picks
	// max(2*chapter_duration, 30min) capped at 24h; missing/zero means
	// Helmsman applies its own default.
	...
	// Processing class this job needs, matched against a node's
	// ProcessingClassCapacity during routing. Empty defaults to
	// "video_transcode" (VOD/clip/DVR).
	ProcessingClass string `protobuf:"bytes,11,opt,name=processing_class,json=processingClass,proto3" json:"processing_class,omitempty"`
	// DVR chapter finalization specifics. Only populated when
	// job_type == "dvr_chapter_finalize".
	SourceChapterId          string                  `protobuf:"bytes,20,opt,name=source_chapter_id,json=sourceChapterId,proto3" json:"source_chapter_id,omitempty"`
	SourceDvrHash            string                  `protobuf:"bytes,21,opt,name=source_dvr_hash,json=sourceDvrHash,proto3" json:"source_dvr_hash,omitempty"`
	SourceStreamInternalName string                  `protobuf:"bytes,22,opt,name=source_stream_internal_name,json=sourceStreamInternalName,proto3" json:"source_stream_internal_name,omitempty"`
	ChapterStartMs           int64                   `protobuf:"varint,23,opt,name=chapter_start_ms,json=chapterStartMs,proto3" json:"chapter_start_ms,omitempty"`
	ChapterEndMs             int64                   `protobuf:"varint,24,opt,name=chapter_end_ms,json=chapterEndMs,proto3" json:"chapter_end_ms,omitempty"`
	SourceSegments           []*DVRChapterSegmentRef `protobuf:"bytes,25,rep,name=source_segments,json=sourceSegments,proto3" json:"source_segments,omitempty"`
	// Foghorn-authoritative runtime name for the processed OUTPUT artifact's
	// DTSH boot post-transcode. Always vod+<internal_name> today, but
	// populated from Foghorn's registry so Helmsman never derives runtime
	// names.
	OutputRuntimeName string `protobuf:"bytes,26,opt,name=output_runtime_name,json=outputRuntimeName,proto3" json:"output_runtime_name,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ProcessingJobRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ProcessingJobRequest) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (x *ProcessingJobRequest) GetArtifactHash() string {
	if x != nil {
		return x.ArtifactHash
	}
	return ""
...
func (x *ProcessingJobRequest) GetSourceUrl() string {
	if x != nil {
		return x.SourceUrl
	}
	return ""
...
func (x *ProcessingJobRequest) GetJobType() string {
	if x != nil {
		return x.JobType
	}
	return ""
...
func (x *ProcessingJobRequest) GetOutputPath() string {
	if x != nil {
		return x.OutputPath
	}
	return ""
...
func (x *ProcessingJobRequest) GetParams() map[string]string {
	if x != nil {
		return x.Params
	}
	return nil
...
func (x *ProcessingJobRequest) GetProcessesJson() string {
	if x != nil {
...
func (x *ProcessingJobRequest) GetInternalName() string {
	if x != nil {
		return x.InternalName
	}
	return ""
...
func (x *ProcessingJobRequest) GetDeadlineUnixMs() int64 {
	if x != nil {
...
func (x *ProcessingJobRequest) GetProcessingClass() string {
	if x != nil {
		return x.ProcessingClass
	}
	return ""
}

func (x *ProcessingJobRequest) GetSourceChapterId() string {
	if x != nil {
...
func (x *ProcessingJobRequest) GetSourceDvrHash() string {
	if x != nil {
		return x.SourceDvrHash
	}
	return ""
...
func (x *ProcessingJobRequest) GetSourceStreamInternalName() string {
	if x != nil {
		return x.SourceStreamInternalName
	}
	return ""
}

func (x *ProcessingJobRequest) GetChapterStartMs() int64 {
	if x != nil {
		return x.ChapterStartMs
	}
	return 0
}

func (x *ProcessingJobRequest) GetChapterEndMs() int64 {
	if x != nil {
		return x.ChapterEndMs
	}
	return 0
}

func (x *ProcessingJobRequest) GetSourceSegments() []*DVRChapterSegmentRef {
	if x != nil {
		return x.SourceSegments
	}
	return nil
}

func (x *ProcessingJobRequest) GetOutputRuntimeName() string {
	if x != nil {
		return x.OutputRuntimeName
	}
	return ""
}

// One source segment for a chapter finalize job. local_path is the
// recording origin's filesystem path (preferred). presigned_recovery_url
// is set when the local copy is gone (dvr_segments.status='lost_local'
// but the recovery freeze succeeded) — Helmsman pulls the bytes via
// the existing block-cache machinery before remux.
type DVRChapterSegmentRef struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	SegmentName          string                 `protobuf:"bytes,1,opt,name=segment_name,json=segmentName,proto3" json:"segment_name,omitempty"`
	Sequence             int64                  `protobuf:"varint,2,opt,name=sequence,proto3" json:"sequence,omitempty"`
	DurationMs           int64                  `protobuf:"varint,3,opt,name=duration_ms,json=durationMs,proto3" json:"duration_ms,omitempty"`
	MediaStartMs         int64                  `protobuf:"varint,4,opt,name=media_start_ms,json=mediaStartMs,proto3" json:"media_start_ms,omitempty"` // absolute Unix epoch ms; PROGRAM-DATE-TIME source
	MediaEndMs           int64                  `protobuf:"varint,5,opt,name=media_end_ms,json=mediaEndMs,proto3" json:"media_end_ms,omitempty"`
	LocalPath            string                 `protobuf:"bytes,6,opt,name=local_path,json=localPath,proto3" json:"local_path,omitempty"`                                    // reserved; Helmsman resolves from its DVRManager job
	PresignedRecoveryUrl string                 `protobuf:"bytes,7,opt,name=presigned_recovery_url,json=presignedRecoveryUrl,proto3" json:"presigned_recovery_url,omitempty"` // S3 GET fallback when local copy is missing
	SizeBytes            int64                  `protobuf:"varint,8,opt,name=size_bytes,json=sizeBytes,proto3" json:"size_bytes,omitempty"`                                   // ledger size hint, drives admission preflight on Helmsman
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *DVRChapterSegmentRef) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DVRChapterSegmentRef) GetSequence() int64 {
	if x != nil {
		return x.Sequence
	}
	return 0
...
func (x *DVRChapterSegmentRef) GetDurationMs() int64 {
	if x != nil {
		return x.DurationMs
	}
	return 0
...
func (x *DVRChapterSegmentRef) GetMediaStartMs() int64 {
	if x != nil {
		return x.MediaStartMs
	}
	return 0
...
func (x *DVRChapterSegmentRef) GetMediaEndMs() int64 {
	if x != nil {
		return x.MediaEndMs
	}
	return 0
...
func (x *DVRChapterSegmentRef) GetLocalPath() string {
	if x != nil {
		return x.LocalPath
	}
	return ""
...
func (x *DVRChapterSegmentRef) GetPresignedRecoveryUrl() string {
	if x != nil {
		return x.PresignedRecoveryUrl
	}
	return ""
}

func (x *DVRChapterSegmentRef) GetSizeBytes() int64 {
	if x != nil {
		return x.SizeBytes
	}
	return 0
...
// Processing job result (Helmsman → Foghorn)
type ProcessingJobResult struct {
	...
	// Accepted full A/V track set of the produced output, taken from the VALIDATED RECORDING_END
	// only on the "completed" path (after Helmsman rejects stale/failed/retired-generation
	// events). This — not the generic Foghorn RECORDING_END trigger — is the authoritative track
	// capture: Foghorn persists it by the already-resolved artifact_hash. Empty on failure.
	Tracks []*StreamTrack `protobuf:"bytes,8,rep,name=tracks,proto3" json:"tracks,omitempty"`
	// tracks_present distinguishes "this completed job captured the track set (replace, even if
	// the set is empty)" from "no track info available (preserve any prior summary)". Set true
	// whenever the completed result carries a validated RECORDING_END; false leaves stored tracks
	// untouched. Without this bit an empty list is ambiguous and stale tracks can't be cleared.
	TracksPresent bool `protobuf:"varint,9,opt,name=tracks_present,json=tracksPresent,proto3" json:"tracks_present,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ProcessingJobResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ProcessingJobResult) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *ProcessingJobResult) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *ProcessingJobResult) GetOutputs() map[string]string {
	if x != nil {
		return x.Outputs
	}
	return nil
...
func (x *ProcessingJobResult) GetOutputPath() string {
	if x != nil {
		return x.OutputPath
	}
	return ""
...
func (x *ProcessingJobResult) GetTracks() []*StreamTrack {
	if x != nil {
		return x.Tracks
	}
	return nil
...
func (x *ProcessingJobResult) GetTracksPresent() bool {
	if x != nil {
...
// ProcessingJobProgress is sent periodically by Helmsman while a processing
// push is running. Foghorn uses it to refresh updated_at (preventing stale
// recovery) and to emit VodLifecycleData progress events.
type ProcessingJobProgress struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	JobId            string                 `protobuf:"bytes,1,opt,name=job_id,json=jobId,proto3" json:"job_id,omitempty"`
...
func (x *ProcessingJobProgress) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ProcessingJobProgress) GetProgressPct() int32 {
	if x != nil {
		return x.ProgressPct
	}
	return 0
...
func (x *ProcessingJobProgress) GetLastMs() int64 {
	if x != nil {
		return x.LastMs
	}
	return 0
...
func (x *APIRequestAggregate) GetLlmInputTokens() uint64 {
	if x != nil {
...
func (x *APIRequestAggregate) GetLlmOutputTokens() uint64 {
	if x != nil {
...
func (x *APIRequestAggregate) GetModel() string {
	if x != nil {
		return x.Model
	}
	return ""
...
func (x *APIRequestAggregate) GetProvider() string {
	if x != nil {
		return x.Provider
	}
	return ""
...
func (x *ValidateEdgeTokenRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type ValidateEdgeTokenResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ValidateEdgeTokenResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ValidateEdgeTokenResponse) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *ValidateEdgeTokenResponse) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (x *ValidateEdgeTokenResponse) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
func (x *ValidateEdgeTokenResponse) GetPermissions() []string {
	if x != nil {
...
// Helmsman -> Foghorn over the control stream. Helmsman never sees the
// JWT secret; Foghorn relays to Commodore.ValidateMistAdminSession and
// injects expected_node_id from the connected stream's node identity so
// a token minted for one edge cannot be replayed against another.
type EdgeMistAdminSessionRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *EdgeMistAdminSessionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type EdgeMistAdminSessionResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Valid         bool                   `protobuf:"varint,1,opt,name=valid,proto3" json:"valid,omitempty"`
	UserId        string                 `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	TenantId      string                 `protobuf:"bytes,3,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`
	...
	ExpiresAt     int64                  `protobuf:"varint,7,opt,name=expires_at,json=expiresAt,proto3" json:"expires_at,omitempty"` // Unix seconds; Helmsman uses for cookie Max-Age.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *EdgeMistAdminSessionResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *EdgeMistAdminSessionResponse) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *EdgeMistAdminSessionResponse) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (x *EdgeMistAdminSessionResponse) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
func (x *EdgeMistAdminSessionResponse) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *EdgeMistAdminSessionResponse) GetClusterId() string {
	if x != nil {
		return x.ClusterId
	}
	return ""
...
func (x *EdgeMistAdminSessionResponse) GetExpiresAt() int64 {
	if x != nil {
		return x.ExpiresAt
	}
	return 0
...
// Helmsman -> Foghorn: request presigned PUT URLs for thumbnail files
type ThumbnailUploadRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	InternalName  string                 `protobuf:"bytes,1,opt,name=internal_name,json=internalName,proto3" json:"internal_name,omitempty"` // MistServer stream name
	FilePaths     []string               `protobuf:"bytes,2,rep,name=file_paths,json=filePaths,proto3" json:"file_paths,omitempty"`          // Local paths (poster.jpg, sprite.jpg, sprite.vtt)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ThumbnailUploadRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ThumbnailUploadRequest) GetFilePaths() []string {
	if x != nil {
		return x.FilePaths
	}
	return nil
...
type ThumbnailUploadResponse struct {
	...
	// Server-minted publication attempt id. The presigned s3_key values are per-attempt STAGING keys; Helmsman
	// MUST echo this id in ThumbnailUploaded so Foghorn can bind the confirmation to the assignment it minted.
...
func (x *ThumbnailUploadResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ThumbnailUploadResponse) GetUploads() []*ThumbnailUploadResponse_PresignedUpload {
	if x != nil {
		return x.Uploads
	}
	return nil
...
func (x *ThumbnailUploadResponse) GetAttemptId() string {
	if x != nil {
		return x.AttemptId
	}
	return ""
...
type ThumbnailUploaded struct {
	...
	AttemptId     string                 `protobuf:"bytes,3,opt,name=attempt_id,json=attemptId,proto3" json:"attempt_id,omitempty"` // echoed from ThumbnailUploadResponse; binds the confirmation to the minted attempt
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ThumbnailUploaded) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ThumbnailUploaded) GetS3Keys() []string {
	if x != nil {
		return x.S3Keys
	}
	return nil
...
func (x *ThumbnailUploaded) GetAttemptId() string {
	if x != nil {
		return x.AttemptId
	}
	return ""
...
// separate because pricing meters and consumers differ — AI billing is in
// pilot and tracked under the processing meter contract, not delivered minutes.
...
type ThumbnailUploadResponse_PresignedUpload struct {
	...
	LocalPath     string                 `protobuf:"bytes,4,opt,name=local_path,json=localPath,proto3" json:"local_path,omitempty"` // echoed from request so Helmsman can find the file
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ThumbnailUploadResponse_PresignedUpload) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*ThumbnailUploadResponse_PresignedUpload) Descriptor() ([]byte, []int) {
	return file_ipc_proto_rawDescGZIP(), []int{145, 0}
}
...
func (x *ThumbnailUploadResponse_PresignedUpload) GetPresignedUrl() string {
	if x != nil {
...
func (x *ThumbnailUploadResponse_PresignedUpload) GetS3Key() string {
	if x != nil {
		return x.S3Key
	}
	return ""
...
func (x *ThumbnailUploadResponse_PresignedUpload) GetLocalPath() string {
	if x != nil {
		return x.LocalPath
	}
	return ""
...
const file_ipc_proto_rawDesc = "" +
	...
	"\x0eartifact_event\x18\x1c \x01(\v2\x1e.helmsmancontrol.ArtifactEventH\x00R\rartifactEvent\x12a\n" +
	"\x18artifact_node_copy_event\x18\x1d \x01(\v2&.helmsmancontrol.ArtifactNodeCopyEventH\x00R\x15artifactNodeCopyEvent\x12G\n" +
	"\x0eincident_event\x18\x1e \x01(\v2\x1e.helmsmancontrol.IncidentEventH\x00R\rincidentEvent\x12#\n" +
	...
	"\tip_bucket\x18\a \x01(\tR\bipBucket\"\x8e\x01\n" +
	"\vTenantEvent\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12%\n" +
	"\x0echanged_fields\x18\x02 \x03(\tR\rchangedFields\x12;\n" +
	"\vattribution\x18\x03 \x01(\v2\x19.common.SignupAttributionR\vattribution\"\xf2\x02\n" +
	...
	"\x12reject_reason_code\x18\x06 \x01(\x0e2$.helmsmancontrol.ClusterRejectReasonR\x10rejectReasonCode\x12:\n" +
	"\fbefore_state\x18\a \x01(\v2\x17.google.protobuf.StructR\vbeforeState\x128\n" +
	"\vafter_state\x18\b \x01(\v2\x17.google.protobuf.StructR\n" +
	"afterState\"W\n" +
	...
	"\x15ArtifactNodeCopyEvent\x12#\n" +
	"\rartifact_hash\x18\x01 \x01(\tR\fartifactHash\x12\x17\n" +
	"\anode_id\x18\x02 \x01(\tR\x06nodeId\x12\x12\n" +
	"\x04role\x18\x04 \x01(\tR\x04role\x12Q\n" +
	"\n" +
	"transition\x18\x06 \x01(\x0e21.helmsmancontrol.ArtifactNodeCopyEvent.TransitionR\n" +
	"transition\x12\x1f\n" +
	...
	"\n" +
	"Transition\x12\x1a\n" +
	"\x16TRANSITION_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06GAINED\x10\x01\x12\b\n" +
	"\x04LOST\x10\x02\x12\v\n" +
	"\aUPDATED\x10\x03\"\xf2\x01\n" +
	...
	"\rupdated_at_ms\x18\b \x01(\x03R\vupdatedAtMs\"\xc12\n" +
	...
	"dvrStopped\x12K\n" +
	"\x10dvr_stop_request\x18\x15 \x01(\v2\x1f.helmsmancontrol.DVRStopRequestH\x00R\x0edvrStopRequest\x12A\n" +
	"\fmist_trigger\x18\x18 \x01(\v2\x1c.helmsmancontrol.MistTriggerH\x00R\vmistTrigger\x12Z\n" +
	"\x15mist_trigger_response\x18\x19 \x01(\v2$.helmsmancontrol.MistTriggerResponseH\x00R\x13mistTriggerResponse\x12L\n" +
	"\x10mist_trigger_ack\x18\x96\x01 \x01(\v2\x1f.helmsmancontrol.MistTriggerAckH\x00R\x0emistTriggerAck\x12>\n" +
	"\vconfig_seed\x18\x1d \x01(\v2\x1b.helmsmancontrol.ConfigSeedH\x00R\n" +
	"configSeed\x12j\n" +
	"\x1abalancer_capability_update\x18\xa9\x01 \x01(\v2).helmsmancontrol.BalancerCapabilityUpdateH\x00R\x18balancerCapabilityUpdate\x12a\n" +
	"\x18config_seed_apply_result\x18\" \x01(\v2&.helmsmancontrol.ConfigSeedApplyResultH\x00R\x15configSeedApplyResult\x12M\n" +
	...
	"\x0ffreeze_progress\x18* \x01(\v2\x1f.helmsmancontrol.FreezeProgressH\x00R\x0efreezeProgress\x12Q\n" +
	...
	"\x11dtsh_sync_request\x182 \x01(\v2 .helmsmancontrol.DtshSyncRequestH\x00R\x0fdtshSyncRequest\x12G\n" +
	"\x0efreeze_request\x183 \x01(\v2\x1e.helmsmancontrol.FreezeRequestH\x00R\rfreezeRequest\x12Z\n" +
	...
	"\x16transcode_job_complete\x18> \x01(\v2%.helmsmancontrol.TranscodeJobCompleteH\x00R\x14transcodeJobComplete\x12]\n" +
	"\x16processing_job_request\x18? \x01(\v2%.helmsmancontrol.ProcessingJobRequestH\x00R\x14processingJobRequest\x12Z\n" +
	"\x15processing_job_result\x18@ \x01(\v2$.helmsmancontrol.ProcessingJobResultH\x00R\x13processingJobResult\x12`\n" +
	"\x17processing_job_progress\x18A \x01(\v2&.helmsmancontrol.ProcessingJobProgressH\x00R\x15processingJobProgress\x12Z\n" +
	"\x15stop_sessions_request\x18F \x01(\v2$.helmsmancontrol.StopSessionsRequestH\x00R\x13stopSessionsRequest\x12l\n" +
	"\x1binvalidate_sessions_request\x18H \x01(\v2*.helmsmancontrol.InvalidateSessionsRequestH\x00R\x19invalidateSessionsRequest\x12T\n" +
	"\x13mode_change_request\x18G \x01(\v2\".helmsmancontrol.ModeChangeRequestH\x00R\x11modeChangeRequest\x12Z\n" +
	"\x15activate_push_targets\x18P \x01(\v2$.helmsmancontrol.ActivatePushTargetsH\x00R\x13activatePushTargets\x12`\n" +
	"\x17deactivate_push_targets\x18Q \x01(\v2&.helmsmancontrol.DeactivatePushTargetsH\x00R\x15deactivatePushTargets\x12W\n" +
	"\x12push_target_status\x18R \x01(\v2'.helmsmancontrol.PushTargetStatusReportH\x00R\x10pushTargetStatus\x12j\n" +
	"\x1bvalidate_edge_token_request\x18Z \x01(\v2).helmsmancontrol.ValidateEdgeTokenRequestH\x00R\x18validateEdgeTokenRequest\x12m\n" +
	"\x1cvalidate_edge_token_response\x18[ \x01(\v2*.helmsmancontrol.ValidateEdgeTokenResponseH\x00R\x19validateEdgeTokenResponse\x12t\n" +
	"\x1fedge_mist_admin_session_request\x18\\ \x01(\v2,.helmsmancontrol.EdgeMistAdminSessionRequestH\x00R\x1bedgeMistAdminSessionRequest\x12w\n" +
	" edge_mist_admin_session_response\x18] \x01(\v2-.helmsmancontrol.EdgeMistAdminSessionResponseH\x00R\x1cedgeMistAdminSessionResponse\x12c\n" +
	"\x18thumbnail_upload_request\x18d \x01(\v2'.helmsmancontrol.ThumbnailUploadRequestH\x00R\x16thumbnailUploadRequest\x12f\n" +
	"\x19thumbnail_upload_response\x18e \x01(\v2(.helmsmancontrol.ThumbnailUploadResponseH\x00R\x17thumbnailUploadResponse\x12S\n" +
	"\x12thumbnail_uploaded\x18f \x01(\v2\".helmsmancontrol.ThumbnailUploadedH\x00R\x11thumbnailUploaded\x12W\n" +
	"\x14desired_state_update\x18n \x01(\v2#.helmsmancontrol.DesiredStateUpdateH\x00R\x12desiredStateUpdate\x12T\n" +
	"\x13update_apply_result\x18o \x01(\v2\".helmsmancontrol.UpdateApplyResultH\x00R\x11updateApplyResult\x12g\n" +
	"\x1arecord_dvr_segment_request\x18x \x01(\v2(.helmsmancontrol.RecordDVRSegmentRequestH\x00R\x17recordDvrSegmentRequest\x12j\n" +
	"\x1brecord_dvr_segment_response\x18y \x01(\v2).helmsmancontrol.RecordDVRSegmentResponseH\x00R\x18recordDvrSegmentResponse\x12d\n" +
	"\x19mark_dvr_segment_uploaded\x18z \x01(\v2'.helmsmancontrol.MarkDVRSegmentUploadedH\x00R\x16markDvrSegmentUploaded\x12T\n" +
	"\x13dvr_segment_dropped\x18{ \x01(\v2\".helmsmancontrol.DVRSegmentDroppedH\x00R\x11dvrSegmentDropped\x12i\n" +
	"\x1aevictable_segments_request\x18| \x01(\v2).helmsmancontrol.EvictableSegmentsRequestH\x00R\x18evictableSegmentsRequest\x12l\n" +
	"\x1bevictable_segments_response\x18} \x01(\v2*.helmsmancontrol.EvictableSegmentsResponseH\x00R\x19evictableSegmentsResponse\x12a\n" +
	"\x18retry_dvr_segment_upload\x18~ \x01(\v2&.helmsmancontrol.RetryDVRSegmentUploadH\x00R\x15retryDvrSegmentUpload\x12U\n" +
	"\x13reclaim_dvr_segment\x18\x81\x01 \x01(\v2\".helmsmancontrol.ReclaimDVRSegmentH\x00R\x11reclaimDvrSegment\x12\x80\x01\n" +
	"#restore_local_segment_index_request\x18\x7f \x01(\v20.helmsmancontrol.RestoreLocalSegmentIndexRequestH\x00R\x1frestoreLocalSegmentIndexRequest\x12\x84\x01\n" +
	"$restore_local_segment_index_response\x18\x80\x01 \x01(\v21.helmsmancontrol.RestoreLocalSegmentIndexResponseH\x00R restoreLocalSegmentIndexResponse\x12[\n" +
	"\x15relay_resolve_request\x18\x8c\x01 \x01(\v2$.helmsmancontrol.RelayResolveRequestH\x00R\x13relayResolveRequest\x12^\n" +
	"\x16relay_resolve_response\x18\x8d\x01 \x01(\v2%.helmsmancontrol.RelayResolveResponseH\x00R\x14relayResolveResponse\x12X\n" +
	"\x14apply_managed_stream\x18\xa0\x01 \x01(\v2#.helmsmancontrol.ApplyManagedStreamH\x00R\x12applyManagedStream\x12^\n" +
	"\x16retract_managed_stream\x18\xa1\x01 \x01(\v2%.helmsmancontrol.RetractManagedStreamH\x00R\x14retractManagedStream\x12X\n" +
	"\x14drain_stream_request\x18\xa2\x01 \x01(\v2#.helmsmancontrol.DrainStreamRequestH\x00R\x12drainStreamRequest\x12[\n" +
	"\x15drain_stream_response\x18\xa3\x01 \x01(\v2$.helmsmancontrol.DrainStreamResponseH\x00R\x13drainStreamResponse\x12n\n" +
	"\x1cauthorize_relay_pull_request\x18\xa6\x01 \x01(\v2*.helmsmancontrol.AuthorizeRelayPullRequestH\x00R\x19authorizeRelayPullRequest\x12q\n" +
	"\x1dauthorize_relay_pull_response\x18\xa7\x01 \x01(\v2+.helmsmancontrol.AuthorizeRelayPullResponseH\x00R\x1aauthorizeRelayPullResponse\x12n\n" +
	...
	"\x1edeactivate_push_targets_result\x18\xaa\x01 \x01(\v2,.helmsmancontrol.DeactivatePushTargetsResultH\x00R\x1bdeactivatePushTargetsResultB\t\n" +
	...
	"\talways_on\x18\x03 \x01(\bR\balwaysOn\x12\x1a\n" +
	"\brealtime\x18\x04 \x01(\bR\brealtime\x12#\n" +
	"\rstop_sessions\x18\x05 \x01(\bR\fstopSessions\x12\x12\n" +
	"\x04tags\x18\x06 \x03(\tR\x04tags\x12\x1f\n" +
	"\vingest_mode\x18\a \x01(\tR\n" +
	"ingestMode\x12\x1b\n" +
	"\tstream_id\x18\b \x01(\tR\bstreamId\x12\x1b\n" +
	"\ttenant_id\x18\t \x01(\tR\btenantId\x12X\n" +
	"\x13placement_admission\x18\n" +
	" \x01(\v2'.helmsmancontrol.ManagedStreamAdmissionR\x12placementAdmission\"\x97\x04\n" +
	"\x16ManagedStreamAdmission\x12%\n" +
	"\x0eschema_version\x18\x01 \x01(\rR\rschemaVersion\x12$\n" +
	"\x0etarget_node_id\x18\x02 \x01(\tR\ftargetNodeId\x12*\n" +
	"\x11target_cluster_id\x18\x03 \x01(\tR\x0ftargetClusterId\x128\n" +
	"\x18object_authority_version\x18\x04 \x01(\x03R\x16objectAuthorityVersion\x128\n" +
	"\x18tenant_authority_version\x18\x05 \x01(\x03R\x16tenantAuthorityVersion\x12'\n" +
	"\x0fpolicy_revision\x18\x06 \x01(\x04R\x0epolicyRevision\x12'\n" +
	"\x0fparent_revision\x18\a \x01(\x04R\x0eparentRevision\x12#\n" +
	"\rpolicy_digest\x18\b \x01(\tR\fpolicyDigest\x12%\n" +
	"\x0ecommand_sha256\x18\t \x01(\fR\rcommandSha256\x127\n" +
	"\tissued_at\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\bissuedAt\x129\n" +
	"\n" +
	"expires_at\x18\v \x01(\v2\x1a.google.protobuf.TimestampR\texpiresAt\"\xa4\x01\n" +
	"\x14RetractManagedStream\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1b\n" +
	"\tstream_id\x18\x02 \x01(\tR\bstreamId\x12[\n" +
	"\x14placement_retraction\x18\x03 \x01(\v2(.helmsmancontrol.ManagedStreamRetractionR\x13placementRetraction\"\x8e\x04\n" +
	"\x17ManagedStreamRetraction\x12$\n" +
	"\x0etarget_node_id\x18\x01 \x01(\tR\ftargetNodeId\x12*\n" +
	"\x11target_cluster_id\x18\x02 \x01(\tR\x0ftargetClusterId\x12\x1b\n" +
	"\ttenant_id\x18\x03 \x01(\tR\btenantId\x128\n" +
	"\x18object_authority_version\x18\x04 \x01(\x03R\x16objectAuthorityVersion\x128\n" +
	"\x18tenant_authority_version\x18\x05 \x01(\x03R\x16tenantAuthorityVersion\x12%\n" +
	"\x0ecommand_sha256\x18\x06 \x01(\fR\rcommandSha256\x127\n" +
	...
	"\x0fparent_revision\x18\n" +
	" \x01(\x04R\x0eparentRevision\x12#\n" +
	"\rpolicy_digest\x18\v \x01(\tR\fpolicyDigest\"\xbf\x01\n" +
	"\x12DrainStreamRequest\x12!\n" +
	"\fruntime_name\x18\x01 \x01(\tR\vruntimeName\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12+\n" +
	"\x11source_generation\x18\x03 \x01(\tR\x10sourceGeneration\x12A\n" +
	"\x1dprior_owner_source_generation\x18\x04 \x01(\tR\x1apriorOwnerSourceGeneration\"\xcc\x01\n" +
	"\x13DrainStreamResponse\x12!\n" +
	"\fruntime_name\x18\x01 \x01(\tR\vruntimeName\x12\x1a\n" +
	"\bunloaded\x18\x02 \x01(\bR\bunloaded\x123\n" +
	"\x15sessions_disconnected\x18\x03 \x01(\rR\x14sessionsDisconnected\x12\x14\n" +
	"\x05error\x18\x04 \x01(\tR\x05error\x12+\n" +
	"\x11source_generation\x18\x05 \x01(\tR\x10sourceGeneration\"x\n" +
	"\x11ModeChangeRequest\x12K\n" +
	"\x0erequested_mode\x18\x01 \x01(\x0e2$.helmsmancontrol.NodeOperationalModeR\rrequestedMode\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\"N\n" +
	"\x14EdgeComponentVersion\x12\x1c\n" +
	"\tcomponent\x18\x01 \x01(\tR\tcomponent\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\"\xf8\x01\n" +
	"\x10DesiredComponent\x12\x1c\n" +
	"\tcomponent\x18\x01 \x01(\tR\tcomponent\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12!\n" +
	"\fartifact_url\x18\x03 \x01(\tR\vartifactUrl\x12\x1a\n" +
	"\bchecksum\x18\x04 \x01(\tR\bchecksum\x12%\n" +
	"\x0edrain_required\x18\x05 \x01(\bR\rdrainRequired\x12#\n" +
	"\rswap_strategy\x18\x06 \x01(\tR\fswapStrategy\x12!\n" +
	"\fonnx_profile\x18\a \x01(\tR\vonnxProfile\"\xac\x02\n" +
	"\x12DesiredStateUpdate\x12\x1d\n" +
	"\n" +
	"cluster_id\x18\x01 \x01(\tR\tclusterId\x12\x17\n" +
	"\anode_id\x18\x02 \x01(\tR\x06nodeId\x12%\n" +
	"\x0etarget_release\x18\x03 \x01(\tR\rtargetRelease\x12A\n" +
	"\n" +
	"components\x18\x04 \x03(\v2!.helmsmancontrol.DesiredComponentR\n" +
	"components\x12!\n" +
	"\fcordon_token\x18\x05 \x01(\tR\vcordonToken\x12Q\n" +
	"\x17cordon_token_expires_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x14cordonTokenExpiresAt\"\x80\x01\n" +
	"\x14ComponentApplyResult\x12\x1c\n" +
	"\tcomponent\x18\x01 \x01(\tR\tcomponent\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12\x18\n" +
	"\asuccess\x18\x03 \x01(\bR\asuccess\x12\x16\n" +
	"\x06detail\x18\x04 \x01(\tR\x06detail\"\x9a\x01\n" +
	"\x11UpdateApplyResult\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\tR\x06nodeId\x12%\n" +
	"\x0etarget_release\x18\x02 \x01(\tR\rtargetRelease\x12E\n" +
	"\n" +
	"components\x18\x03 \x03(\v2%.helmsmancontrol.ComponentApplyResultR\n" +
	"components\"m\n" +
	...
	"streamName\x129\n" +
	"\atargets\x18\x02 \x03(\v2\x1f.helmsmancontrol.PushTargetSpecR\atargets\x12+\n" +
	"\x11source_generation\x18\x03 \x01(\tR\x10sourceGeneration\x12\x1b\n" +
	...
	"\vstream_name\x18\x01 \x01(\tR\n" +
	"streamName\x12+\n" +
	"\x11source_generation\x18\x02 \x01(\tR\x10sourceGeneration\x12'\n" +
	"\x0ftarget_revision\x18\x03 \x01(\x03R\x0etargetRevision\"\x8a\x02\n" +
	"\x1bDeactivatePushTargetsResult\x12\x1f\n" +
	"\vstream_name\x18\x01 \x01(\tR\n" +
	"streamName\x12+\n" +
	"\x11source_generation\x18\x02 \x01(\tR\x10sourceGeneration\x12'\n" +
	"\x0ftarget_revision\x18\x03 \x01(\x03R\x0etargetRevision\x12\x1c\n" +
	"\tconverged\x18\x04 \x01(\bR\tconverged\x12\x14\n" +
	"\x05error\x18\x05 \x01(\tR\x05error\x12@\n" +
	"\atargets\x18\x06 \x03(\v2&.helmsmancontrol.PushTargetConvergenceR\atargets\"\xb7\x02\n" +
	"\x19ActivatePushTargetsResult\x12\x1f\n" +
	"\vstream_name\x18\x01 \x01(\tR\n" +
	"streamName\x12\x1c\n" +
	"\tconverged\x18\x02 \x01(\bR\tconverged\x12\x14\n" +
	...
	"\atargets\x18\x06 \x03(\v2&.helmsmancontrol.PushTargetConvergenceR\atargets\x12-\n" +
	"\x12activation_attempt\x18\a \x01(\tR\x11activationAttempt\"\xd4\x01\n" +
	"\x15PushTargetConvergence\x12\x1b\n" +
	"\ttarget_id\x18\x01 \x01(\tR\btargetId\x12 \n" +
	"\fmist_push_id\x18\x02 \x01(\x03R\n" +
	"mistPushId\x12\x16\n" +
	"\x06active\x18\x03 \x01(\bR\x06active\x127\n" +
	"\x06reason\x18\x04 \x01(\x0e2\x1f.helmsmancontrol.RestreamReasonR\x06reason\x12+\n" +
	"\x11sanitized_message\x18\x05 \x01(\tR\x10sanitizedMessage\"\x91\x06\n" +
	"\x16PushTargetStatusReport\x12\x1b\n" +
	"\ttarget_id\x18\x01 \x01(\tR\btargetId\x12\x1f\n" +
	"\vstream_name\x18\x02 \x01(\tR\n" +
	"streamName\x12\x1a\n" +
	"\x06status\x18\x03 \x01(\tB\x02\x18\x01R\x06status\x12\x18\n" +
	"\x05error\x18\x04 \x01(\tB\x02\x18\x01R\x05error\x12 \n" +
	"\fmist_push_id\x18\x05 \x01(\x03R\n" +
	"mistPushId\x12\x1b\n" +
	"\ttenant_id\x18\x06 \x01(\tR\btenantId\x12\x1b\n" +
	"\tstream_id\x18\a \x01(\tR\bstreamId\x12+\n" +
	"\x11source_generation\x18\b \x01(\tR\x10sourceGeneration\x12'\n" +
	"\x0ftarget_revision\x18\t \x01(\x03R\x0etargetRevision\x124\n" +
	"\x05state\x18\n" +
	" \x01(\x0e2\x1e.helmsmancontrol.RestreamStateR\x05state\x127\n" +
	"\x06reason\x18\v \x01(\x0e2\x1f.helmsmancontrol.RestreamReasonR\x06reason\x12+\n" +
	"\x11sanitized_message\x18\f \x01(\tR\x10sanitizedMessage\x12\"\n" +
	"\rstarted_at_ms\x18\r \x01(\x03R\vstartedAtMs\x12\x1e\n" +
	"\vended_at_ms\x18\x0e \x01(\x03R\tendedAtMs\x12\x1f\n" +
	"\vduration_ms\x18\x0f \x01(\x03R\n" +
	"durationMs\x12\x1d\n" +
	"\n" +
	"bytes_sent\x18\x10 \x01(\x04R\tbytesSent\x12&\n" +
	"\x0fsource_event_id\x18\x11 \x01(\tR\rsourceEventId\x12\x1a\n" +
	"\bplatform\x18\x12 \x01(\tR\bplatform\x12%\n" +
	"\x0ebytes_observed\x18\x13 \x01(\bR\rbytesObserved\x12\x17\n" +
	"\anode_id\x18\x14 \x01(\tR\x06nodeId\x12-\n" +
	"\x12activation_attempt\x18\x15 \x01(\tR\x11activationAttempt\"\xfd\x01\n" +
	...
	"\x0erequested_mode\x18\x0f \x01(\x0e2$.helmsmancontrol.NodeOperationalModeR\rrequestedMode\x12$\n" +
	"\x0erelay_base_url\x18\x10 \x01(\tR\frelayBaseUrl\x12]\n" +
	"\x17applied_managed_streams\x18\x11 \x03(\v2%.helmsmancontrol.AppliedManagedStreamR\x15appliedManagedStreams\x128\n" +
	"\x18control_protocol_version\x18\x12 \x01(\x05R\x16controlProtocolVersion\x12F\n" +
	" node_identity_public_key_ed25519\x18\x13 \x01(\fR\x1cnodeIdentityPublicKeyEd25519\x129\n" +
	"\x19node_identity_proof_nonce\x18\x14 \x01(\fR\x16nodeIdentityProofNonce\x12\\\n" +
	...
	"\n" +
	"\b_disk_gb\"\xc1\x02\n" +
	"\x14AppliedManagedStream\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x16\n" +
	"\x06source\x18\x02 \x01(\tR\x06source\x12\x1b\n" +
	"\talways_on\x18\x03 \x01(\bR\balwaysOn\x12\x1f\n" +
	"\vingest_mode\x18\x04 \x01(\tR\n" +
	"ingestMode\x12\x1b\n" +
	"\tstream_id\x18\x05 \x01(\tR\bstreamId\x12X\n" +
	"\x13placement_admission\x18\x06 \x01(\v2'.helmsmancontrol.ManagedStreamAdmissionR\x12placementAdmission\x12\x1b\n" +
	"\ttenant_id\x18\a \x01(\tR\btenantId\x12+\n" +
	"\x11placement_retired\x18\b \x01(\bR\x10placementRetired\"\xcc\x01\n" +
	...
	"\rinternal_name\x18\f \x01(\tR\finternalName\x12L\n" +
	"\vsource_kind\x18\x14 \x01(\x0e2+.helmsmancontrol.ClipPullRequest.SourceKindR\n" +
	"sourceKind\x12&\n" +
	"\x0fsource_dvr_hash\x18\x15 \x01(\tR\rsourceDvrHash\x12?\n" +
	"\x1csource_chapter_artifact_hash\x18\x16 \x01(\tR\x19sourceChapterArtifactHash\x12,\n" +
	"\x12output_stream_name\x18\x17 \x01(\tR\x10outputStreamName\x122\n" +
	"\x15artifact_runtime_name\x18\x18 \x01(\tR\x13artifactRuntimeName\"u\n" +
	"\n" +
	"SourceKind\x12\x1b\n" +
	"\x17SOURCE_KIND_UNSPECIFIED\x10\x00\x12\x14\n" +
	"\x10SOURCE_KIND_LIVE\x10\x01\x12\x1b\n" +
	"\x17SOURCE_KIND_DVR_ROLLING\x10\x02\x12\x17\n" +
	"\x13SOURCE_KIND_CHAPTER\x10\x03B\r\n" +
	"\v_start_unixB\f\n" +
	"\n" +
	"_stop_unixB\v\n" +
	"\t_start_msB\n" +
	...
	"\x16message_lifecycle_data\x18# \x01(\v2%.helmsmancontrol.MessageLifecycleDataH\x00R\x14messageLifecycleData\x12Z\n" +
	"\x15federation_event_data\x18$ \x01(\v2$.helmsmancontrol.FederationEventDataH\x00R\x13federationEventData\x12N\n" +
	"\x0estream_process\x18& \x01(\v2%.helmsmancontrol.StreamProcessTriggerH\x00R\rstreamProcess\x12]\n" +
	"\x16client_lifecycle_batch\x18' \x01(\v2%.helmsmancontrol.ClientLifecycleBatchH\x00R\x14clientLifecycleBatch\x12R\n" +
	"\x10raw_mist_webhook\x18( \x01(\v2&.helmsmancontrol.RawMistWebhookTriggerH\x00R\x0erawMistWebhook\x12R\n" +
	"\x10push_input_close\x18) \x01(\v2&.helmsmancontrol.PushInputCloseTriggerH\x00R\x0epushInputClose\x12T\n" +
	"\x13playback_boot_trace\x18* \x01(\v2\".helmsmancontrol.PlaybackBootTraceH\x00R\x11playbackBootTrace\x12W\n" +
	...
	"\n" +
	"error_code\x18\x04 \x01(\x0e2 .helmsmancontrol.IngestErrorCodeR\terrorCode\x12+\n" +
	"\x11ingest_generation\x18\x05 \x01(\tR\x10ingestGeneration\x120\n" +
	"\x14ingest_connector_pid\x18\x06 \x01(\x03R\x12ingestConnectorPid\x12:\n" +
	"\x06action\x18\a \x01(\x0e2\".helmsmancontrol.MistTriggerActionR\x06action\x12\x16\n" +
	"\x06reason\x18\b \x01(\tR\x06reason\"\xd1\x01\n" +
	"\x0eMistTriggerAck\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12\x1c\n" +
	"\tretryable\x18\x03 \x01(\bR\tretryable\x12C\n" +
	"\n" +
	"error_code\x18\x04 \x01(\x0e2$.helmsmancontrol.TriggerAckErrorCodeR\terrorCode\x12#\n" +
	"\rerror_message\x18\x05 \x01(\tR\ferrorMessage\"\x81\x05\n" +
	...
	"\rstorage_scope\x18\a \x01(\tH\x03R\fstorageScope\x88\x01\x01\x12@\n" +
	"\x1astorage_provider_tenant_id\x18\b \x01(\tH\x04R\x17storageProviderTenantId\x88\x01\x01\x12B\n" +
	"\x1bstorage_provider_cluster_id\x18\t \x01(\tH\x05R\x18storageProviderClusterId\x88\x01\x01\x12,\n" +
	"\x0fstorage_backend\x18\n" +
	" \x01(\tH\x06R\x0estorageBackend\x88\x01\x01B\f\n" +
	"\n" +
	"_tenant_idB\v\n" +
	"\t_locationB\x0f\n" +
	"\r_capabilitiesB\x10\n" +
	"\x0e_storage_scopeB\x1d\n" +
	"\x1b_storage_provider_tenant_idB\x1e\n" +
	"\x1c_storage_provider_cluster_idB\x12\n" +
	"\x10_storage_backend\"\xca\x02\n" +
	...
	"\x13source_runtime_name\x18\t \x01(\tR\x11sourceRuntimeName\x12-\n" +
	"\x12command_generation\x18\n" +
	" \x01(\x03R\x11commandGeneration\"\xf6\x01\n" +
	"\tDVRConfig\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\x16\n" +
	"\x06format\x18\x03 \x01(\tR\x06format\x12)\n" +
	"\x10segment_duration\x18\x04 \x01(\x05R\x0fsegmentDuration\x12,\n" +
	"\x12dvr_window_seconds\x18\x05 \x01(\x05R\x10dvrWindowSeconds\x12\x1f\n" +
	"\vmax_entries\x18\x06 \x01(\x05R\n" +
	"maxEntries\x12'\n" +
	"\x0fretention_until\x18\a \x01(\x03R\x0eretentionUntilJ\x04\b\x02\x10\x03R\x0eretention_days\"\xdc\x01\n" +
	...
	"\rmanifest_path\x18\t \x01(\tR\fmanifestPath\"\xb5\x01\n" +
	"\x0eDVRStopRequest\x12\x19\n" +
	"\bdvr_hash\x18\x01 \x01(\tR\advrHash\x12\x1d\n" +
	"\n" +
	"request_id\x18\x02 \x01(\tR\trequestId\x12(\n" +
	"\rinternal_name\x18\x03 \x01(\tH\x00R\finternalName\x88\x01\x01\x12-\n" +
	"\x12command_generation\x18\x04 \x01(\x03R\x11commandGenerationB\x10\n" +
	"\x0e_internal_name\"\xc0\x02\n" +
	"\x17RecordDVRSegmentRequest\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x19\n" +
	"\bdvr_hash\x18\x02 \x01(\tR\advrHash\x12!\n" +
	"\fsegment_name\x18\x03 \x01(\tR\vsegmentName\x12$\n" +
	"\x0emedia_start_ms\x18\x04 \x01(\x03R\fmediaStartMs\x12 \n" +
	"\fmedia_end_ms\x18\x05 \x01(\x03R\n" +
	"mediaEndMs\x12\x1f\n" +
	...
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x19\n" +
	"\bdvr_hash\x18\x02 \x01(\tR\advrHash\x12!\n" +
	"\fsegment_name\x18\x03 \x01(\tR\vsegmentName\x12\x1a\n" +
	"\baccepted\x18\x04 \x01(\bR\baccepted\x12\x16\n" +
	"\x06reason\x18\x05 \x01(\tR\x06reason\x12\x1a\n" +
	"\bsequence\x18\x06 \x01(\x03R\bsequence\x12\x15\n" +
	"\x06s3_key\x18\a \x01(\tR\x05s3Key\x12*\n" +
	"\x11presigned_put_url\x18\b \x01(\tR\x0fpresignedPutUrl\x12,\n" +
	"\x12url_expiry_seconds\x18\t \x01(\x03R\x10urlExpirySeconds\"\x94\x01\n" +
	"\x16MarkDVRSegmentUploaded\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x19\n" +
	"\bdvr_hash\x18\x02 \x01(\tR\advrHash\x12!\n" +
	"\fsegment_name\x18\x03 \x01(\tR\vsegmentName\x12\x1d\n" +
	"\n" +
	"size_bytes\x18\x04 \x01(\x04R\tsizeBytes\"\xf1\x02\n" +
	"\x11DVRSegmentDropped\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x19\n" +
	"\bdvr_hash\x18\x02 \x01(\tR\advrHash\x12!\n" +
	"\fsegment_name\x18\x03 \x01(\tR\vsegmentName\x12\x16\n" +
	"\x06reason\x18\x04 \x01(\tR\x06reason\x12\x1f\n" +
	"\vduration_ms\x18\x05 \x01(\x03R\n" +
	"durationMs\x12$\n" +
	"\x0emedia_start_ms\x18\x06 \x01(\x03R\fmediaStartMs\x12 \n" +
	"\fmedia_end_ms\x18\a \x01(\x03R\n" +
	"mediaEndMs\x12\x1d\n" +
	"\n" +
	"size_bytes\x18\b \x01(\x04R\tsizeBytes\x12\x1d\n" +
	"\n" +
	"dropped_at\x18\t \x01(\x03R\tdroppedAt\x12!\n" +
	"\fwas_uploaded\x18\n" +
	" \x01(\bR\vwasUploaded\x12\x1d\n" +
	"\n" +
	"local_path\x18\v \x01(\tR\tlocalPath\"q\n" +
	"\x18EvictableSegmentsRequest\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x19\n" +
	"\bdvr_hash\x18\x02 \x01(\tR\advrHash\x12\x1b\n" +
	"\tmax_count\x18\x03 \x01(\x05R\bmaxCount\"z\n" +
	"\x19EvictableSegmentsResponse\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x19\n" +
	"\bdvr_hash\x18\x02 \x01(\tR\advrHash\x12#\n" +
	...
	"\bsegments\x18\x04 \x03(\v2\x1e.helmsmancontrol.DVRSegmentRefR\bsegments\"r\n" +
	"\x11ReclaimDVRSegment\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x19\n" +
	"\bdvr_hash\x18\x02 \x01(\tR\advrHash\x12#\n" +
	...
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x19\n" +
	"\bdvr_hash\x18\x02 \x01(\tR\advrHash\x12#\n" +
	"\rsegment_names\x18\x03 \x03(\tR\fsegmentNames\x12\x17\n" +
	"\anode_id\x18\x04 \x01(\tR\x06nodeId\"\x98\x01\n" +
	" RestoreLocalSegmentIndexResponse\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x19\n" +
	"\bdvr_hash\x18\x02 \x01(\tR\advrHash\x12:\n" +
	"\bsegments\x18\x03 \x03(\v2\x1e.helmsmancontrol.DVRSegmentRefR\bsegments\"O\n" +
	...
	"\n" +
	"request_id\x18\x02 \x01(\tR\trequestId\"\xed\x01\n" +
	...
	"\n" +
	"size_bytes\x18\x05 \x01(\x04R\tsizeBytesJ\x04\b\x04\x10\x05J\x04\b\x06\x10\aJ\x04\b\a\x10\bJ\x04\b\b\x10\tR\n" +
	"local_pathR\anode_idR\tfilenamesR\x1esupports_server_minted_attempt\"\xba\x02\n" +
	...
	"skipUpload\x12\x1d\n" +
	"\n" +
	"attempt_id\x18\v \x01(\tR\tattemptIdJ\x04\b\a\x10\bR\fsegment_urls\"\xeb\x03\n" +
	...
	"\x12url_expiry_seconds\x18\t \x01(\x03R\x10urlExpirySeconds\x12R\n" +
	"\fsegment_urls\x18\n" +
	" \x03(\v2/.helmsmancontrol.FreezeRequest.SegmentUrlsEntryR\vsegmentUrls\x1a>\n" +
	...
	"\amessage\x18\x05 \x01(\tR\amessage\"\xb1\x02\n" +
	"\rDVRSegmentRef\x12!\n" +
	"\fsegment_name\x18\x01 \x01(\tR\vsegmentName\x12\x15\n" +
	"\x06s3_key\x18\x02 \x01(\tR\x05s3Key\x12*\n" +
	"\x11presigned_get_url\x18\x03 \x01(\tR\x0fpresignedGetUrl\x12$\n" +
	"\x0emedia_start_ms\x18\x04 \x01(\x03R\fmediaStartMs\x12 \n" +
	"\fmedia_end_ms\x18\x05 \x01(\x03R\n" +
	"mediaEndMs\x12\x1f\n" +
	"\vduration_ms\x18\x06 \x01(\x03R\n" +
	...
	"\n" +
	"size_bytes\x18\t \x01(\x03R\tsizeBytes\"J\n" +
	...
	"\x10warm_duration_ms\x18\x04 \x01(\x03R\x0ewarmDurationMs\"\xdd\x02\n" +
	"\x13RelayResolveRequest\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x1d\n" +
	"\n" +
	"asset_kind\x18\x02 \x01(\tR\tassetKind\x12\x1d\n" +
	"\n" +
	"asset_hash\x18\x03 \x01(\tR\tassetHash\x12\x10\n" +
	"\x03ext\x18\x05 \x01(\tR\x03ext\x12B\n" +
	"\x04hint\x18\x06 \x01(\x0e2..helmsmancontrol.RelayResolveRequest.RelayHintR\x04hint\x12\x17\n" +
	"\anode_id\x18\a \x01(\tR\x06nodeId\"h\n" +
	"\tRelayHint\x12\x1a\n" +
	...
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x1d\n" +
	"\n" +
	"asset_hash\x18\x02 \x01(\tR\tassetHash\x121\n" +
	"\x05state\x18\x03 \x01(\x0e2\x1b.helmsmancontrol.AssetStateR\x05state\x12.\n" +
	"\x13media_presigned_url\x18\x04 \x01(\tR\x11mediaPresignedUrl\x12,\n" +
	"\x12dtsh_presigned_get\x18\x05 \x01(\tR\x10dtshPresignedGet\x12.\n" +
	"\x13expected_size_bytes\x18\a \x01(\x04R\x11expectedSizeBytes\x12!\n" +
	"\fcontent_type\x18\b \x01(\tR\vcontentType\x12&\n" +
	"\x0furl_ttl_seconds\x18\t \x01(\x03R\rurlTtlSeconds\x12X\n" +
	"\vpolicy_hint\x18\v \x01(\x0e27.helmsmancontrol.RelayResolveResponse.CacheDecisionHintR\n" +
	"policyHint\x12\x14\n" +
	"\x05error\x18\f \x01(\tR\x05error\x120\n" +
	...
	"\x15CACHE_HINT_PREFER_MEM\x10\x02J\x04\b\x06\x10\aJ\x04\b\n" +
	"\x10\vJ\x04\b\x0f\x10\x10J\x04\b\x11\x10\x12R\x12dtsh_presigned_putR\x10chapter_segmentsR\x15peer_relay_auth_tokenR\x1apeer_relay_dtsh_auth_token\"\x9d\x01\n" +
	"\x19AuthorizeRelayPullRequest\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x19\n" +
	"\bgrant_id\x18\x02 \x01(\tR\agrantId\x12#\n" +
	"\rartifact_hash\x18\x03 \x01(\tR\fartifactHash\x12!\n" +
	"\frequest_path\x18\x04 \x01(\tR\vrequestPath\"m\n" +
	"\x1aAuthorizeRelayPullResponse\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x18\n" +
	...
	"\rlocal_missing\x18\t \x01(\bR\flocalMissingJ\x04\b\x04\x10\x05J\x04\b\a\x10\bR\x06s3_urlR\anode_id\"\xf8\x01\n" +
	...
	"\"\xb7\x01\n" +
	"\x12CacheFailureReason\x12\x1c\n" +
	"\x18CACHE_REASON_UNSPECIFIED\x10\x00\x12#\n" +
	"\x1fCACHE_REASON_INSUFFICIENT_SPACE\x10\x01\x12\x1f\n" +
	"\x1bCACHE_REASON_DOWNLOAD_ERROR\x10\x02\x12\x19\n" +
	"\x15CACHE_REASON_LOCAL_IO\x10\x03\x12\"\n" +
	"\x1eCACHE_REASON_PRESIGNED_INVALID\x10\x04B\f\n" +
	"\n" +
	"_tenant_idB\x10\n" +
	...
	"\tstream_id\x18\x11 \x01(\tH\rR\bstreamId\x88\x01\x01\x12\x10\n" +
	"\x03pid\x18\x12 \x01(\x03R\x03pid\x12!\n" +
	"\ftrigger_uuid\x18\x13 \x01(\tR\vtriggerUuid\x12.\n" +
	"\x13trigger_unix_millis\x18\x14 \x01(\x03R\x11triggerUnixMillis\x12-\n" +
	"\x12observed_connector\x18\x15 \x01(\tR\x11observedConnectorB\v\n" +
	"\t_protocolB\n" +
	"\n" +
	"\b_encoderB\x12\n" +
	...
	"\n" +
	"_stream_id\"\x8b\x01\n" +
	"\x15ConnectionPlayTrigger\x12\x1f\n" +
	"\vstream_name\x18\x01 \x01(\tR\n" +
	"streamName\x12\x12\n" +
	"\x04host\x18\x02 \x01(\tR\x04host\x12\x1c\n" +
	"\tconnector\x18\x03 \x01(\tR\tconnector\x12\x1f\n" +
	...
	"\n" +
	"_stream_id\"7\n" +
	"\x14StreamProcessTrigger\x12\x1f\n" +
	"\vstream_name\x18\x01 \x01(\tR\n" +
	"streamName\"\xb1\x01\n" +
	...
	"\n" +
	"_stream_id\"\xa4\x03\n" +
	"\x15PushInputCloseTrigger\x12\x1f\n" +
	"\vstream_name\x18\x01 \x01(\tR\n" +
	"streamName\x12\x1f\n" +
	...
	"\x0emachine_reason\x18\x05 \x01(\tR\rmachineReason\x12!\n" +
	"\fhuman_reason\x18\x06 \x01(\tR\vhumanReason\x12\x1f\n" +
	"\vtracks_json\x18\a \x01(\tR\n" +
	"tracksJson\x12\x1c\n" +
	"\anode_id\x18\b \x01(\tH\x00R\x06nodeId\x88\x01\x01\x12 \n" +
	"\tstream_id\x18\t \x01(\tH\x01R\bstreamId\x88\x01\x01\x12.\n" +
	"\x13trigger_unix_millis\x18\n" +
	" \x01(\x03R\x11triggerUnixMillis\x12!\n" +
	"\ftrigger_uuid\x18\v \x01(\tR\vtriggerUuidB\n" +
	"\n" +
	"\b_node_idB\f\n" +
	"\n" +
	"_stream_id\"\x8d\a\n" +
	...
	"\fviewer_token\x18\x03 \x01(\tR\vviewerToken\x12\x1c\n" +
	...
	"nodeBucket\x88\x01\x01\x12 \n" +
	"\tstream_id\x18\x12 \x01(\tH\tR\bstreamId\x88\x01\x01\x12D\n" +
	...
	"\tstream_id\x18\r \x01(\tH\bR\bstreamId\x88\x01\x01\x12\"\n" +
	"\n" +
	"buffer_pid\x18\x0e \x01(\x03H\tR\tbufferPid\x88\x01\x01B\r\n" +
	"\v_has_issuesB\x15\n" +
	...
	"\tstream_id\x18\t \x01(\tH\aR\bstreamId\x88\x01\x01\x12.\n" +
	"\x13trigger_unix_millis\x18\n" +
	" \x01(\x03R\x11triggerUnixMillis\x12!\n" +
	"\ftrigger_uuid\x18\v \x01(\tR\vtriggerUuidB\x13\n" +
	...
	"\n" +
	"_stream_id\"\xf0\x02\n" +
	"\x14ProcessingSpeedStats\x12\x14\n" +
	"\x05ticks\x18\x01 \x01(\rR\x05ticks\x12\x1b\n" +
	"\tspeed_min\x18\x02 \x01(\x01R\bspeedMin\x12\x1b\n" +
	"\tspeed_avg\x18\x03 \x01(\x01R\bspeedAvg\x12\x1b\n" +
	"\tspeed_max\x18\x04 \x01(\x01R\bspeedMax\x12&\n" +
	"\x0fhard_slow_ticks\x18\x05 \x01(\rR\rhardSlowTicks\x12,\n" +
	"\x12regular_slow_ticks\x18\x06 \x01(\rR\x10regularSlowTicks\x12\x19\n" +
	"\bramp_ups\x18\a \x01(\rR\arampUps\x12#\n" +
	"\rlockout_ticks\x18\b \x01(\rR\flockoutTicks\x12(\n" +
	"\x10stale_hold_ticks\x18\t \x01(\rR\x0estaleHoldTicks\x12\x1e\n" +
	"\bdrain_ms\x18\n" +
	" \x01(\x03H\x00R\adrainMs\x88\x01\x01B\v\n" +
	"\t_drain_ms\"\xb6\x05\n" +
	...
	"\x06tracks\x18\r \x03(\v2\x1c.helmsmancontrol.StreamTrackR\x06tracks\x12U\n" +
	"\x10processing_speed\x18\x0e \x01(\v2%.helmsmancontrol.ProcessingSpeedStatsH\x04R\x0fprocessingSpeed\x88\x01\x01B\n" +
	"\n" +
	"\b_node_idB\f\n" +
	"\n" +
	"_stream_idB\x0e\n" +
	"\f_exit_reasonB\x14\n" +
	"\x12_human_exit_reasonB\x13\n" +
	"\x11_processing_speed\"\xea\x01\n" +
	...
	"\x15packets_retransmitted\x18\x1b \x01(\x04H\x15R\x14packetsRetransmitted\x88\x01\x01\x120\n" +
	"\x11ingest_generation\x18' \x01(\tH\x16R\x10ingestGeneration\x88\x01\x01\x125\n" +
	"\x14ingest_connector_pid\x18( \x01(\x03H\x17R\x12ingestConnectorPid\x88\x01\x01\x12^\n" +
	"\x13process_observation\x18) \x01(\v2-.helmsmancontrol.MistStreamProcessObservationR\x12processObservation\x12 \n" +
	"\tbuffer_ms\x18\x1c \x01(\rH\x18R\bbufferMs\x88\x01\x01\x12 \n" +
	"\tjitter_ms\x18\x1d \x01(\rH\x19R\bjitterMs\x88\x01\x01\x12+\n" +
	"\x0fmax_keepaway_ms\x18\x1e \x01(\rH\x1aR\rmaxKeepawayMs\x88\x01\x01\x121\n" +
	"\x12track_details_json\x18\x1f \x01(\tH\x1bR\x10trackDetailsJson\x88\x01\x01\x12*\n" +
	"\x0eaudio_channels\x18  \x01(\rH\x1cR\raudioChannels\x88\x01\x01\x12/\n" +
	"\x11audio_sample_rate\x18! \x01(\rH\x1dR\x0faudioSampleRate\x88\x01\x01\x12$\n" +
	"\vaudio_codec\x18\" \x01(\tH\x1eR\n" +
	"audioCodec\x88\x01\x01\x12(\n" +
	"\raudio_bitrate\x18# \x01(\rH\x1fR\faudioBitrate\x88\x01\x01\x12+\n" +
	...
	"\r_packets_lostB\r\n" +
	"\v_replicatedB\x18\n" +
	"\x16_packets_retransmittedB\x14\n" +
	"\x12_ingest_generationB\x17\n" +
	"\x15_ingest_connector_pidB\f\n" +
	"\n" +
	"_buffer_msB\f\n" +
	"\n" +
	"_jitter_msB\x12\n" +
	...
	"\n" +
	"buffer_pid\x18\x02 \x01(\x03H\x00R\tbufferPid\x88\x01\x01\x12*\n" +
	"\x11source_pids_known\x18\x03 \x01(\bR\x0fsourcePidsKnown\x12\x1f\n" +
	"\vsource_pids\x18\x04 \x03(\x03R\n" +
	"sourcePids\x12)\n" +
	"\x0efirst_media_ms\x18\x05 \x01(\x04H\x01R\ffirstMediaMs\x88\x01\x01\x12'\n" +
	"\rlast_media_ms\x18\x06 \x01(\x04H\x02R\vlastMediaMs\x88\x01\x01\x127\n" +
	"\x18read_started_unix_millis\x18\a \x01(\x03R\x15readStartedUnixMillis\x12;\n" +
	...
	"\rinternal_name\x18\x03 \x01(\tR\finternalName\x12\x17\n" +
	...
	"\attfb_ms\x18\x03 \x01(\rR\x06ttfbMs\x12\x1f\n" +
	"\vduration_ms\x18\x04 \x01(\rR\n" +
	"durationMs\x12#\n" +
	"\rtransfer_size\x18\x05 \x01(\x04R\ftransferSize\x12*\n" +
	"\x11encoded_body_size\x18\x06 \x01(\x04R\x0fencodedBodySize\x12*\n" +
	"\x11decoded_body_size\x18\a \x01(\x04R\x0fdecodedBodySize\x12&\n" +
	"\fcache_status\x18\b \x01(\tH\x00R\vcacheStatus\x88\x01\x01\x12$\n" +
	"\vage_seconds\x18\t \x01(\rH\x01R\n" +
	"ageSeconds\x88\x01\x01B\x0f\n" +
	"\r_cache_statusB\x0e\n" +
	"\f_age_seconds\"\x93\b\n" +
	"\x11PlaybackBootTrace\x12 \n" +
	"\ttenant_id\x18\x01 \x01(\tH\x00R\btenantId\x88\x01\x01\x12 \n" +
	"\tstream_id\x18\x02 \x01(\tH\x01R\bstreamId\x88\x01\x01\x12#\n" +
	"\rartifact_hash\x18\x03 \x01(\tR\fartifactHash\x12#\n" +
	"\rinternal_name\x18\x04 \x01(\tR\finternalName\x12\x17\n" +
	"\anode_id\x18\x05 \x01(\tR\x06nodeId\x12,\n" +
	"\x12serving_cluster_id\x18\x06 \x01(\tR\x10servingClusterId\x12*\n" +
	"\x11origin_cluster_id\x18\a \x01(\tR\x0foriginClusterId\x12-\n" +
	"\x12cluster_attributed\x18\b \x01(\bR\x11clusterAttributed\x12\x1d\n" +
	"\n" +
	"content_id\x18\t \x01(\tR\tcontentId\x12\x1d\n" +
	"\n" +
	"session_id\x18\n" +
	" \x01(\tR\tsessionId\x12\x19\n" +
	"\btrace_id\x18\v \x01(\tR\atraceId\x12.\n" +
	"\x13client_timestamp_ms\x18\f \x01(\x03R\x11clientTimestampMs\x12 \n" +
	"\ftotal_ttf_ms\x18\x14 \x01(\rR\n" +
	"totalTtfMs\x12,\n" +
	"\x12gateway_resolve_ms\x18\x15 \x01(\rR\x10gatewayResolveMs\x12&\n" +
	"\x0fmist_hydrate_ms\x18\x16 \x01(\rR\rmistHydrateMs\x12(\n" +
	"\x10player_select_ms\x18\x17 \x01(\rR\x0eplayerSelectMs\x12\x1d\n" +
	"\n" +
	"connect_ms\x18\x18 \x01(\rR\tconnectMs\x12!\n" +
	"\fprebuffer_ms\x18\x19 \x01(\rR\vprebufferMs\x12\x18\n" +
	"\aoutcome\x18\x1e \x01(\tR\aoutcome\x12\x1d\n" +
	"\n" +
	"error_code\x18\x1f \x01(\tR\terrorCode\x12\x1f\n" +
	"\vplayer_type\x18  \x01(\tR\n" +
	"playerType\x12\x1a\n" +
	"\bprotocol\x18! \x01(\tR\bprotocol\x12!\n" +
	"\fcontent_type\x18\" \x01(\tR\vcontentType\x12\x17\n" +
	"\ais_live\x18# \x01(\bR\x06isLive\x12'\n" +
	"\x0fconnection_type\x18$ \x01(\tR\x0econnectionType\x12%\n" +
	"\x0eplayer_version\x18% \x01(\tR\rplayerVersion\x12C\n" +
	"\tresources\x18( \x03(\v2%.helmsmancontrol.PlaybackBootResourceR\tresourcesB\f\n" +
	"\n" +
	"_tenant_idB\f\n" +
	"\n" +
	"_stream_id\"\xd2\f\n" +
	"\x12PlaybackSessionQoe\x12 \n" +
	"\ttenant_id\x18\x01 \x01(\tH\x00R\btenantId\x88\x01\x01\x12 \n" +
	"\tstream_id\x18\x02 \x01(\tH\x01R\bstreamId\x88\x01\x01\x12#\n" +
	"\rartifact_hash\x18\x03 \x01(\tR\fartifactHash\x12#\n" +
	"\rinternal_name\x18\x04 \x01(\tR\finternalName\x12\x17\n" +
	...
	"session_id\x18\n" +
	" \x01(\tR\tsessionId\x12.\n" +
	"\x13client_timestamp_ms\x18\f \x01(\x03R\x11clientTimestampMs\x12\x1d\n" +
	"\n" +
	"beacon_seq\x18\r \x01(\rR\tbeaconSeq\x12\x19\n" +
	"\bis_final\x18\x0e \x01(\bR\aisFinal\x12!\n" +
	"\fflush_reason\x18\x0f \x01(\tR\vflushReason\x12\x1f\n" +
	"\vplayer_type\x18\x1e \x01(\tR\n" +
	"playerType\x12\x1a\n" +
	"\bprotocol\x18\x1f \x01(\tR\bprotocol\x12!\n" +
	"\fcontent_type\x18  \x01(\tR\vcontentType\x12\x17\n" +
	"\ais_live\x18! \x01(\bR\x06isLive\x12'\n" +
	"\x0fconnection_type\x18\" \x01(\tR\x0econnectionType\x12%\n" +
	"\x0eplayer_version\x18# \x01(\tR\rplayerVersion\x12\x1b\n" +
	"\tplayed_ms\x18( \x01(\x04R\bplayedMs\x12\x1f\n" +
	"\vrebuffer_ms\x18) \x01(\x04R\n" +
	"rebufferMs\x12%\n" +
	"\x0erebuffer_count\x18* \x01(\rR\rrebufferCount\x12 \n" +
	"\fseek_wait_ms\x18+ \x01(\x04R\n" +
	"seekWaitMs\x122\n" +
	"\x15frame_stats_supported\x18, \x01(\bR\x13frameStatsSupported\x12%\n" +
	"\x0eframes_decoded\x18- \x01(\x04R\rframesDecoded\x12%\n" +
	"\x0eframes_dropped\x18. \x01(\x04R\rframesDropped\x12)\n" +
	"\x10frames_corrupted\x18/ \x01(\x04R\x0fframesCorrupted\x12\x1f\n" +
	"\vfirst_frame\x180 \x01(\bR\n" +
	"firstFrame\x12\x1f\n" +
	"\vfatal_error\x181 \x01(\bR\n" +
	"fatalError\x12\x1d\n" +
	"\n" +
	"error_code\x182 \x01(\tR\terrorCode\x12.\n" +
	"\x13bitrate_bps_seconds\x18< \x01(\x04R\x11bitrateBpsSeconds\x12,\n" +
	"\x12abr_upswitch_count\x18= \x01(\rR\x10abrUpswitchCount\x120\n" +
	"\x14abr_downswitch_count\x18> \x01(\rR\x12abrDownswitchCount\x12\x1f\n" +
	"\vplay_intent\x18? \x01(\bR\n" +
	"playIntent\x12/\n" +
	"\x14live_edge_latency_ms\x18@ \x01(\rR\x11liveEdgeLatencyMs\x12$\n" +
	"\x0ebucket_width_s\x18F \x01(\rR\fbucketWidthS\x12(\n" +
	"\x10asset_duration_s\x18G \x01(\rR\x0eassetDurationS\x12+\n" +
	"\x11retention_buckets\x18H \x03(\rR\x10retentionBuckets\x12:\n" +
	"\x19retention_seconds_watched\x18I \x03(\x02R\x17retentionSecondsWatched\x12,\n" +
	"\x12max_bucket_reached\x18J \x01(\rR\x10maxBucketReachedB\f\n" +
	"\n" +
	"_tenant_idB\f\n" +
	"\n" +
	"_stream_id\"\xf1\x0f\n" +
	...
	"\tnode_uuid\x18\x1e \x01(\tH\x01R\bnodeUuid\x88\x01\x01\x12T\n" +
	"\x12component_versions\x18\x1f \x03(\v2%.helmsmancontrol.EdgeComponentVersionR\x11componentVersions\x12#\n" +
	...
	"\x12connections_cached\x18, \x01(\rR\x11connectionsCached\x12\x1f\n" +
	"\vdeploy_mode\x18- \x01(\tR\n" +
	"deployMode\x12\x0e\n" +
	"\x02os\x18. \x01(\tR\x02os\x12\x12\n" +
	"\x04arch\x18/ \x01(\tR\x04arch\x120\n" +
	"\x14artifacts_report_seq\x180 \x01(\x03R\x12artifactsReportSeq\x12<\n" +
	...
	"\ttenant_id\x18\f \x01(\tH\tR\btenantId\x88\x01\x01\x125\n" +
	"\x14stream_internal_name\x18\r \x01(\tH\n" +
	"R\x12streamInternalName\x88\x01\x01\x12\"\n" +
	"\n" +
	...
	"\x0ehas_local_copy\x18\x1b \x01(\bH\x18R\fhasLocalCopy\x88\x01\x01\x12 \n" +
	"\tis_synced\x18\x1c \x01(\bH\x19R\bisSynced\x88\x01\x01\x12&\n" +
	"\fis_finalized\x18\x1d \x01(\bH\x1aR\visFinalized\x88\x01\x01\x12U\n" +
	"\x10processing_speed\x18\x1f \x01(\v2%.helmsmancontrol.ProcessingSpeedStatsH\x1bR\x0fprocessingSpeed\x88\x01\x01\x121\n" +
	"\x12processing_wall_ms\x18  \x01(\x03H\x1cR\x10processingWallMs\x88\x01\x01\x124\n" +
	"\x14source_updated_at_ms\x18! \x01(\x03H\x1dR\x11sourceUpdatedAtMs\x88\x01\x01\"\x8e\x01\n" +
	"\x05Stage\x12\x15\n" +
	...
	"_is_syncedB\x0f\n" +
	"\r_is_finalizedB\x13\n" +
	"\x11_processing_speedB\x15\n" +
	"\x13_processing_wall_msB\x17\n" +
	"\x15_source_updated_at_msJ\x04\b\x1e\x10\x1f\"\xe6\n" +
	"\n" +
	...
	"\ttenant_id\x18\n" +
	" \x01(\tH\aR\btenantId\x88\x01\x01\x125\n" +
	"\x14stream_internal_name\x18\v \x01(\tH\bR\x12streamInternalName\x88\x01\x01\x12\"\n" +
	"\n" +
	...
	"syncStatus\x88\x01\x01\x12)\n" +
	"\x0ehas_local_copy\x18\x13 \x01(\bH\x10R\fhasLocalCopy\x88\x01\x01\x12 \n" +
	"\tis_synced\x18\x14 \x01(\bH\x11R\bisSynced\x88\x01\x01\x12&\n" +
	"\fis_finalized\x18\x15 \x01(\bH\x12R\visFinalized\x88\x01\x01\x124\n" +
	"\x14source_updated_at_ms\x18\x17 \x01(\x03H\x13R\x11sourceUpdatedAtMs\x88\x01\x01\"\x85\x01\n" +
	"\x06Status\x12\x16\n" +
	...
	"_is_syncedB\x0f\n" +
	"\r_is_finalizedB\x17\n" +
	"\x15_source_updated_at_msJ\x04\b\x16\x10\x17\"\x81\x0f\n" +
	...
	"syncStatus\x88\x01\x01\x12)\n" +
	"\x0ehas_local_copy\x18\x1a \x01(\bH\x17R\fhasLocalCopy\x88\x01\x01\x12 \n" +
	"\tis_synced\x18\x1b \x01(\bH\x18R\bisSynced\x88\x01\x01\x12&\n" +
	"\fis_finalized\x18\x1c \x01(\bH\x19R\visFinalized\x88\x01\x01\x12U\n" +
	"\x10processing_speed\x18\x1e \x01(\v2%.helmsmancontrol.ProcessingSpeedStatsH\x1aR\x0fprocessingSpeed\x88\x01\x01\x121\n" +
	"\x12processing_wall_ms\x18\x1f \x01(\x03H\x1bR\x10processingWallMs\x88\x01\x01\x124\n" +
	"\x14source_updated_at_ms\x18  \x01(\x03H\x1cR\x11sourceUpdatedAtMs\x88\x01\x01\"\xa0\x01\n" +
	"\x06Status\x12\x16\n" +
	...
	"\x11_processing_speedB\x15\n" +
	"\x13_processing_wall_msB\x17\n" +
	"\x15_source_updated_at_msJ\x04\b\x1d\x10\x1e\"\x94\x05\n" +
	...
	"\vstream_name\x18\x05 \x01(\tH\x01R\n" +
	"streamName\x88\x01\x01\x12 \n" +
	"\tstream_id\x18\x06 \x01(\tH\x02R\bstreamId\x88\x01\x01\x12$\n" +
	"\vsource_node\x18\a \x01(\tH\x03R\n" +
	"sourceNode\x88\x01\x01\x12 \n" +
	"\tdest_node\x18\b \x01(\tH\x04R\bdestNode\x88\x01\x01\x12\x1e\n" +
	"\bdtsc_url\x18\t \x01(\tH\x05R\adtscUrl\x88\x01\x01\x12\"\n" +
	"\n" +
	"latency_ms\x18\n" +
	" \x01(\x02H\x06R\tlatencyMs\x88\x01\x01\x12*\n" +
	"\x0ftime_to_live_ms\x18\v \x01(\x02H\aR\ftimeToLiveMs\x88\x01\x01\x12*\n" +
	"\x0efailure_reason\x18\f \x01(\tH\bR\rfailureReason\x88\x01\x01\x12.\n" +
	"\x10queried_clusters\x18\r \x01(\rH\tR\x0fqueriedClusters\x88\x01\x01\x124\n" +
	"\x13responding_clusters\x18\x0e \x01(\rH\n" +
	"R\x12respondingClusters\x88\x01\x01\x12.\n" +
	"\x10total_candidates\x18\x0f \x01(\rH\vR\x0ftotalCandidates\x88\x01\x01\x12/\n" +
	"\x11best_remote_score\x18\x10 \x01(\x04H\fR\x0fbestRemoteScore\x88\x01\x01\x12&\n" +
	"\fpeer_cluster\x18\x11 \x01(\tH\rR\vpeerCluster\x88\x01\x01\x12\x17\n" +
	"\x04role\x18\x12 \x01(\tH\x0eR\x04role\x88\x01\x01\x12\x1b\n" +
	"\x06reason\x18\x13 \x01(\tH\x0fR\x06reason\x88\x01\x01\x12,\n" +
	"\x0fblocked_cluster\x18\x14 \x01(\tH\x10R\x0eblockedCluster\x88\x01\x01\x12E\n" +
	"\x1cexisting_replication_cluster\x18\x15 \x01(\tH\x11R\x1aexistingReplicationCluster\x88\x01\x01\x12 \n" +
	"\tlocal_lat\x18\x16 \x01(\x01H\x12R\blocalLat\x88\x01\x01\x12 \n" +
	"\tlocal_lon\x18\x17 \x01(\x01H\x13R\blocalLon\x88\x01\x01\x12\"\n" +
	"\n" +
	...
	"\x05_roleB\t\n" +
	"\a_reasonB\x12\n" +
	"\x10_blocked_clusterB\x1f\n" +
	"\x1d_existing_replication_clusterB\f\n" +
	"\n" +
	"_local_latB\f\n" +
	"\n" +
	"_local_lonB\r\n" +
	...
	"\x12local_input_codecs\x18\x04 \x03(\tR\x10localInputCodecs\"\xf2\x01\n" +
	"\x14ProcessMeterQuantity\x12\x14\n" +
	"\x05meter\x18\x01 \x01(\tR\x05meter\x12\x12\n" +
	"\x04unit\x18\x02 \x01(\tR\x04unit\x12\x1a\n" +
	"\bquantity\x18\x03 \x01(\x01R\bquantity\x12U\n" +
	"\n" +
	"dimensions\x18\x04 \x03(\v25.helmsmancontrol.ProcessMeterQuantity.DimensionsEntryR\n" +
	"dimensions\x1a=\n" +
	...
	"\foperation_id\x18H \x01(\tH/R\voperationId\x88\x01\x01\x122\n" +
	"\x12processing_product\x18I \x01(\tH0R\x11processingProduct\x88\x01\x01\x120\n" +
	"\x11execution_backend\x18J \x01(\tH1R\x10executionBackend\x88\x01\x01\x121\n" +
	"\x12provider_tenant_id\x18K \x01(\tH2R\x10providerTenantId\x88\x01\x01\x123\n" +
	...
	"\v_cluster_idB\x14\n" +
	"\x12_origin_cluster_idB\x0f\n" +
	"\r_operation_idB\x15\n" +
	"\x13_processing_productB\x14\n" +
	"\x12_execution_backendB\x15\n" +
	...
	"\ts3_prefix\x18\x03 \x01(\tR\bs3Prefix\"\x85\x01\n" +
	"\x17ProcessingClassCapacity\x12\x14\n" +
	"\x05class\x18\x01 \x01(\tR\x05class\x12\x1f\n" +
	"\vslots_total\x18\x02 \x01(\x05R\n" +
	"slotsTotal\x12\x1d\n" +
	"\n" +
	"slots_used\x18\x03 \x01(\x05R\tslotsUsed\x12\x14\n" +
	"\x05ready\x18\x04 \x03(\tR\x05ready\"\xdf\x01\n" +
	"\n" +
	"NodeLimits\x124\n" +
	"\x16storage_capacity_bytes\x18\x02 \x01(\x04R\x14storageCapacityBytes\x12,\n" +
	"\x12storage_used_bytes\x18\x03 \x01(\x04R\x10storageUsedBytes\x12W\n" +
	"\x12processing_classes\x18\x04 \x03(\v2(.helmsmancontrol.ProcessingClassCapacityR\x11processingClassesJ\x04\b\x01\x10\x02R\x0emax_transcodes\"\x84\x02\n" +
	"\n" +
	"StreamData\x12\x14\n" +
	...
	"\rartifact_type\x18\v \x01(\x0e2+.helmsmancontrol.ArtifactEvent.ArtifactTypeR\fartifactType\x128\n" +
	"\x04role\x18\f \x01(\x0e2$.helmsmancontrol.StoredArtifact.RoleR\x04role\x12\x1f\n" +
	"\vis_complete\x18\r \x01(\bR\n" +
	"isComplete\"=\n" +
	"\x04Role\x12\x14\n" +
	"\x10ROLE_UNSPECIFIED\x10\x00\x12\x0e\n" +
	"\n" +
	"ROLE_CACHE\x10\x01\x12\x0f\n" +
	"\vROLE_ORIGIN\x10\x02\"\x8a\x03\n" +
	...
	"\tprocesses\x18\x05 \x03(\v2\x1e.helmsmancontrol.StreamProcessR\tprocesses\x12>\n" +
	"\x1bprocess_controlled_realtime\x18\x06 \x01(\bR\x19processControlledRealtime\"x\n" +
	...
	"\x04caps\x18\x04 \x03(\tR\x04caps\"\xd8\x01\n" +
	"\rTLSCertBundle\x12\x19\n" +
	...
	"\x0esite_addresses\x18\x06 \x03(\tR\rsiteAddresses\x12\x18\n" +
	"\aversion\x18\a \x01(\tR\aversion\"\xc7\x05\n" +
	"\n" +
	"ConfigSeed\x12\x17\n" +
	...
	"\x15foghorn_balancer_base\x18\x18 \x01(\tR\x13foghornBalancerBase\x12!\n" +
	"\fseed_version\x18\x19 \x01(\x04R\vseedVersion\x12?\n" +
	"\vtls_bundles\x18\x1a \x03(\v2\x1e.helmsmancontrol.TLSCertBundleR\n" +
	"tlsBundles\"\x8a\x01\n" +
	"\x18BalancerCapabilityUpdate\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\tR\x06nodeId\x122\n" +
	"\x15foghorn_balancer_base\x18\x02 \x01(\tR\x13foghornBalancerBase\x12!\n" +
	"\fseed_version\x18\x03 \x01(\x04R\vseedVersion\"\xc0\x03\n" +
	"\x15ConfigSeedApplyResult\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\tR\x06nodeId\x12!\n" +
	"\fseed_version\x18\x02 \x01(\x04R\vseedVersion\x12,\n" +
	"\x12applied_bundle_ids\x18\x03 \x03(\tR\x10appliedBundleIds\x12*\n" +
	"\x11failed_bundle_ids\x18\x04 \x03(\tR\x0ffailedBundleIds\x12\x18\n" +
	"\asuccess\x18\x05 \x01(\bR\asuccess\x12\x14\n" +
	"\x05error\x18\x06 \x01(\tR\x05error\x129\n" +
	"\n" +
	"applied_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tappliedAt\x12c\n" +
	"\x0fbundle_versions\x18\b \x03(\v2:.helmsmancontrol.ConfigSeedApplyResult.BundleVersionsEntryR\x0ebundleVersions\x1aA\n" +
	...
	"poolDomain\x12\x1d\n" +
	"\n" +
	"acme_email\x18\x04 \x01(\tR\tacmeEmail\"\x96\x01\n" +
	...
	"\x05error\x18\x05 \x01(\tR\x05error\"\xd4\x06\n" +
	"\x14ProcessingJobRequest\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12\x1b\n" +
	"\ttenant_id\x18\x02 \x01(\tR\btenantId\x12#\n" +
	"\rartifact_hash\x18\x03 \x01(\tR\fartifactHash\x12\x1d\n" +
	"\n" +
	"source_url\x18\x04 \x01(\tR\tsourceUrl\x12\x19\n" +
	"\bjob_type\x18\x05 \x01(\tR\ajobType\x12\x1f\n" +
	"\voutput_path\x18\x06 \x01(\tR\n" +
	"outputPath\x12I\n" +
	"\x06params\x18\a \x03(\v21.helmsmancontrol.ProcessingJobRequest.ParamsEntryR\x06params\x12%\n" +
	"\x0eprocesses_json\x18\b \x01(\tR\rprocessesJson\x12#\n" +
	"\rinternal_name\x18\t \x01(\tR\finternalName\x12(\n" +
	"\x10deadline_unix_ms\x18\n" +
	" \x01(\x03R\x0edeadlineUnixMs\x12)\n" +
	"\x10processing_class\x18\v \x01(\tR\x0fprocessingClass\x12*\n" +
	"\x11source_chapter_id\x18\x14 \x01(\tR\x0fsourceChapterId\x12&\n" +
	"\x0fsource_dvr_hash\x18\x15 \x01(\tR\rsourceDvrHash\x12=\n" +
	"\x1bsource_stream_internal_name\x18\x16 \x01(\tR\x18sourceStreamInternalName\x12(\n" +
	"\x10chapter_start_ms\x18\x17 \x01(\x03R\x0echapterStartMs\x12$\n" +
	"\x0echapter_end_ms\x18\x18 \x01(\x03R\fchapterEndMs\x12N\n" +
	"\x0fsource_segments\x18\x19 \x03(\v2%.helmsmancontrol.DVRChapterSegmentRefR\x0esourceSegments\x12.\n" +
	"\x13output_runtime_name\x18\x1a \x01(\tR\x11outputRuntimeName\x1a9\n" +
	"\vParamsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xb2\x02\n" +
	"\x14DVRChapterSegmentRef\x12!\n" +
	"\fsegment_name\x18\x01 \x01(\tR\vsegmentName\x12\x1a\n" +
	"\bsequence\x18\x02 \x01(\x03R\bsequence\x12\x1f\n" +
	"\vduration_ms\x18\x03 \x01(\x03R\n" +
	"durationMs\x12$\n" +
	"\x0emedia_start_ms\x18\x04 \x01(\x03R\fmediaStartMs\x12 \n" +
	"\fmedia_end_ms\x18\x05 \x01(\x03R\n" +
	...
	"\n" +
	"size_bytes\x18\b \x01(\x03R\tsizeBytes\"\xd4\x03\n" +
	...
	"\x11media_duration_ms\x18\a \x01(\x03H\x00R\x0fmediaDurationMs\x88\x01\x01\x124\n" +
	"\x06tracks\x18\b \x03(\v2\x1c.helmsmancontrol.StreamTrackR\x06tracks\x12%\n" +
	"\x0etracks_present\x18\t \x01(\bR\rtracksPresent\x1a:\n" +
	...
	"\vpermissions\x18\x05 \x03(\tR\vpermissions\"3\n" +
	"\x1bEdgeMistAdminSessionRequest\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\"\xd5\x01\n" +
	"\x1cEdgeMistAdminSessionResponse\x12\x14\n" +
	"\x05valid\x18\x01 \x01(\bR\x05valid\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x1b\n" +
	"\ttenant_id\x18\x03 \x01(\tR\btenantId\x12\x12\n" +
	...
	"\n" +
	"file_paths\x18\x02 \x03(\tR\tfilePaths\"\xbd\x02\n" +
	"\x17ThumbnailUploadResponse\x12#\n" +
	"\rthumbnail_key\x18\x01 \x01(\tR\fthumbnailKey\x12R\n" +
	"\auploads\x18\x02 \x03(\v28.helmsmancontrol.ThumbnailUploadResponse.PresignedUploadR\auploads\x12\x1d\n" +
	"\n" +
	"attempt_id\x18\x03 \x01(\tR\tattemptId\x1a\x89\x01\n" +
	...
	"\n" +
	"local_path\x18\x04 \x01(\tR\tlocalPath\"p\n" +
	"\x11ThumbnailUploaded\x12#\n" +
	"\rthumbnail_key\x18\x01 \x01(\tR\fthumbnailKey\x12\x17\n" +
	"\as3_keys\x18\x02 \x03(\tR\x06s3Keys\x12\x1d\n" +
	"\n" +
	"attempt_id\x18\x03 \x01(\tR\tattemptId\"\xb4\x06\n" +
	...
	"\x16RESTREAM_STATE_PUSHING\x10\x02\x12\x1b\n" +
	...
	"\x19RESTREAM_REASON_COMPLETED\x10\x02\x12(\n" +
	"$RESTREAM_REASON_DESTINATION_REJECTED\x10\x03\x12!\n" +
	"\x1dRESTREAM_REASON_NETWORK_ERROR\x10\x04\x12!\n" +
	...
	"\x18MIST_TRIGGER_ACTION_DENY\x10\x02\x12\x1c\n" +
	"\x18MIST_TRIGGER_ACTION_KEEP\x10\x03\x12\x1f\n" +
	"\x1bMIST_TRIGGER_ACTION_OFFLINE\x10\x04\x12&\n" +
	"\"MIST_TRIGGER_ACTION_USE_CONFIGURED\x10\x05*\x85\x02\n" +
	"\x13TriggerAckErrorCode\x12\x1a\n" +
	"\x16TRIGGER_ACK_ERROR_NONE\x10\x00\x12\x1e\n" +
	"\x1aTRIGGER_ACK_ERROR_INTERNAL\x10\x01\x12,\n" +
	"(TRIGGER_ACK_ERROR_DOWNSTREAM_UNAVAILABLE\x10\x02\x12#\n" +
	...
	"\x19STORAGE_LOCATION_FREEZING\x10\x03\"\x04\b\x04\x10\x04*\x1bSTORAGE_LOCATION_DEFROSTING*\x96\x01\n" +
	"\n" +
	"AssetState\x12\x1b\n" +
	"\x17ASSET_STATE_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14ASSET_STATE_PLAYABLE\x10\x01\x12\x1e\n" +
	"\x1aASSET_STATE_SOURCE_MISSING\x10\x02\x12\x1a\n" +
	"\x16ASSET_STATE_ACTIVE_DVR\x10\x03\"\x04\b\x04\x10\x04*\x0fASSET_STATE_GAP*\xa9\x01\n" +
	...
	"!NODE_OPERATIONAL_MODE_MAINTENANCE\x10\x03*\x8b\x02\n" +
	"\x13FederationEventType\x12 \n" +
	"\x1cFEDERATION_EVENT_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14ORIGIN_PULL_ARRANGED\x10\x01\x12\x19\n" +
	"\x15ORIGIN_PULL_COMPLETED\x10\x02\x12\x16\n" +
	"\x12ORIGIN_PULL_FAILED\x10\x03\x12\x14\n" +
	"\x10FEDERATION_QUERY\x10\x04\x12\x12\n" +
	"\x0ePEER_CONNECTED\x10\x05\x12\x15\n" +
	"\x11PEER_DISCONNECTED\x10\x06\x12\x13\n" +
	"\x0fLEADER_ACQUIRED\x10\a\x12\x0f\n" +
	"\vLEADER_LOST\x10\b\x12\x1e\n" +
...
var file_ipc_proto_msgTypes = make([]protoimpl.MessageInfo, 162)
var file_ipc_proto_goTypes = []any{
	...
	(*ApplyManagedStream)(nil),                      // 34: helmsmancontrol.ApplyManagedStream
	(*ManagedStreamAdmission)(nil),                  // 35: helmsmancontrol.ManagedStreamAdmission
	(*RetractManagedStream)(nil),                    // 36: helmsmancontrol.RetractManagedStream
	(*ManagedStreamRetraction)(nil),                 // 37: helmsmancontrol.ManagedStreamRetraction
	(*DrainStreamRequest)(nil),                      // 38: helmsmancontrol.DrainStreamRequest
	(*DrainStreamResponse)(nil),                     // 39: helmsmancontrol.DrainStreamResponse
	(*ModeChangeRequest)(nil),                       // 40: helmsmancontrol.ModeChangeRequest
	(*EdgeComponentVersion)(nil),                    // 41: helmsmancontrol.EdgeComponentVersion
	(*DesiredComponent)(nil),                        // 42: helmsmancontrol.DesiredComponent
	(*DesiredStateUpdate)(nil),                      // 43: helmsmancontrol.DesiredStateUpdate
	(*ComponentApplyResult)(nil),                    // 44: helmsmancontrol.ComponentApplyResult
	(*UpdateApplyResult)(nil),                       // 45: helmsmancontrol.UpdateApplyResult
	(*StopSessionsRequest)(nil),                     // 46: helmsmancontrol.StopSessionsRequest
	(*InvalidateSessionsRequest)(nil),               // 47: helmsmancontrol.InvalidateSessionsRequest
	(*ActivatePushTargets)(nil),                     // 48: helmsmancontrol.ActivatePushTargets
	(*PushTargetSpec)(nil),                          // 49: helmsmancontrol.PushTargetSpec
	(*DeactivatePushTargets)(nil),                   // 50: helmsmancontrol.DeactivatePushTargets
	(*DeactivatePushTargetsResult)(nil),             // 51: helmsmancontrol.DeactivatePushTargetsResult
	(*ActivatePushTargetsResult)(nil),               // 52: helmsmancontrol.ActivatePushTargetsResult
	(*PushTargetConvergence)(nil),                   // 53: helmsmancontrol.PushTargetConvergence
	(*PushTargetStatusReport)(nil),                  // 54: helmsmancontrol.PushTargetStatusReport
	(*ArtifactDeleted)(nil),                         // 55: helmsmancontrol.ArtifactDeleted
	(*Register)(nil),                                // 56: helmsmancontrol.Register
	(*AppliedManagedStream)(nil),                    // 57: helmsmancontrol.AppliedManagedStream
	(*NodeFingerprint)(nil),                         // 58: helmsmancontrol.NodeFingerprint
	(*ClipPullRequest)(nil),                         // 59: helmsmancontrol.ClipPullRequest
	(*ControlError)(nil),                            // 60: helmsmancontrol.ControlError
	(*Heartbeat)(nil),                               // 61: helmsmancontrol.Heartbeat
	(*MistTrigger)(nil),                             // 62: helmsmancontrol.MistTrigger
	(*RawMistWebhookTrigger)(nil),                   // 63: helmsmancontrol.RawMistWebhookTrigger
	(*MistTriggerResponse)(nil),                     // 64: helmsmancontrol.MistTriggerResponse
	(*MistTriggerAck)(nil),                          // 65: helmsmancontrol.MistTriggerAck
	(*StorageSnapshot)(nil),                         // 66: helmsmancontrol.StorageSnapshot
	(*TenantStorageUsage)(nil),                      // 67: helmsmancontrol.TenantStorageUsage
	(*ClipHashRequest)(nil),                         // 68: helmsmancontrol.ClipHashRequest
	(*ClipHashResponse)(nil),                        // 69: helmsmancontrol.ClipHashResponse
	(*DVRStartRequest)(nil),                         // 70: helmsmancontrol.DVRStartRequest
	(*DVRConfig)(nil),                               // 71: helmsmancontrol.DVRConfig
	(*DVRProgress)(nil),                             // 72: helmsmancontrol.DVRProgress
	(*DVRStopped)(nil),                              // 73: helmsmancontrol.DVRStopped
	(*DVRStopRequest)(nil),                          // 74: helmsmancontrol.DVRStopRequest
	(*RecordDVRSegmentRequest)(nil),                 // 75: helmsmancontrol.RecordDVRSegmentRequest
	(*RecordDVRSegmentResponse)(nil),                // 76: helmsmancontrol.RecordDVRSegmentResponse
	(*MarkDVRSegmentUploaded)(nil),                  // 77: helmsmancontrol.MarkDVRSegmentUploaded
	(*DVRSegmentDropped)(nil),                       // 78: helmsmancontrol.DVRSegmentDropped
	(*EvictableSegmentsRequest)(nil),                // 79: helmsmancontrol.EvictableSegmentsRequest
	(*EvictableSegmentsResponse)(nil),               // 80: helmsmancontrol.EvictableSegmentsResponse
	(*RetryDVRSegmentUpload)(nil),                   // 81: helmsmancontrol.RetryDVRSegmentUpload
	(*ReclaimDVRSegment)(nil),                       // 82: helmsmancontrol.ReclaimDVRSegment
	(*RestoreLocalSegmentIndexRequest)(nil),         // 83: helmsmancontrol.RestoreLocalSegmentIndexRequest
	(*RestoreLocalSegmentIndexResponse)(nil),        // 84: helmsmancontrol.RestoreLocalSegmentIndexResponse
	(*ClipDeleteRequest)(nil),                       // 85: helmsmancontrol.ClipDeleteRequest
	(*DVRDeleteRequest)(nil),                        // 86: helmsmancontrol.DVRDeleteRequest
	(*VodDeleteRequest)(nil),                        // 87: helmsmancontrol.VodDeleteRequest
	(*FreezePermissionRequest)(nil),                 // 88: helmsmancontrol.FreezePermissionRequest
	(*FreezePermissionResponse)(nil),                // 89: helmsmancontrol.FreezePermissionResponse
	(*FreezeRequest)(nil),                           // 90: helmsmancontrol.FreezeRequest
	(*FreezeProgress)(nil),                          // 91: helmsmancontrol.FreezeProgress
	(*DVRSegmentRef)(nil),                           // 92: helmsmancontrol.DVRSegmentRef
	(*CanDeleteRequest)(nil),                        // 93: helmsmancontrol.CanDeleteRequest
	(*CanDeleteResponse)(nil),                       // 94: helmsmancontrol.CanDeleteResponse
	(*RelayResolveRequest)(nil),                     // 95: helmsmancontrol.RelayResolveRequest
	(*RelayResolveResponse)(nil),                    // 96: helmsmancontrol.RelayResolveResponse
	(*AuthorizeRelayPullRequest)(nil),               // 97: helmsmancontrol.AuthorizeRelayPullRequest
	(*AuthorizeRelayPullResponse)(nil),              // 98: helmsmancontrol.AuthorizeRelayPullResponse
	(*SyncComplete)(nil),                            // 99: helmsmancontrol.SyncComplete
	(*DtshSyncRequest)(nil),                         // 100: helmsmancontrol.DtshSyncRequest
	(*StorageLifecycleData)(nil),                    // 101: helmsmancontrol.StorageLifecycleData
	(*PushRewriteTrigger)(nil),                      // 102: helmsmancontrol.PushRewriteTrigger
	(*ConnectionPlayTrigger)(nil),                   // 103: helmsmancontrol.ConnectionPlayTrigger
	(*ViewerResolveTrigger)(nil),                    // 104: helmsmancontrol.ViewerResolveTrigger
	(*StreamSourceTrigger)(nil),                     // 105: helmsmancontrol.StreamSourceTrigger
	(*StreamProcessTrigger)(nil),                    // 106: helmsmancontrol.StreamProcessTrigger
	(*PushOutStartTrigger)(nil),                     // 107: helmsmancontrol.PushOutStartTrigger
	(*PushEndTrigger)(nil),                          // 108: helmsmancontrol.PushEndTrigger
	(*PushInputCloseTrigger)(nil),                   // 109: helmsmancontrol.PushInputCloseTrigger
	(*ViewerConnectTrigger)(nil),                    // 110: helmsmancontrol.ViewerConnectTrigger
	(*ViewerDisconnectTrigger)(nil),                 // 111: helmsmancontrol.ViewerDisconnectTrigger
	(*SessionTimeShare)(nil),                        // 112: helmsmancontrol.SessionTimeShare
	(*StreamBufferTrigger)(nil),                     // 113: helmsmancontrol.StreamBufferTrigger
	(*StreamEndTrigger)(nil),                        // 114: helmsmancontrol.StreamEndTrigger
	(*StreamTrackListTrigger)(nil),                  // 115: helmsmancontrol.StreamTrackListTrigger
	(*ProcessingSpeedStats)(nil),                    // 116: helmsmancontrol.ProcessingSpeedStats
	(*RecordingCompleteTrigger)(nil),                // 117: helmsmancontrol.RecordingCompleteTrigger
	(*RecordingSegmentTrigger)(nil),                 // 118: helmsmancontrol.RecordingSegmentTrigger
	(*StreamLifecycleUpdate)(nil),                   // 119: helmsmancontrol.StreamLifecycleUpdate
	(*IngestRuntimeAbsent)(nil),                     // 120: helmsmancontrol.IngestRuntimeAbsent
	(*MistStreamProcessObservation)(nil),            // 121: helmsmancontrol.MistStreamProcessObservation
	(*ClientLifecycleUpdate)(nil),                   // 122: helmsmancontrol.ClientLifecycleUpdate
	(*ClientLifecycleBatch)(nil),                    // 123: helmsmancontrol.ClientLifecycleBatch
	(*PlaybackBootResource)(nil),                    // 124: helmsmancontrol.PlaybackBootResource
	(*PlaybackBootTrace)(nil),                       // 125: helmsmancontrol.PlaybackBootTrace
	(*PlaybackSessionQoe)(nil),                      // 126: helmsmancontrol.PlaybackSessionQoe
	(*NodeLifecycleUpdate)(nil),                     // 127: helmsmancontrol.NodeLifecycleUpdate
	(*LoadBalancingData)(nil),                       // 128: helmsmancontrol.LoadBalancingData
	(*ClipLifecycleData)(nil),                       // 129: helmsmancontrol.ClipLifecycleData
	(*DVRLifecycleData)(nil),                        // 130: helmsmancontrol.DVRLifecycleData
	(*VodLifecycleData)(nil),                        // 131: helmsmancontrol.VodLifecycleData
	(*MessageLifecycleData)(nil),                    // 132: helmsmancontrol.MessageLifecycleData
	(*FederationEventData)(nil),                     // 133: helmsmancontrol.FederationEventData
	(*NodeCapabilities)(nil),                        // 134: helmsmancontrol.NodeCapabilities
	(*ProcessingConfig)(nil),                        // 135: helmsmancontrol.ProcessingConfig
	(*ProcessMeterQuantity)(nil),                    // 136: helmsmancontrol.ProcessMeterQuantity
	(*ProcessBillingEvent)(nil),                     // 137: helmsmancontrol.ProcessBillingEvent
	(*StorageInfo)(nil),                             // 138: helmsmancontrol.StorageInfo
	(*ProcessingClassCapacity)(nil),                 // 139: helmsmancontrol.ProcessingClassCapacity
	(*NodeLimits)(nil),                              // 140: helmsmancontrol.NodeLimits
	(*StreamData)(nil),                              // 141: helmsmancontrol.StreamData
	(*StreamTrack)(nil),                             // 142: helmsmancontrol.StreamTrack
	(*StoredArtifact)(nil),                          // 143: helmsmancontrol.StoredArtifact
	(*StreamProcess)(nil),                           // 144: helmsmancontrol.StreamProcess
	(*StreamDef)(nil),                               // 145: helmsmancontrol.StreamDef
	(*StreamTemplate)(nil),                          // 146: helmsmancontrol.StreamTemplate
	(*TLSCertBundle)(nil),                           // 147: helmsmancontrol.TLSCertBundle
	(*ConfigSeed)(nil),                              // 148: helmsmancontrol.ConfigSeed
	(*BalancerCapabilityUpdate)(nil),                // 149: helmsmancontrol.BalancerCapabilityUpdate
	(*ConfigSeedApplyResult)(nil),                   // 150: helmsmancontrol.ConfigSeedApplyResult
	(*SiteConfig)(nil),                              // 151: helmsmancontrol.SiteConfig
	(*TranscodeProfile)(nil),                        // 152: helmsmancontrol.TranscodeProfile
	(*TranscodeJobRequest)(nil),                     // 153: helmsmancontrol.TranscodeJobRequest
	(*TranscodeJobProgress)(nil),                    // 154: helmsmancontrol.TranscodeJobProgress
	(*TranscodeJobComplete)(nil),                    // 155: helmsmancontrol.TranscodeJobComplete
	(*ProcessingJobRequest)(nil),                    // 156: helmsmancontrol.ProcessingJobRequest
	(*DVRChapterSegmentRef)(nil),                    // 157: helmsmancontrol.DVRChapterSegmentRef
	(*ProcessingJobResult)(nil),                     // 158: helmsmancontrol.ProcessingJobResult
	(*ProcessingJobProgress)(nil),                   // 159: helmsmancontrol.ProcessingJobProgress
	(*APIRequestBatch)(nil),                         // 160: helmsmancontrol.APIRequestBatch
	(*APIRequestAggregate)(nil),                     // 161: helmsmancontrol.APIRequestAggregate
	(*ValidateEdgeTokenRequest)(nil),                // 162: helmsmancontrol.ValidateEdgeTokenRequest
	(*ValidateEdgeTokenResponse)(nil),               // 163: helmsmancontrol.ValidateEdgeTokenResponse
	(*EdgeMistAdminSessionRequest)(nil),             // 164: helmsmancontrol.EdgeMistAdminSessionRequest
	(*EdgeMistAdminSessionResponse)(nil),            // 165: helmsmancontrol.EdgeMistAdminSessionResponse
	(*ThumbnailUploadRequest)(nil),                  // 166: helmsmancontrol.ThumbnailUploadRequest
	(*ThumbnailUploadResponse)(nil),                 // 167: helmsmancontrol.ThumbnailUploadResponse
	(*ThumbnailUploaded)(nil),                       // 168: helmsmancontrol.ThumbnailUploaded
	(*GatewayTelemetryEvent)(nil),                   // 169: helmsmancontrol.GatewayTelemetryEvent
	(*OrchestratorVantageGeo)(nil),                  // 170: helmsmancontrol.OrchestratorVantageGeo
	(*OrchestratorDiscoveryObserved)(nil),           // 171: helmsmancontrol.OrchestratorDiscoveryObserved
	(*OrchestratorStateUpdate)(nil),                 // 172: helmsmancontrol.OrchestratorStateUpdate
	(*OrchestratorCapabilityPriceEntry)(nil),        // 173: helmsmancontrol.OrchestratorCapabilityPriceEntry
	(*OrchestratorTranscodeOutcome)(nil),            // 174: helmsmancontrol.OrchestratorTranscodeOutcome
	(*OrchestratorAIOutcome)(nil),                   // 175: helmsmancontrol.OrchestratorAIOutcome
	nil,                                             // 176: helmsmancontrol.FreezeRequest.SegmentUrlsEntry
	nil,                                             // 177: helmsmancontrol.NodeLifecycleUpdate.StreamsEntry
	nil,                                             // 178: helmsmancontrol.ProcessMeterQuantity.DimensionsEntry
	nil,                                             // 179: helmsmancontrol.StreamProcess.ExtraEntry
	nil,                                             // 180: helmsmancontrol.ConfigSeedApplyResult.BundleVersionsEntry
	nil,                                             // 181: helmsmancontrol.ProcessingJobRequest.ParamsEntry
	nil,                                             // 182: helmsmancontrol.ProcessingJobResult.OutputsEntry
	(*ThumbnailUploadResponse_PresignedUpload)(nil), // 183: helmsmancontrol.ThumbnailUploadResponse.PresignedUpload
	(*timestamppb.Timestamp)(nil),                   // 184: google.protobuf.Timestamp
	(*common.SignupAttribution)(nil),                // 185: common.SignupAttribution
	(*structpb.Struct)(nil),                         // 186: google.protobuf.Struct
	(*common.EdgeTelemetryConfig)(nil),              // 187: common.EdgeTelemetryConfig
	(*emptypb.Empty)(nil),                           // 188: google.protobuf.Empty
}
var file_ipc_proto_depIdxs = []int32{
	184, // 0: helmsmancontrol.ServiceEvent.timestamp:type_name -> google.protobuf.Timestamp
	160, // 1: helmsmancontrol.ServiceEvent.api_request_batch:type_name -> helmsmancontrol.APIRequestBatch
	...
	132, // 8: helmsmancontrol.ServiceEvent.support_event:type_name -> helmsmancontrol.MessageLifecycleData
	...
	185, // 12: helmsmancontrol.TenantEvent.attribution:type_name -> common.SignupAttribution
	0,   // 13: helmsmancontrol.ClusterEvent.reject_reason_code:type_name -> helmsmancontrol.ClusterRejectReason
	186, // 14: helmsmancontrol.ClusterEvent.before_state:type_name -> google.protobuf.Struct
	186, // 15: helmsmancontrol.ClusterEvent.after_state:type_name -> google.protobuf.Struct
	...
	184, // 18: helmsmancontrol.ControlMessage.sent_at:type_name -> google.protobuf.Timestamp
	56,  // 19: helmsmancontrol.ControlMessage.register:type_name -> helmsmancontrol.Register
	60,  // 20: helmsmancontrol.ControlMessage.error:type_name -> helmsmancontrol.ControlError
	61,  // 21: helmsmancontrol.ControlMessage.heartbeat:type_name -> helmsmancontrol.Heartbeat
	70,  // 22: helmsmancontrol.ControlMessage.dvr_start_request:type_name -> helmsmancontrol.DVRStartRequest
	72,  // 23: helmsmancontrol.ControlMessage.dvr_progress:type_name -> helmsmancontrol.DVRProgress
	73,  // 24: helmsmancontrol.ControlMessage.dvr_stopped:type_name -> helmsmancontrol.DVRStopped
	74,  // 25: helmsmancontrol.ControlMessage.dvr_stop_request:type_name -> helmsmancontrol.DVRStopRequest
	62,  // 26: helmsmancontrol.ControlMessage.mist_trigger:type_name -> helmsmancontrol.MistTrigger
	64,  // 27: helmsmancontrol.ControlMessage.mist_trigger_response:type_name -> helmsmancontrol.MistTriggerResponse
	65,  // 28: helmsmancontrol.ControlMessage.mist_trigger_ack:type_name -> helmsmancontrol.MistTriggerAck
	148, // 29: helmsmancontrol.ControlMessage.config_seed:type_name -> helmsmancontrol.ConfigSeed
	149, // 30: helmsmancontrol.ControlMessage.balancer_capability_update:type_name -> helmsmancontrol.BalancerCapabilityUpdate
	150, // 31: helmsmancontrol.ControlMessage.config_seed_apply_result:type_name -> helmsmancontrol.ConfigSeedApplyResult
	55,  // 32: helmsmancontrol.ControlMessage.artifact_deleted:type_name -> helmsmancontrol.ArtifactDeleted
	85,  // 33: helmsmancontrol.ControlMessage.clip_delete:type_name -> helmsmancontrol.ClipDeleteRequest
	86,  // 34: helmsmancontrol.ControlMessage.dvr_delete:type_name -> helmsmancontrol.DVRDeleteRequest
	87,  // 35: helmsmancontrol.ControlMessage.vod_delete:type_name -> helmsmancontrol.VodDeleteRequest
	88,  // 36: helmsmancontrol.ControlMessage.freeze_permission_request:type_name -> helmsmancontrol.FreezePermissionRequest
	89,  // 37: helmsmancontrol.ControlMessage.freeze_permission_response:type_name -> helmsmancontrol.FreezePermissionResponse
	91,  // 38: helmsmancontrol.ControlMessage.freeze_progress:type_name -> helmsmancontrol.FreezeProgress
	93,  // 39: helmsmancontrol.ControlMessage.can_delete_request:type_name -> helmsmancontrol.CanDeleteRequest
	94,  // 40: helmsmancontrol.ControlMessage.can_delete_response:type_name -> helmsmancontrol.CanDeleteResponse
	99,  // 41: helmsmancontrol.ControlMessage.sync_complete:type_name -> helmsmancontrol.SyncComplete
	100, // 42: helmsmancontrol.ControlMessage.dtsh_sync_request:type_name -> helmsmancontrol.DtshSyncRequest
	90,  // 43: helmsmancontrol.ControlMessage.freeze_request:type_name -> helmsmancontrol.FreezeRequest
	153, // 44: helmsmancontrol.ControlMessage.transcode_job_request:type_name -> helmsmancontrol.TranscodeJobRequest
	154, // 45: helmsmancontrol.ControlMessage.transcode_job_progress:type_name -> helmsmancontrol.TranscodeJobProgress
	155, // 46: helmsmancontrol.ControlMessage.transcode_job_complete:type_name -> helmsmancontrol.TranscodeJobComplete
	156, // 47: helmsmancontrol.ControlMessage.processing_job_request:type_name -> helmsmancontrol.ProcessingJobRequest
	158, // 48: helmsmancontrol.ControlMessage.processing_job_result:type_name -> helmsmancontrol.ProcessingJobResult
	159, // 49: helmsmancontrol.ControlMessage.processing_job_progress:type_name -> helmsmancontrol.ProcessingJobProgress
	46,  // 50: helmsmancontrol.ControlMessage.stop_sessions_request:type_name -> helmsmancontrol.StopSessionsRequest
	47,  // 51: helmsmancontrol.ControlMessage.invalidate_sessions_request:type_name -> helmsmancontrol.InvalidateSessionsRequest
	40,  // 52: helmsmancontrol.ControlMessage.mode_change_request:type_name -> helmsmancontrol.ModeChangeRequest
	48,  // 53: helmsmancontrol.ControlMessage.activate_push_targets:type_name -> helmsmancontrol.ActivatePushTargets
	50,  // 54: helmsmancontrol.ControlMessage.deactivate_push_targets:type_name -> helmsmancontrol.DeactivatePushTargets
	54,  // 55: helmsmancontrol.ControlMessage.push_target_status:type_name -> helmsmancontrol.PushTargetStatusReport
	162, // 56: helmsmancontrol.ControlMessage.validate_edge_token_request:type_name -> helmsmancontrol.ValidateEdgeTokenRequest
	163, // 57: helmsmancontrol.ControlMessage.validate_edge_token_response:type_name -> helmsmancontrol.ValidateEdgeTokenResponse
	164, // 58: helmsmancontrol.ControlMessage.edge_mist_admin_session_request:type_name -> helmsmancontrol.EdgeMistAdminSessionRequest
	165, // 59: helmsmancontrol.ControlMessage.edge_mist_admin_session_response:type_name -> helmsmancontrol.EdgeMistAdminSessionResponse
	166, // 60: helmsmancontrol.ControlMessage.thumbnail_upload_request:type_name -> helmsmancontrol.ThumbnailUploadRequest
	167, // 61: helmsmancontrol.ControlMessage.thumbnail_upload_response:type_name -> helmsmancontrol.ThumbnailUploadResponse
	168, // 62: helmsmancontrol.ControlMessage.thumbnail_uploaded:type_name -> helmsmancontrol.ThumbnailUploaded
	43,  // 63: helmsmancontrol.ControlMessage.desired_state_update:type_name -> helmsmancontrol.DesiredStateUpdate
	45,  // 64: helmsmancontrol.ControlMessage.update_apply_result:type_name -> helmsmancontrol.UpdateApplyResult
	75,  // 65: helmsmancontrol.ControlMessage.record_dvr_segment_request:type_name -> helmsmancontrol.RecordDVRSegmentRequest
	76,  // 66: helmsmancontrol.ControlMessage.record_dvr_segment_response:type_name -> helmsmancontrol.RecordDVRSegmentResponse
	77,  // 67: helmsmancontrol.ControlMessage.mark_dvr_segment_uploaded:type_name -> helmsmancontrol.MarkDVRSegmentUploaded
	78,  // 68: helmsmancontrol.ControlMessage.dvr_segment_dropped:type_name -> helmsmancontrol.DVRSegmentDropped
	79,  // 69: helmsmancontrol.ControlMessage.evictable_segments_request:type_name -> helmsmancontrol.EvictableSegmentsRequest
	80,  // 70: helmsmancontrol.ControlMessage.evictable_segments_response:type_name -> helmsmancontrol.EvictableSegmentsResponse
	81,  // 71: helmsmancontrol.ControlMessage.retry_dvr_segment_upload:type_name -> helmsmancontrol.RetryDVRSegmentUpload
	82,  // 72: helmsmancontrol.ControlMessage.reclaim_dvr_segment:type_name -> helmsmancontrol.ReclaimDVRSegment
	83,  // 73: helmsmancontrol.ControlMessage.restore_local_segment_index_request:type_name -> helmsmancontrol.RestoreLocalSegmentIndexRequest
	84,  // 74: helmsmancontrol.ControlMessage.restore_local_segment_index_response:type_name -> helmsmancontrol.RestoreLocalSegmentIndexResponse
	95,  // 75: helmsmancontrol.ControlMessage.relay_resolve_request:type_name -> helmsmancontrol.RelayResolveRequest
	96,  // 76: helmsmancontrol.ControlMessage.relay_resolve_response:type_name -> helmsmancontrol.RelayResolveResponse
	34,  // 77: helmsmancontrol.ControlMessage.apply_managed_stream:type_name -> helmsmancontrol.ApplyManagedStream
	36,  // 78: helmsmancontrol.ControlMessage.retract_managed_stream:type_name -> helmsmancontrol.RetractManagedStream
	38,  // 79: helmsmancontrol.ControlMessage.drain_stream_request:type_name -> helmsmancontrol.DrainStreamRequest
	39,  // 80: helmsmancontrol.ControlMessage.drain_stream_response:type_name -> helmsmancontrol.DrainStreamResponse
	97,  // 81: helmsmancontrol.ControlMessage.authorize_relay_pull_request:type_name -> helmsmancontrol.AuthorizeRelayPullRequest
	98,  // 82: helmsmancontrol.ControlMessage.authorize_relay_pull_response:type_name -> helmsmancontrol.AuthorizeRelayPullResponse
	52,  // 83: helmsmancontrol.ControlMessage.activate_push_targets_result:type_name -> helmsmancontrol.ActivatePushTargetsResult
	51,  // 84: helmsmancontrol.ControlMessage.deactivate_push_targets_result:type_name -> helmsmancontrol.DeactivatePushTargetsResult
	35,  // 85: helmsmancontrol.ApplyManagedStream.placement_admission:type_name -> helmsmancontrol.ManagedStreamAdmission
	184, // 86: helmsmancontrol.ManagedStreamAdmission.issued_at:type_name -> google.protobuf.Timestamp
	184, // 87: helmsmancontrol.ManagedStreamAdmission.expires_at:type_name -> google.protobuf.Timestamp
	37,  // 88: helmsmancontrol.RetractManagedStream.placement_retraction:type_name -> helmsmancontrol.ManagedStreamRetraction
	184, // 89: helmsmancontrol.ManagedStreamRetraction.issued_at:type_name -> google.protobuf.Timestamp
	184, // 90: helmsmancontrol.ManagedStreamRetraction.expires_at:type_name -> google.protobuf.Timestamp
	8,   // 91: helmsmancontrol.ModeChangeRequest.requested_mode:type_name -> helmsmancontrol.NodeOperationalMode
	42,  // 92: helmsmancontrol.DesiredStateUpdate.components:type_name -> helmsmancontrol.DesiredComponent
	184, // 93: helmsmancontrol.DesiredStateUpdate.cordon_token_expires_at:type_name -> google.protobuf.Timestamp
	44,  // 94: helmsmancontrol.UpdateApplyResult.components:type_name -> helmsmancontrol.ComponentApplyResult
	49,  // 95: helmsmancontrol.ActivatePushTargets.targets:type_name -> helmsmancontrol.PushTargetSpec
	53,  // 96: helmsmancontrol.DeactivatePushTargetsResult.targets:type_name -> helmsmancontrol.PushTargetConvergence
	53,  // 97: helmsmancontrol.ActivatePushTargetsResult.targets:type_name -> helmsmancontrol.PushTargetConvergence
	2,   // 98: helmsmancontrol.PushTargetConvergence.reason:type_name -> helmsmancontrol.RestreamReason
	1,   // 99: helmsmancontrol.PushTargetStatusReport.state:type_name -> helmsmancontrol.RestreamState
	2,   // 100: helmsmancontrol.PushTargetStatusReport.reason:type_name -> helmsmancontrol.RestreamReason
	58,  // 101: helmsmancontrol.Register.fingerprint:type_name -> helmsmancontrol.NodeFingerprint
	8,   // 102: helmsmancontrol.Register.requested_mode:type_name -> helmsmancontrol.NodeOperationalMode
	57,  // 103: helmsmancontrol.Register.applied_managed_streams:type_name -> helmsmancontrol.AppliedManagedStream
	184, // 104: helmsmancontrol.Register.node_identity_proof_issued_at:type_name -> google.protobuf.Timestamp
	35,  // 105: helmsmancontrol.AppliedManagedStream.placement_admission:type_name -> helmsmancontrol.ManagedStreamAdmission
	12,  // 106: helmsmancontrol.ClipPullRequest.source_kind:type_name -> helmsmancontrol.ClipPullRequest.SourceKind
	57,  // 107: helmsmancontrol.Heartbeat.applied_managed_streams:type_name -> helmsmancontrol.AppliedManagedStream
	102, // 108: helmsmancontrol.MistTrigger.push_rewrite:type_name -> helmsmancontrol.PushRewriteTrigger
	104, // 109: helmsmancontrol.MistTrigger.play_rewrite:type_name -> helmsmancontrol.ViewerResolveTrigger
	105, // 110: helmsmancontrol.MistTrigger.stream_source:type_name -> helmsmancontrol.StreamSourceTrigger
	107, // 111: helmsmancontrol.MistTrigger.push_out_start:type_name -> helmsmancontrol.PushOutStartTrigger
	108, // 112: helmsmancontrol.MistTrigger.push_end:type_name -> helmsmancontrol.PushEndTrigger
	110, // 113: helmsmancontrol.MistTrigger.viewer_connect:type_name -> helmsmancontrol.ViewerConnectTrigger
	111, // 114: helmsmancontrol.MistTrigger.viewer_disconnect:type_name -> helmsmancontrol.ViewerDisconnectTrigger
	113, // 115: helmsmancontrol.MistTrigger.stream_buffer:type_name -> helmsmancontrol.StreamBufferTrigger
	114, // 116: helmsmancontrol.MistTrigger.stream_end:type_name -> helmsmancontrol.StreamEndTrigger
	115, // 117: helmsmancontrol.MistTrigger.track_list:type_name -> helmsmancontrol.StreamTrackListTrigger
	117, // 118: helmsmancontrol.MistTrigger.recording_complete:type_name -> helmsmancontrol.RecordingCompleteTrigger
	119, // 119: helmsmancontrol.MistTrigger.stream_lifecycle_update:type_name -> helmsmancontrol.StreamLifecycleUpdate
	122, // 120: helmsmancontrol.MistTrigger.client_lifecycle_update:type_name -> helmsmancontrol.ClientLifecycleUpdate
	127, // 121: helmsmancontrol.MistTrigger.node_lifecycle_update:type_name -> helmsmancontrol.NodeLifecycleUpdate
	128, // 122: helmsmancontrol.MistTrigger.load_balancing_data:type_name -> helmsmancontrol.LoadBalancingData
	129, // 123: helmsmancontrol.MistTrigger.clip_lifecycle_data:type_name -> helmsmancontrol.ClipLifecycleData
	130, // 124: helmsmancontrol.MistTrigger.dvr_lifecycle_data:type_name -> helmsmancontrol.DVRLifecycleData
	66,  // 125: helmsmancontrol.MistTrigger.storage_snapshot:type_name -> helmsmancontrol.StorageSnapshot
	101, // 126: helmsmancontrol.MistTrigger.storage_lifecycle_data:type_name -> helmsmancontrol.StorageLifecycleData
	118, // 127: helmsmancontrol.MistTrigger.recording_segment:type_name -> helmsmancontrol.RecordingSegmentTrigger
	137, // 128: helmsmancontrol.MistTrigger.process_billing:type_name -> helmsmancontrol.ProcessBillingEvent
	131, // 129: helmsmancontrol.MistTrigger.vod_lifecycle_data:type_name -> helmsmancontrol.VodLifecycleData
	160, // 130: helmsmancontrol.MistTrigger.api_request_batch:type_name -> helmsmancontrol.APIRequestBatch
	132, // 131: helmsmancontrol.MistTrigger.message_lifecycle_data:type_name -> helmsmancontrol.MessageLifecycleData
	133, // 132: helmsmancontrol.MistTrigger.federation_event_data:type_name -> helmsmancontrol.FederationEventData
	106, // 133: helmsmancontrol.MistTrigger.stream_process:type_name -> helmsmancontrol.StreamProcessTrigger
	123, // 134: helmsmancontrol.MistTrigger.client_lifecycle_batch:type_name -> helmsmancontrol.ClientLifecycleBatch
	63,  // 135: helmsmancontrol.MistTrigger.raw_mist_webhook:type_name -> helmsmancontrol.RawMistWebhookTrigger
	109, // 136: helmsmancontrol.MistTrigger.push_input_close:type_name -> helmsmancontrol.PushInputCloseTrigger
	125, // 137: helmsmancontrol.MistTrigger.playback_boot_trace:type_name -> helmsmancontrol.PlaybackBootTrace
	126, // 138: helmsmancontrol.MistTrigger.playback_session_qoe:type_name -> helmsmancontrol.PlaybackSessionQoe
	120, // 139: helmsmancontrol.MistTrigger.ingest_runtime_absent:type_name -> helmsmancontrol.IngestRuntimeAbsent
	54,  // 140: helmsmancontrol.MistTrigger.restream_status:type_name -> helmsmancontrol.PushTargetStatusReport
	103, // 141: helmsmancontrol.MistTrigger.connection_play:type_name -> helmsmancontrol.ConnectionPlayTrigger
	5,   // 142: helmsmancontrol.MistTriggerResponse.error_code:type_name -> helmsmancontrol.IngestErrorCode
	3,   // 143: helmsmancontrol.MistTriggerResponse.action:type_name -> helmsmancontrol.MistTriggerAction
	4,   // 144: helmsmancontrol.MistTriggerAck.error_code:type_name -> helmsmancontrol.TriggerAckErrorCode
	134, // 145: helmsmancontrol.StorageSnapshot.capabilities:type_name -> helmsmancontrol.NodeCapabilities
	67,  // 146: helmsmancontrol.StorageSnapshot.usage:type_name -> helmsmancontrol.TenantStorageUsage
	71,  // 147: helmsmancontrol.DVRStartRequest.config:type_name -> helmsmancontrol.DVRConfig
	92,  // 148: helmsmancontrol.RetryDVRSegmentUpload.segments:type_name -> helmsmancontrol.DVRSegmentRef
	92,  // 149: helmsmancontrol.RestoreLocalSegmentIndexResponse.segments:type_name -> helmsmancontrol.DVRSegmentRef
	176, // 150: helmsmancontrol.FreezeRequest.segment_urls:type_name -> helmsmancontrol.FreezeRequest.SegmentUrlsEntry
	13,  // 151: helmsmancontrol.RelayResolveRequest.hint:type_name -> helmsmancontrol.RelayResolveRequest.RelayHint
	7,   // 152: helmsmancontrol.RelayResolveResponse.state:type_name -> helmsmancontrol.AssetState
	14,  // 153: helmsmancontrol.RelayResolveResponse.policy_hint:type_name -> helmsmancontrol.RelayResolveResponse.CacheDecisionHint
	15,  // 154: helmsmancontrol.StorageLifecycleData.action:type_name -> helmsmancontrol.StorageLifecycleData.Action
	16,  // 155: helmsmancontrol.StorageLifecycleData.reason:type_name -> helmsmancontrol.StorageLifecycleData.CacheFailureReason
	22,  // 156: helmsmancontrol.PushRewriteTrigger.publisher_bucket:type_name -> helmsmancontrol.GeoBucket
	22,  // 157: helmsmancontrol.PushRewriteTrigger.node_bucket:type_name -> helmsmancontrol.GeoBucket
	22,  // 158: helmsmancontrol.ViewerResolveTrigger.client_bucket:type_name -> helmsmancontrol.GeoBucket
	22,  // 159: helmsmancontrol.ViewerResolveTrigger.node_bucket:type_name -> helmsmancontrol.GeoBucket
	22,  // 160: helmsmancontrol.ViewerConnectTrigger.client_bucket:type_name -> helmsmancontrol.GeoBucket
	22,  // 161: helmsmancontrol.ViewerConnectTrigger.node_bucket:type_name -> helmsmancontrol.GeoBucket
	22,  // 162: helmsmancontrol.ViewerDisconnectTrigger.client_bucket:type_name -> helmsmancontrol.GeoBucket
	22,  // 163: helmsmancontrol.ViewerDisconnectTrigger.node_bucket:type_name -> helmsmancontrol.GeoBucket
	112, // 164: helmsmancontrol.ViewerDisconnectTrigger.stream_times:type_name -> helmsmancontrol.SessionTimeShare
	112, // 165: helmsmancontrol.ViewerDisconnectTrigger.connector_times:type_name -> helmsmancontrol.SessionTimeShare
	112, // 166: helmsmancontrol.ViewerDisconnectTrigger.host_times:type_name -> helmsmancontrol.SessionTimeShare
	142, // 167: helmsmancontrol.StreamBufferTrigger.tracks:type_name -> helmsmancontrol.StreamTrack
	142, // 168: helmsmancontrol.StreamTrackListTrigger.tracks:type_name -> helmsmancontrol.StreamTrack
	142, // 169: helmsmancontrol.RecordingCompleteTrigger.tracks:type_name -> helmsmancontrol.StreamTrack
	116, // 170: helmsmancontrol.RecordingCompleteTrigger.processing_speed:type_name -> helmsmancontrol.ProcessingSpeedStats
	121, // 171: helmsmancontrol.StreamLifecycleUpdate.process_observation:type_name -> helmsmancontrol.MistStreamProcessObservation
	119, // 172: helmsmancontrol.IngestRuntimeAbsent.lifecycle:type_name -> helmsmancontrol.StreamLifecycleUpdate
	122, // 173: helmsmancontrol.ClientLifecycleBatch.samples:type_name -> helmsmancontrol.ClientLifecycleUpdate
	124, // 174: helmsmancontrol.PlaybackBootTrace.resources:type_name -> helmsmancontrol.PlaybackBootResource
	134, // 175: helmsmancontrol.NodeLifecycleUpdate.capabilities:type_name -> helmsmancontrol.NodeCapabilities
	138, // 176: helmsmancontrol.NodeLifecycleUpdate.storage:type_name -> helmsmancontrol.StorageInfo
	140, // 177: helmsmancontrol.NodeLifecycleUpdate.limits:type_name -> helmsmancontrol.NodeLimits
	177, // 178: helmsmancontrol.NodeLifecycleUpdate.streams:type_name -> helmsmancontrol.NodeLifecycleUpdate.StreamsEntry
	143, // 179: helmsmancontrol.NodeLifecycleUpdate.artifacts:type_name -> helmsmancontrol.StoredArtifact
	41,  // 180: helmsmancontrol.NodeLifecycleUpdate.component_versions:type_name -> helmsmancontrol.EdgeComponentVersion
	8,   // 181: helmsmancontrol.NodeLifecycleUpdate.operational_mode:type_name -> helmsmancontrol.NodeOperationalMode
	22,  // 182: helmsmancontrol.LoadBalancingData.client_bucket:type_name -> helmsmancontrol.GeoBucket
	22,  // 183: helmsmancontrol.LoadBalancingData.node_bucket:type_name -> helmsmancontrol.GeoBucket
	17,  // 184: helmsmancontrol.ClipLifecycleData.stage:type_name -> helmsmancontrol.ClipLifecycleData.Stage
	116, // 185: helmsmancontrol.ClipLifecycleData.processing_speed:type_name -> helmsmancontrol.ProcessingSpeedStats
	18,  // 186: helmsmancontrol.DVRLifecycleData.status:type_name -> helmsmancontrol.DVRLifecycleData.Status
	19,  // 187: helmsmancontrol.VodLifecycleData.status:type_name -> helmsmancontrol.VodLifecycleData.Status
	116, // 188: helmsmancontrol.VodLifecycleData.processing_speed:type_name -> helmsmancontrol.ProcessingSpeedStats
	20,  // 189: helmsmancontrol.MessageLifecycleData.event_type:type_name -> helmsmancontrol.MessageLifecycleData.EventType
	9,   // 190: helmsmancontrol.FederationEventData.event_type:type_name -> helmsmancontrol.FederationEventType
	178, // 191: helmsmancontrol.ProcessMeterQuantity.dimensions:type_name -> helmsmancontrol.ProcessMeterQuantity.DimensionsEntry
	136, // 192: helmsmancontrol.ProcessBillingEvent.meter_quantities:type_name -> helmsmancontrol.ProcessMeterQuantity
	139, // 193: helmsmancontrol.NodeLimits.processing_classes:type_name -> helmsmancontrol.ProcessingClassCapacity
	10,  // 194: helmsmancontrol.StoredArtifact.artifact_type:type_name -> helmsmancontrol.ArtifactEvent.ArtifactType
	21,  // 195: helmsmancontrol.StoredArtifact.role:type_name -> helmsmancontrol.StoredArtifact.Role
	179, // 196: helmsmancontrol.StreamProcess.extra:type_name -> helmsmancontrol.StreamProcess.ExtraEntry
	144, // 197: helmsmancontrol.StreamDef.processes:type_name -> helmsmancontrol.StreamProcess
	145, // 198: helmsmancontrol.StreamTemplate.def:type_name -> helmsmancontrol.StreamDef
	146, // 199: helmsmancontrol.ConfigSeed.templates:type_name -> helmsmancontrol.StreamTemplate
	135, // 200: helmsmancontrol.ConfigSeed.processing:type_name -> helmsmancontrol.ProcessingConfig
	8,   // 201: helmsmancontrol.ConfigSeed.operational_mode:type_name -> helmsmancontrol.NodeOperationalMode
	147, // 202: helmsmancontrol.ConfigSeed.tls:type_name -> helmsmancontrol.TLSCertBundle
	151, // 203: helmsmancontrol.ConfigSeed.site:type_name -> helmsmancontrol.SiteConfig
	187, // 204: helmsmancontrol.ConfigSeed.telemetry:type_name -> common.EdgeTelemetryConfig
	147, // 205: helmsmancontrol.ConfigSeed.tls_bundles:type_name -> helmsmancontrol.TLSCertBundle
	184, // 206: helmsmancontrol.ConfigSeedApplyResult.applied_at:type_name -> google.protobuf.Timestamp
	180, // 207: helmsmancontrol.ConfigSeedApplyResult.bundle_versions:type_name -> helmsmancontrol.ConfigSeedApplyResult.BundleVersionsEntry
	152, // 208: helmsmancontrol.TranscodeJobRequest.profiles:type_name -> helmsmancontrol.TranscodeProfile
	181, // 209: helmsmancontrol.ProcessingJobRequest.params:type_name -> helmsmancontrol.ProcessingJobRequest.ParamsEntry
	157, // 210: helmsmancontrol.ProcessingJobRequest.source_segments:type_name -> helmsmancontrol.DVRChapterSegmentRef
	182, // 211: helmsmancontrol.ProcessingJobResult.outputs:type_name -> helmsmancontrol.ProcessingJobResult.OutputsEntry
	142, // 212: helmsmancontrol.ProcessingJobResult.tracks:type_name -> helmsmancontrol.StreamTrack
	161, // 213: helmsmancontrol.APIRequestBatch.aggregates:type_name -> helmsmancontrol.APIRequestAggregate
	183, // 214: helmsmancontrol.ThumbnailUploadResponse.uploads:type_name -> helmsmancontrol.ThumbnailUploadResponse.PresignedUpload
	184, // 215: helmsmancontrol.GatewayTelemetryEvent.timestamp:type_name -> google.protobuf.Timestamp
	171, // 216: helmsmancontrol.GatewayTelemetryEvent.discovery:type_name -> helmsmancontrol.OrchestratorDiscoveryObserved
	172, // 217: helmsmancontrol.GatewayTelemetryEvent.state:type_name -> helmsmancontrol.OrchestratorStateUpdate
	174, // 218: helmsmancontrol.GatewayTelemetryEvent.transcode:type_name -> helmsmancontrol.OrchestratorTranscodeOutcome
	175, // 219: helmsmancontrol.GatewayTelemetryEvent.ai:type_name -> helmsmancontrol.OrchestratorAIOutcome
	184, // 220: helmsmancontrol.OrchestratorVantageGeo.geo_resolved_at:type_name -> google.protobuf.Timestamp
	170, // 221: helmsmancontrol.OrchestratorDiscoveryObserved.vantage:type_name -> helmsmancontrol.OrchestratorVantageGeo
	170, // 222: helmsmancontrol.OrchestratorStateUpdate.vantage:type_name -> helmsmancontrol.OrchestratorVantageGeo
	173, // 223: helmsmancontrol.OrchestratorStateUpdate.capability_price_entries:type_name -> helmsmancontrol.OrchestratorCapabilityPriceEntry
	141, // 224: helmsmancontrol.NodeLifecycleUpdate.StreamsEntry.value:type_name -> helmsmancontrol.StreamData
	33,  // 225: helmsmancontrol.HelmsmanControl.Connect:input_type -> helmsmancontrol.ControlMessage
	68,  // 226: helmsmancontrol.HelmsmanControl.ResolveClipHash:input_type -> helmsmancontrol.ClipHashRequest
	62,  // 227: helmsmancontrol.DecklogService.SendEvent:input_type -> helmsmancontrol.MistTrigger
	23,  // 228: helmsmancontrol.DecklogService.SendServiceEvent:input_type -> helmsmancontrol.ServiceEvent
	169, // 229: helmsmancontrol.DecklogService.SendGatewayTelemetry:input_type -> helmsmancontrol.GatewayTelemetryEvent
	33,  // 230: helmsmancontrol.HelmsmanControl.Connect:output_type -> helmsmancontrol.ControlMessage
	69,  // 231: helmsmancontrol.HelmsmanControl.ResolveClipHash:output_type -> helmsmancontrol.ClipHashResponse
	188, // 232: helmsmancontrol.DecklogService.SendEvent:output_type -> google.protobuf.Empty
	188, // 233: helmsmancontrol.DecklogService.SendServiceEvent:output_type -> google.protobuf.Empty
	188, // 234: helmsmancontrol.DecklogService.SendGatewayTelemetry:output_type -> google.protobuf.Empty
...
func file_ipc_proto_init() {
	...
	file_ipc_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*ServiceEvent_ArtifactNodeCopyEvent)(nil),
		(*ServiceEvent_IncidentEvent)(nil),
	}
	...
	file_ipc_proto_msgTypes[11].OneofWrappers = []any{
		...
		(*ControlMessage_MistTriggerAck)(nil),
		(*ControlMessage_ConfigSeed)(nil),
		(*ControlMessage_BalancerCapabilityUpdate)(nil),
		(*ControlMessage_ConfigSeedApplyResult)(nil),
		...
		(*ControlMessage_FreezeRequest)(nil),
		(*ControlMessage_TranscodeJobRequest)(nil),
		(*ControlMessage_TranscodeJobProgress)(nil),
		(*ControlMessage_TranscodeJobComplete)(nil),
		(*ControlMessage_ProcessingJobRequest)(nil),
		(*ControlMessage_ProcessingJobResult)(nil),
		(*ControlMessage_ProcessingJobProgress)(nil),
		(*ControlMessage_StopSessionsRequest)(nil),
		(*ControlMessage_InvalidateSessionsRequest)(nil),
		(*ControlMessage_ModeChangeRequest)(nil),
		(*ControlMessage_ActivatePushTargets)(nil),
		(*ControlMessage_DeactivatePushTargets)(nil),
		(*ControlMessage_PushTargetStatus)(nil),
		(*ControlMessage_ValidateEdgeTokenRequest)(nil),
		(*ControlMessage_ValidateEdgeTokenResponse)(nil),
		(*ControlMessage_EdgeMistAdminSessionRequest)(nil),
		(*ControlMessage_EdgeMistAdminSessionResponse)(nil),
		(*ControlMessage_ThumbnailUploadRequest)(nil),
		(*ControlMessage_ThumbnailUploadResponse)(nil),
		(*ControlMessage_ThumbnailUploaded)(nil),
		(*ControlMessage_DesiredStateUpdate)(nil),
		(*ControlMessage_UpdateApplyResult)(nil),
		(*ControlMessage_RecordDvrSegmentRequest)(nil),
		(*ControlMessage_RecordDvrSegmentResponse)(nil),
		(*ControlMessage_MarkDvrSegmentUploaded)(nil),
		(*ControlMessage_DvrSegmentDropped)(nil),
		(*ControlMessage_EvictableSegmentsRequest)(nil),
		(*ControlMessage_EvictableSegmentsResponse)(nil),
		(*ControlMessage_RetryDvrSegmentUpload)(nil),
		(*ControlMessage_ReclaimDvrSegment)(nil),
		(*ControlMessage_RestoreLocalSegmentIndexRequest)(nil),
		(*ControlMessage_RestoreLocalSegmentIndexResponse)(nil),
		(*ControlMessage_RelayResolveRequest)(nil),
		(*ControlMessage_RelayResolveResponse)(nil),
		(*ControlMessage_ApplyManagedStream)(nil),
		(*ControlMessage_RetractManagedStream)(nil),
		(*ControlMessage_DrainStreamRequest)(nil),
		(*ControlMessage_DrainStreamResponse)(nil),
		(*ControlMessage_AuthorizeRelayPullRequest)(nil),
		(*ControlMessage_AuthorizeRelayPullResponse)(nil),
	...
	file_ipc_proto_msgTypes[40].OneofWrappers = []any{
		...
		(*MistTrigger_FederationEventData)(nil),
		(*MistTrigger_StreamProcess)(nil),
		(*MistTrigger_ClientLifecycleBatch)(nil),
		(*MistTrigger_RawMistWebhook)(nil),
		(*MistTrigger_PushInputClose)(nil),
		(*MistTrigger_PlaybackBootTrace)(nil),
		(*MistTrigger_PlaybackSessionQoe)(nil),
	...
	file_ipc_proto_msgTypes[136].OneofWrappers = []any{}
	file_ipc_proto_msgTypes[147].OneofWrappers = []any{
