...
func RegisterStreamAnalyticsServiceServer(s grpc.ServiceRegistrar, srv StreamAnalyticsServiceServer) {
	// If the following call pancis, it indicates UnimplementedStreamAnalyticsServiceServer was
...
func RegisterViewerAnalyticsServiceServer(s grpc.ServiceRegistrar, srv ViewerAnalyticsServiceServer) {
	// If the following call pancis, it indicates UnimplementedViewerAnalyticsServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterTrackAnalyticsServiceServer(s grpc.ServiceRegistrar, srv TrackAnalyticsServiceServer) {
	// If the following call pancis, it indicates UnimplementedTrackAnalyticsServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterConnectionAnalyticsServiceServer(s grpc.ServiceRegistrar, srv ConnectionAnalyticsServiceServer) {
	// If the following call pancis, it indicates UnimplementedConnectionAnalyticsServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterNodeAnalyticsServiceServer(s grpc.ServiceRegistrar, srv NodeAnalyticsServiceServer) {
	// If the following call pancis, it indicates UnimplementedNodeAnalyticsServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedRoutingAnalyticsServiceServer) GetRoutingEfficiency(context.Context, *GetRoutingEfficiencyRequest) (*GetRoutingEfficiencyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRoutingEfficiency not implemented")
}
...
func RegisterRoutingAnalyticsServiceServer(s grpc.ServiceRegistrar, srv RoutingAnalyticsServiceServer) {
	// If the following call pancis, it indicates UnimplementedRoutingAnalyticsServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterPlatformAnalyticsServiceServer(s grpc.ServiceRegistrar, srv PlatformAnalyticsServiceServer) {
	// If the following call pancis, it indicates UnimplementedPlatformAnalyticsServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterClipAnalyticsServiceServer(s grpc.ServiceRegistrar, srv ClipAnalyticsServiceServer) {
	// If the following call pancis, it indicates UnimplementedClipAnalyticsServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedAggregatedAnalyticsServiceServer) GetStreamHealthSummary(context.Context, *GetStreamHealthSummaryRequest) (*GetStreamHealthSummaryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetStreamHealthSummary not implemented")
}
func (UnimplementedAggregatedAnalyticsServiceServer) GetClientQoeSummary(context.Context, *GetClientQoeSummaryRequest) (*GetClientQoeSummaryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetClientQoeSummary not implemented")
}
func (UnimplementedAggregatedAnalyticsServiceServer) GetNetworkUsage(context.Context, *GetNetworkUsageRequest) (*GetNetworkUsageResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetNetworkUsage not implemented")
}
func (UnimplementedAggregatedAnalyticsServiceServer) GetAcquisitionFunnel(context.Context, *GetAcquisitionFunnelRequest) (*GetAcquisitionFunnelResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAcquisitionFunnel not implemented")
}
func (UnimplementedAggregatedAnalyticsServiceServer) GetAcquisitionCohortUsage(context.Context, *GetAcquisitionCohortUsageRequest) (*GetAcquisitionCohortUsageResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAcquisitionCohortUsage not implemented")
}
...
func RegisterAggregatedAnalyticsServiceServer(s grpc.ServiceRegistrar, srv AggregatedAnalyticsServiceServer) {
	// If the following call pancis, it indicates UnimplementedAggregatedAnalyticsServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
