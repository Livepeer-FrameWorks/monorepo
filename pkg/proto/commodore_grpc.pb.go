...
func (UnimplementedStreamServiceServer) GetStreamsBatch(context.Context, *GetStreamsBatchRequest) (*GetStreamsBatchResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetStreamsBatch not implemented")
}
...
func RegisterStreamKeyServiceServer(s grpc.ServiceRegistrar, srv StreamKeyServiceServer) {
	// If the following call pancis, it indicates UnimplementedStreamKeyServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterDVRServiceServer(s grpc.ServiceRegistrar, srv DVRServiceServer) {
	// If the following call pancis, it indicates UnimplementedDVRServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterVodServiceServer(s grpc.ServiceRegistrar, srv VodServiceServer) {
	// If the following call pancis, it indicates UnimplementedVodServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
