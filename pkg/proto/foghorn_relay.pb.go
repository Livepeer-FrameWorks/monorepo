...
func (x *ForwardCommandRequest) GetActivatePushTargets() *ActivatePushTargets {
	if x != nil {
...
func (x *ForwardCommandRequest) GetDeactivatePushTargets() *DeactivatePushTargets {
	if x != nil {
...
func (x *ForwardCommandRequest) GetFreeze() *FreezeRequest {
	if x != nil {
...
func (x *ForwardCommandRequest) GetDesiredStateUpdate() *DesiredStateUpdate {
	if x != nil {
...
func (x *ForwardCommandRequest) GetDrainStream() *DrainStreamRequest {
	if x != nil {
...
func (x *ForwardCommandRequest) GetDvrUpdateSource() *DVRUpdateSourceRequest {
	if x != nil {
...
type ForwardCommandRequest_ActivatePushTargets struct {
	ActivatePushTargets *ActivatePushTargets `protobuf:"bytes,20,opt,name=activate_push_targets,json=activatePushTargets,proto3,oneof"`
}
...
type ForwardCommandRequest_Freeze struct {
	Freeze *FreezeRequest `protobuf:"bytes,23,opt,name=freeze,proto3,oneof"`
}
...
type ForwardCommandRequest_DrainStream struct {
	...
	// right Helmsman.
	DrainStream *DrainStreamRequest `protobuf:"bytes,28,opt,name=drain_stream,json=drainStream,proto3,oneof"`
}
...
type ForwardCommandRequest_DvrUpdateSource struct {
	...
	DvrUpdateSource *DVRUpdateSourceRequest `protobuf:"bytes,29,opt,name=dvr_update_source,json=dvrUpdateSource,proto3,oneof"`
}
