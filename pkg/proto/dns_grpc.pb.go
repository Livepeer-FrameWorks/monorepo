...
func (c *navigatorServiceClient) SyncDNS(ctx context.Context, in *SyncDNSRequest, opts ...grpc.CallOption) (*SyncDNSResponse, error) {
	...
	err := c.cc.Invoke(ctx, NavigatorService_SyncDNS_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *navigatorServiceClient) IssueCertificate(ctx context.Context, in *IssueCertificateRequest, opts ...grpc.CallOption) (*IssueCertificateResponse, error) {
	...
	err := c.cc.Invoke(ctx, NavigatorService_IssueCertificate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *navigatorServiceClient) GetCertificate(ctx context.Context, in *GetCertificateRequest, opts ...grpc.CallOption) (*GetCertificateResponse, error) {
	...
	err := c.cc.Invoke(ctx, NavigatorService_GetCertificate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedNavigatorServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedNavigatorServiceServer) SyncDNS(context.Context, *SyncDNSRequest) (*SyncDNSResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SyncDNS not implemented")
}
