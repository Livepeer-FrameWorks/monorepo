...
type SyncDNSResponse struct {
	...
	Errors  map[string]string `protobuf:"bytes,3,rep,name=errors,proto3" json:"errors,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Map of FQDN to error message
}
...
func file_dns_proto_init() {
	...
	file_dns_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_dns_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_dns_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_dns_proto_msgTypes[4].OneofWrappers = []interface{}{}
	file_dns_proto_msgTypes[5].OneofWrappers = []interface{}{}
	type x struct{}
