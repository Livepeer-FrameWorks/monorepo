...
func (ClipLifecycleData_Stage) EnumDescriptor() ([]byte, []int) {
	return file_ipc_proto_rawDescGZIP(), []int{54, 0}
}
...
type ArtifactDeleted struct {
	...
	Reason        string                 `protobuf:"bytes,3,opt,name=reason,proto3" json:"reason,omitempty"` // "cleanup", "expired", "manual"
...
const file_ipc_proto_rawDesc = "" +
	...
	"clipDelete\x12B\n" +
	"\n" +
	"dvr_delete\x18  \x01(\v2!.helmsmancontrol.DVRDeleteRequestH\x00R\tdvrDelete\x12f\n" +
	...
	"\x16transcode_job_complete\x18> \x01(\v2%.helmsmancontrol.TranscodeJobCompleteH\x00R\x14transcodeJobCompleteB\t\n" +
	"\apayload\"\x9b\x01\n" +
	...
	"\n" +
	"size_bytes\x18\x05 \x01(\x04R\tsizeBytes\"\xa7\x04\n" +
	"\bRegister\x12\x17\n" +
	...
	"\tHeartbeat\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\tR\x06nodeId\"\xc0\x10\n" +
	"\vMistTrigger\x12!\n" +
	...
	"\x12vod_lifecycle_data\x18  \x01(\v2!.helmsmancontrol.VodLifecycleDataH\x00R\x10vodLifecycleDataB\x11\n" +
	"\x0ftrigger_payloadB\f\n" +
	"\n" +
	"_tenant_idB\n" +
	"\n" +
	"\b_user_idJ\x04\b\x14\x10\x15R\x10stream_bandwidth\"f\n" +
	"\x13MistTriggerResponse\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x1a\n" +
	"\bresponse\x18\x02 \x01(\tR\bresponse\x12\x14\n" +
	"\x05abort\x18\x03 \x01(\bR\x05abort\"\xbe\x02\n" +
	...
	"\x05usage\x18\x06 \x03(\v2#.helmsmancontrol.TenantStorageUsageR\x05usageB\f\n" +
	"\n" +
	"_tenant_idB\v\n" +
	"\t_locationB\x0f\n" +
	"\r_capabilities\"\xca\x01\n" +
	...
	"\tvod_bytes\x18\x06 \x01(\x04R\bvodBytes\".\n" +
	...
	"\rinternal_name\x18\x05 \x01(\tH\x01R\finternalName\x88\x01\x01\x12\x1d\n" +
	"\n" +
	"size_bytes\x18\x06 \x01(\x04R\tsizeBytes\x12\x1a\n" +
	"\x06s3_url\x18\a \x01(\tH\x02R\x05s3Url\x88\x01\x01\x12\"\n" +
	"\n" +
	"local_path\x18\b \x01(\tH\x03R\tlocalPath\x88\x01\x01\x12\x1c\n" +
	"\anode_id\x18\t \x01(\tH\x04R\x06nodeId\x88\x01\x01\x12\x19\n" +
	"\x05error\x18\n" +
	" \x01(\tH\x05R\x05error\x88\x01\x01\x12$\n" +
	"\vduration_ms\x18\v \x01(\x03H\x06R\n" +
	"durationMs\x88\x01\x01\x12-\n" +
	"\x10warm_duration_ms\x18\f \x01(\x03H\aR\x0ewarmDurationMs\x88\x01\x01\"\xa1\x01\n" +
	"\x06Action\x12\x16\n" +
	...
	"\x06reason\x18\x05 \x01(\tR\x06reason\"\x9f\a\n" +
	...
	"pushStatus\x12\x1c\n" +
	"\anode_id\x18\a \x01(\tH\x00R\x06nodeId\x88\x01\x01B\n" +
	"\n" +
	"\b_node_id\"\xa4\x05\n" +
	...
	"\x0e_client_bucketB\x0e\n" +
	"\f_node_bucketJ\x04\b\b\x10\t\"\x96\x06\n" +
	...
	"\anode_id\x18\b \x01(\tH\x06R\x06nodeId\x88\x01\x01B\x13\n" +
	...
	"\x1a_primary_audio_sample_rate\"\xe7\x02\n" +
	...
	"\n" +
	"time_ended\x18\x05 \x01(\x03R\ttimeEnded\"\x99\x10\n" +
	...
	"\x0fvideo_jitter_ms\x18% \x01(\rH\x1fR\rvideoJitterMs\x88\x01\x01B\f\n" +
	"\n" +
	"_tenant_idB\x0f\n" +
	"\r_buffer_stateB\x11\n" +
	...
	"\x10client_longitude\x18\x16 \x01(\x01H\x0eR\x0fclientLongitude\x88\x01\x01B\f\n" +
	"\n" +
	"_tenant_idB\r\n" +
	"\v_session_idB\x12\n" +
	...
	"\f_client_cityB\x12\n" +
	"\x10_client_latitudeB\x13\n" +
	"\x11_client_longitudeJ\x04\b\x12\x10\x13\"\xd1\v\n" +
	...
	"\x14connections_outgoing\x18* \x01(\rR\x13connectionsOutgoing\x12-\n" +
	...
	"\n" +
	"latency_ms\x18\x14 \x01(\x02H\bR\tlatencyMs\x88\x01\x01B\x13\n" +
	...
	"\n" +
	"expires_at\x18\x14 \x01(\x03H\x11R\texpiresAt\x88\x01\x01\"\x8e\x01\n" +
	"\x05Stage\x12\x15\n" +
	...
	"\n" +
	"expires_at\x18\f \x01(\x03H\tR\texpiresAt\x88\x01\x01\"\x85\x01\n" +
	"\x06Status\x12\x16\n" +
	...
	"\x12local_input_codecs\x18\x04 \x03(\tR\x10localInputCodecs\"\xd2\x16\n" +
	...
	"\foutput_codec\x18\v \x01(\tH\x02R\voutputCodec\x88\x01\x01\x12\"\n" +
	"\n" +
	"track_type\x18\f \x01(\tH\x03R\ttrackType\x88\x01\x01\x12*\n" +
	"\x0esegment_number\x18\x14 \x01(\x05H\x04R\rsegmentNumber\x88\x01\x01\x12\x19\n" +
	"\x05width\x18\x15 \x01(\x05H\x05R\x05width\x88\x01\x01\x12\x1b\n" +
	"\x06height\x18\x16 \x01(\x05H\x06R\x06height\x88\x01\x01\x12,\n" +
	"\x0frendition_count\x18\x17 \x01(\x05H\aR\x0erenditionCount\x88\x01\x01\x12,\n" +
	"\x0fbroadcaster_url\x18\x18 \x01(\tH\bR\x0ebroadcasterUrl\x88\x01\x01\x12)\n" +
	"\x0eupload_time_us\x18\x19 \x01(\x03H\tR\fuploadTimeUs\x88\x01\x01\x123\n" +
	"\x13livepeer_session_id\x18\x1a \x01(\tH\n" +
	"R\x11livepeerSessionId\x88\x01\x01\x12-\n" +
	"\x10segment_start_ms\x18\x1b \x01(\x03H\vR\x0esegmentStartMs\x88\x01\x01\x12$\n" +
	"\vinput_bytes\x18\x1c \x01(\x03H\fR\n" +
	"inputBytes\x88\x01\x01\x121\n" +
	"\x12output_bytes_total\x18\x1d \x01(\x03H\rR\x10outputBytesTotal\x88\x01\x01\x12(\n" +
	"\rattempt_count\x18( \x01(\x05H\x0eR\fattemptCount\x88\x01\x01\x12(\n" +
	"\rturnaround_ms\x18) \x01(\x03H\x0fR\fturnaroundMs\x88\x01\x01\x12&\n" +
	"\fspeed_factor\x18* \x01(\x01H\x10R\vspeedFactor\x88\x01\x01\x12,\n" +
	"\x0frenditions_json\x18+ \x01(\tH\x11R\x0erenditionsJson\x88\x01\x01\x12&\n" +
	"\finput_frames\x18\x1e \x01(\x03H\x12R\vinputFrames\x88\x01\x01\x12(\n" +
	"\routput_frames\x18\x1f \x01(\x03H\x13R\foutputFrames\x88\x01\x01\x122\n" +
	"\x13decode_us_per_frame\x18  \x01(\x03H\x14R\x10decodeUsPerFrame\x88\x01\x01\x128\n" +
	"\x16transform_us_per_frame\x18! \x01(\x03H\x15R\x13transformUsPerFrame\x88\x01\x01\x122\n" +
	"\x13encode_us_per_frame\x18\" \x01(\x03H\x16R\x10encodeUsPerFrame\x88\x01\x01\x12\x1e\n" +
	"\bis_final\x18# \x01(\bH\x17R\aisFinal\x88\x01\x01\x121\n" +
	"\x12input_frames_delta\x182 \x01(\x03H\x18R\x10inputFramesDelta\x88\x01\x01\x123\n" +
	"\x13output_frames_delta\x183 \x01(\x03H\x19R\x11outputFramesDelta\x88\x01\x01\x12/\n" +
	"\x11input_bytes_delta\x184 \x01(\x03H\x1aR\x0finputBytesDelta\x88\x01\x01\x121\n" +
	"\x12output_bytes_delta\x185 \x01(\x03H\x1bR\x10outputBytesDelta\x88\x01\x01\x12$\n" +
	"\vinput_width\x186 \x01(\x05H\x1cR\n" +
	"inputWidth\x88\x01\x01\x12&\n" +
	"\finput_height\x187 \x01(\x05H\x1dR\vinputHeight\x88\x01\x01\x12&\n" +
	"\foutput_width\x188 \x01(\x05H\x1eR\voutputWidth\x88\x01\x01\x12(\n" +
	"\routput_height\x189 \x01(\x05H\x1fR\foutputHeight\x88\x01\x01\x12\"\n" +
	"\n" +
	...
	"\bhas_dtsh\x18\b \x01(\bR\ahasDtsh\"\x8a\x03\n" +
	...
	"\x1bSTORAGE_LOCATION_DEFROSTING\x10\x042\xba\x01\n" +
...
var file_ipc_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_ipc_proto_msgTypes = make([]protoimpl.MessageInfo, 78)
var file_ipc_proto_goTypes = []any{
	(StorageLocation)(0),             // 0: helmsmancontrol.StorageLocation
	(StorageLifecycleData_Action)(0), // 1: helmsmancontrol.StorageLifecycleData.Action
	(ClipLifecycleData_Stage)(0),     // 2: helmsmancontrol.ClipLifecycleData.Stage
	(DVRLifecycleData_Status)(0),     // 3: helmsmancontrol.DVRLifecycleData.Status
	(VodLifecycleData_Status)(0),     // 4: helmsmancontrol.VodLifecycleData.Status
	(*GeoBucket)(nil),                // 5: helmsmancontrol.GeoBucket
	(*ControlMessage)(nil),           // 6: helmsmancontrol.ControlMessage
	(*ArtifactDeleted)(nil),          // 7: helmsmancontrol.ArtifactDeleted
	(*Register)(nil),                 // 8: helmsmancontrol.Register
	(*NodeFingerprint)(nil),          // 9: helmsmancontrol.NodeFingerprint
	(*ClipPullRequest)(nil),          // 10: helmsmancontrol.ClipPullRequest
	(*ClipProgress)(nil),             // 11: helmsmancontrol.ClipProgress
	(*ClipDone)(nil),                 // 12: helmsmancontrol.ClipDone
	(*ControlError)(nil),             // 13: helmsmancontrol.ControlError
	(*Heartbeat)(nil),                // 14: helmsmancontrol.Heartbeat
	(*MistTrigger)(nil),              // 15: helmsmancontrol.MistTrigger
	(*MistTriggerResponse)(nil),      // 16: helmsmancontrol.MistTriggerResponse
	(*StorageSnapshot)(nil),          // 17: helmsmancontrol.StorageSnapshot
	(*TenantStorageUsage)(nil),       // 18: helmsmancontrol.TenantStorageUsage
	(*ClipHashRequest)(nil),          // 19: helmsmancontrol.ClipHashRequest
	(*ClipHashResponse)(nil),         // 20: helmsmancontrol.ClipHashResponse
	(*DVRStartRequest)(nil),          // 21: helmsmancontrol.DVRStartRequest
	(*DVRConfig)(nil),                // 22: helmsmancontrol.DVRConfig
	(*DVRProgress)(nil),              // 23: helmsmancontrol.DVRProgress
	(*DVRStopped)(nil),               // 24: helmsmancontrol.DVRStopped
	(*DVRStopRequest)(nil),           // 25: helmsmancontrol.DVRStopRequest
	(*ClipDeleteRequest)(nil),        // 26: helmsmancontrol.ClipDeleteRequest
	(*DVRDeleteRequest)(nil),         // 27: helmsmancontrol.DVRDeleteRequest
	(*FreezePermissionRequest)(nil),  // 28: helmsmancontrol.FreezePermissionRequest
	(*FreezePermissionResponse)(nil), // 29: helmsmancontrol.FreezePermissionResponse
	(*FreezeRequest)(nil),            // 30: helmsmancontrol.FreezeRequest
	(*FreezeProgress)(nil),           // 31: helmsmancontrol.FreezeProgress
	(*FreezeComplete)(nil),           // 32: helmsmancontrol.FreezeComplete
	(*DefrostRequest)(nil),           // 33: helmsmancontrol.DefrostRequest
	(*DefrostProgress)(nil),          // 34: helmsmancontrol.DefrostProgress
	(*DefrostComplete)(nil),          // 35: helmsmancontrol.DefrostComplete
	(*CanDeleteRequest)(nil),         // 36: helmsmancontrol.CanDeleteRequest
	(*CanDeleteResponse)(nil),        // 37: helmsmancontrol.CanDeleteResponse
	(*SyncComplete)(nil),             // 38: helmsmancontrol.SyncComplete
	(*DtshSyncRequest)(nil),          // 39: helmsmancontrol.DtshSyncRequest
	(*StorageLifecycleData)(nil),     // 40: helmsmancontrol.StorageLifecycleData
	(*DVRReadyRequest)(nil),          // 41: helmsmancontrol.DVRReadyRequest
	(*DVRReadyResponse)(nil),         // 42: helmsmancontrol.DVRReadyResponse
	(*PushRewriteTrigger)(nil),       // 43: helmsmancontrol.PushRewriteTrigger
	(*ViewerResolveTrigger)(nil),     // 44: helmsmancontrol.ViewerResolveTrigger
	(*StreamSourceTrigger)(nil),      // 45: helmsmancontrol.StreamSourceTrigger
	(*PushOutStartTrigger)(nil),      // 46: helmsmancontrol.PushOutStartTrigger
	(*PushEndTrigger)(nil),           // 47: helmsmancontrol.PushEndTrigger
	(*ViewerConnectTrigger)(nil),     // 48: helmsmancontrol.ViewerConnectTrigger
	(*ViewerDisconnectTrigger)(nil),  // 49: helmsmancontrol.ViewerDisconnectTrigger
	(*StreamBufferTrigger)(nil),      // 50: helmsmancontrol.StreamBufferTrigger
	(*StreamEndTrigger)(nil),         // 51: helmsmancontrol.StreamEndTrigger
	(*StreamTrackListTrigger)(nil),   // 52: helmsmancontrol.StreamTrackListTrigger
	(*RecordingCompleteTrigger)(nil), // 53: helmsmancontrol.RecordingCompleteTrigger
	(*RecordingSegmentTrigger)(nil),  // 54: helmsmancontrol.RecordingSegmentTrigger
	(*StreamLifecycleUpdate)(nil),    // 55: helmsmancontrol.StreamLifecycleUpdate
	(*ClientLifecycleUpdate)(nil),    // 56: helmsmancontrol.ClientLifecycleUpdate
	(*NodeLifecycleUpdate)(nil),      // 57: helmsmancontrol.NodeLifecycleUpdate
	(*LoadBalancingData)(nil),        // 58: helmsmancontrol.LoadBalancingData
	(*ClipLifecycleData)(nil),        // 59: helmsmancontrol.ClipLifecycleData
	(*DVRLifecycleData)(nil),         // 60: helmsmancontrol.DVRLifecycleData
	(*VodLifecycleData)(nil),         // 61: helmsmancontrol.VodLifecycleData
	(*NodeCapabilities)(nil),         // 62: helmsmancontrol.NodeCapabilities
	(*ProcessingConfig)(nil),         // 63: helmsmancontrol.ProcessingConfig
	(*ProcessBillingEvent)(nil),      // 64: helmsmancontrol.ProcessBillingEvent
	(*StorageInfo)(nil),              // 65: helmsmancontrol.StorageInfo
	(*NodeLimits)(nil),               // 66: helmsmancontrol.NodeLimits
	(*StreamData)(nil),               // 67: helmsmancontrol.StreamData
	(*StreamTrack)(nil),              // 68: helmsmancontrol.StreamTrack
	(*StoredArtifact)(nil),           // 69: helmsmancontrol.StoredArtifact
	(*StreamProcess)(nil),            // 70: helmsmancontrol.StreamProcess
	(*StreamDef)(nil),                // 71: helmsmancontrol.StreamDef
	(*StreamTemplate)(nil),           // 72: helmsmancontrol.StreamTemplate
	(*ConfigSeed)(nil),               // 73: helmsmancontrol.ConfigSeed
	(*TranscodeProfile)(nil),         // 74: helmsmancontrol.TranscodeProfile
	(*TranscodeJobRequest)(nil),      // 75: helmsmancontrol.TranscodeJobRequest
	(*TranscodeJobProgress)(nil),     // 76: helmsmancontrol.TranscodeJobProgress
	(*TranscodeJobComplete)(nil),     // 77: helmsmancontrol.TranscodeJobComplete
	nil,                              // 78: helmsmancontrol.FreezePermissionResponse.SegmentUrlsEntry
	nil,                              // 79: helmsmancontrol.DefrostRequest.SegmentUrlsEntry
	nil,                              // 80: helmsmancontrol.DtshSyncRequest.DtshUrlsEntry
	nil,                              // 81: helmsmancontrol.NodeLifecycleUpdate.StreamsEntry
	nil,                              // 82: helmsmancontrol.StreamProcess.ExtraEntry
...
var file_ipc_proto_depIdxs = []int32{
	83, // 0: helmsmancontrol.ControlMessage.sent_at:type_name -> google.protobuf.Timestamp
	8,  // 1: helmsmancontrol.ControlMessage.register:type_name -> helmsmancontrol.Register
	10, // 2: helmsmancontrol.ControlMessage.clip_pull_request:type_name -> helmsmancontrol.ClipPullRequest
	11, // 3: helmsmancontrol.ControlMessage.clip_progress:type_name -> helmsmancontrol.ClipProgress
	12, // 4: helmsmancontrol.ControlMessage.clip_done:type_name -> helmsmancontrol.ClipDone
	13, // 5: helmsmancontrol.ControlMessage.error:type_name -> helmsmancontrol.ControlError
	14, // 6: helmsmancontrol.ControlMessage.heartbeat:type_name -> helmsmancontrol.Heartbeat
	21, // 7: helmsmancontrol.ControlMessage.dvr_start_request:type_name -> helmsmancontrol.DVRStartRequest
	23, // 8: helmsmancontrol.ControlMessage.dvr_progress:type_name -> helmsmancontrol.DVRProgress
	24, // 9: helmsmancontrol.ControlMessage.dvr_stopped:type_name -> helmsmancontrol.DVRStopped
	25, // 10: helmsmancontrol.ControlMessage.dvr_stop_request:type_name -> helmsmancontrol.DVRStopRequest
	41, // 11: helmsmancontrol.ControlMessage.dvr_ready_request:type_name -> helmsmancontrol.DVRReadyRequest
	42, // 12: helmsmancontrol.ControlMessage.dvr_ready_response:type_name -> helmsmancontrol.DVRReadyResponse
	15, // 13: helmsmancontrol.ControlMessage.mist_trigger:type_name -> helmsmancontrol.MistTrigger
	16, // 14: helmsmancontrol.ControlMessage.mist_trigger_response:type_name -> helmsmancontrol.MistTriggerResponse
	73, // 15: helmsmancontrol.ControlMessage.config_seed:type_name -> helmsmancontrol.ConfigSeed
	7,  // 16: helmsmancontrol.ControlMessage.artifact_deleted:type_name -> helmsmancontrol.ArtifactDeleted
	26, // 17: helmsmancontrol.ControlMessage.clip_delete:type_name -> helmsmancontrol.ClipDeleteRequest
	27, // 18: helmsmancontrol.ControlMessage.dvr_delete:type_name -> helmsmancontrol.DVRDeleteRequest
	28, // 19: helmsmancontrol.ControlMessage.freeze_permission_request:type_name -> helmsmancontrol.FreezePermissionRequest
	29, // 20: helmsmancontrol.ControlMessage.freeze_permission_response:type_name -> helmsmancontrol.FreezePermissionResponse
	31, // 21: helmsmancontrol.ControlMessage.freeze_progress:type_name -> helmsmancontrol.FreezeProgress
	32, // 22: helmsmancontrol.ControlMessage.freeze_complete:type_name -> helmsmancontrol.FreezeComplete
	33, // 23: helmsmancontrol.ControlMessage.defrost_request:type_name -> helmsmancontrol.DefrostRequest
	34, // 24: helmsmancontrol.ControlMessage.defrost_progress:type_name -> helmsmancontrol.DefrostProgress
	35, // 25: helmsmancontrol.ControlMessage.defrost_complete:type_name -> helmsmancontrol.DefrostComplete
	36, // 26: helmsmancontrol.ControlMessage.can_delete_request:type_name -> helmsmancontrol.CanDeleteRequest
	37, // 27: helmsmancontrol.ControlMessage.can_delete_response:type_name -> helmsmancontrol.CanDeleteResponse
	38, // 28: helmsmancontrol.ControlMessage.sync_complete:type_name -> helmsmancontrol.SyncComplete
	39, // 29: helmsmancontrol.ControlMessage.dtsh_sync_request:type_name -> helmsmancontrol.DtshSyncRequest
	75, // 30: helmsmancontrol.ControlMessage.transcode_job_request:type_name -> helmsmancontrol.TranscodeJobRequest
	76, // 31: helmsmancontrol.ControlMessage.transcode_job_progress:type_name -> helmsmancontrol.TranscodeJobProgress
	77, // 32: helmsmancontrol.ControlMessage.transcode_job_complete:type_name -> helmsmancontrol.TranscodeJobComplete
	9,  // 33: helmsmancontrol.Register.fingerprint:type_name -> helmsmancontrol.NodeFingerprint
	43, // 34: helmsmancontrol.MistTrigger.push_rewrite:type_name -> helmsmancontrol.PushRewriteTrigger
	44, // 35: helmsmancontrol.MistTrigger.play_rewrite:type_name -> helmsmancontrol.ViewerResolveTrigger
	45, // 36: helmsmancontrol.MistTrigger.stream_source:type_name -> helmsmancontrol.StreamSourceTrigger
	46, // 37: helmsmancontrol.MistTrigger.push_out_start:type_name -> helmsmancontrol.PushOutStartTrigger
	47, // 38: helmsmancontrol.MistTrigger.push_end:type_name -> helmsmancontrol.PushEndTrigger
	48, // 39: helmsmancontrol.MistTrigger.viewer_connect:type_name -> helmsmancontrol.ViewerConnectTrigger
	49, // 40: helmsmancontrol.MistTrigger.viewer_disconnect:type_name -> helmsmancontrol.ViewerDisconnectTrigger
	50, // 41: helmsmancontrol.MistTrigger.stream_buffer:type_name -> helmsmancontrol.StreamBufferTrigger
	51, // 42: helmsmancontrol.MistTrigger.stream_end:type_name -> helmsmancontrol.StreamEndTrigger
	52, // 43: helmsmancontrol.MistTrigger.track_list:type_name -> helmsmancontrol.StreamTrackListTrigger
	53, // 44: helmsmancontrol.MistTrigger.recording_complete:type_name -> helmsmancontrol.RecordingCompleteTrigger
	55, // 45: helmsmancontrol.MistTrigger.stream_lifecycle_update:type_name -> helmsmancontrol.StreamLifecycleUpdate
	56, // 46: helmsmancontrol.MistTrigger.client_lifecycle_update:type_name -> helmsmancontrol.ClientLifecycleUpdate
	57, // 47: helmsmancontrol.MistTrigger.node_lifecycle_update:type_name -> helmsmancontrol.NodeLifecycleUpdate
	58, // 48: helmsmancontrol.MistTrigger.load_balancing_data:type_name -> helmsmancontrol.LoadBalancingData
	59, // 49: helmsmancontrol.MistTrigger.clip_lifecycle_data:type_name -> helmsmancontrol.ClipLifecycleData
	60, // 50: helmsmancontrol.MistTrigger.dvr_lifecycle_data:type_name -> helmsmancontrol.DVRLifecycleData
	17, // 51: helmsmancontrol.MistTrigger.storage_snapshot:type_name -> helmsmancontrol.StorageSnapshot
	40, // 52: helmsmancontrol.MistTrigger.storage_lifecycle_data:type_name -> helmsmancontrol.StorageLifecycleData
	54, // 53: helmsmancontrol.MistTrigger.recording_segment:type_name -> helmsmancontrol.RecordingSegmentTrigger
	64, // 54: helmsmancontrol.MistTrigger.process_billing:type_name -> helmsmancontrol.ProcessBillingEvent
	61, // 55: helmsmancontrol.MistTrigger.vod_lifecycle_data:type_name -> helmsmancontrol.VodLifecycleData
	62, // 56: helmsmancontrol.StorageSnapshot.capabilities:type_name -> helmsmancontrol.NodeCapabilities
	18, // 57: helmsmancontrol.StorageSnapshot.usage:type_name -> helmsmancontrol.TenantStorageUsage
	22, // 58: helmsmancontrol.DVRStartRequest.config:type_name -> helmsmancontrol.DVRConfig
	78, // 59: helmsmancontrol.FreezePermissionResponse.segment_urls:type_name -> helmsmancontrol.FreezePermissionResponse.SegmentUrlsEntry
	79, // 60: helmsmancontrol.DefrostRequest.segment_urls:type_name -> helmsmancontrol.DefrostRequest.SegmentUrlsEntry
	80, // 61: helmsmancontrol.DtshSyncRequest.dtsh_urls:type_name -> helmsmancontrol.DtshSyncRequest.DtshUrlsEntry
	1,  // 62: helmsmancontrol.StorageLifecycleData.action:type_name -> helmsmancontrol.StorageLifecycleData.Action
	22, // 63: helmsmancontrol.DVRReadyResponse.config:type_name -> helmsmancontrol.DVRConfig
	5,  // 64: helmsmancontrol.PushRewriteTrigger.publisher_bucket:type_name -> helmsmancontrol.GeoBucket
	5,  // 65: helmsmancontrol.PushRewriteTrigger.node_bucket:type_name -> helmsmancontrol.GeoBucket
	5,  // 66: helmsmancontrol.ViewerResolveTrigger.client_bucket:type_name -> helmsmancontrol.GeoBucket
	5,  // 67: helmsmancontrol.ViewerResolveTrigger.node_bucket:type_name -> helmsmancontrol.GeoBucket
	5,  // 68: helmsmancontrol.ViewerConnectTrigger.client_bucket:type_name -> helmsmancontrol.GeoBucket
	5,  // 69: helmsmancontrol.ViewerConnectTrigger.node_bucket:type_name -> helmsmancontrol.GeoBucket
	5,  // 70: helmsmancontrol.ViewerDisconnectTrigger.client_bucket:type_name -> helmsmancontrol.GeoBucket
	5,  // 71: helmsmancontrol.ViewerDisconnectTrigger.node_bucket:type_name -> helmsmancontrol.GeoBucket
	68, // 72: helmsmancontrol.StreamBufferTrigger.tracks:type_name -> helmsmancontrol.StreamTrack
	68, // 73: helmsmancontrol.StreamTrackListTrigger.tracks:type_name -> helmsmancontrol.StreamTrack
	62, // 74: helmsmancontrol.NodeLifecycleUpdate.capabilities:type_name -> helmsmancontrol.NodeCapabilities
	65, // 75: helmsmancontrol.NodeLifecycleUpdate.storage:type_name -> helmsmancontrol.StorageInfo
	66, // 76: helmsmancontrol.NodeLifecycleUpdate.limits:type_name -> helmsmancontrol.NodeLimits
	81, // 77: helmsmancontrol.NodeLifecycleUpdate.streams:type_name -> helmsmancontrol.NodeLifecycleUpdate.StreamsEntry
	69, // 78: helmsmancontrol.NodeLifecycleUpdate.artifacts:type_name -> helmsmancontrol.StoredArtifact
	5,  // 79: helmsmancontrol.LoadBalancingData.client_bucket:type_name -> helmsmancontrol.GeoBucket
	5,  // 80: helmsmancontrol.LoadBalancingData.node_bucket:type_name -> helmsmancontrol.GeoBucket
	2,  // 81: helmsmancontrol.ClipLifecycleData.stage:type_name -> helmsmancontrol.ClipLifecycleData.Stage
	3,  // 82: helmsmancontrol.DVRLifecycleData.status:type_name -> helmsmancontrol.DVRLifecycleData.Status
	4,  // 83: helmsmancontrol.VodLifecycleData.status:type_name -> helmsmancontrol.VodLifecycleData.Status
	82, // 84: helmsmancontrol.StreamProcess.extra:type_name -> helmsmancontrol.StreamProcess.ExtraEntry
	70, // 85: helmsmancontrol.StreamDef.processes:type_name -> helmsmancontrol.StreamProcess
	71, // 86: helmsmancontrol.StreamTemplate.def:type_name -> helmsmancontrol.StreamDef
	72, // 87: helmsmancontrol.ConfigSeed.templates:type_name -> helmsmancontrol.StreamTemplate
	63, // 88: helmsmancontrol.ConfigSeed.processing:type_name -> helmsmancontrol.ProcessingConfig
	74, // 89: helmsmancontrol.TranscodeJobRequest.profiles:type_name -> helmsmancontrol.TranscodeProfile
	67, // 90: helmsmancontrol.NodeLifecycleUpdate.StreamsEntry.value:type_name -> helmsmancontrol.StreamData
	6,  // 91: helmsmancontrol.HelmsmanControl.Connect:input_type -> helmsmancontrol.ControlMessage
	19, // 92: helmsmancontrol.HelmsmanControl.ResolveClipHash:input_type -> helmsmancontrol.ClipHashRequest
	15, // 93: helmsmancontrol.DecklogService.SendEvent:input_type -> helmsmancontrol.MistTrigger
	6,  // 94: helmsmancontrol.HelmsmanControl.Connect:output_type -> helmsmancontrol.ControlMessage
	20, // 95: helmsmancontrol.HelmsmanControl.ResolveClipHash:output_type -> helmsmancontrol.ClipHashResponse
	84, // 96: helmsmancontrol.DecklogService.SendEvent:output_type -> google.protobuf.Empty
