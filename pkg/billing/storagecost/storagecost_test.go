...
func TestProject(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			pricing:  &purserpb.StoragePricing{UnitPricePerGibMonth: 0.035, Currency: "EUR"},
			bytes:    0,
			wantCurr: "EUR",
		},
		{
			name:     "zero unit price returns zero (free meter)",
			pricing:  &purserpb.StoragePricing{UnitPricePerGibMonth: 0, Currency: "EUR"},
			bytes:    5_000_000_000,
			wantCurr: "EUR",
		},
		{
			name:     "1 GiB @ 0.035/GiB-month",
			pricing:  &purserpb.StoragePricing{UnitPricePerGibMonth: 0.035, Currency: "EUR"},
			bytes:    1024 * 1024 * 1024,
			wantMo:   0.035,
			wantDay:  0.035 * 24 / 730,
			wantCurr: "EUR",
		},
		{
			name:     "100 MiB @ 0.035/GiB-month",
			pricing:  &purserpb.StoragePricing{UnitPricePerGibMonth: 0.035, Currency: "EUR"},
			bytes:    100 * 1024 * 1024,
			wantMo:   (100.0 / 1024.0) * 0.035,
			wantDay:  (100.0 / 1024.0) * 0.035 * 24 / 730,
			wantCurr: "EUR",
		},
	}
