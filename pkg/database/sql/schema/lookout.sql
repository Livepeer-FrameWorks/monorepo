...
-- Operator activity is deliberately separate from incident delivery: these
-- rows announce committed product, billing, support, and marketing facts but
-- do not create incidents or incident timeline events.
