...
type InfrastructureCluster struct {
	...
	MeteredRateConfig map[string]any `json:"metered_rate_config,omitempty" db:"metered_rate_config"`
...
type ClusterService struct {
	...
	ConfigBlob      map[string]any `json:"config_blob,omitempty" db:"config_blob"`
	EnvironmentVars map[string]any `json:"environment_vars,omitempty" db:"environment_vars"`
...
type ClusterInvite struct {
	...
	ResourceLimits    map[string]any `json:"resource_limits,omitempty" db:"resource_limits"`
