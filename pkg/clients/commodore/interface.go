...
type Interface interface {
	...
	MintChapterPlaybackID(ctx context.Context, chapterID, tenantID, artifactHash, userID, filename, originClusterID, storageClusterID, streamID, dvrHash string) (*commodorepb.MintChapterPlaybackIDResponse, error)
	...
	ListStreams(ctx context.Context, pagination *commonpb.CursorPaginationRequest, search string) (*commodorepb.ListStreamsResponse, error)
	...
	DeleteDVR(ctx context.Context, dvrHash string) (bool, error)
	...
	ResolveViewer(ctx context.Context, req *sharedpb.ViewerEndpointRequest) (*sharedpb.ViewerEndpointResponse, error)
	...
	ImportVodAsset(ctx context.Context, req *sharedpb.ImportVodAssetRequest) (*sharedpb.ImportVodAssetResponse, error)
