...
type Interface interface {
	...
	GetArtifactNodeCopies(ctx context.Context, tenantID string, artifactHash string) (*periscopepb.GetArtifactNodeCopiesResponse, error)
	...
	ListTopAssets(ctx context.Context, tenantID string, timeRange *TimeRangeOpts, limit int32) (*periscopepb.ListTopAssetsResponse, error)
