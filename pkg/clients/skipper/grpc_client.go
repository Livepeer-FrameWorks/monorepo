...
type GRPCClient struct {
	...
	client skipperpb.SkipperChatServiceClient
...
func NewGRPCClient(config GRPCConfig) (*GRPCClient, error) {
	...
	return &GRPCClient{
		conn:   conn,
		client: skipperpb.NewSkipperChatServiceClient(conn),
...
func (c *GRPCClient) Chat(ctx context.Context, req *skipperpb.SkipperChatRequest) (grpc.ServerStreamingClient[skipperpb.SkipperChatEvent], error) {
	return c.client.Chat(ctx, req)
}

// ListConversations lists conversations for the authenticated user.
func (c *GRPCClient) ListConversations(ctx context.Context, limit, offset int32) (*skipperpb.ListSkipperConversationsResponse, error) {
	return c.client.ListConversations(ctx, &skipperpb.ListSkipperConversationsRequest{
		Limit:  limit,
		Offset: offset,
	})
}
...
func (c *GRPCClient) GetConversation(ctx context.Context, id string) (*skipperpb.SkipperConversationDetail, error) {
	return c.client.GetConversation(ctx, &skipperpb.GetSkipperConversationRequest{
		Id: id,
	})
}

// DeleteConversation deletes a conversation.
func (c *GRPCClient) DeleteConversation(ctx context.Context, id string) (*skipperpb.DeleteSkipperConversationResponse, error) {
	return c.client.DeleteConversation(ctx, &skipperpb.DeleteSkipperConversationRequest{
		Id: id,
	})
}

// UpdateConversationTitle updates the title of a conversation.
func (c *GRPCClient) UpdateConversationTitle(ctx context.Context, id, title string) (*skipperpb.SkipperConversationSummary, error) {
	return c.client.UpdateConversationTitle(ctx, &skipperpb.UpdateSkipperConversationTitleRequest{
		Id:    id,
		Title: title,
	})
}
...
func (c *GRPCClient) ListReports(ctx context.Context, limit, offset int32) (*skipperpb.ListSkipperReportsResponse, error) {
	return c.client.ListReports(ctx, &skipperpb.ListSkipperReportsRequest{
		Limit:  limit,
		Offset: offset,
	})
}
...
func (c *GRPCClient) GetReport(ctx context.Context, id string) (*skipperpb.SkipperReport, error) {
	return c.client.GetReport(ctx, &skipperpb.GetSkipperReportRequest{Id: id})
}

// MarkReportsRead marks investigation reports as read.
func (c *GRPCClient) MarkReportsRead(ctx context.Context, ids []string) (*skipperpb.MarkSkipperReportsReadResponse, error) {
	return c.client.MarkReportsRead(ctx, &skipperpb.MarkSkipperReportsReadRequest{Ids: ids})
}

// GetUnreadReportCount returns the count of unread investigation reports.
func (c *GRPCClient) GetUnreadReportCount(ctx context.Context) (*skipperpb.GetUnreadReportCountResponse, error) {
	return c.client.GetUnreadReportCount(ctx, &skipperpb.GetUnreadReportCountRequest{})
}
