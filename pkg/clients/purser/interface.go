...
type Interface interface {
	...
	GetPrepaidBalance(ctx context.Context, tenantID string) (*purserpb.PrepaidBalance, error)
	InitializePrepaidBalance(ctx context.Context, tenantID string, initialBalanceCents, thresholdCents int64) (*purserpb.PrepaidBalance, error)
	InitializePrepaidAccount(ctx context.Context, tenantID string) (*purserpb.InitializePrepaidAccountResponse, error)
	...
	TopupBalance(ctx context.Context, tenantID string, amountCents int64, description string, referenceID, referenceType *string) (*purserpb.BalanceTransaction, error)
	DeductBalance(ctx context.Context, tenantID string, amountCents int64, description string, referenceID, referenceType *string) (*purserpb.BalanceTransaction, error)
