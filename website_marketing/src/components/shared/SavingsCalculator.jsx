...
const Calculator = ({ className, variant = 'default' }) => {
  ...
  return (
    <div className={cn('pricing-calculator', variant === 'compact' && 'pricing-calculator--compact', className)}>
      ...
      <div className="pricing-calculator__grid">
        <div className="pricing-calculator__inputs">
          <div className="pricing-calculator__row">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <Label htmlFor={ids.viewers} className="pricing-calculator__label">Concurrent viewers</Label>
                <Input
                  id={ids.viewers}
                  type="number"
          ...
          <div className="pricing-calculator__row pricing-calculator__row--split">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <Label htmlFor={ids.hoursPerDay} className="pricing-calculator__label">Hours/day</Label>
                <Input
                  id={ids.hoursPerDay}
                  type="number"
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <Label htmlFor={ids.daysPerMonth} className="pricing-calculator__label">Days/month</Label>
                <Input
                  id={ids.daysPerMonth}
                  type="number"
                  className="w-20 h-9 text-sm"
          ...
          <div className="pricing-calculator__row pricing-calculator__row--split">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <Label htmlFor={ids.edgeOffloadPercent} className="pricing-calculator__label">Edge offload (%)</Label>
                <Input
              ...
              <Slider
                ...
                className="w-full"
              />
              <div className="pricing-calculator__hint">Offloaded minutes are not billed by FrameWorks.</div>
            </div>
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <Label htmlFor={ids.gpuHoursMonthly} className="pricing-calculator__label">GPU hrs/mo</Label>
                <Input
              ...
              <Slider
                ...
                className="w-full"
              />
              <div className="pricing-calculator__hint">Included by tier: 10/50/250 hrs. Overage €{formatNumber(GPU_OVERAGE_PER_HOUR)}/hr.</div>
            </div>
          </div>
        </div>
        <div className="pricing-calculator__panels">
          <div className="pricing-calculator__panel">
            ...
            <div className="pricing-calculator__metric">
              ...
              <span className="pricing-calculator__metric-value">{formatNumber(bestEstimate.billableMinutes)}</span>
            </div>
          </div>
          <div className="pricing-calculator__panel">
            {isEnterpriseVolume && (
            ...
            <div className="pricing-calculator__panel-heading">
              ...
              <InfoTooltip>
                Delivery is priced per minute. Offload to your own edges to shrink billable minutes. GPU hours are separate; overage is charged per hour. Enterprise: custom quote.
              </InfoTooltip>
            </div>
            <div className="pricing-calculator__metric">
