  ...
  (
    ...
    >
      ...
      <MarketingGridSeam
        ...
        className={cn(
          "marketing-partner-surface__grid",
          variant === "flush" && "marketing-partner-surface__grid--flush"
        )}
      >
        {partners.map((partner) => {
          ...
          return (
            ...
            >
              <div className="marketing-partner-card__header">
                <div className="marketing-partner-card__identity">
                  <span className="marketing-partner-card__avatar">
                    {partner.avatar ? (
                      <img src={partner.avatar} alt="" aria-hidden="true" />
                    ) : (
                      renderSlot(partner.icon)
                    )}
                  </span>
                  <div className="marketing-partner-card__meta">
                    <span className="marketing-partner-card__name">{partner.name}</span>
                    {partner.role ? (
                      <span className="marketing-partner-card__role">{partner.role}</span>
                    ) : null}
                  </div>
                </div>
                {hasLink ? (
              ...
              {partner.description ? (
                <p className="marketing-partner-card__copy">{partner.description}</p>
              ) : null}
            </Wrapper>
          );
        })}
