...
const MarketingHero = ({
  ...
  const accentElements = (accents ?? []).map((accent, index) => {
  ...
  return (
    ...
    >
      ...
      <SectionContainer className="marketing-hero__container px-0 sm:px-0">
        <motion.div className="marketing-hero__layout" initial={{ opacity: 0, y: 26 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
          <div className="marketing-hero__body">
            <div className="marketing-hero__content">
              {eyebrow ? <span className="marketing-hero__eyebrow marketing-pill">{eyebrow}</span> : null}
              ...
              {support ? <div className="marketing-hero__support">{renderSlot(support)}</div> : null}
              ...
              {footnote ? <div className="marketing-hero__footnote">{renderSlot(footnote)}</div> : null}
