              ...
              <div className="marketing-timeline__row">
                ...
                <div className="marketing-timeline__content">
                  <div className="marketing-timeline__title-row">
                    {item.year ? (
                      <span className="marketing-timeline__year">{item.year}</span>
                    ) : null}
                    <span className="marketing-timeline__title">{item.title}</span>
                  </div>
                  {item.subtitle ? (
                    <span className="marketing-timeline__subtitle">{item.subtitle}</span>
                  ) : null}
                </div>
              </div>
              {badges.length ? (
                <div className="marketing-timeline__badges">
                  {badges.map((badge) => (
                    <Badge
                      key={`${value}-${badge}`}
                      variant="outline"
                      className="marketing-timeline__badge"
                    >
                      {badge}
                    </Badge>
                  ))}
