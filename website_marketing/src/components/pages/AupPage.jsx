...
const fairUse = [
  ...
  "We monitor for patterns that degrade the experience for others, including runaway retries, abandoned high-bitrate ingests, and automated abuse. We may rate-limit or pause them to protect the network.",
];
