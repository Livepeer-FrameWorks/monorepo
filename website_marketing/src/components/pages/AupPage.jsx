      ...
      <SectionContainer className="max-w-3xl space-y-12">
        <div className="space-y-4">
          ...
          <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
            ...
            <p>
              We may throttle, suspend, or terminate accounts that violate these rules. Serious violations may be
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 text-sm leading-relaxed text-muted-foreground">
            <p>
              Unsure whether your use case complies with the policy? Contact us before you deploy. We are happy to
              confirm whether a workload is acceptable or suggest alternatives.
            </p>
            <p>
              Report suspected abuse to <a href={`mailto:${config.contactEmail}`} className="text-accent underline">{config.contactEmail}</a>.
            </p>
          </div>
        </div>
      </SectionContainer>
