...
FOGHORN_CONTROL_REALPG_TESTS := $(FOGHORN_CONTROL_REALPG_TESTS_BASE)|TestDelayedSyncCannotMovePlacementClockBackward_RealPG
...
NAVIGATOR_STORE_REALPG_TESTS := TestNavigatorStoreQueryPack_RealPG
NAVIGATOR_STORE_REALYB_TESTS := TestNavigatorStoreQueryPack_RealYugabyte
FOGHORN_STATE_REALVALKEY_TESTS := TestRedisStateContracts_RealValkey|TestTenantCapacityContracts_RealValkey|TestTenantCapacityRenewRespectsCap_RealValkey|TestTenantCapacityBoundedCleanupCannotEraseReactivatedViewer_RealValkey|TestTenantCapacityTargetReconciledBeyondBoundedCleanup_RealValkey
FOGHORN_CONTROL_REALVALKEY_TESTS := TestStreamRegistryContracts_RealValkey|TestRelayGrantContracts_RealValkey

verify-foghorn-test-selection:
...
verify-schema-migrations-core: verify-foghorn-test-selection
	...
	@$(CONTRACT_GO_TEST) api_analytics_ingest clickhouse/periscope-metering-chain-ingest -tags schema_verify -run 'TestSourceFactProjectionAndLedgerReplay_RealClickHouse' -count=1 -timeout 600s ./internal/handlers/
	...
	@$(CONTRACT_GO_TEST) api_analytics_query clickhouse/periscope-query-rpc -tags schema_verify -run 'TestEveryRPCQuerySiteExecutesAgainstCurrentClickHouse|TestClusterWorkloadSeparatesStorageFlowStockAndScope_RealClickHouse|TestFederationSummaryPreservesOperatorHistoryWithoutDualRollupDuplicates_RealClickHouse' -count=1 -timeout 1200s ./internal/grpc/
	...
	@$(CONTRACT_GO_TEST) api_control postgres/commodore-query-catalog -tags schema_verify -run 'TestGeneratedQueryCatalogPrepares_RealPG|TestDVRRegistrationSnapshotsReadyWebhookAuthority_RealPG|TestResolveVODByHashIdentifiesChapterParent_RealPG|TestChapterPlaybackAuthorityDataMigration_RealPG|TestChapterPlaybackAuthorityBackfillDoesNotOverwriteConcurrentPolicyCascade_RealPG|TestUpsertChapterPlaybackIDRejectsCrossTenantCollision_RealPG|TestArtifactCreationCommandAckLease_RealPG|TestManualQueryAdapters_RealPG|TestAccountSessionRepository_RealPG|TestAccountRecoveryWalletRepository_RealPG' -count=1 -timeout 600s ./internal/database/commodoredb/
...
verify-foghorn-valkey: verify-foghorn-test-selection
	...
	@$(CONTRACT_GO_TEST) api_balancing valkey/foghorn-federation -tags schema_verify -run 'TestFederationCacheContracts_RealValkey' -count=1 -timeout 600s ./internal/federation/
...
verify-schema-postgres: verify-foghorn-test-selection
	...
	@cd api_control && go test -tags schema_verify -run 'TestGeneratedQueryCatalogPrepares_RealPG|TestDVRRegistrationSnapshotsReadyWebhookAuthority_RealPG|TestResolveVODByHashIdentifiesChapterParent_RealPG|TestChapterPlaybackAuthorityDataMigration_RealPG|TestChapterPlaybackAuthorityBackfillDoesNotOverwriteConcurrentPolicyCascade_RealPG|TestUpsertChapterPlaybackIDRejectsCrossTenantCollision_RealPG|TestArtifactCreationCommandAckLease_RealPG|TestManualQueryAdapters_RealPG|TestAccountSessionRepository_RealPG|TestAccountRecoveryWalletRepository_RealPG' -count=1 -timeout 600s ./internal/database/commodoredb/
	...
	@cd api_tenants && go test -tags schema_verify -run 'TestGeneratedQueryCatalogPrepares_RealPG|TestManualQueryAdapters_RealPG|TestConvertedRuntimeAdapters_RealPG' -count=1 -timeout 600s ./internal/database/quartermasterdb/
