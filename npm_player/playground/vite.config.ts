...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@livepeer-frameworks/player-react/player.css": path.resolve(__dirname, "../packages/react/src/player.css"),
      "@livepeer-frameworks/player-svelte/player.css": path.resolve(__dirname, "../packages/svelte/src/player.css"),
      "@livepeer-frameworks/player-core/player.css": path.resolve(__dirname, "../packages/core/src/styles/player.css"),
      ...
      "@livepeer-frameworks/streamcrafter-react/streamcrafter.css": path.resolve(__dirname, "../../npm_studio/packages/react/src/streamcrafter.css"),
      "@livepeer-frameworks/streamcrafter-svelte/streamcrafter.css": path.resolve(__dirname, "../../npm_studio/packages/svelte/src/streamcrafter.css"),
      "@livepeer-frameworks/streamcrafter-core/streamcrafter.css": path.resolve(__dirname, "../../npm_studio/packages/core/src/styles/streamcrafter.css"),
      "@livepeer-frameworks/streamcrafter-core": path.resolve(__dirname, "../../npm_studio/packages/core/src"),
      "@livepeer-frameworks/streamcrafter-react": path.resolve(__dirname, "../../npm_studio/packages/react/src"),
      // Deduplicate React
      "react": path.resolve(__dirname, "node_modules/react"),
      "react-dom": path.resolve(__dirname, "node_modules/react-dom"),
    },
    dedupe: ['react', 'react-dom', '@radix-ui/react-context-menu', '@radix-ui/react-select', '@radix-ui/react-slider', '@radix-ui/react-slot'],
  },
  server: {
    port: 4173,
    open: true,
    fs: {
      allow: [
        ...
        path.resolve(__dirname, '../../npm_studio'),
      ],
    },
  },
  preview: {
