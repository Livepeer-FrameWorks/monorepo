...
// Handles direct playback: native HTML5 video + WHEP (WebRTC)
export class DirectPlaybackPlayerImpl extends BasePlayer {
  readonly capability: PlayerCapability = {
    name: "Direct Playback Player",
    shortname: "direct",
...
const DirectPlaybackPlayer: React.FC<Props> = ({ 
  src, 
  muted = true, 
  autoPlay = true, 
  controls = true, 
...
export default DirectPlaybackPlayer;
