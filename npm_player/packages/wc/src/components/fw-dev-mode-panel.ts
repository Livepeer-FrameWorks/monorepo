                                ...
                                ? html`
                                    ...
                                    ${typeof combo.scoreBreakdown.reliabilityScore === "number"
                                      ? html`
                                        ...
                                        `
                                      : nothing}
                                    ${typeof combo.scoreBreakdown.latencyScore === "number"
                                      ? html`
                                          <div class="fw-dev-tooltip-row">
                                            Protocol axes (${this.playbackMode}):
                                            <span class="fw-dev-tooltip-value"
                                              >lat ${combo.scoreBreakdown.latencyScore.toFixed(2)} ·
                                              stab
                                              ${(combo.scoreBreakdown.stabilityScore ?? 0).toFixed(
                                                2
                                              )}
                                              · boot
                                              ${(combo.scoreBreakdown.bootScore ?? 0).toFixed(2)} ·
                                              vod
                                              ${(combo.scoreBreakdown.vodScore ?? 0).toFixed(
                                                2
                                              )}</span
                                            >
                                          </div>
