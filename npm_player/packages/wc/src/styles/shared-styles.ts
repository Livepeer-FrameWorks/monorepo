 ...
 * Component styles are scoped with fw-* classes so host stylesheets do not need Tailwind.
 */
...
/* Scoped utility fallbacks for wrappers that render package components without Tailwind. */
.fw-player-surface.relative,
.fw-player-surface .relative {
  position: relative;
}

.fw-player-surface.absolute,
.fw-player-surface .absolute {
  position: absolute;
}

.fw-player-surface.flex,
.fw-player-surface .flex {
  display: flex;
}

.fw-player-surface.hidden,
.fw-player-surface .hidden {
  display: none;
}

.fw-player-surface .flex-col {
  flex-direction: column;
}

.fw-player-surface .items-center {
  align-items: center;
}

.fw-player-surface .justify-center {
  justify-content: center;
}

.fw-player-surface .justify-between {
  justify-content: space-between;
}

.fw-player-surface .justify-start {
  justify-content: flex-start;
}

.fw-player-surface .justify-end {
  justify-content: flex-end;
}

.fw-player-surface.w-full,
.fw-player-surface .w-full {
  width: 100%;
}

.fw-player-surface.h-full,
.fw-player-surface .h-full {
  height: 100%;
}

.fw-player-surface.overflow-hidden,
.fw-player-surface .overflow-hidden {
  overflow: hidden;
}

.fw-player-surface .overflow-auto {
  overflow: auto;
}

.fw-player-surface .min-w-0 {
  min-width: 0;
}

.fw-player-surface .flex-1 {
  flex: 1 1 0%;
}

.fw-player-surface .flex-shrink-0,
.fw-player-surface .shrink-0 {
  flex-shrink: 0;
}

.fw-player-surface .inset-0 {
  inset: 0;
}

.fw-player-surface .inset-x-0 {
  left: 0;
  right: 0;
}

.fw-player-surface .top-0 {
  top: 0;
}

.fw-player-surface .top-2 {
  top: 0.5rem;
}

.fw-player-surface .top-3 {
  top: 0.75rem;
}

.fw-player-surface .right-0 {
  right: 0;
}

.fw-player-surface .right-2 {
  right: 0.5rem;
}

.fw-player-surface .right-3 {
  right: 0.75rem;
}

.fw-player-surface .bottom-0 {
  bottom: 0;
}

.fw-player-surface .bottom-20 {
  bottom: 5rem;
}

.fw-player-surface .left-0 {
  left: 0;
}

.fw-player-surface .left-1\\/2 {
  left: 50%;
}

.fw-player-surface .z-10 {
  z-index: 10;
}

.fw-player-surface .z-20 {
  z-index: 20;
}

.fw-player-surface .z-30 {
  z-index: 30;
}

.fw-player-surface .z-\\[4\\] {
  z-index: 4;
}

.fw-player-surface.pointer-events-none,
.fw-player-surface .pointer-events-none {
  pointer-events: none;
}

.fw-player-surface.pointer-events-auto,
.fw-player-surface .pointer-events-auto {
  pointer-events: auto;
}

.fw-player-surface .-translate-x-1\\/2 {
  transform: translateX(-50%);
}

.fw-player-surface .scale-75 {
  transform: scale(0.75);
}

.fw-player-surface .scale-100 {
  transform: scale(1);
}

.fw-player-surface .-translate-x-1\\/2.scale-75 {
  transform: translateX(-50%) scale(0.75);
}

.fw-player-surface .-translate-x-1\\/2.scale-100 {
  transform: translateX(-50%) scale(1);
}

.fw-player-surface .w-1\\/3 {
  width: 33.333333%;
}

.fw-player-surface .w-3\\.5 {
  width: 0.875rem;
}

.fw-player-surface .h-3\\.5 {
  height: 0.875rem;
}

.fw-player-surface .w-4 {
  width: 1rem;
}

.fw-player-surface .h-4 {
  height: 1rem;
}

.fw-player-surface .w-8 {
  width: 2rem;
}

.fw-player-surface .h-8 {
  height: 2rem;
}

.fw-player-surface .w-20 {
  width: 5rem;
}

.fw-player-surface .h-20 {
  height: 5rem;
}

.fw-player-surface .max-w-\\[70\\%\\] {
  max-width: 70%;
}

.fw-player-surface .max-w-\\[80\\%\\] {
  max-width: 80%;
}

.fw-player-surface .max-w-\\[320px\\] {
  max-width: 320px;
}

.fw-player-surface .max-w-sm {
  max-width: 24rem;
}

.fw-player-surface .max-h-\\[80\\%\\] {
  max-height: 80%;
}

.fw-player-surface .min-h-\\[280px\\] {
  min-height: 280px;
}

.fw-player-surface .gap-1 {
  gap: 0.25rem;
}

.fw-player-surface .gap-2 {
  gap: 0.5rem;
}

.fw-player-surface .gap-4 {
  gap: 1rem;
}

.fw-player-surface .p-1 {
  padding: 0.25rem;
}

.fw-player-surface .p-4 {
  padding: 1rem;
}

.fw-player-surface .p-5 {
  padding: 1.25rem;
}

.fw-player-surface .p-6 {
  padding: 1.5rem;
}

.fw-player-surface .px-2 {
  padding-left: 0.5rem;
  padding-right: 0.5rem;
}

.fw-player-surface .px-2\\.5 {
  padding-left: 0.625rem;
  padding-right: 0.625rem;
}

.fw-player-surface .px-3 {
  padding-left: 0.75rem;
  padding-right: 0.75rem;
}

.fw-player-surface .px-4 {
  padding-left: 1rem;
  padding-right: 1rem;
}

.fw-player-surface .px-6 {
  padding-left: 1.5rem;
  padding-right: 1.5rem;
}

.fw-player-surface .py-1 {
  padding-top: 0.25rem;
  padding-bottom: 0.25rem;
}

.fw-player-surface .py-1\\.5 {
  padding-top: 0.375rem;
  padding-bottom: 0.375rem;
}

.fw-player-surface .py-2 {
  padding-top: 0.5rem;
  padding-bottom: 0.5rem;
}

.fw-player-surface .py-2\\.5 {
  padding-top: 0.625rem;
  padding-bottom: 0.625rem;
}

.fw-player-surface .py-3 {
  padding-top: 0.75rem;
  padding-bottom: 0.75rem;
}

.fw-player-surface .mt-0\\.5 {
  margin-top: 0.125rem;
}

.fw-player-surface .mt-1 {
  margin-top: 0.25rem;
}

.fw-player-surface .mt-1\\.5 {
  margin-top: 0.375rem;
}

.fw-player-surface .mt-2 {
  margin-top: 0.5rem;
}

.fw-player-surface .mt-3 {
  margin-top: 0.75rem;
}

.fw-player-surface .mb-1 {
  margin-bottom: 0.25rem;
}

.fw-player-surface .ml-auto {
  margin-left: auto;
}

.fw-player-surface .ml-0\\.5 {
  margin-left: 0.125rem;
}

.fw-player-surface .ml-2 {
  margin-left: 0.5rem;
}

.fw-player-surface .-ml-4 {
  margin-left: -1rem;
}

.fw-player-surface .-mr-1 {
  margin-right: -0.25rem;
}

.fw-player-surface .text-center {
  text-align: center;
}

.fw-player-surface .text-right {
  text-align: right;
}

.fw-player-surface .text-\\[10px\\] {
  font-size: 10px;
}

.fw-player-surface .text-xs {
  font-size: 0.75rem;
  line-height: 1rem;
}

.fw-player-surface .text-sm {
  font-size: 0.875rem;
  line-height: 1.25rem;
}

.fw-player-surface .text-base {
  font-size: 1rem;
  line-height: 1.5rem;
}

.fw-player-surface .text-lg {
  font-size: 1.125rem;
  line-height: 1.75rem;
}

.fw-player-surface .font-mono {
  font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace;
}

.fw-player-surface .font-medium {
  font-weight: 500;
}

.fw-player-surface .font-semibold {
  font-weight: 600;
}

.fw-player-surface .uppercase {
  text-transform: uppercase;
}

.fw-player-surface .tracking-wider {
  letter-spacing: 0.05em;
}

.fw-player-surface .tracking-widest {
  letter-spacing: 0.1em;
}

.fw-player-surface .tabular-nums {
  font-variant-numeric: tabular-nums;
}

.fw-player-surface .truncate {
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
}

.fw-player-surface .line-clamp-2 {
  display: -webkit-box;
  -webkit-line-clamp: 2;
...
.fw-player-surface .text-white {
  color: white;
}

.fw-player-surface .text-white\\/50 {
  color: rgb(255 255 255 / 0.5);
}

.fw-player-surface .text-white\\/60 {
  color: rgb(255 255 255 / 0.6);
}

.fw-player-surface .text-white\\/70 {
  color: rgb(255 255 255 / 0.7);
}

.fw-player-surface .text-white\\/80 {
  color: rgb(255 255 255 / 0.8);
}

.fw-player-surface .text-white\\/90 {
  color: rgb(255 255 255 / 0.9);
}

.fw-player-surface .text-yellow-400 {
  color: rgb(250 204 21);
}

.fw-player-surface .text-red-400 {
  color: rgb(248 113 113);
}

.fw-player-surface .text-slate-400 {
  color: rgb(148 163 184);
}

.fw-player-surface .text-primary {
  color: hsl(var(--fw-accent));
}

.fw-player-surface .text-primary-foreground {
  color: hsl(var(--fw-on-accent));
}

.fw-player-surface .text-muted-foreground {
  color: hsl(var(--fw-text-muted));
}

.fw-player-surface .bg-black,
.fw-player-surface.bg-black {
  background-color: rgb(0 0 0);
}

.fw-player-surface .bg-black\\/60 {
  background-color: rgb(0 0 0 / 0.6);
}

.fw-player-surface .bg-black\\/70 {
  background-color: rgb(0 0 0 / 0.7);
}

.fw-player-surface .bg-black\\/80 {
  background-color: rgb(0 0 0 / 0.8);
}

.fw-player-surface .bg-muted {
  background-color: hsl(var(--fw-surface));
}

.fw-player-surface .bg-primary,
.fw-player-surface .bg-primary\\/90 {
  background-color: hsl(var(--fw-accent) / 0.9);
}

.fw-player-surface .bg-slate-950 {
  background-color: rgb(2 6 23);
}

.fw-player-surface .bg-cover {
  background-size: cover;
}

.fw-player-surface .bg-center {
  background-position: center;
}

.fw-player-surface .bg-gradient-to-b {
  background-image: linear-gradient(to bottom, var(--fw-gradient-stops));
}

.fw-player-surface .from-black\\/70 {
  --fw-gradient-from: rgb(0 0 0 / 0.7);
  --fw-gradient-stops: var(--fw-gradient-from), var(--fw-gradient-to, rgb(0 0 0 / 0));
}

.fw-player-surface .via-black\\/40 {
  --fw-gradient-stops:
    var(--fw-gradient-from), rgb(0 0 0 / 0.4), var(--fw-gradient-to, rgb(0 0 0 / 0));
}

.fw-player-surface .to-transparent {
  --fw-gradient-to: transparent;
}

.fw-player-surface .border {
  border-width: 1px;
  border-style: solid;
}

.fw-player-surface .border-b {
  border-bottom-width: 1px;
  border-bottom-style: solid;
}

.fw-player-surface .border-white\\/10 {
  border-color: rgb(255 255 255 / 0.1);
}

.fw-player-surface .border-white\\/15 {
  border-color: rgb(255 255 255 / 0.15);
}

.fw-player-surface .border-yellow-500\\/30 {
  border-color: rgb(234 179 8 / 0.3);
}

.fw-player-surface .rounded {
  border-radius: 0.25rem;
}

.fw-player-surface .rounded-md {
  border-radius: 0.375rem;
}

.fw-player-surface .rounded-lg {
  border-radius: 0.5rem;
}

.fw-player-surface .rounded-xl {
  border-radius: 0.75rem;
}

.fw-player-surface .rounded-full {
  border-radius: 9999px;
}

.fw-player-surface .shadow-inner {
  box-shadow: inset 0 2px 4px 0 rgb(0 0 0 / 0.05);
}

.fw-player-surface .shadow-lg {
  box-shadow:
    0 10px 15px -3px rgb(0 0 0 / 0.1),
    0 4px 6px -4px rgb(0 0 0 / 0.1);
}

.fw-player-surface .shadow-primary\\/40 {
  box-shadow: 0 10px 15px -3px hsl(var(--fw-accent) / 0.4);
}

.fw-player-surface .backdrop-blur,
.fw-player-surface .backdrop-blur-sm {
  backdrop-filter: blur(4px);
}

.fw-player-surface .transition,
.fw-player-surface .transition-all {
  transition-property: all;
}

.fw-player-surface .transition-colors {
  transition-property: color, background-color, border-color, text-decoration-color, fill, stroke;
}

.fw-player-surface .transition-opacity {
  transition-property: opacity;
}

.fw-player-surface .transition-transform {
  transition-property: transform;
}

.fw-player-surface .duration-200 {
  transition-duration: 200ms;
}

.fw-player-surface .duration-300 {
  transition-duration: 300ms;
}

.fw-player-surface .opacity-0 {
  opacity: 0;
}

.fw-player-surface .opacity-25 {
  opacity: 0.25;
}

.fw-player-surface .opacity-50 {
  opacity: 0.5;
}

.fw-player-surface .opacity-70 {
  opacity: 0.7;
}

.fw-player-surface .opacity-75 {
  opacity: 0.75;
}

.fw-player-surface .opacity-100 {
  opacity: 1;
}

.fw-player-surface .animate-pulse {
  animation: fw-pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite;
}

.fw-player-surface .animate-in,
.fw-player-surface .fade-in,
.fw-player-surface .slide-in-from-bottom-2 {
  animation: fw-fade-slide-in 200ms ease-out;
}

.fw-player-surface .space-y-1 > :not([hidden]) ~ :not([hidden]) {
  margin-top: 0.25rem;
}

.fw-player-surface .hover\\:text-white:hover {
  color: white;
}

.fw-player-surface .hover\\:bg-primary:hover,
.fw-player-surface .focus-visible\\:bg-primary:focus-visible {
  background-color: hsl(var(--fw-accent));
}

.fw-player-surface .group:hover .group-hover\\:rotate-90 {
  transform: rotate(90deg);
}

@media (min-width: 640px) {
  .fw-player-surface .sm\\:flex {
    display: flex;
  }

  .fw-player-surface .sm\\:gap-6 {
    gap: 1.5rem;
  }
}
