                        ...
                        >
                          ...
                          {combo.compatible && combo.scoreBreakdown ? (
                            <>
                              ...
                              {combo.scoreBreakdown.latencyScore !== undefined && (
                                <div className="fw-dev-tooltip-row">
                                  Protocol axes ({playbackMode}):{" "}
                                  <span className="fw-dev-tooltip-value">
                                    lat {combo.scoreBreakdown.latencyScore.toFixed(2)} · stab{" "}
                                    {(combo.scoreBreakdown.stabilityScore ?? 0).toFixed(2)} · boot{" "}
                                    {(combo.scoreBreakdown.bootScore ?? 0).toFixed(2)} · vod{" "}
                                    {(combo.scoreBreakdown.vodScore ?? 0).toFixed(2)}
                                  </span>
                                </div>
                              )}
