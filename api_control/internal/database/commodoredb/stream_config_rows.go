...
type StreamConfigRow struct {
	...
	PullAllowedClusterIDs, ManagedAllowedClusterIDs                                                       []string
	ManagedPlacementCount, DVRChapterIntervalSeconds, DVRRetentionDaysOverride, ClipRetentionDaysOverride sql.NullInt32
}
...
func streamConfigRow(
	...
	ingestMode string, sourceURI sql.NullString, pullEnabled sql.NullBool, pullAllowed []string,
	...
	return StreamConfigRow{
		...
		SourceURIEnc: sourceURI, PullEnabled: pullEnabled, PullAllowedClusterIDs: pullAllowed,
		ManagedSourceKind: managedSourceKind, ManagedAlwaysOn: managedAlwaysOn,
