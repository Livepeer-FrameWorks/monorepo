...
const getPlacementPreviewStream = `-- name: GetPlacementPreviewStream :one
...
type GetPlacementPreviewStreamParams struct {
	StreamID string `db:"stream_id" json:"stream_id"`
	TenantID string `db:"tenant_id" json:"tenant_id"`
}

type GetPlacementPreviewStreamRow struct {
...
func (q *Queries) GetPlacementPreviewStream(ctx context.Context, arg GetPlacementPreviewStreamParams) (GetPlacementPreviewStreamRow, error) {
	row := q.db.QueryRowContext(ctx, getPlacementPreviewStream, arg.StreamID, arg.TenantID)
	var i GetPlacementPreviewStreamRow
	err := row.Scan(
		&i.ID,
		&i.InternalName,
		&i.IngestMode,
