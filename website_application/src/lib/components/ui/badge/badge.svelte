  ...
  export const badgeVariants = tv({
    ...
    variants: {
      ...
      tone: {
        ...
        purple:
          "relative isolate bg-[linear-gradient(135deg,hsl(262_68%_72%),hsl(258_72%_48%))] text-[rgba(8,10,18,0.94)] border-[hsla(258,72%,32%,0.75)] shadow-[0_14px_28px_rgba(6,15,65,0.18)]",
        green:
          "relative isolate bg-[linear-gradient(135deg,hsl(96_55%_66%),hsl(134_52%_44%))] text-[rgba(8,10,18,0.94)] border-[hsla(134,52%,28%,0.75)] shadow-[0_14px_28px_rgba(6,15,65,0.18)]",
        yellow:
          "relative isolate bg-[linear-gradient(135deg,hsl(38_80%_68%),hsl(32_78%_46%))] text-[rgba(8,10,18,0.94)] border-[hsla(32,78%,30%,0.75)] shadow-[0_14px_28px_rgba(6,15,65,0.18)]",
        ...
        orange:
          "relative isolate bg-[linear-gradient(135deg,hsl(28_92%_68%),hsl(20_88%_46%))] text-[rgba(8,10,18,0.94)] border-[hsla(20,88%,30%,0.75)] shadow-[0_14px_28px_rgba(6,15,65,0.18)]",
        ...
        neutral:
          "relative isolate bg-[linear-gradient(135deg,color-mix(in_srgb,hsl(var(--brand-surface-strong))_90%,transparent),color-mix(in_srgb,hsl(var(--brand-surface))_85%,transparent))] text-[hsl(var(--brand-terminal))] border-[hsl(var(--border)/0.55)] shadow-[0_14px_28px_rgba(6,15,65,0.18)]",
      },
    },
    defaultVariants: {
      variant: "default",
