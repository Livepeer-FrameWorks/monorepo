...
{:else}
	<input
		...
		data-slot={dataSlot}
		class={cn(
			"border-input/60 bg-[hsl(var(--brand-surface)/0.9)] selection:bg-primary dark:bg-input/30 selection:text-primary-foreground ring-offset-background placeholder:text-muted-foreground shadow-[0_2px_8px_rgba(6,15,65,0.12)] flex h-auto w-full min-w-0 rounded-lg border px-4 py-3 text-base outline-none transition-[color,box-shadow] disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
			"focus-visible:border-primary/90 focus-visible:ring-primary/35 focus-visible:ring-[2px]",
			"aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
			className
		)}
