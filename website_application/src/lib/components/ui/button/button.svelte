<script lang="ts" module>
  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-[0_12px_28px_rgba(0,0,0,0.35)] hover:bg-primary/90 hover:-translate-y-0.5 hover:shadow-[0_24px_48px_rgba(0,0,0,0.45)]",
        destructive:
        ...
        secondary:
          "bg-secondary text-secondary-foreground shadow-[0_12px_28px_rgba(0,0,0,0.35)] hover:bg-secondary/80 hover:-translate-y-0.5 hover:shadow-[0_24px_48px_rgba(0,0,0,0.45)]",
        ghost:
          "hover:bg-accent/90 hover:text-accent-foreground hover:-translate-y-0.5 dark:hover:bg-accent/50",
