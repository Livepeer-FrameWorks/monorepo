  ...
  <div class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
    <div class="bg-card border border-destructive/50 p-6 max-w-lg w-full shadow-2xl">
      <div class="flex items-center space-x-3 mb-4">
        ...
        <div>
          <h2 class="text-xl font-semibold text-destructive mb-1">Something went wrong</h2>
          <p class="text-muted-foreground text-sm">An error occurred while loading this page</p>
        </div>
      </div>
      ...
      <div class="bg-background border border-border p-4 mb-6">
        ...
        {#if errorState.errorInfo}
          <details class="text-sm">
            ...
            <pre
              class="mt-2 text-xs text-muted-foreground font-mono whitespace-pre-wrap break-words">
