...
export const EXPLORER_CATALOG: ExplorerSection[] = [
  ...
  },
  {
    ...
    title: "Webhooks",
    description:
      "Outbound webhook endpoints and their delivery log. Endpoint secrets are returned only by create and rotate.",
    examples: [
      {
        id: "webhook-endpoints",
        title: "Webhook Endpoints",
        description: "List endpoints with status, subscribed types, and failure streak.",
        operationType: "query",
        templatePath: "operations/queries/GetWebhookEndpointsConnection.gql",
        tags: ["developer", "webhooks"],
      },
      {
        id: "webhook-event-types",
        title: "Webhook Event Types",
        description: 'Public event types an endpoint can subscribe to, plus "*".',
        operationType: "query",
        templatePath: "operations/queries/GetWebhookEventTypes.gql",
        tags: ["developer", "webhooks", "events"],
      },
      {
        id: "webhook-failed-deliveries",
        title: "Failed Webhook Deliveries",
        description: "Deliveries whose retries ran out or that were skipped, newest first.",
        operationType: "query",
        templatePath: "operations/queries/GetWebhookDeliveriesConnection.gql",
        variables: { statuses: ["FAILED", "SKIPPED"], first: 20 },
        tags: ["developer", "webhooks"],
      },
      {
        id: "webhook-delivery-attempts",
        title: "Webhook Delivery Attempts",
        description:
          "One delivery with every HTTP attempt: status code, latency, response excerpt.",
        operationType: "query",
        templatePath: "operations/queries/GetWebhookDelivery.gql",
        variables: { id: "demo_webhook_delivery_001" },
        tags: ["developer", "webhooks"],
      },
    ],
  },
  {
    ...
    examples: [
      ...
      {
        id: "live-tenant-events",
        title: "Tenant Events",
        description: "Every public event of your account, as webhooks deliver them.",
        operationType: "subscription",
        templatePath: "operations/subscriptions/TenantEvents.gql",
        expectedPayload:
          "Event ID, type, time, subject, and the registered payload of the type (stream, clip, recording, upload, multistream, API token, billing, account, and custom domain events).",
        tags: ["subscription", "events"],
      },
      {
        id: "live-clip-recording-events",
        title: "Clip and Recording Events",
        description: "Clip and recording events of one stream.",
        operationType: "subscription",
        templatePath: "operations/subscriptions/TenantEvents.gql",
        expectedPayload:
        ...
        tags: ["advanced", "subscription", "events"],
      },
      {
        id: "live-upload-events",
        title: "Upload Events",
        description: "VOD upload events: created, completed, ready, failed, aborted.",
        operationType: "subscription",
        templatePath: "operations/subscriptions/TenantEvents.gql",
        expectedPayload: "upload.* events with the artifact, filename, and sizes.",
        variables: {
          types: [
            "upload.created",
            "upload.completed",
