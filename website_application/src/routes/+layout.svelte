<script lang="ts">
  ...
  const publicRoutes = [
    ...
    registerIndexPath,
    verifyEmailPath,
    verifyEmailIndexPath,
    forgotPasswordPath,
    forgotPasswordIndexPath,
    resetPasswordPath,
      ...
      {#if isAuthenticated}
        ...
        <div class="flex flex-col h-screen">
            ...
            <div class="flex items-stretch">
              ...
              >
                <span class="text-sm text-muted-foreground"
                  >Welcome, <span class="text-primary font-medium">{user?.name || user?.email}</span
                  ></span
                >
              </div>
          ...
          <div class="flex flex-1 overflow-hidden">
            <!-- Sidebar -->
            <Sidebar on:comingSoon={handleComingSoon} collapsed={sidebarStore.collapsed} />
        ...
        >
          ...
          >
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="hidden lg:flex items-center space-x-8">
                  ...
                  <div class="flex items-center space-x-8">
                    ...
                    >
                      Features
                      <svg
                        class="w-3 h-3 opacity-60 group-hover:opacity-100 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-200"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                  ...
                  <div class="flex items-center space-x-8">
                    <a
                      href={loginPath}
                      class="relative text-foreground-dark hover:text-info transition-colors duration-200 font-medium after:content-[''] after:absolute after:left-0 after:right-0 after:bottom-[-4px] after:h-[2px] after:rounded-full after:bg-[linear-gradient(90deg,hsl(var(--primary)),hsl(var(--accent)))] after:origin-left after:transition-transform after:duration-[250ms] after:ease-[ease] after:opacity-85 {$page
                        .url.pathname === loginIndexPath || $page.url.pathname === loginPath
                        ? 'text-info after:scale-x-100'
                    ...
                    <a
                      href={registerPath}
                      class="relative text-foreground-dark hover:text-info transition-colors duration-200 font-medium after:content-[''] after:absolute after:left-0 after:right-0 after:bottom-[-4px] after:h-[2px] after:rounded-full after:bg-[linear-gradient(90deg,hsl(var(--primary)),hsl(var(--accent)))] after:origin-left after:transition-transform after:duration-[250ms] after:ease-[ease] after:opacity-85 {$page
                        .url.pathname === registerIndexPath || $page.url.pathname === registerPath
                        ? 'text-info after:scale-x-100'
                        : 'after:scale-x-0 hover:after:scale-x-100'}"
                    >
                      Register
              ...
              <!-- Mobile Menu -->
              {#if mobileMenuOpen}
                <div class="lg:hidden border-t border-border bg-background/95 backdrop-blur-sm">
                  <div class="px-4 py-6 space-y-4">
                    ...
                    <div class="pt-4 border-t border-border space-y-3">
                      <Button
                        href={loginPath}
                        variant={$page.url.pathname === loginIndexPath ||
                        $page.url.pathname === loginPath
                          ? "default"
                          : "outline"}
                      ...
                      <Button
                        href={registerPath}
                        variant={$page.url.pathname === registerIndexPath ||
                        $page.url.pathname === registerPath
                          ? "default"
                          : "outline"}
                        class="w-full justify-center"
                        onclick={() => (mobileMenuOpen = false)}
