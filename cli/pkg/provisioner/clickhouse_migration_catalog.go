...
var PeriscopeMigrationCatalog = ClickHouseMigrationCatalog{
	Tables: []string{
		...
		"raw_mist_triggers", "rebuffering_events", "restream_sessions_anomalous", "rollup_backfill_markers",
		"rollup_backfill_seed_receipts",
		"restream_sessions_current", "restream_sessions_final", "routing_cluster_hourly",
	...
	InsertTriggerMVs: []string{
		"client_qoe_5m_mv", "federation_hourly_mv", "federation_hourly_v2_mv", "node_metrics_1h_mv",
	...
	Views: []string{
		...
		"stream_runtime_daily", "stream_runtime_hourly", "stream_sessions_anomalous_v",
		"stream_sessions_final_v", "stream_sessions_topology_v",
		...
		"viewer_hours_hourly", "viewer_sessions_anomalous_v", "viewer_sessions_final_v",
		"viewer_sessions_topology_v", "viewer_usage_5m_v",
	},
}
