...
func chatwootRoleDetect(ctx context.Context, host inventory.Host, config ServiceConfig, helpers RoleBuildHelpers) (*detect.ServiceState, error) {
	return serviceRoleDetect("chatwoot")(ctx, host, config, helpers)
}
