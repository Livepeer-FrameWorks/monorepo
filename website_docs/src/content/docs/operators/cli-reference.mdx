...
- `--version string` - Target release (`stable`, `rc`, or `vX.Y.Z`), resolved the same way as `cluster release apply --version`; defaults to the manifest channel
...
| `frameworks cluster set-channel <channel>`                         | Set the manifest release channel. Valid channels are `stable` and `rc`; `cluster release plan/apply` uses this when no explicit version is given.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
