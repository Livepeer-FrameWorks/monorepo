...
<Aside type="caution" title="Estimates only">
  ...
  estimates. The table below is a planning aid, not a billing promise. It should be treated as a
  rough model until deployments have measured prompt sizes, tool-call counts, conversation lengths,
  provider choices, and model mix.
</Aside>
