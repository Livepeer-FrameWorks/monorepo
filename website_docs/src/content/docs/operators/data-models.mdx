...
Self-hosted and hybrid deployments are in active testing. This page reflects the current implementation and may evolve as the platform hardens.
</Aside>
...
<Aside type="tip">
Raw IPs remain in ClickHouse for future per-tenant analytics features. Operators with direct database access can query these, but platform APIs enforce redaction.
</Aside>
