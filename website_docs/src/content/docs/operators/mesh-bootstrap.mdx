...
description: "How Privateer brings up the internal WireGuard mesh: identity, seed peers, DNS, and Quartermaster-managed topology."
---
...
Privateer does not build a global all-to-all service network. Provisioning and
runtime sync derive mesh reachability from three graphs:
...
central Skipper can attach to the first healthy regional Gateway MCP hub and
fail over deterministically, while the regional Bridges keep
`skipper.internal` as the reciprocal spoke endpoint.
