...
| ------------------ | ----------------------------- | ----------------------------------- | --------------------------------------------------------------- |
| **RTMP Ingest**    | `edge-ingest.your-domain.com` | `/live/{streamKey}`                 | `rtmp://edge-ingest.your-domain.com:1935/live/sk_abc123`        |
| **WHIP Ingest**    | `edge-ingest.your-domain.com` | `/webrtc/{streamKey}`               | `https://edge-ingest.your-domain.com/webrtc/sk_abc123`          |
| **HLS Playback**   | `foghorn.your-domain.com`     | `/play/{playbackId}/hls/index.m3u8` | `https://foghorn.your-domain.com/play/pk_xyz789/hls/index.m3u8` |
| **WebRTC (WHEP)**  | `foghorn.your-domain.com`     | `/play/{playbackId}/webrtc`         | `https://foghorn.your-domain.com/play/pk_xyz789/webrtc`         |
| **Viewer Routing** | `foghorn.your-domain.com`     | `/play/{contentId}`                 | Returns JSON or 307 redirect                                    |
...
STREAMING_INGEST_URL=https://edge-ingest.your-domain.com
STREAMING_PLAY_URL=https://foghorn.your-domain.com
...
<Aside type="tip">
  For streaming endpoints (`edge.your-domain.com`, `edge-ingest.your-domain.com`), use DNS-only mode
