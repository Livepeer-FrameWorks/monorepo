...
page. If it persists, check that `LISTMONK_FRONTEND_URL` in GitOps is your
public Listmonk URL and re-run `frameworks cluster provision`, which writes it
to `app.root_url`. If you can sign in, you can also correct **Root URL** under
**Settings → General**.
