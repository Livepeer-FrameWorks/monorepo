...
This fetches the cluster manifest and referenced files from the repo, then runs the standard provision pipeline. Operators manage config changes via pull requests.
