...
_Note: The Android app is present in-tree as an early stub. It is not a supported production client
yet._
...
| **Open Marketplace** | Operators can publish listed clusters with access controls, invites, subscription requests, and pricing metadata. A vetted public marketplace program is still being built.                                                                                |
