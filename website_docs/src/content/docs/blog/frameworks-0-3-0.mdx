...
description: "The next FrameWorks tag focuses on the operating layer: platform admin, analytics, resilient edge playback, safer agent workflows, and the real-time foundation for chat and conferencing."
tags:
  - announcements
  - releases
  - roadmap
