...
description: "A live stream is a ring buffer on an edge node. Everything that outlives it — DVR archives, chapters, clips, VOD — has to be copied out before the buffer moves on. How that pipeline works, including across clusters."
tags:
  - engineering
  - architecture
  - dvr
