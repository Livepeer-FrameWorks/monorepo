...
| **BYOC ownership levels** | Expanding | Docs | The supported ownership boundary for bring-your-own edge capacity and adjacent unsupported control-plane models. |
| ↳ Customer-operated media control plane | Expanding | — | Operate Foghorn and its coupled media/data services outside the FrameWorks provider plane. |
...
| ↳ Customer-operated full platform | Expanding | — | A separate, unsupported trust model in which a customer would operate Foghorn, federation, media dependencies, durable services, and an isolated control plane. |
