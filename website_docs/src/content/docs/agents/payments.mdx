...
<Aside type="tip">
  API requests are free but rate limited. Current beta does not commercially enforce paid-tier usage
  allowances for stream count, viewer connections, or delivered minutes; prepaid balance still gates
  agent write actions and suspension handling.
</Aside>
