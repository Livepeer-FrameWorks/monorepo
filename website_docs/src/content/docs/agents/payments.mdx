...
```json
{
  ...
  "payTo": "0x...",
  "networks": [
    { "name": "base", "chainId": 8453, "asset": "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913" },
    { "name": "arbitrum", "chainId": 42161, "asset": "0xaf88d065e77c8cC2239327C5EDb3A432268e5831" }
  ]
}
```
...
Call `submit_payment` with `value=0` to authenticate via wallet signature without transferring funds. This proves wallet ownership and provisions a tenant, similar to `wallet-login`.
...
| Arbitrum Sepolia (testnet) | 421614   | `0x75faf114eafb1BDbe2F0316DF893fd58CE46AA4d` |
...
Testnet payments are accepted when enabled on the server. Use testnets for agent dry-runs without spending mainnet funds.
...
<Aside type="caution">
  x402 payments of €100 or more require billing details. Call `update_billing_details` first.
</Aside>
