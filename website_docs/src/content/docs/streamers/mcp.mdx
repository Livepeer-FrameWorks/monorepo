...
FrameWorks publishes agent-facing metadata and a wallet-first auth flow:

- **skill.md**: https://frameworks.network/skill.md
- **skill.json**: https://frameworks.network/skill.json
- **MCP discovery**: `/.well-known/mcp.json`

Agents should use wallet authentication or x402 payment headers for headless access. Wallet auth auto-provisions a prepaid tenant with $0 balance, while x402 enables instant top-ups and acts as an anti-abuse barrier.
