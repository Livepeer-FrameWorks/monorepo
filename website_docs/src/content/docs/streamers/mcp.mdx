...
MCP is an open protocol for connecting AI models to external systems. It defines three primitives: **Resources** (data to read), **Tools** (actions to take), and **Prompts** (guided workflows). See [modelcontextprotocol.io](https://modelcontextprotocol.io).
</Aside>
