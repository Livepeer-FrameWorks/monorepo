...
```
HLS:    %EDGE_URL%/play/{content-id}/hls/index.m3u8
DASH:   %EDGE_URL%/play/{content-id}/cmaf/index.mpd
WebRTC: %EDGE_URL%/play/{content-id}/webrtc
MP4:    %EDGE_URL%/play/{content-id}.mp4
```
