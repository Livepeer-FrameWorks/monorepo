...
<Aside type="note" title="Same API everywhere">
This API is identical whether you're using the managed service or self-hosting. Self-hosted deployments run the same Bridge (API Gateway) with the same GraphQL schema.
</Aside>
