...
These encoder settings are the same for managed and self‑hosted deployments. Ingest endpoints and exposed ports can differ, so use the URLs shown in your dashboard.
</Aside>
