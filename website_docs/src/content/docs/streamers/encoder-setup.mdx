...
These encoder settings work identically whether you're using the managed FrameWorks service or self-hosting on your own infrastructure.
</Aside>
...
Selecting the correct bitrate is key to stream stability. A higher bitrate improves quality but requires a stronger internet connection. Use these targets as a starting point:

| Quality | Resolution | FPS | Bitrate |
|---------|-----------|-----|---------|
| Low | 720p | 30 | 2,500 kbps |
| Medium | 1080p | 30 | 4,500 kbps |
| High | 1080p | 60 | 6,000 kbps |
| Very High | 1440p | 60 | 9,000 kbps |
