...
Create a USDC prepaid top-up deposit. ETH and LPT prepaid top-ups are not currently accepted by the prepaid top-up backend.
...
x402 supports USDC on Base and Arbitrum. Prepaid crypto top-ups currently accept USDC only.
