...
description: "FrameWorks is an alternative to video APIs like Mux, Bunny Stream, and Livepeer Studio — run it hosted, hybrid, or fully self-hosted. Moving from another platform? Pick your starting point."
sidebar:
  order: 1
---
