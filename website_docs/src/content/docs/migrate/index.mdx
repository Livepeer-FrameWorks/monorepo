...
- **Always-on DVR without arbitrary rollover.** Run long-lived live channels, keep one continuous archive, and replay historical windows through chapter playlists.
...
<Aside type="note">
  Some FrameWorks areas are still maturing: billing rates, production self-hosting runbooks, the
