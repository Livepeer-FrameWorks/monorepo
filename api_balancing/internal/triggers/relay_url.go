...
// sidecar): 127.0.0.1 wherever Mist and Helmsman share loopback, which is
// every native host and every edge container, including the dev compose edge.
//
...
// instead: Helmsman's relay accepts it via loopback, or via
// HELMSMAN_RELAY_TRUSTED_CIDR when Mist reaches Helmsman over a non-loopback
// address.
//
